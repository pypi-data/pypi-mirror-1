...
$Id: setup.py 49136 2006-09-19 09:16:11Z bdelbosc $
"""
...
setup(
    ...
    long_description="""\
BundleMan try to manage releasing of application build on versioned products
under subversion.

An application is a products suite defined using subversion
svn:externals property. An application is a bundle of products.
