...
MXBASE_URL = 'http://downloads.egenix.com/python/egenix-mx-base-3.1.2.zip'
...
_urls = {
    # Linux 32bit
    (2, 1, 'Linux', 'i686'): 'py2.1',
    (2, 2, 'Linux', 'i686'): 'py2.2',
    (2, 3, 'Linux', 'i686'): 'py2.3',
    (2, 4, 'Linux', 'i686'): 'py2.4',
    (2, 5, 'Linux', 'i686'): 'py2.5',
