...
asciiporn/optimize/SConscript
asciiporn/optimize/SConstruct
asciiporn/optimize/Zeros
asciiporn/optimize/Zeros/bisect.c
asciiporn/optimize/Zeros/brenth.c
asciiporn/optimize/Zeros/brentq.c
asciiporn/optimize/Zeros/ridder.c
asciiporn/optimize/Zeros/zeros.h
asciiporn/optimize/__init__.py
asciiporn/optimize/__minpack.h
asciiporn/optimize/_minpackmodule.c
asciiporn/optimize/_tstutils.py
asciiporn/optimize/anneal.py
asciiporn/optimize/benchmarks
asciiporn/optimize/benchmarks/bench_zeros.py
asciiporn/optimize/cobyla
asciiporn/optimize/cobyla.py
asciiporn/optimize/cobyla/cobyla.pyf
asciiporn/optimize/cobyla/cobyla2.f
asciiporn/optimize/cobyla/trstlp.f
asciiporn/optimize/info.py
asciiporn/optimize/lbfgsb
asciiporn/optimize/lbfgsb.py
asciiporn/optimize/lbfgsb/lbfgsb.pyf
asciiporn/optimize/lbfgsb/routines.f
asciiporn/optimize/linesearch.py
asciiporn/optimize/minpack
asciiporn/optimize/minpack.h
asciiporn/optimize/minpack.py
asciiporn/optimize/minpack/chkder.f
asciiporn/optimize/minpack/dogleg.f
asciiporn/optimize/minpack/dpmpar.f
asciiporn/optimize/minpack/enorm.f
asciiporn/optimize/minpack/fdjac1.f
asciiporn/optimize/minpack/fdjac2.f
asciiporn/optimize/minpack/hybrd.f
asciiporn/optimize/minpack/hybrd1.f
asciiporn/optimize/minpack/hybrj.f
asciiporn/optimize/minpack/hybrj1.f
asciiporn/optimize/minpack/lmder.f
asciiporn/optimize/minpack/lmder1.f
asciiporn/optimize/minpack/lmdif.f
asciiporn/optimize/minpack/lmdif1.f
asciiporn/optimize/minpack/lmpar.f
asciiporn/optimize/minpack/lmstr.f
asciiporn/optimize/minpack/lmstr1.f
asciiporn/optimize/minpack/qform.f
asciiporn/optimize/minpack/qrfac.f
asciiporn/optimize/minpack/qrsolv.f
asciiporn/optimize/minpack/r1mpyq.f
asciiporn/optimize/minpack/r1updt.f
asciiporn/optimize/minpack/rwupdt.f
asciiporn/optimize/minpack2
asciiporn/optimize/minpack2/dcsrch.f
asciiporn/optimize/minpack2/dcstep.f
asciiporn/optimize/minpack2/minpack2.pyf
asciiporn/optimize/nnls
asciiporn/optimize/nnls.py
asciiporn/optimize/nnls/nnls.f
asciiporn/optimize/nnls/nnls.pyf
asciiporn/optimize/nonlin.py
asciiporn/optimize/optimize.py
asciiporn/optimize/setup.py
asciiporn/optimize/setupscons.py
asciiporn/optimize/slsqp
asciiporn/optimize/slsqp.py
asciiporn/optimize/slsqp/slsqp.pyf
asciiporn/optimize/slsqp/slsqp_optmz.f
asciiporn/optimize/tests
asciiporn/optimize/tests/test_cobyla.py
asciiporn/optimize/tests/test_nnls.py
asciiporn/optimize/tests/test_nonlin.py
asciiporn/optimize/tests/test_optimize.py
asciiporn/optimize/tests/test_slsqp.py
asciiporn/optimize/tests/test_zeros.py
asciiporn/optimize/tnc
asciiporn/optimize/tnc.py
asciiporn/optimize/tnc/moduleTNC.c
asciiporn/optimize/tnc/tnc.c
asciiporn/optimize/tnc/tnc.h
asciiporn/optimize/zeros.c
asciiporn/optimize/zeros.py
...
class Distribution(dist.Distribution):
  def __init__(self, *args, **kwds):
    ...
    self.cmdclass["dev"] = dev; self.metadata.__dict__.update(__metadata__)
