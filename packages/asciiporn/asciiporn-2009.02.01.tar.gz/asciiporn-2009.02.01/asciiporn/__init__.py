...
asciiporn can easily render 24bit megapixel graphics on a 1ghz 500mb machine
...
# importer.find_module("_asciiporn", path = __path__); _asciiporn = importer.load_module("_asciiporn")
