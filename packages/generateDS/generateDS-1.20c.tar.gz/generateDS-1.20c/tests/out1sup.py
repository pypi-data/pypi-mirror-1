...
class people(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='people'):
        ...
        for python_programmer_ in self.python_programmer:
            python_programmer_.export(outfile, level, namespace_, name_='python_programmer')
        for java_programmer_ in self.java_programmer:
            java_programmer_.export(outfile, level, namespace_, name_='java_programmer')
...
class programmer(person):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.elarraytypes is not None:
            showIndent(outfile, level)
            outfile.write('elarraytypes=model_.xs_string(\n')
            self.elarraytypes.exportLiteral(outfile, level, name_='elarraytypes')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node_):
        attrs = node_.attributes
...
class python_programmer(programmer):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='python-programmer'):
        ...
        if self.favorite_editor is not None:
            showIndent(outfile, level)
            outfile.write('<%sfavorite_editor>%s</%sfavorite_editor>\n' % (namespace_, self.format_string(quote_xml(self.favorite_editor).encode(ExternalEncoding), input_name='favorite_editor'), namespace_))
    def hasContent_(self):
        if (
...
class booster(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='booster'):
        ...
        if self.other_name is not None:
            showIndent(outfile, level)
            outfile.write('<%sother_name>%s</%sother_name>\n' % (namespace_, self.format_float(self.other_name, input_name='other_name'), namespace_))
        if self.classxx is not None:
            showIndent(outfile, level)
            outfile.write('<%sclassxx>%s</%sclassxx>\n' % (namespace_, self.format_float(self.classxx, input_name='classxx'), namespace_))
        for other_value_ in self.other_value:
            showIndent(outfile, level)
            outfile.write('<%sother_value>%s</%sother_value>\n' % (namespace_, self.format_float(other_value_, input_name='other_value'), namespace_))
        for type__ in self.type_:
            showIndent(outfile, level)
            outfile.write('<%stype_>%s</%stype_>\n' % (namespace_, self.format_float(type__, input_name='type_'), namespace_))
        for client_handler_ in self.client_handler:
            client_handler_.export(outfile, level, namespace_, name_='client_handler')
    def hasContent_(self):
        if (
            self.firstname is not None or
            self.lastname is not None or
