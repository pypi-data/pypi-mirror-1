...
# =============================================================================
# $Id: web_ui.py 58 2008-03-05 22:38:36Z s0undt3ch $
# =============================================================================
#             $URL: http://wikinotification.ufsoft.org/svn/branches/trac-0.10.x/WikiNotification/web_ui.py $
...
class WikiNotificationWebModule(Component):
    ...
    def process_request(self, req):
        ...
        if wikipage:
            ...
            req.hdf['notification.redir'] = req.href.wiki(wikipage)
            ...
            if req.method == 'POST' and req.args.get('remove'):
                ...
                for wikipage in sel:
                    self._unwatch_page(req, wikipage)
                req.hdf['notification.redir'] = req.href.notification()
