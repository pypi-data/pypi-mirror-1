softwarefabrica.django.common library
=====================================

This library provides the infrastructure common to most non-trivial
SoftwareFabrica `Django`_ applications and projects.
