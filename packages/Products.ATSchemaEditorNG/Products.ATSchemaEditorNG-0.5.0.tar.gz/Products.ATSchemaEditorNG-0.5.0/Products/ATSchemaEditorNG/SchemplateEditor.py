...
class SchemplateEditor(SchemaEditor):
    ...
    def atse_addSchemplate(self, atse_schemplate_id, schema_template, REQUEST=None):
        ...
        if REQUEST:        
            util.redirect(REQUEST, schema_template,
    ...
    def atse_deleteSchemplateById(self, atse_schemplate_id, schema_template, REQUEST=None):
