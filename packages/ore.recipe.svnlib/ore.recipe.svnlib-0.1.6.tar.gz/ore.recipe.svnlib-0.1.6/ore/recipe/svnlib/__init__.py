    ...
    def install( self ):
        ...
        try:
            ...
            try:
                ...
                system("make install")
                system("make swig-py")
                cmd = "make install-swig-py DESTDIR=%s swig_py_libdir=/lib swig_pydir=/lib/python/libsvn swig_pydir_extra=/lib/python/svn"%dest
                cmd = "make install-swig-py DESTDIR=%s"%dest #swig_py_libdir=/lib swig_pydir=/lib/python/libsvn swig_pydir_extra=/lib/python/svn"%dest
            ...
            logger.error("Error in Compilation, result left in working directory %s, install swig-py cmd %s"%(tmp, cmd ))
            raise
        shutil.rmtree(dest)
