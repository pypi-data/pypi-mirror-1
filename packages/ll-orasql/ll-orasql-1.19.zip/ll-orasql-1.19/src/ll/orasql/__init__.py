...
class Connection(Connection):
	...
	def __init__(self, *args, **kwargs):
		...
		:func:`cx_Oracle.connect` the following keyword arguments are supported.
		...
		:var:`unicode` : bool
			If :var:`unicode` is true, strings (and :class:`CLOB` values, if
			:var:`readlobs` has the appropriate value) will be returned as
			:class:`unicode` objects (except for :class:`BLOB` values). Note that
			strings in the national character set (and :class:`NCLOB` values) are
			not supported).
		"""
	...
	def cursor(self, readlobs=None, unicode=None):
		...
		:var:`readlobs` and :var:`unicode` see :meth:`__init__`.
		"""
...
class Cursor(Cursor):
	"""
	A subclass of the cursor class in :mod:`cx_Oracle`. Database results
	returned from :meth:`fetchone`, :meth:`fetchmany`, :meth:`fetchall` and
	:meth:`fetch` or by iterating the cursor will be returned as
	...
	def __init__(self, connection, readlobs=None, unicode=None):
		...
		of :var:`readlobs` and :var:`unicode` see :meth:`Connection.__init__.
		"""
