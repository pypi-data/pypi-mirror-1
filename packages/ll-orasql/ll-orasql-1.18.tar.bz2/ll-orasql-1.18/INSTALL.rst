...
To use this module you need the following software packages:
	...
	3.	`cx_Oracle`_ (version 4.3 or later).
...
__ http://www.livinglogic.de/Python/orasql/Download.html

This will install :mod:`ll.orasql` as part of the :mod:`ll` package.
