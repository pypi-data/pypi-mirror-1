...
from tgext.ws.controllers import WebServicesRoot, WebServicesController, \
                                      wsexpose, wsvalidate

from tgext.ws.runtime import typedproperty, unsigned
...
class BooleanInput(WebServicesController):
    @wsexpose(bool)
    @wsvalidate(bool)
...
class NamespacedRoot(WebServicesRoot):
    def __init__(self):
        super(NamespacedRoot, self).__init__(tns = 'http://foo.bar/service/URI/')
