...
from dictannotation.interfaces import IDictAnnotation
from anytitlesubscriberbase import AnyTitileSubscriberBase

class DictAnnotation2TitleSubscriber( AnyTitileSubscriberBase ) :
