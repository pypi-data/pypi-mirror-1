...
# Todo: Rename as AbstractRegister - this class is NOT a list. :-)
    ...
    def sortDomainObjects(self, domainObjects):
        if debug:
            ...
            if count:
                ...
                msg = "Sorting %s %s domain objects." % (count, className)
                self.log.debug(msg)
...
class DomainObject(DomainBase):
    ...
    def getLabelValue(self):
        ...
        return str(self.getRegisterKeyValue())
