"""
Commmands for the KForge core service layer. 
"""
...
class Command(object):
    """
    Command layer supertype.
    'Service Layer', [Fowler, 2003] 'Command (233)' [GoF, 1995].
    """
...
class DomainObjectCommand(Command):
    ...
    def createRegister(self):
        ...
        return objectClass.createRegister()
...
class DomainObjectList(DomainObjectCommand):
    ...
    def execute(self):
        ...
        if self.startsWith:
            if not self.startsWithAttributeName:
                self.startsWithAttributeName = domainObjectRegister.keyName
