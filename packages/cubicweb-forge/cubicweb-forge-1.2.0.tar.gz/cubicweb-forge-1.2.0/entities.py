...
class Project(project.Project):
    ...
    TICKET_DEFAULT_STATE_RESTR = 'S name IN ("open","confirmed","waiting feedback","in-progress","validation pending")'
...
class Version(version.Version, ProgressMixIn):
    ...
    def unrelated_rql(self, rtype, targettype, role, ordermethod=None,
        ...
        if rtype == 'depends_on' and role == 'subject' and self.has_eid():
            ...
            return super(Version, self).unrelated_rql(
                rtype, targettype, role, ordermethod, vocabconstraints)
