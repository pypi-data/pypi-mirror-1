...
confirmed  = twf.add_state(_('confirmed'))
...
twf.add_transition(_('confirm'), open, confirmed,
                   ('managers', 'staff'), xperm('developer'))
twf.add_transition(_('start'), (open, confirmed), inprogress,
                   ('managers', 'staff'), xperm('developer'))
twf.add_transition(_('stop'), inprogress, confirmed,
                   ('managers', 'staff'), xperm('developer'))
twf.add_transition(_('reject'), (open, confirmed, inprogress), rejected,
                   ('managers', 'staff'), xperm('developer'))
twf.add_transition(_('done'), (open, confirmed, inprogress), vp,
                   ('managers', 'staff'), xperm('developer'))
twf.add_transition(_('deprecate'), (open, confirmed), deprecated,
                   ('managers', 'staff'), xperm('client', 'developer'))
twf.add_transition(_('resolve'), vp, resolved,
                   ('managers', 'staff'), xperm('client'))
twf.add_transition(_('reopen'), (vp, rejected), open,
                   ('managers', 'staff'), xperm('client'))
twf.add_transition(_('wait for feedback'), open, waiting,
                   ('managers', 'staff'), xperm('developer'))
twf.add_transition(_('got feedback'), waiting, open,
                   ('managers', 'staff'), xperm('developer'))


# TestInstance workflow
tiwf = add_workflow(_('default test instance workflow'), 'TestInstance')

todo    = tiwf.add_state(_('todo'), initial=True)
succeed = tiwf.add_state(_('succeed'))
failed  = tiwf.add_state(_('failed'))

tiwf.add_transition(_('success'), todo, succeed,
                    ('managers', 'staff'), xperm('client', 'developer'))
tiwf.add_transition(_('failure'), todo, failed,
                    ('managers', 'staff'), xperm('client', 'developer'))
