...
class CPKCS11Lib(_object):
    ...
    def C_GetMechanismList(*args): return _LowLevel.CPKCS11Lib_C_GetMechanismList(*args)
    def C_GetMechanismInfo(*args): return _LowLevel.CPKCS11Lib_C_GetMechanismInfo(*args)
