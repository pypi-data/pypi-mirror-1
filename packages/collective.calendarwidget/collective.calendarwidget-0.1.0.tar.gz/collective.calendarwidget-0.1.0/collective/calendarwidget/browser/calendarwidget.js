...
$j(document).ready(function() {
    ...
    var language = CCW['language'] 
    var jquery_date_format = CCW['jquery_fmt']; 
    var python_date_format = CCW['python_fmt']; 

    jQuery(function($){
                
            $.datepicker.regional[language] = {clearText: 'l&ouml;schen', clearStatus: 'aktuelles Datum l&ouml;schen',
