...
from PyKDE4.kdecore import ki18n, KAboutData, KCmdLineArgs, KAuthorized
from PyKDE4.kdeui import KApplication, KMainWindow, KHelpMenu


class MainWindow (KMainWindow):
    def __init__ (self):
        KMainWindow.__init__ (self)
        print KAuthorized.authorizeKAction("help_whats_this")
