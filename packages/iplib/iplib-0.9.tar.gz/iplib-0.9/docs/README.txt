  ...
  iplib
  -----
You can use this Python module (and the scripts 'ipconv', 'nmconv'
and 'cidrinfo') to convert amongst many different notations
...
ICQ UIN:        83641305 (nick 'Mad77')
Jabber ID:      alberanid@jabber.linux.it
