...
// overloaded in fckconfigPlone.js
...
/* added : FF2 SpellChecker Plugin */
FCKConfig.Plugins.Add( 'rtSpellCheck' ) ;

/* added universalkey plugin */
FCKConfig.Plugins.Add( 'universalkey' ) ;
/* FileIcon plugin */
FCKConfig.Plugins.Add( 'FileIcon' ) ;
...
FCKConfig.ToolbarSets["PloneDefaultToolbar"] = [
	...
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Anchor'],
	['Image','Flash','Table','Rule','SpecialChar','PageBreak','Smiley'],
	'/',
	['Style','FontFormat'],
	['FitWindow','-','About']
] ;
...
FCKConfig.ToolbarSets["FullToolBar"] = [
	['Source','DocProps','-','Save','NewPage','Preview','-','Templates'],
	['Cut','Copy','Paste','PasteText','PasteWord','-','Print','rtSpellCheck'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	...
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Anchor'],
	['Image','Flash','Table','Rule','SpecialChar','UniversalKey','PageBreak','Smiley'],
	['Form','Checkbox','Radio','TextField','Textarea','Select','Button','ImageButton','HiddenField'],
	'/',
	['Style','FontFormat','FontName','FontSize'],
	['TextColor','BGColor'],
...
// dont use it with rtSpellcheck plugin
...
FCKConfig.BodyClass = 'documentContent' ;
...
FCKConfig.MediaBrowserURL = FCKConfig.BasePath + "fck_browse_files.html" ;
