...
so it pass the module name where it's being run. Now, can be used all methods
of *_log* --*debug()*, *info()*, *warning()*, *error()* and *critical()*--
to indicate the importance of a logged message.
