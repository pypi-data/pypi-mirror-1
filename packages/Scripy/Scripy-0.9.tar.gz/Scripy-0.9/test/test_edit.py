...
from scripy import (edit, path, shell)
...
class TestEdit(object):
    ...
    def check_append(self, text):
        assert shell.Code.OK == self.edit.append(text, overwrite=False)
    ...
    def test_comment(self):
        assert shell.Code.OK == self.edit.comment('yesterday')

    def test_commentout(self):
        assert shell.Code.OK == self.edit.comment_out('yesterday')
