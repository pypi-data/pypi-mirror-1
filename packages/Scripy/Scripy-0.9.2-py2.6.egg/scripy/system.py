...
class Kernel(object):
    ...
    def get_release():
        ...
        """
        uname_cmd = shell._run("!uname -r")
        kernel = uname_cmd.stdout.split('-')[0].split('.')
    ...
    def load_modules(*modules):
        ...
        mach = shell._run("!uname -m").stdout
        ...
        for mod in set(modules):  # Without elements repeated.
            ...
            try:
                shell._run("!sudo !modprobe {module}".format(module=new_module))
