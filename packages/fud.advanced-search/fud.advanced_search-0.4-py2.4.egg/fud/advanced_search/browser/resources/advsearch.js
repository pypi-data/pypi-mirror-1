jq(document).ready(function(){
   ...
   jq("#as-reset-form").click(function(){
      ...
      if(jq('#as-categs2 option').attr("disabled")==false){
          ...
          jq('#as-categs2').html("<option id=\"as-opt-allcat\" value=\"\" disabled>alle Kategorien</option>");
      }

   });
   jq("#as-addcat").click(function(){
       jq('#as-opt-allcat').remove();
   ...
   jq("#as-addallcat").click(function(){
       jq('#as-categs2 option:disabled').remove();
       jq('#as-categs1 option').remove().appendTo('#as-categs2');
   });
