...
__version__ = "$Revision: 1.18.2.1 $"[11:-2]
...
class Daemon(object):
	...
	def optionparser(self):
		...
		p.add_option("--pidfile", dest="pidfile", help="PID filename", default=self.pidfile)
		p.add_option("--stdin", dest="stdin", help="stdin filename", default=self.stdin)
		p.add_option("--stdout", dest="stdout", help="stdout filename", default=self.stdout)
		p.add_option("--stderr", dest="stderr", help="stderr filename", default=self.stderr)
		p.add_option("--user", dest="user", help="user name or id", default=self.user)
		p.add_option("--group", dest="group", help="group name or id", default=self.group)
		return p
	...
	def service(self, args=None):
		...
		<par>The return value is true, a starting option has been specified
		as the command line argument, i.e. if the daemon should be started.</par>

		<par>The <module>optparse</module> options and arguments are available
