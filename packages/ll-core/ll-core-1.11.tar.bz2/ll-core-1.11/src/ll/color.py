...
"""
<mod>ll.color</mod> provides classes and functions for handling RGB colors.
"""
...
class Color(object):
	...
	def fromrgb(cls, r, g, b):
		...
		See the <pyref property="rgb"><prop>rgb</prop></pyref> property for more info.
		"""
		c = cls()
		c.rgb = (r, g, b)
		return c
	...
	def fromrgb4(cls, r4, g4, b4):
		...
		See the <pyref property="rgb4"><prop>rgb4</prop></pyref> property for more info.
		"""
		c = cls()
		c.rgb4 = (r4, g4, b4)
		return c
	...
	def fromrgb8(cls, r8, g8, b8):
		...
		See the <pyref property="rgb8"><prop>rgb8</prop></pyref> property for more info.
		"""
		c = cls()
		c.rgb8 = (r8, g8, b8)
		return c
	...
	def fromint4(cls, int4):
		...
		See the <pyref property="int4"><prop>int4</prop></pyref> property for more info.
		"""
		c = cls()
		c.int4 = int4
		return c
	...
	def fromint8(cls, int8):
		...
		See the <pyref property="int8"><prop>int8</prop></pyref> property for more info.
		"""
		c = cls()
		c.int8 = int8
		return c
	...
	def fromcss(cls, s):
		...
		See the <pyref property="css"><prop>css</prop></pyref> property for more info.
		"""
		c = cls()
		c.css = s
		return c
	...
	def fromhsv(cls, h, s, v):
		...
		See the <pyref property="hsv"><prop>hsv</prop></pyref> property for more info.
		"""
		c = cls()
		c.hsv = (h, s, v)
		return c
	...
	def fromhls(cls, h, l, s):
		...
		See the <pyref property="hls"><prop>hls</prop></pyref> property for more info.
		"""
		c = cls()
		c.hls = (h, l, s)
		return c
	...
	class lum(misc.propclass):
		"""
		The luminance value from the <pyref property="hls"><prop>hls</prop></pyref>
		property.
		"""
		def __get__(self):
