...
__version__ = tuple(map(int, "$Revision: 1.54 $"[11:-2].split(".")))
...
def _import(filename):
	...
	sys.modules[name] = mod = new.ModuleType(name) # create module and make sure it can find itself in sys.module
