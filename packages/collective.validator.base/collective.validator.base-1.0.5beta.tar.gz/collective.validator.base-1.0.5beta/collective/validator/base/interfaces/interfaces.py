...
class IValidationToolProxySchema(Interface):
    ...
    proxy_address = TextLine(title=_(u'Proxy address'),
                        description=_(u'Insert the proxy address'),
                        required=False)
    proxy_port = TextLine(title=_(u'Proxy port'),
                        description=_(u'Insert the proxy port'),
                        required=False)
    proxy_userid = TextLine(title=_(u'Proxy userid'),
                        description=_(u'Insert the userid for proxy'),
                        required=False)
    proxy_password = TextLine(title=_(u'Proxy password'),
