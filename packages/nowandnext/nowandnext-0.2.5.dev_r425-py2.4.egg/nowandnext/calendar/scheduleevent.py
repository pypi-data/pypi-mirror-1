...
class scheduleevent( schedulething ):
    ...
    def __init__( self, eventinstance, default_artist="Unknown Artist", default_website="", default_logo="", default_category="" ):
    ...
    def getTitle(self):
        return self._eventinstance.getEvent().getTitle().decode("utf8")

    def getDescription(self):
        return self._eventinstance.getEvent().getDescription().decode("utf8")
    
    def getGuid(self):
        return "%s@%s" % ( self.getTitle(), self.getStartTime() )
