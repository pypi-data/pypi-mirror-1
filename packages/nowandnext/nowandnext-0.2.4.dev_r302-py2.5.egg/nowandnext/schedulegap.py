...
from nowandnext.schedulething import schedulething
...
class schedulegap( schedulething ):
    ...
    def __init__( self, startTime, endTime, default_title="", default_artist="", default_website="", default_description="" ):
