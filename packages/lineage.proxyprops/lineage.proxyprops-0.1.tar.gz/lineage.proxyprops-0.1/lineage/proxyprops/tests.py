...
def setup_product():
    ...
    import lineage.proxyprops
    zcml.load_config('configure.zcml', lineage.proxyprops)
...
setup_product()
ptc.setupPloneSite(products=['lineage.proxyprops'])
...
def test_suite():
    return unittest.TestSuite([
        ...
        ztc.ZopeDocFileSuite(
            'README.txt', package='lineage.proxyprops',
