...
PLONE_CORE = [
    ...
    ZProduct('CMFPlone', PLONE_GOOGLE + 'PloneBase-3.0-rc1.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.kss', CHEESE_SOURCE + 'p/plone.app.kss/plone.app.kss-1.2-rc1.1.tar.gz', version="1.2-rc1.1"),
    PyModule('plone.app.layout', CHEESE_SOURCE + 'p/plone.app.layout/plone.app.layout-1.0rc1.tar.gz', version="1.0rc1"),
    PyModule('plone.app.linkintegrity', CHEESE_SOURCE + 'p/plone.app.linkintegrity/plone.app.linkintegrity-1.0rc1.1.tar.gz', version="1.0rc1.1"),
    ...
    PyModule('wicked', CHEESE_SOURCE + 'w/wicked/wicked-1.1.3.tar.gz', version="1.1.3"),
...
AT1_5 = [
    ZProduct('Archetypes', PLONE_ORG + 'archetypes/releases/1.5/Archetypes-1.5.0-rc2.tar.gz'),
]
