...
PLONE_CORE = [
    ...
    ZProduct('ATReferenceBrowserWidget', PLONE_ORG + 'atreferencebrowserwidget/releases/2.0.2/ATReferenceBrowserWidget-2.0.2.tar.gz'),
    ...
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.1.4.tar.gz'),
    ...
    ZProduct('PlacelessTranslationService',  PLONE_ORG + 'pts/releases/1.4.12/PlacelessTranslationService-1.4.12.tar.gz'),
    ZProduct('PloneTestCase',PLONE_ORG + 'plonetestcase/releases/0.9.7/PloneTestCase-0.9.7.tar.gz'),
    ZProduct('PloneTranslations', PLONE_ORG + 'plonetranslations/releases/3.1.3/PloneTranslations-3.1.3.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('kss.core', CHEESE_SOURCE + 'k/kss.core/kss.core-1.4.1.tar.gz', version="1.4.1"),
    PyModule('kss.demo', CHEESE_SOURCE + 'k/kss.demo/kss.demo-1.4.1.tar.gz', version="1.4.1"),
    PyModule('plone.app.content', CHEESE_SOURCE + 'p/plone.app.content/plone.app.content-1.3.tar.gz', version="1.3"),
    PyModule('plone.app.contentmenu', CHEESE_SOURCE + 'p/plone.app.contentmenu/plone.app.contentmenu-1.1.3.tar.gz', version="1.1.3"),
    PyModule('plone.app.contentrules', CHEESE_SOURCE + 'p/plone.app.contentrules/plone.app.contentrules-1.1.0.tar.gz', version="1.1.0"),
    PyModule('plone.app.controlpanel', CHEESE_SOURCE + 'p/plone.app.controlpanel/plone.app.controlpanel-1.1.1.tar.gz', version="1.1.1"),
    ...
    PyModule('plone.app.kss', CHEESE_SOURCE + 'p/plone.app.kss/plone.app.kss-1.4.1.tar.gz', version="1.4.1"),
    PyModule('plone.app.layout', CHEESE_SOURCE + 'p/plone.app.layout/plone.app.layout-1.1.3.tar.gz', version="1.1.3"),
    ...
    PyModule('plone.app.portlets', CHEESE_SOURCE + 'p/plone.app.portlets/plone.app.portlets-1.1.3.tar.gz', version="1.1.3"),
    ...
    PyModule('plone.app.workflow', CHEESE_SOURCE + 'p/plone.app.workflow/plone.app.workflow-1.1.4.tar.gz', version="1.1.4"),
    ...
    PyModule('plone.fieldsets', CHEESE_SOURCE + 'p/plone.fieldsets/plone.fieldsets-1.0.2.tar.gz', version="1.0.2"),
    PyModule('plone.i18n', CHEESE_SOURCE + 'p/plone.i18n/plone.i18n-1.0.5.tar.gz', version="1.0.5"),
    ...
    PyModule('plone.portlet.static', CHEESE_SOURCE + 'p/plone.portlet.static/plone.portlet.static-1.1.2.tar.gz', version="1.1.2"),
