...
PLONE_CORE = [
    ...
    ZProduct('CMFPlacefulWorkflow', PLONE_ORG + 'cmfplacefulworkflow/releases/1.3.0r43/cmfplacefulworkflow-1-3-0rc4.tgz'),
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.1-rc1.tar.gz'),
    ZProduct('CMFQuickInstallerTool', PLONE_ORG + 'cmfquickinstallertool/releases/2.1.1/CMFQuickInstallerTool-2.1.1.tar.gz'),
    ...
    ZProduct('PlacelessTranslationService',  PLONE_ORG + 'pts/releases/1.4.9/PlacelessTranslationService-1.4.9.tar.gz'),
    ZProduct('PloneTestCase',PLONE_ORG + 'plonetestcase/releases/0.9.7/PloneTestCase-0.9.7.tar.gz'),
    ZProduct('PloneTranslations', PLONE_ORG + 'plonetranslations/releases/3.1/PloneTranslations-3.1.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.content', CHEESE_SOURCE + 'p/plone.app.content/plone.app.content-1.1.1.tar.gz', version="1.1.1"),
    ...
    PyModule('plone.app.controlpanel', CHEESE_SOURCE + 'p/plone.app.controlpanel/plone.app.controlpanel-1.0.5.tar.gz', version="1.0.5"),
    PyModule('plone.app.customerize', CHEESE_SOURCE + 'p/plone.app.customerize/plone.app.customerize-1.0.3.tar.gz', version="1.0.3"),
    ...
    PyModule('plone.app.linkintegrity', CHEESE_SOURCE + 'p/plone.app.linkintegrity/plone.app.linkintegrity-1.0.7.tar.gz', version="1.0.7"),
    PyModule('plone.app.openid', CHEESE_SOURCE + 'p/plone.app.openid/plone.app.openid-1.0.2.tar.gz', version="1.0.2"),
    PyModule('plone.app.portlets', CHEESE_SOURCE + 'p/plone.app.portlets/plone.app.portlets-1.1rc1.tar.gz', version="1.1rc1"),
    ...
    PyModule('plone.contentrules', CHEESE_SOURCE + 'p/plone.contentrules/plone.contentrules-1.1.0a1.tar.gz', version="1.1.0a1"),
    ...
    PyModule('plone.portlets', CHEESE_SOURCE + 'p/plone.portlets/plone.portlets-1.1rc1.tar.gz', version="1.1rc1"),
    PyModule('plone.protect', CHEESE_SOURCE + 'p/plone.protect/plone.protect-1.0rc1.tar.gz', version="1.0rc1"),
    ...
    PyModule('plone.portlet.collection', CHEESE_SOURCE + 'p/plone.portlet.collection/plone.portlet.collection-1.1rc1.tar.gz', version="1.1rc1"),
    PyModule('plone.portlet.static', CHEESE_SOURCE + 'p/plone.portlet.static/plone.portlet.static-1.1rc2.tar.gz', version="1.1rc2"),
...
AT1_5 = [
    ZProduct('Archetypes', PLONE_ORG + 'archetypes/releases/1.5/Archetypes-1.5.7.tgz'),
]
