...
PLONE_CORE = [
    ...
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.1.6.tar.gz'),
    ...
    ZProduct('kupu', PLONE_ORG + 'kupu/releases/1.4.12/kupu-1-4-12.tgz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.contentmenu', CHEESE_SOURCE + 'p/plone.app.contentmenu/plone.app.contentmenu-1.1.6.zip', version="1.1.6"),
