...
PLONE_CORE = [
    ...
    ZProduct('GenericSetup', ZOPE_ORG + 'GenericSetup/GenericSetup-1.3.3/GenericSetup-1.3.3.tgz'),
    ZProduct('ATContentTypes', PLONE_GOOGLE + 'ATContentTypes-1.2.4.tgz'),
    ...
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.0.5.tar.gz'),
    ZProduct('CMFQuickInstallerTool', PLONE_ORG + 'cmfquickinstallertool/releases/2.0.4/CMFQuickInstallerTool-2.0.4.tar.gz'),
    ZProduct('CMFDiffTool', PLONE_ORG + 'cmfdifftool/releases/0.3.5/CMFDiffTool-0.3.5.tgz'),
    ...
    ZProduct('kupu', PLONE_ORG + 'kupu/releases/1.4.7/kupu-1-4-7.tgz'),
    ZProduct('PlacelessTranslationService',  PLONE_ORG + 'pts/releases/1.4.8/PlacelessTranslationService-1.4.8.tar.gz'),
    ZProduct('PloneTestCase',PLONE_ORG + 'plonetestcase/releases/0.9.7/PloneTestCase-0.9.7.tar.gz'),
    ZProduct('PloneTranslations', PLONE_ORG + 'plonetranslations/releases/3.0.10/PloneTranslations-3.0.10.tar.gz'),
    ...
    ZProduct('PluggableAuthService', ZOPE_ORG + 'PluggableAuthService/PluggableAuthService-1.5.2/PluggableAuthService-1.5.2.tar.gz', 'PluggableAuthService-1.5.2'),
    ...
    ZProduct('CMFEditions', PLONE_ORG + 'cmfeditions/releases/1.1.4/CMFEditions-1.1.4.tgz'),
...
PLONE_CORE_PACKAGES = [
    PyModule('archetypes.kss', CHEESE_SOURCE + 'a/archetypes.kss/archetypes.kss-1.2.5.tar.gz', version="1.2.5"),
    PyModule('kss.core', CHEESE_SOURCE + 'k/kss.core/kss.core-1.2.4.tar.gz', version="1.2.4"),
    PyModule('plone.app.content', CHEESE_SOURCE + 'p/plone.app.content/plone.app.content-1.0.1.tar.gz', version="1.0.1"),
    PyModule('plone.app.contentmenu', CHEESE_SOURCE + 'p/plone.app.contentmenu/plone.app.contentmenu-1.0.6.tar.gz', version="1.0.6"),
    PyModule('plone.app.contentrules', CHEESE_SOURCE + 'p/plone.app.contentrules/plone.app.contentrules-1.0.5.tar.gz', version="1.0.5"),
    PyModule('plone.app.controlpanel', CHEESE_SOURCE + 'p/plone.app.controlpanel/plone.app.controlpanel-1.0.3.tar.gz', version="1.0.3"),
    PyModule('plone.app.customerize', CHEESE_SOURCE + 'p/plone.app.customerize/plone.app.customerize-1.0.1.tar.gz', version="1.0.1"),
    PyModule('plone.app.form', CHEESE_SOURCE + 'p/plone.app.form/plone.app.form-1.0.4.tar.gz', version="1.0.4"),
    PyModule('plone.app.i18n', CHEESE_SOURCE + 'p/plone.app.i18n/plone.app.i18n-1.0.1.tar.gz', version="1.0.1"),
    PyModule('plone.app.iterate', CHEESE_SOURCE + 'p/plone.app.iterate/plone.app.iterate-1.0.tar.gz', version="1.0"),
    PyModule('plone.app.kss', CHEESE_SOURCE + 'p/plone.app.kss/plone.app.kss-1.2.5.tar.gz', version="1.2.5"),
    PyModule('plone.app.layout', CHEESE_SOURCE + 'p/plone.app.layout/plone.app.layout-1.0.5.tar.gz', version="1.0.5"),
    PyModule('plone.app.linkintegrity', CHEESE_SOURCE + 'p/plone.app.linkintegrity/plone.app.linkintegrity-1.0.4.tar.gz', version="1.0.4"),
    PyModule('plone.app.openid', CHEESE_SOURCE + 'p/plone.app.openid/plone.app.openid-1.0.1.tar.gz', version="1.0.1"),
    PyModule('plone.app.portlets', CHEESE_SOURCE + 'p/plone.app.portlets/plone.app.portlets-1.0.5.tar.gz', version="1.0.5"),
    ...
    PyModule('plone.app.vocabularies', CHEESE_SOURCE + 'p/plone.app.vocabularies/plone.app.vocabularies-1.0.2.tar.gz', version="1.0.2"),
    PyModule('plone.app.workflow', CHEESE_SOURCE + 'p/plone.app.workflow/plone.app.workflow-1.0.1.1.tar.gz', version="1.0.1.1"),
    PyModule('plone.contentrules', CHEESE_SOURCE + 'p/plone.contentrules/plone.contentrules-1.0.5.tar.gz', version="1.0.5"),
    PyModule('plone.fieldsets', CHEESE_SOURCE + 'p/plone.fieldsets/plone.fieldsets-1.0.tar.gz', version="1.0"),
    PyModule('plone.i18n', CHEESE_SOURCE + 'p/plone.i18n/plone.i18n-1.0.2.tar.gz', version="1.0.2"),
