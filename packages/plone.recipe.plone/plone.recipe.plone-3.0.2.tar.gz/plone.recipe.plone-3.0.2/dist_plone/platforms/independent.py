...
PLONE_CORE = [
    ...
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.0.2.tar.gz'),
    ...
    ZProduct('kupu', PLONE_ORG + 'kupu/releases/1.4.3/kupu-1-4-3.tgz'),
    ...
    ZProduct('statusmessages', PLONE_ORG + 'statusmessages/releases/3.0.1/statusmessages-3.0.1.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.layout', CHEESE_SOURCE + 'p/plone.app.layout/plone.app.layout-1.0.2.1.tar.gz', version="1.0.2.1"),
    ...
    PyModule('plone.app.portlets', CHEESE_SOURCE + 'p/plone.app.portlets/plone.app.portlets-1.0.2.tar.gz', version="1.0.2"),
...
AT1_5 = [
    ZProduct('Archetypes', PLONE_ORG + 'archetypes/releases/1.5/Archetypes-1.5.3.tgz'),
]
