...
PLONE_CORE = [
    ...
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.0.6.tar.gz'),
    ...
    ZProduct('kupu', PLONE_ORG + 'kupu/releases/1.4.8/kupu-1-4-8.tgz'),
    ...
    ZProduct('PlonePAS', PLONE_ORG + 'plonepas/releases/3.2/PlonePAS-3.2.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    PyModule('archetypes.kss', CHEESE_SOURCE + 'a/archetypes.kss/archetypes.kss-1.2.6.tar.gz', version="1.2.6"),
    ...
    PyModule('plone.app.controlpanel', CHEESE_SOURCE + 'p/plone.app.controlpanel/plone.app.controlpanel-1.0.4.tar.gz', version="1.0.4"),
