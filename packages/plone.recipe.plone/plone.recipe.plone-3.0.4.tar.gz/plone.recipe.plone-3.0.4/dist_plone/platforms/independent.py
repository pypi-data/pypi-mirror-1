...
PLONE_CORE = [
    ...
    ZProduct('ATContentTypes', PLONE_ORG + 'atcontenttypes/releases/1.2.3/ATContentTypes-1.2.3.tgz'),
    ...
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.0.4.tar.gz'),
    ...
    ZProduct('kupu', PLONE_ORG + 'kupu/releases/1.4.6/kupu-1-4-6.tgz'),
    ZProduct('PlacelessTranslationService',  PLONE_ORG + 'pts/releases/1.4.6/PlacelessTranslationService-1.4.6.tar.gz'),
    ZProduct('PloneTestCase',PLONE_ORG + 'plonetestcase/releases/0.9.7/PloneTestCase-0.9.7.tar.gz'),
    ZProduct('PloneTranslations', PLONE_ORG + 'plonetranslations/releases/3.0.9/PloneTranslations-3.0.9.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    PyModule('archetypes.kss', CHEESE_SOURCE + 'a/archetypes.kss/archetypes.kss-1.2.4.1.tar.gz', version="1.2.4.1"),
    ...
    PyModule('plone.app.kss', CHEESE_SOURCE + 'p/plone.app.kss/plone.app.kss-1.2.4.tar.gz', version="1.2.4"),
    PyModule('plone.app.layout', CHEESE_SOURCE + 'p/plone.app.layout/plone.app.layout-1.0.4.tar.gz', version="1.0.4"),
    PyModule('plone.app.linkintegrity', CHEESE_SOURCE + 'p/plone.app.linkintegrity/plone.app.linkintegrity-1.0.3.tar.gz', version="1.0.3"),
