...
PLONE_CORE = [
    ...
    ZProduct('GenericSetup', ZOPE_ORG + 'GenericSetup/GenericSetup-1.4.0-beta/GenericSetup-1.4.0-beta.tar.gz'),
    ...
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.1-beta1.tar.gz'),
    ZProduct('CMFQuickInstallerTool', PLONE_ORG + 'cmfquickinstallertool/releases/2.1/CMFQuickInstallerTool-2.1.tar.gz'),
    ...
    ZProduct('CMFEditions', PLONE_ORG + 'cmfeditions/releases/1.1.5/cmfeditions-1-1-5.tgz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.customerize', CHEESE_SOURCE + 'p/plone.app.customerize/plone.app.customerize-1.0.2.tar.gz', version="1.0.2"),
    PyModule('plone.app.form', CHEESE_SOURCE + 'p/plone.app.form/plone.app.form-1.1.0a1.tar.gz', version="1.1.0a1"),
    PyModule('plone.app.i18n', CHEESE_SOURCE + 'p/plone.app.i18n/plone.app.i18n-1.0.3.tar.gz', version="1.0.3"),
    PyModule('plone.app.iterate', CHEESE_SOURCE + 'p/plone.app.iterate/plone.app.iterate-1.0.7.tar.gz', version="1.0.7"),
    ...
    PyModule('plone.portlets', CHEESE_SOURCE + 'p/plone.portlets/plone.portlets-1.1.0a1.tar.gz', version="1.1.0a1"),
    ...
    PyModule('plone.portlet.static', CHEESE_SOURCE + 'p/plone.portlet.static/plone.portlet.static-1.1.0a1.tar.gz', version="1.1.0a1"),
