...
PLONE_CORE = [
    ...
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.1.5.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.portlets', CHEESE_SOURCE + 'p/plone.app.portlets/plone.app.portlets-1.1.5.tar.gz', version="1.1.5"),
