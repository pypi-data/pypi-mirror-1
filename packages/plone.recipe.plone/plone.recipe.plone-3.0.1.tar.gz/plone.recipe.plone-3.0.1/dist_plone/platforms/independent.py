...
PLONE_CORE = [
    ...
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.0.1.tar.gz'),
    ...
    ZProduct('kupu', PLONE_ORG + 'kupu/releases/1.4.2/kupu-1.4.2.tgz'),
    ...
    ZProduct('PloneTranslations', PLONE_ORG + 'plonetranslations/releases/3.0.5/PloneTranslations-3.0.5.tar.gz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.contentmenu', CHEESE_SOURCE + 'p/plone.app.contentmenu/plone.app.contentmenu-1.0.tar.gz', version="1.0"),
    PyModule('plone.app.contentrules', CHEESE_SOURCE + 'p/plone.app.contentrules/plone.app.contentrules-1.0.1.1.tar.gz', version="1.0.1.1"),
    PyModule('plone.app.controlpanel', CHEESE_SOURCE + 'p/plone.app.controlpanel/plone.app.controlpanel-1.0.1.tar.gz', version="1.0.1"),
    PyModule('plone.app.customerize', CHEESE_SOURCE + 'p/plone.app.customerize/plone.app.customerize-1.0.tar.gz', version="1.0"),
    PyModule('plone.app.form', CHEESE_SOURCE + 'p/plone.app.form/plone.app.form-1.0.1.1.tar.gz', version="1.0.1.1"),
    ...
    PyModule('plone.app.layout', CHEESE_SOURCE + 'p/plone.app.layout/plone.app.layout-1.0.1.1.tar.gz', version="1.0.1.1"),
    ...
    PyModule('plone.app.portlets', CHEESE_SOURCE + 'p/plone.app.portlets/plone.app.portlets-1.0.1.1.tar.gz', version="1.0.1.1"),
    ...
    PyModule('plone.memoize', CHEESE_SOURCE + 'p/plone.memoize/plone.memoize-1.0.1.1.tar.gz', version="1.0.1.1"),
    PyModule('plone.openid', CHEESE_SOURCE + 'p/plone.openid/plone.openid-1.0.tar.gz', version="1.0"),
    PyModule('plone.portlets', CHEESE_SOURCE + 'p/plone.portlets/plone.portlets-1.0.1.1.tar.gz', version="1.0.1.1"),
...
AT1_5 = [
    ZProduct('Archetypes', PLONE_ORG + 'archetypes/releases/1.5/Archetypes-1.5.2.tar.gz'),
]
