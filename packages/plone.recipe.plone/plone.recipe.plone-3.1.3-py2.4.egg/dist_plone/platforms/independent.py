...
PLONE_CORE = [
    ...
    ZProduct('CMFPlone', PLONE_DIST + 'PloneBase-3.1.3.tar.gz'),
    ...
    ZProduct('kupu', PLONE_ORG + 'kupu/releases/1.4.10/kupu-1-4-10.tgz'),
...
PLONE_CORE_PACKAGES = [
    ...
    PyModule('plone.app.customerize', CHEESE_SOURCE + 'p/plone.app.customerize/plone.app.customerize-1.1.1.tar.gz', version="1.1.1"),
    ...
    PyModule('plone.app.workflow', CHEESE_SOURCE + 'p/plone.app.workflow/plone.app.workflow-1.1.3.tar.gz', version="1.1.3"),
