...
(if screenplay-mode-menu-bar-map
  ...
  (define-key screenplay-mode-menu-bar-map [style screenplay-style-scene]
	'("Other Scene" . screenplay-style-scene))
...
(if screenplay-mode-prefix-map
  ...
  (define-key screenplay-mode-prefix-map "\C-g" 'screenplay-style-scene)        
...
(defun screenplay-style-scene ()
  "Mark following paragraph as scene"
  (interactive)
  (insert "\n**scene\n")
  (insert "\n***description\n")
  (previous-line 2)
