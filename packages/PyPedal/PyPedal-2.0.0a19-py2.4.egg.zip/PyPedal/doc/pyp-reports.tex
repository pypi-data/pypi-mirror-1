pyp\_reports\index[func]{pyp_reports} contains a set of procedures for ...

\subsection*{Module Contents}
\begin{description}
\item[\textbf{meanMetricBy(pedobj, metric='fa', byvar='by')} $\Rightarrow$ dictionary]\index[func]{pyp_reports!meanMetricsBy()}
