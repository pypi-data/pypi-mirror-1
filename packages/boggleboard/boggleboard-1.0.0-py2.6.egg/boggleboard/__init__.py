...
A class to generate and manipulate Boggle-style boards. Boards of different
...
# The additional challenge die in Big Boggle. This can be substituted in for one
# of the above, or added to the above, in which case, one die will be omitted
# randomly.
defaultDie25Challenge = ['i', 'k', 'l', 'm', 'qu', 'u']

# The collection of all dice in a 5x5 Big Boggle game, for convenience:
defaultDice25Challenge = defaultDice25 + [defaultDie25Challenge]
...
class AbstractBoggleBoard:
    ...
    def _determineAdjacencies(self):
        ...
        raise NotImplemented, "AbstractBoggleBoard has no inherent structure."
