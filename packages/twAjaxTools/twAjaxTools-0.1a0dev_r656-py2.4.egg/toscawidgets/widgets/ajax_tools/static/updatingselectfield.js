...
UpdatingSelectFieldManager.prototype.watcher = function(e, name, qweqw) {
...
UpdatingSelectFieldManager.prototype.requestOk = function(request) {
    ...
    $A(results.options).each(function(opt) {
        ...
        this.field.options.add(new Option(opt[1], name));
    }.bind(this));
    
    if (this.options.initial_value) {
        this.field.selectedIndex = this.options.initial_value - 1;
