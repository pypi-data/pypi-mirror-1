...
def set_verbosity(env):
    ...
    if level > 0:
        ...
        env['LDMODULECOMSTR']   = "     LDMOD   $SOURCE"

        env['INSTALLSTR']       = "     INSTALL $SOURCE"

        env['ARRAPIGENCOMSTR']  = "     GEN_ARRAY_API   $SOURCE"
        env['UFUNCAPIGENCOMSTR']= "     GEN_UFUNC_API   $SOURCE"
        env['TEMPLATECOMSTR']   = "     GEN_C   $SOURCE"
        env['UMATHCOMSTR']      = "     GEN_UMATH   $SOURCE"

        env['CTEMPLATECOMSTR']  = "     GEN_C   $SOURCE"
        env['FTEMPLATECOMSTR']  = "     GEN_F   $SOURCE"
