...
class Field(object):
    ...
    **Attributes**
    ...
    Examples::
        ...
        >>> Field(name='name')
        rum.fields.Field(name='name', required=False, label='Name', default=NoDefault, read_only=False, searchable=False)
    """
...
class JPEGImage(Image):
    def __init__(self,name, required=False, label=None, default=NoDefault, 
                 read_only=False,preview_width=150,preview_height=100, searchable=False):
        super(JPEGImage,self).__init__(name=name,required=required,label=label,default=default,read_only=read_only,\
            content_type="image/jpeg",preview_width=preview_width,preview_height=preview_height, searchable=searchable)
...
class String(Field):
    ...
    **Attributes** 
    ...
    def __init__(self, name, required=False, label=None, default=NoDefault, 
        ...
        super(String, self).__init__(name, required, label, default, read_only, searchable=searchable)
        self.length = length
...
class Boolean(Field):
    ...
    Examples::
        ...
        >>> Boolean(name='name')
        rum.fields.Boolean(name='name', required=False, label='Name', default=NoDefault, read_only=False, searchable=False)
    """
...
class Number(Field):
    ...
    **Attributes** 
    ...
    def __init__(self, name, required=False, label=None, default=NoDefault,
        ...
        super(Number, self).__init__(name, required, label, default, read_only, searchable=searchable)
        self.range = range
        self.sortable=sortable
...
class Date(Field):
    ...
    def __init__(self, name, required=False, label=None, default=NoDefault,
        ...
        super(Date, self).__init__(name, required, label, default, read_only, searchable=searchable)
        self.sortable=sortable
...
class Time(Field):
    ...
    **Attributes** 
    ...
    def __init__(self, name, required=False, label=None, default=NoDefault,
        ...
        super(Time, self).__init__(name, required, label, default, read_only, searchable=searchable)
...
class Relation(Field):
    ...
    **Attributes** 
    ...
    Examples::
        ...
        rum.fields.Relation(name='name', other=<class rum.fields.Related at ...>, remote_name='related', required=False, label='Name', default=NoDefault, read_only=False, searchable=False)
    """
    def __init__(self, name, other, remote_name, required=False, label=None,
                 default=NoDefault, read_only=False, searchable=False):
        super(Relation, self).__init__(name, required, label, default, read_only, searchable=searchable)
        self.other = other
...
class Collection(Relation):
    ...
    Examples::
        ...
        rum.fields.Collection(name='name', other=<class rum.fields.Related at ...>, remote_name='related', required=False, label='Name', default=NoDefault, read_only=False, searchable=False)
    """
...
class List(Collection):
    ...
    Examples::
        ...
        rum.fields.List(name='name', other=<class rum.fields.Related at ...>, remote_name='related', required=False, label='Name', default=NoDefault, read_only=False, searchable=False)
    """
...
class Mapping(Collection):
    ...
    Examples::
        ...
        rum.fields.Mapping(name='name', other=<class rum.fields.Related at ...>, remote_name='related', required=False, label='Name', default=NoDefault, read_only=False, searchable=False)
    """
