...
class IObjectWillBeExportedEvent(IObjectModifiedEvent):
    """Event fired just before a object gets exported"""

class IObjectExportedEvent(IObjectModifiedEvent):
    """Event fired after a object got exported"""

class IObjectWillBeImportedEvent(IObjectModifiedEvent):
...
class IObjectImportedEvent(IObjectModifiedEvent):
