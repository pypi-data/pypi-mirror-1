...
try:
    ...
    print "Usage: %s ini_file path_to_watch" % os.path.basename(sys.argv[0])
    sys.exit(1)
    
file(os.path.join(WORK_DIR, "%s.pid"%win32process.GetCurrentProcessId()), 'w').write("%s\n%s"%(ini_file, path_to_watch))
