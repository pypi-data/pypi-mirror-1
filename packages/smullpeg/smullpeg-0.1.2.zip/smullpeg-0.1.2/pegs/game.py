...
class PegGame(object):
    ...
    def __init__(self, open='random'):
        ...
        self.hinttext=font.render("Hints on", 1, (0,170,0), self.BACKGROUND_COLOR)
        self.hintbox=pygame.Surface(self.hinttext.get_size())
        self.hintbox.fill(self.BACKGROUND_COLOR)
    ...
    def draw_background(self, screen):
        ...
        self.background.blit(text, (10, size[1] - text.get_size()[1]-5)) #.widthsize[1]-24))
