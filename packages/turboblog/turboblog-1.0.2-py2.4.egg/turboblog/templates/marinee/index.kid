...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:py="http://purl.org/kid/ns#"
    ...
    <body>
            ...
            <header></header>
            <div  py:if="not blog_posts.count()">No posts here!"</div>
            <div class="bloque">
                <div id="noticias">
...
?>
            ...
            <div class="post" id="post-${post.id}">
                <h2><a href="${post.link(blog.id)}" rel="bookmark" title="Permanent Link to ${post.title}">${post.title}</a></h2>
                ...
                <a href="${post.link(blog.id)}#comments">${nc}</a>
                </p>
