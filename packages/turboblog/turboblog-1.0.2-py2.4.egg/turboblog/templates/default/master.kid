...
<link rel="pingback" href="${tg.url('/RPC')}" />
<link rel="alternate" type="application/rss+xml" title="${'%s' % blog.name}" href="${tg.url('/%s/feed' % blog.slug)}"/>
...
<div id="sidebar">
    <ul>
        ...
        <ul py:if="not cloud">
            ...
            <a href="${blog.link()}?tagged=${tag.id}">${tag.name} (${len(tag.published_posts())})</a>
            </li>
            <li>
        ...
        <li><h2>Meta</h2>
            <ul>
                <li py:if="not can_comment"><a href="${tg.url('/login')}">Login</a></li>
                <li><a href="http://validator.w3.org/check/referer" title="This page validates as XHTML 1.0 Transitional">Valid <abbr title="eXtensible HyperText Markup Language">XHTML</abbr></a></li>
                <li><a href="http://gmpg.org/xfn/"><abbr title="XHTML Friends Network">XFN</abbr></a></li>
                <li><a href="" title="Powered by TurboBlog">TurboBlog</a></li>
                <li py:if="can_comment">Logged in as ${tg.identity.user.display_name} <a href="${tg.url('/logout')}" title="Log out of this account">Logout</a>
                </li>
            </ul>
        </li>
    </ul>
...
<div id="footer">
    ...
    <br /><a href="${tg.url('/%s/feed' % blog.slug)}">Entries (RSS)</a>
    </p>
</div>
<hr />
</footer>
...
<div py:if="can_admin or can_post" id="wpcombar">
    <div id="quicklinks">
        <ul>
            <li py:if="can_admin">  <a href="${tg.url('/admin')}"> Site Dashboard </a> </li>
            <li py:if="can_admin_blog">  <a href="${tg.url('/blog_admin?bid=%s' % blog.id)}"> Blog Dashboard </a> </li>
    ...
    <div id="loginout"> Howdy,
        ...
        <a href="${tg.url('/logout')}" title="Log out of this account"> Sign Out </a>
        ,
