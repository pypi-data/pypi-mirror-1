...
Timeline.DefaultEventSource.prototype.loadXML = function(xml, url) {
    ...
    while (node != null) {
        if (node.nodeType == 1) {
		 ...
		 ajaxDescription: node.getAjaxDescription(),
...
Timeline.DefaultEventSource.prototype.loadJSON = function(data, url) {
    ...
    if (data && data.events){
		...
		ajaxDescription: event.ajaxDescription,
...
Timeline.DefaultEventSource.Event = function(args) {
  ...
  this._ajaxdescription = args.ajaxDescription
...
Timeline.DefaultEventSource.Event.prototype = {
    ...
    getAjaxDescription: function() { return this._ajaxdescription; },
    ...
    fillInfoBubble: function(elmt, theme, labeller) {
        ...
        if (this._ajaxdescription != null) {
            $.ajax({ url: this._ajaxdescription, success: function(html) { divBody.innerHTML = html; } });
           }
