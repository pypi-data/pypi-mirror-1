...
### Begin Python2.2 workarounds and monkeypatching
##################################################

# Not included in Python 2.2's unittest
def _strclass(cls):
    return "%s.%s" % (cls.__module__, cls.__name__)

# Python 2.2's TestSuite is not iter()-able        
def TestSuite_iter(self):
    return iter(self._tests)
unittest.TestSuite.__iter__ = TestSuite_iter

# The TestLoader that ships with Python 2.2 doesn't support new-style classes    
def TestLoader_loadTestsFromModule(self, module):
...
unittest.TestLoader.loadTestsFromModule = TestLoader_loadTestsFromModule

################################################
### End Python2.2 workarounds and monkeypatching
...
class Todo_Failed(Exception):
    pass
        
class Todo_Passed(Exception):
    pass
...
class TodoCase(unittest.TestCase, object):
