...
try:
    import silvercitycolor    # enables: .. code-block:: Python
except ImportError:           # SilverCity not installed...
    import dpcodeblocksupport # transform code-block's to textarea's
...
__date__ = "$Date: 2006-08-12 00:14:12 -0700 (Sat, 12 Aug 2006) $"
__revision__ = "$Revision: 127 $"
