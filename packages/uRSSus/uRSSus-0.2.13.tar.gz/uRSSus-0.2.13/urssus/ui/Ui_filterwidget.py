...
#
# Created: Wed Feb 18 13:49:10 2009
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.statusCombo.addItem(QtCore.QString())
        self.statusCombo.addItem(QtCore.QString())
        self.statusCombo.addItem(QtCore.QString())
    ...
    def retranslateUi(self, Form):
        ...
        self.statusCombo.setItemText(0, QtGui.QApplication.translate("Form", "All Articles", None, QtGui.QApplication.UnicodeUTF8))
        self.statusCombo.setItemText(1, QtGui.QApplication.translate("Form", "Unread", None, QtGui.QApplication.UnicodeUTF8))
        self.statusCombo.setItemText(2, QtGui.QApplication.translate("Form", "Important", None, QtGui.QApplication.UnicodeUTF8))
