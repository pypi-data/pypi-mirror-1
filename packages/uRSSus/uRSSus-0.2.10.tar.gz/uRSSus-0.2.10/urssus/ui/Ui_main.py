...
# Form implementation generated from reading ui file 'urssus/ui/main.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralWidget.setGeometry(QtCore.QRect(0,65,800,503))
        ...
        self.feeds.setEditTriggers(QtGui.QAbstractItemView.DoubleClicked)
        self.feeds.setDragEnabled(True)
        self.feeds.setDragDropMode(QtGui.QAbstractItemView.DragDrop)
        self.feeds.setAlternatingRowColors(True)
        self.feeds.setTextElideMode(QtCore.Qt.ElideRight)
        ...
        self.feeds.setHeaderHidden(False)
        ...
        self.view_container.setFrameShape(QtGui.QFrame.Panel)
        ...
        self.toolBar.setGeometry(QtCore.QRect(0,27,142,38))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/urssus.svg"),QtGui.QIcon.Normal,QtGui.QIcon.Off)
        ...
        self.statusBar.setGeometry(QtCore.QRect(0,580,800,20))
        ...
        self.filterBar.setGeometry(QtCore.QRect(142,27,658,38))
        ...
        self.searchBar.setGeometry(QtCore.QRect(0,568,800,12))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/view_top_bottom.svg"),QtGui.QIcon.Normal,QtGui.QIcon.Off)
        self.actionNormal_View.setIcon(icon)
        self.actionNormal_View.setObjectName("actionNormal_View")
        self.actionCombined_View = QtGui.QAction(MainWindow)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/view_detailed.svg"),QtGui.QIcon.Normal,QtGui.QIcon.Off)
        self.actionCombined_View.setIcon(icon)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/view_left_right.svg"),QtGui.QIcon.Normal,QtGui.QIcon.Off)
        self.actionWidescreen_View.setIcon(icon)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/view_detailed.svg"),QtGui.QIcon.Normal,QtGui.QIcon.Off)
        self.actionFancy_View.setIcon(icon)
        self.actionFancy_View.setObjectName("actionFancy_View")
        self.actionPost_to_Twitter = QtGui.QAction(MainWindow)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/twitter.svg"),QtGui.QIcon.Normal,QtGui.QIcon.Off)
        self.actionPost_to_Twitter.setIcon(icon)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/window_fullscreen.svg"),QtGui.QIcon.Normal,QtGui.QIcon.Off)
        self.actionFull_Screen.setIcon(icon)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/menubar.svg"),QtGui.QIcon.Normal,QtGui.QIcon.Off)
        self.actionShow_Menu_Bar.setIcon(icon)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/bug.svg"),QtGui.QIcon.Normal,QtGui.QIcon.Off)
        self.actionReport_Bug.setIcon(icon)
        self.actionReport_Bug.setObjectName("actionReport_Bug")
        self.actionPreferences = QtGui.QAction(MainWindow)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/configure.svg"),QtGui.QIcon.Normal,QtGui.QIcon.Off)
