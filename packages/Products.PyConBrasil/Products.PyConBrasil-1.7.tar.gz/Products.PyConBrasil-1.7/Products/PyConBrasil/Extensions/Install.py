...
from Products.PyConBrasil.config import PROJECTNAME
from Products.PyConBrasil.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install PyConBrasil """
    out = StringIO()
    ...
    try:
        from Products.PyConBrasil.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    wft.setChainForPortalTypes( ['Treinamento'], "palestra_workflow")
    wft.setChainForPortalTypes( ['PalestraRelampago'], "palestra_workflow")
    wft.setChainForPortalTypes( ['Imprensa'], "inscricao_workflow")
    ...
    from Products.PyConBrasil.config import STYLESHEETS
    try:
        ...
        pass
    from Products.PyConBrasil.config import JAVASCRIPTS
    try:
