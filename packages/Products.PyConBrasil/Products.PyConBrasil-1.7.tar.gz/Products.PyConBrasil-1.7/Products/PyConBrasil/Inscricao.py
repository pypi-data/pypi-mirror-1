...
schema = Schema((
    ...
    StringField(
        name='tipo',
        widget=SelectionWidget(
            description="Tipo da inscrição que está sendo realizada. Estudantes e Membros APyB: R$ 25,00. Membros SBC e ABRAWEB: R$ 35,00. Público em geral: R$ 45,00.",
            condition="not:object/emPreInscricao",
            label='Tipo',
        ...
        required=1,
        vocabulary=(('1', 'Estudante'), ('2', 'Membro SBC ou Membro ABRAWEB'), ('3', 'Público em geral'))
    ),
...
class Inscricao(UIDRenamer, BaseContent):
    ...
    suppl_views = ()
    typeDescription = "Inscrição de um participante do evento."
