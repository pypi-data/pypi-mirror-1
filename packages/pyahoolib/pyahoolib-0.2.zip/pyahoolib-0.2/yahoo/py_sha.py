...
if __name__ == '__main__':
    sha_hash1 = new()
    sha_hash1.update('[W\x02n}\\@\x05\x0f@B\x05O\x03PD\\Rr\x00\x05w\x1b\x1b6666666666666666666666666666666666666666')
    #sha_hash1.count[1] = 511L
    sha_hash1.update('%k)\xc7')
    print sha_hash1.hexdigest()
    
    # 5c 9 d0 30 66 87 fc f9 99 f8 8d 89 b8 ba b5 20 ff ce 87 5b