...
from z3c.form.interfaces import IFormLayer, ISubForm, IWidgets
...
class PloneForm(plone.z3cform.fieldsets.extensible.ExtensibleForm, z3c.form.form.Form):
    ...
    def update(self):
        #plone.z3cform.fieldsets.extensible.ExtensibleForm.update(self)
        z3c.form.form.Form.update(self)

    def updateWidgets(self):
        return z3c.form.form.Form.updateWidgets(self)

class PloneEditForm(z3c.form.form.EditForm, PloneForm):
    grok.baseclass()
    def __init__(self, context, request):
        PloneForm.__init__(self, context, request)
        return z3c.form.form.EditForm.__init__(self, context, request)
