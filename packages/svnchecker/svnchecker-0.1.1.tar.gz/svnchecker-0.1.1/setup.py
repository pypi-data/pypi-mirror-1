...
#
# Created: 09/01/2007 Andreas Schreiber <Andreas.Schreiber@dlr.de>
# Changed: 
#
# Copyright 2007 Deutsches Zentrum für Luft- und Raumfahrt e.V. (DLR)
#
...
setup(name='svnchecker',
      ...
      url='https://wiki.sistec.dlr.de/SVNChecker',
