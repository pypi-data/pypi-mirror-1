...
def resourceExists(node, name = None, resourceType = PROP_RESOURCE_TYPE_RESOURCE):
    ...
    @type node: L{ResourceStorer<datafinder.webdav.WebdavClient.ResourceStorer>}
...
def downloadCollectionContent(destinationPath, collectionToDownload):
    ...
    @type collectionToDownload: instance of L{CollectionStorer<datafinder.webdav.WebdavClient.CollectionStorer>}
