...
class LiveProperties(object):
    ...
    def getContentLanguage(self):
        ...
        @return: string
        """
        return str(self.properties.get(Constants.PROP_CONTENT_LANGUAGE))
    ...
    def getContentLength(self):
        ...
        """
        xml = self.properties.get(Constants.PROP_CONTENT_LENGTH, 0)
        return int(str(xml))
    ...
    def getContentType(self):
        ...
        """
        return str(self.properties.get(Constants.PROP_CONTENT_TYPE))

    def getCreationDate(self):
        """
        Return date of creation in a 9-tuple (of integers)
        ...
        See also: U{Python-doc.<http://www.python.org/doc/2.2.2/lib/module-time.html>}
        
        @return: time of creation
        @rtype:  9-tuple (y, m , d, h, m, s, wd, jd, dls-flag)
        """
        string = str(self.properties.get(Constants.PROP_CREATION_DATE))
        return time.strptime(string, Constants.DATE_FORMAT_ISO8601)
    ...
    def getEntityTag(self):
        ...
        """
        return self.properties.get(Constants.PROP_ETAG)
    ...
    def getDisplayName(self):
        ...
        @return: string
        """
        string = str(self.properties.get(Constants.PROP_DISPLAY_NAME))
        return string

    def getLastModified(self):
        """
        Return time stamp of last modification of resource.
        
        Format of time stamp: see L{getCreationDate}
        
        @return: time of modification
        @rtype:  9-tuple (y, m , d, h, m, s, wd, jd, dls-flag)
        """
        string = str(self.properties.get(Constants.PROP_LAST_MODIFIED))
        return time.struct_time(rfc822.parsedate(string))

    def getLockDiscovery(self):
        """
        Return all current lock's applied to a resource or null if it is not locked.
        
        @return: a lockdiscovery DOM element accrding to RFC 2815
        """
...
class Element(qp_xml._element):
    ...
    def __str__(self):
        return self.textof().encode('latin-1')
