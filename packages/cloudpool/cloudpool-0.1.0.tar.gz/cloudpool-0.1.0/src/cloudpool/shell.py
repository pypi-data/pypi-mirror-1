...
class SecureShell(RemoteShell):
    ...
    def establishConnection(self):
        ...
        connection = paramiko.SSHClient.open_connection(
            self.hostname(), 
            username=self.user(), 
    ...
    def stageFile(self, file=None, **kwd):
        ...
        fs.put(os.path.sep.join(localpath), remotepath)
        
        return

    def destageFile(self, file=None, **kwd):
        ...
        fs.get(remotepath, os.path.sep.join(localpath))
