...
%ignore PCShellSetDestroy;
%ignore PCShellSetSetUp;
%ignore PCShellSetView;
%ignore PCShellSetPreSolve;
%ignore PCShellSetPostSolve;
%ignore PCShellSetApply;
%ignore PCShellSetApplyTranspose;
%ignore PCShellSetApplyRichardson;
