...
PETSC_ENUM_INIT_VALUE(PetscTruth, PETSC_FALSE);
...
PETSC_ENUM_INIT_VALUE(PetscViewerFormat, PETSC_VIEWER_ASCII_DEFAULT);
...
PETSC_ENUM_INIT_VALUE(KSPConvergedReason, KSP_CONVERGED_ITERATING);
PETSC_OVERRIDE(
PetscErrorCode,
...
PETSC_ENUM(PCSide)
PETSC_ENUM_INIT_VALUE(PCSide, PC_LEFT);
...
PETSC_ENUM_INIT_VALUE(SNESConvergedReason, SNES_CONVERGED_ITERATING);
PETSC_OVERRIDE(
PetscErrorCode,
...
PETSC_ENUM_INIT_VALUE(TSProblemType, TS_LINEAR);
