...
The parallel module provides elementary support for parallel programming in
...
Update the parallel __version__ attribute.
...
To make Debian packages:
  ...
  2. Make a symbolic link in the distribution's root directory to keep the
     ...
     ln -s packages/debian/python2.4-parallel-module/debian/
