...
def findallfigs():
    ...
    for wantedTitle in _FIG_FORMATS:
        ...
        for hwnd, wndTitle in windowList:
            try:
...
def _fig2wnd(figs):
    ...
    global _FIG_FORMATS
    for fig in figs:
        for format in _FIG_FORMATS:
            winTitle = format + ' %d' % fig
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        figwid = int(round(figwid))
        fighgt = int(round(fighgt))

#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#% Put the figures where they belong.
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        idx = 0
        for ix in xrange(nlayers):
            for row in xrange(nv):
                for col in xrange(nh):
#%idx = (row-1)*nh + col;
                    if  (row)*nh + col < nfigspertile :      # idx <= nfigs
