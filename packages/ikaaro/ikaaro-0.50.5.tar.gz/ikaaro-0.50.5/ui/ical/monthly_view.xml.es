...
<div id="cal_monthly_view">
  <div id="selector">
    <a href="${today}" class="cal_today" stl:if="today">
  ...
  <table>
    ...
    <tr stl:repeat="week weeks" valign="top">
      ...
      <td stl:repeat="day week/days" class="day">
        <span class="bold" stl:if="not day/selected">${day/nday}</span>  <span class="cal_day_selected" stl:if="day/selected">${day/nday}</span>  <a href="${day/url}" class="add_event" stl:if="day/url">  <img width="16" src="${add_icon}" height="16"></img></a> ${day/events}
      </td>
    </tr>
  </table>
</div>
