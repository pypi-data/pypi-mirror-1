...
<stl:block xmlns="http://www.w3.org/1999/xhtml" xmlns:stl="http://www.hforge.org/xml-namespaces/stl">
  ...
  <fieldset>
    ...
    <form action=";view" method="get">
      <table>
        <tr>
          <td colspan="2">
            ...
            <input name="text" size="30" class="tracker_select" id="text" type="text" value="${text}"></input>
          </td>
          <td colspan="1">
            <label for="mtime">Modified since:</label><br></br>
            <input value="${mtime}" id="mtime" size="2" name="mtime" type="text"></input> days ago
          </td>
        </tr>
        <tr>
          <td valign="top">
            ...
            <br></br>
            <select id="product" multiple="multiple" name="product" size="4" class="tracker_select">
          ...
          <td valign="top">
            ...
            <br></br>
            <select id="module" multiple="multiple" name="module" size="4" class="tracker_select">
          ...
          <td valign="top">
            ...
            <br></br>
            <select id="version" multiple="multiple" name="version" size="4" class="tracker_select">
        ...
        <tr>
          <td valign="top">
            ...
            <br></br>
            <select id="type" multiple="multiple" name="type" size="4" class="tracker_select">
          ...
          <td valign="top">
            ...
            <br></br>
            <select id="state" multiple="multiple" name="state" size="4" class="tracker_select">
          ...
          <td valign="top">
            ...
            <br></br>
            <select id="priority" multiple="multiple" name="priority" size="4" class="tracker_select">
        ...
        <tr>
          <td colspan="3" valign="top">
            ...
            <br></br>
            <select id="assigned_to" multiple="multiple" name="assigned_to" size="4" class="tracker_select">
      ...
      <br></br>
      <input name=";view" type="submit" class="button_search" value="Search"></input>
    </form>
  </fieldset>
