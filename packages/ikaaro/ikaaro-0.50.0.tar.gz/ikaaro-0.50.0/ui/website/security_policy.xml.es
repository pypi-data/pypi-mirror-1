...
<form action=";edit_security_policy" method="post">
  <fieldset>
    ...
    <p>
      <input value="0" name="website_is_open" type="radio" id="intranet" checked="${is_closed}"></input>
    ...
    <p>
      <input value="1" name="website_is_open" type="radio" id="extranet" checked="${is_open}"></input>
