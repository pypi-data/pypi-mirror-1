  ...
  <body>
    <div id="body">
      ...
      <div id="browse" stl:if="show_browse">
        ...
        <table width="100%" cellpadding="1" class="thumbs" cellspacing="1" border="0">
          <tr>
            ...
            <td valign="top">
              ...
              <stl:block stl:repeat="item bc/items">
                <dl class="thumb">
                  ...
                  <dd>
                    <abbr title="${item/title}">${item/short_title}</abbr><br></br>  <a href="javascript:select_element('${element_to_add}', '${item/path}', '${item/title}')"> Select </a>
                  </dd>
                </dl>
              </stl:block>
            </td>
      ...
      <div id="insert" stl:if="show_insert">
        ...
        <form action=";add_link#insert" method="post">
          ...
          <input value="Aceptar" name=";add_resource" class="button_ok" type="submit"></input>
        </form>
      </div>
      ...
      <div id="upload" stl:if="show_upload">
        ...
        <form action=";add_link#upload" method="post" enctype="multipart/form-data">
          ...
          <input value="Upload and Link" name=";upload" class="button_upload" type="submit"></input>
        </form>
      </div>
    </div>
  </body>
