...
<stl:block xmlns="http://www.w3.org/1999/xhtml" xmlns:stl="http://www.hforge.org/xml-namespaces/stl">
  ...
  function update_tracker(){
      update_tracker_list('version', true);
      update_tracker_list('module', true);
  }
  </script>
    ...
    <table>
      ...
      <tr>
        ...
        <td colspan="2" valign="top">
          ...
          <select id="cc_list" name="cc_list" class="tracker_select" size="5" multiple="multiple">
      ...
      <tr>
        <td colspan="3" valign="top">
          ...
          <textarea name="comment" rows="10" id="description" cols="80">${comment/value}</textarea>
        </td>
      </tr>
      <tr>
        <td colspan="3" valign="top">
