...
<stl:block xmlns="http://www.w3.org/1999/xhtml" xmlns:stl="http://www.hforge.org/xml-namespaces/stl">
  ...
  <fieldset>
    ...
    <form id="browse_list" action="" method="post">
      <table summary="Configuration des langues">
        ...
        <tbody>
          <tr stl:repeat="language active_languages" class="${repeat/language/even}">
            <td>
              <input value="${language/code}" type="checkbox" name="codes" class="checkbox"></input>
            </td>
            <td>${language/name}</td>
            <td>${language/code}</td>
            <td align="center">
      ...
      <p>
        <input value="Change default" name=";change_default_language" class="button_ok" type="submit"></input>
        <input value="Suprimir" name=";remove_languages" class="button_delete" type="submit"></input>
      </p>
    </form>
  </fieldset>
  ...
  <fieldset>
    ...
    <form action="" method="post">
      ...
      <input value="Agregar" name=";add_language" class="button_ok" type="submit"></input>
    </form>
  </fieldset>
