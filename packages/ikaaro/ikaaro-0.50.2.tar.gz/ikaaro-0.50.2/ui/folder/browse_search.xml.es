...
<form action="" method="get" stl:if="search_fields">
  <fieldset>
    ...
    <!-- SubFolders -->  <input value="1" name="search_subfolders" type="checkbox" id="search_subfolders" checked="${search_subfolders}"></input><label for="search_subfolders">Buscar subcarpetas</label>  <!-- OK -->
       
