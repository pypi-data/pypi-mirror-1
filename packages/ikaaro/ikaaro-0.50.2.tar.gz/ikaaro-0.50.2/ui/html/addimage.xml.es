    ...
    <div id="body">
      ...
      <div id="browse" stl:if="show_browse">
        ...
        <stl:block stl:repeat="item bc/items">
          <dl class="thumb" stl:if="item/is_image">
            ...
            <dd>
              <abbr title="${item/title}">${item/short_title}</abbr><br></br>  <a href="javascript:select_element('${element_to_add}', '${item/path}${resource_action}', '${item/short_title}')"> Select </a>
            </dd>
          </dl>
        </stl:block>
        <div class="clear"></div>
      ...
      <div id="upload" stl:if="show_upload">
        ...
        <form action=";add_image#upload" method="post" enctype="multipart/form-data">
          ...
          <input value="${target_id}" name="target_id" type="hidden"></input>  <input id="file" name="file" size="35" type="file"></input>  <input value="${mode}" id="mode" name="mode" type="hidden"></input>  <br></br>
          <input value="Upload and Insert" type="submit" name=";upload" class="button_upload"></input>
        </form>
      </div>
