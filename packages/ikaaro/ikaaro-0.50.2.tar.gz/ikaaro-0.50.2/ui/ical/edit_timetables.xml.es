  ...
  <fieldset>
    ...
    <table class="form">
      <tr stl:repeat="timetable timetables">
        <td>
          <input value="${timetable/index}" type="checkbox" name="ids" class="checkbox"></input>
        </td>
        <td>
      ...
      <tr>
        ...
        <td style="padding-left: 10px;">
          ...
          <input value="Agregar" name=";add" class="button_add" type="submit"></input>
        </td>
      </tr>
    </table>

    <br></br>
    <input value="Suprimir" name=";remove" class="button_delete" type="submit"></input>
    <input value="Update" name=";update" class="button_ok" type="submit"></input>
  </fieldset>
</form>
