...
<form method="post" action="${action}" id="edit_event" stl:if="action">
  ...
  <table class="form">
    ...
    <tr>
      <td>Summary</td>
      <td>
        <input value="${SUMMARY}" id="SUMMARY" name="SUMMARY" type="text"></input>
      </td>
    </tr>
    <tr>
      <td>Localización</td>
  ...
  <p stl:if="allowed">
     <input value="Aceptar" name=";edit_event" class="button_ok" type="submit"></input>
     <input value="Definitely remove" name=";remove_event" stl:if="remove" class="button_delete" type="submit"></input>
     <input value="Cancelar" name=";cancel" stl:if="not remove" class="button_cancel" type="submit"></input>
  </p>
