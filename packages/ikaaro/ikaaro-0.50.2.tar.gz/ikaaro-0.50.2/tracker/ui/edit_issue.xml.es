    ...
    <table>
      <tr>
        <td colspan="2">
          ...
          <input value="${title/value}" name="title" id="title" size="48" type="text"></input>
        </td>
      </tr>
      <tr>
        <td valign="top">
      ...
      <tr>
        ...
        <td valign="top">
          ...
          <select id="cc_add" multiple="multiple" name="cc_add" size="5" class="tracker_select">
        ...
        <td valign="top">
          ...
          <select id="cc_list" multiple="multiple" name="cc_list" size="4" class="tracker_select">
