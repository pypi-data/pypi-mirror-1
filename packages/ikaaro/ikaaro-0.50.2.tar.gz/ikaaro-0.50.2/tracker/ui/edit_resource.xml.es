...
<form action="${action}" method="post">
  <fieldset>
    ...
    <input value="Assign" name=";add" type="submit" class="button_ok" stl:if="not id"></input>
    <input value="Save Changes" name=";edit" type="submit" class="button_ok" stl:if="id"></input>
  </fieldset>
</form>
<br></br>
