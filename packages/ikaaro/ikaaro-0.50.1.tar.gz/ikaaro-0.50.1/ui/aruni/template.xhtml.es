...
<html xmlns="http://www.w3.org/1999/xhtml" lang="${language}" xmlns:stl="http://www.hforge.org/xml-namespaces/stl">
  <head>
    ...
    <meta name="${meta/name}" content="${meta/content}" stl:repeat="meta meta_tags" lang="${meta/lang}"></meta>  <!-- CSS -->  <link rel="stylesheet" href="${style}" stl:repeat="style styles" type="text/css"></link>
