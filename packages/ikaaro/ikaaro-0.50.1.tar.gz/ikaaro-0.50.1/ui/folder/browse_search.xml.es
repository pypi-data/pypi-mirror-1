...
<form action="" method="get" stl:if="search_fields">
  <fieldset>
    ...
    <!-- SubFolders -->  <input name="search_subfolders" type="checkbox" id="search_subfolders" value="1" checked="${search_subfolders}"></input><label for="search_subfolders">Buscar subcarpetas</label>  <!-- OK -->
       
