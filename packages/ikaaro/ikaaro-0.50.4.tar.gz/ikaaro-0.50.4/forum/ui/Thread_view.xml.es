...
<stl:block xmlns="http://www.w3.org/1999/xhtml" xmlns:stl="http://www.hforge.org/xml-namespaces/stl">
  ...
  <form action="." method="post">
    ...
    <p stl:if="editable">
      <input value="Suprimir" type="submit" name=";remove" class="button_delete" onclick="return confirm('${remove_message}');"></input>
    </p>
  </form>
  ...
  <form action="." method="post" stl:if="is_allowed_to_add">
    ...
    ${rte}
    <p>
    <input value="Responder" type="submit" name=";new_reply" class="button_ok"></input>
    </p>
  </form>
