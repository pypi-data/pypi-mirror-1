...
<stl:block xmlns="http://www.w3.org/1999/xhtml" xmlns:stl="http://www.hforge.org/xml-namespaces/stl">
  ...
  <fieldset>
    ...
    <form id="browse_list" action="" method="post">
      ...
      <p>
        <input value="Change default" class="button_ok" name=";change_default_language" type="submit"></input>
  ...
  <fieldset>
    ...
    <form action="" method="post">
      ...
      <input value="Agregar" class="button_ok" name=";add_language" type="submit"></input>
    </form>
  </fieldset>
