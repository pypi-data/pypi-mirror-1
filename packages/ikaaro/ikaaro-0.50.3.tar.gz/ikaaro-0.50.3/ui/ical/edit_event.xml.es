...
<form method="post" action="${action}" id="edit_event" stl:if="action">
  ...
  <p stl:if="allowed">
     ...
     <input stl:if="remove" value="Definitely remove" class="button_delete" name=";remove_event" type="submit"></input>
     <input stl:if="not remove" value="Cancelar" class="button_cancel" name=";cancel" type="submit"></input>
  </p>
