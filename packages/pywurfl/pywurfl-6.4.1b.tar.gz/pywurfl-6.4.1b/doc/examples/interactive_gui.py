...
Copyright 2004-2006, Armand Lynch <lyncha@users.sourceforge.net>
...
def follow_link(event):
    ...
    wid = infotext.get(trange[0], trange[1])
...
soptions.add_checkbutton(label="Filter Noise", variable=filter_var)
