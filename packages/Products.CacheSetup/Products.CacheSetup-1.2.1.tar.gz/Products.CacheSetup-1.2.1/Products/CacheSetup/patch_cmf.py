...
if PLONE25:
    ...
    from Products.CMFPlone.patches.unicodehacks import FasterStringIO as StringIO
...
def PT_pt_render(self, source=0, extra_context={}):
    ...
    # The following looks like it was left over from when we still did macro caching
    # I'm commenting it out for now as I don't think we do lazy expressions in cachefu anymore
    # 
    ##clean up - XXX
