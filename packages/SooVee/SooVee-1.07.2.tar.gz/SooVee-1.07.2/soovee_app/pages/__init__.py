...
"""
import soovee_lib.plugin as mod
...
class _Page(mod.Loader):
    ...
    def get(self, method, cache, service=None, update=True):
        ...
        @param method: Nickname for page to extract data.
        @type method: basestring
        @param cache: Initialized soovee_lib.cache.
        @type cache: object
        @param service: Initialized soovee_app.conf.ServiceConf.
        @type service: object
        @param update: Default 'True'. Force cache to load from the network.
        @type update: bool
