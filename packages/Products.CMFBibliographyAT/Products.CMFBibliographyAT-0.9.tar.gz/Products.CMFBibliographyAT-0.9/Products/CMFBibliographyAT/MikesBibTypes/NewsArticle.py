...
schema = BaseSchema +  Base_Schema + Schema((
    ...
    StringField('Newspaper',
                required=1,
                searchable=1,
                widget=StringWidget(description="The title of the newspaper.",
    ...
    IntegerField('PublishDay',
                  required=0,
                  searchable=0,
                  validators=('isInt',),
                  widget=IntegerWidget(description="Enter the day of publication.",
    ...
    StringField('ISSN',
                required=0,
                searchable=0,
                widget=StringWidget(description="The ISSN of the newspaper.",
                                    label="ISSN"),
                ),
    )) + Trailing_Schema
...
class NewsArticle(BibSchema):
    """A bibliographic record of a newspaper article"""
    schema = schema
    actions = actions
    include_default_actions = 0
    global_allow = 0
    filter_content_types = 1
    archetype_name = "Newspaper Article"    

registerType(NewsArticle)
