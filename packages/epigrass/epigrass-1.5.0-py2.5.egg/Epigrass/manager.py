...
##        sstats = '%s,%s'%(sdeg,spop)
        ...
        sitef.write('round,geocode,name,infection_time,degree,distance,seed,seedname\n')
...
##            sitef.write(str(s.sitename)+','+st+it+'\n')
            ...
            sitef.write(str(self.round)+','+str(s.geocode)+','+s.sitename+','+it+','+degree+','+distseed+','+seedgc+','+seedname+'\n')
