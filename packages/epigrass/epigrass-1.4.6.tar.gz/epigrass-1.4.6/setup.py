...
setup(name='epigrass',
	...
	download_url = 'http://sourceforge.net/project/showfiles.php?group_id=128000',
        license = 'GPL',
        packages = ['Epigrass'],
        entry_points ={'gui_scripts':['epigrass=epigrass.py']},
        data_files = [('share/epigrass/demos',['demos/script.epg', 'demos/mesh.epg', 'demos/star.epg','demos/flu.epg','demos/sitios3.csv','demos/edgesout.csv', 'demos/nodes.csv','demos/mesh.csv','demos/star.csv','demos/limites.map','demos/CustomModel_example.py']),
