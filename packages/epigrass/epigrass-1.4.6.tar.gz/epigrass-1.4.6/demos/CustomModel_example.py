...
# own custom models.
#
# This file is an example. Please save it as CustomModel.py and edit it to your tastes fore using.
...
def Model(self,vars,par,theta=0, npass=0):
        ...
        # Returning results. This function must return the same variables as it receives in the vars argument.
        return [0,Ipos,Spos]
