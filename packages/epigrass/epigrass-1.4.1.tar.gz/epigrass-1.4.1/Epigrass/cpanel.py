...
#
# Created: Qui Out 27 14:37:04 2005
...
class MainPanel(QWidget):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        self.visualBox1 = QCheckBox(self,"visualBox1")
        self.visualBox1.setEnabled(0)
        self.visualBox1.setGeometry(QRect(10,380,180,28))
        self.visualBox1.setAutoMask(0)
        self.visualBox1.setChecked(0)
        ...
        self.modSpec.setGeometry(QRect(6,6,506,140))

        LayoutWidget_2 = QWidget(self.modSpec,"layout3")
        LayoutWidget_2.setGeometry(QRect(10,20,488,100))
        layout3 = QGridLayout(LayoutWidget_2,1,1,6,6,"layout3")

        self.textLabel1 = QLabel(LayoutWidget_2,"textLabel1")

        layout3.addWidget(self.textLabel1,0,0)

        self.editButton = QPushButton(LayoutWidget_2,"editButton")

        layout3.addWidget(self.editButton,1,2)

        self.scriptNameEdit = QLineEdit(LayoutWidget_2,"scriptNameEdit")

        layout3.addWidget(self.scriptNameEdit,0,1)
        spacer5 = QSpacerItem(370,20,QSizePolicy.Expanding,QSizePolicy.Minimum)
        layout3.addMultiCell(spacer5,1,1,0,1)

        self.chooseButton = QPushButton(LayoutWidget_2,"chooseButton")

        layout3.addWidget(self.chooseButton,0,2)

        self.groupBox2 = QGroupBox(self.Widget8,"groupBox2")
        self.groupBox2.setGeometry(QRect(6,160,510,170))
        self.groupBox2.setSizePolicy(QSizePolicy(QSizePolicy.Expanding,QSizePolicy.Preferred,0,0,self.groupBox2.sizePolicy().hasHeightForWidth()))

        LayoutWidget_3 = QWidget(self.groupBox2,"layout8")
        LayoutWidget_3.setGeometry(QRect(11,96,238,59))
        layout8 = QGridLayout(LayoutWidget_3,1,1,6,6,"layout8")

        self.textLabel4 = QLabel(LayoutWidget_3,"textLabel4")

        layout8.addWidget(self.textLabel4,0,0)

        self.uidEdit = QLineEdit(LayoutWidget_3,"uidEdit")

        layout8.addWidget(self.uidEdit,1,0)

        LayoutWidget_4 = QWidget(self.groupBox2,"layout7")
        LayoutWidget_4.setGeometry(QRect(11,31,238,59))
        layout7 = QGridLayout(LayoutWidget_4,1,1,6,6,"layout7")

        self.hostnEdit = QLineEdit(LayoutWidget_4,"hostnEdit")

        layout7.addWidget(self.hostnEdit,1,0)

        self.textLabel2 = QLabel(LayoutWidget_4,"textLabel2")

        layout7.addWidget(self.textLabel2,0,0)

        LayoutWidget_5 = QWidget(self.groupBox2,"layout9")
        LayoutWidget_5.setGeometry(QRect(261,96,238,59))
        layout9 = QGridLayout(LayoutWidget_5,1,1,6,6,"layout9")
        ...
        layout9.addWidget(self.pwEdit,1,0)

        LayoutWidget_6 = QWidget(self.groupBox2,"layout12")
        LayoutWidget_6.setGeometry(QRect(260,30,240,59))
        layout12 = QGridLayout(LayoutWidget_6,1,1,6,6,"layout12")

        self.textLabel3 = QLabel(LayoutWidget_6,"textLabel3")

        layout12.addWidget(self.textLabel3,0,0)

        self.portEdit = QLineEdit(LayoutWidget_6,"portEdit")

        layout12.addWidget(self.portEdit,1,0)
        ...
        self.dbBackup.setGeometry(QRect(321,40,178,33))
        ...
        self.textLabel2_4.setGeometry(QRect(10,180,270,23))

        self.textLabel1_10 = QLabel(self.visPage,"textLabel1_10")
        self.textLabel1_10.setGeometry(QRect(8,100,260,20))
        ...
        self.dbscanButton.setGeometry(QRect(360,10,140,36))
    ...
    def languageChange(self):
        ...
        self.visualBox1.setText(self.__tr("Visualize Graph"))
        QToolTip.add(self.visualBox1,self.__tr("Check this box if you have vpython intalled"))
        self.textLabel1_6.setText(self.__tr("Progress:"))
        QToolTip.add(self.stepLCD,self.__tr("Simulation step"))
        QToolTip.add(self.tabWidget,self.__tr("Visualization tools"))
        ...
        self.groupBox2.setTitle(self.__tr("Database Specification"))
