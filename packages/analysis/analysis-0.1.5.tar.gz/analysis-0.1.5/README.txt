...
(This produces HTML files alongside each Python program in the tests
directory.)
...
(This produces C source files alongside each Python program in the tests
directory.)
...
python dump.py tests/fib.py --C builtins.c fib.c
