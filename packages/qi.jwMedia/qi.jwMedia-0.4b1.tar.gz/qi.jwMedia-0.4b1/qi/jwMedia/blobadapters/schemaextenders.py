...
class BlobFieldAutoId(BlobField):
	"""
	A blob field that uses plone's default auto-generated id
	"""
	
	def fixAutoId(self, instance):
		"""
		Bypass Blobfield's id generation
		"""
		pass
		
class ExtensionBlobField(ExtensionField, BlobFieldAutoId):
