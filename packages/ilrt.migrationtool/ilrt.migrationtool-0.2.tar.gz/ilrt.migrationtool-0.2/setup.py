...
setup(name='ilrt.migrationtool',
      version=version,
      description="A generic migration tool for migrating sites based on version releases of the sites theme egg(s)",
      ...
      url='https://svn.ilrt.bris.ac.uk/repos/plone3/trunk/src/ilrt.migrationtool/',
      license='GPL',
