...
# I'm too tired to figure out if I need this
import buggdUtil 
...
def error_search(error_text):
    ...
    global _search_id
    global _error_list
    _search_id = _buggd.submitError(_buggdEmail, error_text)
...
def error_help(item_number = None):
    ...
    if _buggdEmail == None:
        # Ask for user email
        _buggdEmail = buggdUtil.getUserEmail()
