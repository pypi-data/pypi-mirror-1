...
if sys.platform[:3]=='win':
        x=gettext.translation('BPGR', resource_filename(__name__, 'locale'), languages=['ru', 'en'])
else:
...
class ApplicationFrame(wx.Frame):
    def __init__(self, parent, id):
        ...
        sizer.Add(self.bitmap, (0, 0), (1, 4), flag=wx.ALIGN_CENTER|wx.TOP|wx.BOTTOM, border=5)
