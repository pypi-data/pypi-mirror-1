...
def getModel(engine):
    ...
    class Testrunner(Base):
        ...
        run = relation('Run', backref='run_id', passive_deletes=True, cascade='all, delete, delete-orphan')
    ...
    class Run(Base):
        ...
        result = relation('Result', backref='result_id', passive_deletes=True, cascade='all, delete, delete-orphan')
