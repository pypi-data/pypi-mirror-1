...
schema = Schema((
    ...
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            label_msgid='CMFPlomino_label_id',
            description_msgid='CMFPlomino_help_id',
    ...
    BooleanField(
        ...
        widget=BooleanField._properties['widget'](
            ...
            label_msgid='CMFPlomino_label_isSearchForm',
            description_msgid='CMFPlomino_help_isSearchForm',
            i18n_domain='CMFPlomino',
        ),
        schemata="Parameters",
    ),
    ...
    IntegerField(
        ...
        widget=IntegerField._properties['widget'](
            ...
            description_msgid="CMFPlomino_decription_Position",
            i18n_domain='CMFPlomino',
        ),
        schemata="Parameters",
    ),
...
class PlominoForm(ATFolder):
    ...
    def searchDocuments(self,REQUEST):
        ...
        if searchformula:
            filteredResults = []
            for doc in results:
                logger.info('searchDocuments-> doc title : ' + str(doc.getObject().Title()))
                try:
                    valid = self.runFormulaScript("form_"+self.id+"_searchformula", doc.getObject(), self.SearchFormula)
                    logger.info('searchDocuments-> run formula ok')
                except Exception, e:
                    logger.info('searchDocuments-> except : ' + str(e))
                    valid = False
                if valid:
                    logger.info('searchDocuments-> valid : ' + str(doc.getObject().Title()))
                    filteredResults.append(doc)
            results = filteredResults

        logger.info('searchDocuments-> filtered results : ' + str(results))
