...
schema = Schema((
    ...
    BooleanField(
        ...
        widget=BooleanField._properties['widget'](
            ...
            label_msgid='CMFPlomino_label_Mandatory',
            description_msgid='CMFPlomino_help_Mandatory',
            i18n_domain='CMFPlomino',
        ),
    ),
    TextField(
        ...
        widget=TextAreaWidget(
            ...
            label_msgid='CMFPlomino_label_ValidationFormula',
            description_msgid='CMFPlomino_help_ValidationFormula',
            i18n_domain='CMFPlomino',
        ),
    ),
    BooleanField(
        ...
        widget=BooleanField._properties['widget'](
            ...
            label_msgid='CMFPlomino_label_ToBeIndexed',
            description_msgid='CMFPlomino_help_ToBeIndexed',
            i18n_domain='CMFPlomino',
        ),
    ),
),
