...
import logging
logger = logging.getLogger('PlominoView')
...
class PlominoView(ATFolder):
    ...
    def exportCSV(self, REQUEST=None, displayColumnsTitle='False', separator="\t"):
        ...
        writer = csv.writer(stream, delimiter=separator, quotechar='"', quoting=csv.QUOTE_NONNUMERIC)
