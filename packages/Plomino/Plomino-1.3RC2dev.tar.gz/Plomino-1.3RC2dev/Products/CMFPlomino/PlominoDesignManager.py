...
class PlominoDesignManager(Persistent):
    ...
    def exportDesign(self, REQUEST=None):
        ...
        if designelements:
            ...
            result=authenticateAndPostToURL(targetURL+"/importDesignFromXML", username, password, '%s.%s' % (id, 'xml'), xmlstring)
    ...
    def runFormulaScript(self, script_id, context, formula_getter, with_args=False, *args):
        try:
            ...
            try:
                ...
                if hasattr(contextual_ps, 'errors') and self.debugMode:
                    logger.info('python errors : ' + str(contextual_ps.errors))
            except Exception, e:
                self.traceErr(e, context, formula_getter)
                raise
            return result
    ...
    def traceErr(self, e, context, formula_getter):
        ...
        if self.debugMode:
            ...
            msg = str(f.getvalue())
            #code / value
            msg = msg + "Plomino formula error : " + str(e)
            msg = msg + "\n   in code : \n" + formula_getter()
    ...
    security.declarePrivate('writeMessageOnPage')
    ...
    def exportElementAsXML(self, xmldoc, obj):
        """
        """
    ...
    def exportResourceAsXML(self, xmldoc, obj):
        ...
        if type=="Page Template":
            ...
            data = xmldoc.createCDATASection(obj.data.encode('base64'))
            ...
            while child is not None:
                ...
                if name == 'id':
                    ...
                    if child.hasChildNodes():
                        ...
                        obj.processForm(values={name : child.firstChild.data})
