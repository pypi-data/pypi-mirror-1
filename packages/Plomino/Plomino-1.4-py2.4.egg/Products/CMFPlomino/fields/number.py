    ...
    def validate(self, submittedValue):
        ...
        if self.type=="INTEGER":
            try:
                ...
                errors.append(fieldname+" must be an integer (submitted value was: "+submittedValue+")")
        if self.type=="FLOAT":
            try:
                v = float(submittedValue)
            except:
                errors.append(fieldname+" must be a float (submitted value was: "+submittedValue+")")
