...
schema = Schema((
    ...
    TextField(
        ...
        widget=TextAreaWidget(
            ...
            label_msgid='CMFPlomino_label_Hidewhen',
            description_msgid='CMFPlomino_help_Hidewhen',
            i18n_domain='CMFPlomino',
        ),
    ),
    BooleanField(
        ...
        widget=BooleanField._properties['widget'](
            ...
            label_msgid='CMFPlomino_label_InActionBar',
            description_msgid='CMFPlomino_help_InActionBar',
            i18n_domain='CMFPlomino',
        ),
    ),
),
