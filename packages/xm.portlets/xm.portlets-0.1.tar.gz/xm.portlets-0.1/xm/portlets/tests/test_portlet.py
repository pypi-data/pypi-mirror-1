...
from xm.portlets.project.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(IPortletType, name='xm.portlets.project.ProjectPortlet')
        self.assertEquals(portlet.addview, 'xm.portlets.project.ProjectPortlet')
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = project.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, project.EditForm))
