...
i18ndude rebuild-pot --pot sc.base.memberdataexport.pot --create sc.base.memberdataexport --merge manual.pot ../*

# finally, update the po files
i18ndude sync --pot sc.base.memberdataexport.pot  `find . -iregex '.*\.po$'|grep -v plone`
