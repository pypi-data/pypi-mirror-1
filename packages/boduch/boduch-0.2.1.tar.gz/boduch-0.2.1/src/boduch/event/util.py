...
def subscribe(evt, handle):
    ...
    return EventManager.subscribe(evt, handle)
...
def processed(is_processed):
    """Set the mode of the event manager.  True for processed mode."""
    ThreadManager.processed=is_processed
    
__all__=['publish', 'subscribe', 'unsubscribe', 'threaded', 'processed']