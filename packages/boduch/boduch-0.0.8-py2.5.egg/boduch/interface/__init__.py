...
from boduch.interface.threadmanager import IThreadManager
...
__all__=['IEventThread', 'IEvent', 'IEventManager', 'ILockManager',\
         'IThreadManager', 'IType', 'IHandle', 'ISet', 'IHash']