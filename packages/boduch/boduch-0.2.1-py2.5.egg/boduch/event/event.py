...
from boduch.event import subscribe, unsubscribe
...
class Event(Type):
    ...
    @classmethod
    def subscribe(cls, handle):
        """Subscribe the specified handle class to this event class."""
        return subscribe(cls, handle)
        
    @classmethod
    def unsubscribe(cls, handle):
        """Unsubscribe the specified handle class from this event class."""
