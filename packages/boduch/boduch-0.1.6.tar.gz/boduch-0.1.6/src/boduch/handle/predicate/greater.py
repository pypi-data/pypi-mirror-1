...
"""This module defines the HandleGreater predicate event handle."""

from boduch.handle import Handle
from boduch import PRIORITY_CRITICAL

class HandleGreater(Handle):
    """The HandleGreater event handle.  This event handle is
    executed for EventGreater events."""
