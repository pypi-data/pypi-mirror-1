...
from djangoplus.utils import path_to_object, split1000
...
def moneyformat(value, decimal_places=2, thousands_separator=''):
    ...
    if thousands_separator:
        ...
        ret = split1000(parts[0], thousands_separator) + dec_sep + parts[1]
...
class AjaxFKWidgetCellsRender(template.Node):
    ...
    def render(self, context):
        ...
        context[self.var_result] = [{'name': f, 'value': getattr(obj, f, None)} for f in list_display]
