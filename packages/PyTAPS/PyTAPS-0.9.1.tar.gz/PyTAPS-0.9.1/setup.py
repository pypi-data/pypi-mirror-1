...
class BuildExtCommand(build_ext, ITAPSCommand):
    def _check_for_iface(self, iface):
        ...
        try:
            ...
            if iface in self.defs:
                include_dirs += self.defs[iface][0]
    ...
    def build_extension(self, ext):
        ...
        if name == 'iBase' or self._check_for_iface(name):
...
setup(name = 'PyTAPS',
      ...
      long_description = open(os.path.join(sys.path[0], "README")).read(),
