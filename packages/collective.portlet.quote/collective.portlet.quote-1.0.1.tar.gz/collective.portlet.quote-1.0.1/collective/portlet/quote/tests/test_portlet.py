...
from collective.portlet.quote import randomquote

from collective.portlet.quote.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_interfaces(self):
        ...
        portlet = randomquote.Assignment()
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = randomquote.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, randomquote.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        self.failUnless(isinstance(renderer, randomquote.Renderer))
...
class TestRenderer(TestCase):
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        # constructor.
        assignment = assignment or randomquote.Assignment()
