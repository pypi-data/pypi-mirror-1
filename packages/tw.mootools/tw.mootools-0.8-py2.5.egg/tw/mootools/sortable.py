from toscawidgets.api import Widget, JSLink, CSSLink, CSSSource, JSSource
from genshi.template.text import TextTemplate
from base import DomElementWithValue, moo_js
...
class SortableWidget(Widget):
    ...
    template = "genshi:toscawidgets.widgets.mootools.templates.sortable"
