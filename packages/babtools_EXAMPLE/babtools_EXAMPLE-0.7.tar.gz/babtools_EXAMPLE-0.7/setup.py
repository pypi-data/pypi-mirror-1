...
"""babtools_EXAMPLE - Example structure with efficient PyPI usage: very small overhead for updating the PyPI entry.
...
For updating your PyPI entry to a new version, you only need to change the __version__ parameter in your main file (here it is babtools_EXAMPLE.py) and then run "python setup.py register".
