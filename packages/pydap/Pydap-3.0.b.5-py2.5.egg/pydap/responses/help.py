...
DEFAULT_TEMPLATE = """<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="main">
            ...
            <p>In case you <strong>don't have</strong> a client installed, you can also download data by accessing the <a href="${location}.html">web interface</a> for this dataset.</p>
