...
class StoredEntity(Entity):
    ...
    @_init_obj_wrapper
    def put_stream(self, part_id, bytestream, mimetype=None, version=None, commit_metadata_changes=False):
        response = self.obj.add_part(part_id, bytestream, version=version)
        ...
        #self.add_triple(version_uri, "dcterms:isPartOf", self.uri)
