#LT 2007/11 ajout import sys
#LT 2007/11 adaptation a sqlalchemyManager
"""\
...
#import authproxy.lib.authkit_adapter.authenticate as authkit_authenticate_adapter

#LT
from authproxy.lib.authkit_adapter.authenticate import AuthKitConfigError, get_template, \
...
class DigestUserSetter(object):
    def __init__(self, application, realm, authfunc, users):
        self.application = application
        #self.users = users
        #LT 11/2007 adapation a sqlalchemyMiddleware
        self.users = "WSGI"
