...
GETPAID_BASE_PACKAGES = [
    ...
    PyModule('getpaid.core', CHEESE_SOURCE + 'g/getpaid.core/getpaid.core-0.7.3.tar.gz', version="0.7.3"),
    PyModule('Products.PloneGetPaid', CHEESE_SOURCE + 'P/Products.PloneGetPaid/Products.PloneGetPaid-0.7.5.tar.gz', version="0.7.5"),
...
GETPAID_OTHER_PACKAGES = {
    ...
    # others
    'getpaid.formgen': PyModule('getpaid.formgen', CHEESE_SOURCE + 'g/getpaid.formgen/getpaid.formgen-0.1.tar.gz', version="0.1"),
