...
setup(
    ...
    long_description = "0.41 fixes several bugs. The 0.40 release introduces major changes to the basic working and philosophy of pod and is not backward compatible.", 
    )