    ...
    class Pod(object):
        ...
        def inst_new(self, inst = None, kwargs = None):
            ...
            if kwargs is not None:
                ...
                for key,value in kwargs.iteritems():
                    self.inst_check_if_mutant(inst = inst, attr = key, value = value, set_attr = True)
        ...
        def inst_set_attr(self, inst, attr, value):
            ...
            if self.inst_check_if_exists(inst):
                ...
                self.inst_check_if_mutant(inst = inst, attr = attr, value = value, set_attr = True)
        ...
        def inst_check_if_mutant(self, inst, attr, value, set_attr = False):
            ...
            if set_attr and inst in self.db.mutants:
                self.db.mutants[inst].discard(attr)
...
class Object(object):
    ...
    def __setattr__(self, attr, value): 
        # The mutant code -- it's the same all three places.  Direct insert instead of function call for speed. 
        if value is not None and not isinstance(value, (Object, NoSave, str, int, float, bool, long, complex, tuple, frozenset)):
            type.__getattribute__(object.__getattribute__(self, '__class__'), 'pod').db.mutants.setdefault(self,set()).add(attr)
