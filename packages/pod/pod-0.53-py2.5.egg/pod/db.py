...
class Db(object):
    ...
    def __init__(self, file = ':memory:', remove = False, clear = False, connect = True, attach = None, index = False, chatty = False, very_chatty = False, use_full_table_name = True):
    ...
    def get_inst(self, cls_id, inst_id): 
        ...
        if cls_pod:
            ...
            if id in self.undefineds:
                ...
                undefined = core.Undefined(id = (cls_id, inst_id), cursor = self.db.cursor)
