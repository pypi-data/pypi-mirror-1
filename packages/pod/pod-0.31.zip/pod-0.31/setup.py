...
setup(
    ...
    long_description = "The 0.30 release changes underlying architecture to increase insert speed, adds new features.  Not backward compatible.  Visit http://code.google.com/p/pickled-object-database/wiki/what_is_new"
)
