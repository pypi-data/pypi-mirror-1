...
kukit.sa.ServerAction.prototype.processResult = function(domDoc) {
    ...
    if (dom == null) {
        ...
        if (payload) {
            try {
                ...
                ;;; kukit.E = new kukit.err.ResponseParsingError('Error parsing X-KSSCOMMANDS header.');
                throw kukit.E;
            }
            commandstags = kukit.dom.getNsTags(dom, 'commands');
            if (commandstags.length != 1) {
            ...
            ;;;     kukit.E = new kukit.err.ResponseParsingError(errtxt + ': ' + Sarissa.getParseErrorText(dom));
            ;;; } else {
            ;;;     kukit.E = new kukit.err.ResponseParsingError(errtxt);
            ;;; }
            throw kukit.E;
        }
    }
    if (dom == null) {
        ...
        ;;; kukit.E = new kukit.err.ResponseParsingError('Neither xml nor html payload.');
        throw kukit.E;
    }
