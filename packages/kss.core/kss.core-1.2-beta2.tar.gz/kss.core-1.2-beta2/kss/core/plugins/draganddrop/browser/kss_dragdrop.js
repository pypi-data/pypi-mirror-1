...
kukit.eventsGlobalRegistry.registerForAllEvents('dad', ['drag', 'start', 'end'], kukit.draganddrop.DragAndDropEvent, '__bind_drag__', null);
kukit.eventsGlobalRegistry.registerForAllEvents('dad', ['drop', 'hover'], kukit.draganddrop.DragAndDropEvent, '__bind_drop__', null);
