...
class AmplInfoTester(pyutilib.th.TestCase):
    ...
    def test_add(self):
        ...
        tmp = str(self.info)
        target = "con f ['a'] None\nparam b ['a'] None\nvar c ['a', 'a'] None\nmin d ['a'] None\nset a [] None\nmax e ['a', 'a'] None"
        self.failUnlessEqual(tmp,target)
        #
        ...
        for i in self.info:
            tmp.append(i[1])
        self.failUnlessEqual(tmp,['f','b','c','d','a','e'])
    ...
    def test_initialize1(self):
        ...
        self.failUnlessFileEqualsBaseline(currdir+"initialize1.out",currdir+"initialize1.txt")
    ...
    def test_initialize2(self):
        ...
        print str(sinfo)
        pyutilib.misc.reset_redirect()
        self.failUnlessFileEqualsBaseline(currdir+"initialize2.out",currdir+"initialize2.txt")
    ...
    def test_initialize3(self):
        ...
        print str(sinfo)
        pyutilib.misc.reset_redirect()
        self.failUnlessFileEqualsBaseline(currdir+"initialize3.out",currdir+"initialize3.txt")
    ...
    def test_check(self):
        ...
        self.info.check(sinfo)
        pyutilib.misc.reset_redirect()
        self.failUnlessFileEqualsBaseline(currdir+"check.out",currdir+"check.txt")
