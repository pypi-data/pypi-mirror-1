#############################################################################
#  
#	$Id: remote_nons.py,v 1.4 2004/02/22 20:50:55 irmen Exp $
...
def get_server_object(objectName, hostname , portnum):
    ...
    try:
        ...
        raise Error("Couldn't bind object, Pyro says:", x)

def provide_server_object(object, name = None, hostname = '', portnum = None):
