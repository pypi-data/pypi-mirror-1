...
Installation
    ...
    The buildout way:
        ...
        1. Unpack webcouturier.hosting.theme package to src/ folder of your buildout
        ...
        Zope to configure webcouturier.hosting.theme.
    
        If another package depends on the webcouturier.hosting.theme egg or includes
