...
# 254: override Message.messageKind
...
# 130: override Property.navigability
...
# 122: override Property.isComposite derives Property.aggregation
...
# 86: override Classifier.general
...
# 203: override Component.provided
import itertools
...
# 98: override Namespace.importedMember
Namespace.importedMember = derivedunion('importedMember', PackageableElement, 0, '*')
# 273: override StructuredClassifier.part
...
BehavioralFeature.parameter = derivedunion('parameter', Parameter, 0, '*', BehavioralFeature.returnResult, BehavioralFeature.formalParameter)
Transition.redefintionContext = derivedunion('redefintionContext', Classifier, 1, 1)
# 239: override Component.required
...
# 127: override Constraint.context
