...
# 210: override Message.messageKind
...
Element.appliedStereotype = association('appliedStereotype', InstanceSpecification)
...
Slot.definingFeature = association('definingFeature', StructuralFeature, lower=1, upper=1)
...
# 102: override Property.isComposite derives Property.aggregation
...
Property.classifier = derivedunion('classifier', Classifier, 0, 1, Property.useCase, Property.actor, Property.interface_, Property.datatype, Property.class_)
...
Element.owner = derivedunion('owner', Element, 0, 1, Realization.abstraction, ActivityEdge.activity, ActivityGroup.superGroup, Slot.owningInstance, NamedElement.namespace, PackageImport.importingNamespace, PackageMerge.mergingPackage, ElementImport.importingNamespace, ActivityGroup.activity, Pseudostate.state)
...
DirectedRelationship.source = derivedunion('source', Element, 1, '*', Extend.extension, Realization.abstraction, Substitution.substitutingClassifier, PackageImport.importingNamespace, PackageMerge.mergingPackage, Include.includingCase, ElementImport.importingNamespace)
...
# 159: override Component.provided
import itertools
...
# 78: override Namespace.importedMember
Namespace.importedMember = derivedunion('importedMember', PackageableElement, 0, '*')
StructuredClassifier.part = derivedunion('part', Property, 0, '*')
# 30: override Association.endType derives Association.memberEnd Property.type
...
# 52: override Extension.metaclass
...
DirectedRelationship.target = derivedunion('target', Element, 1, '*', Extend.extendedCase, Realization.realizingClassifier, PackageImport.importedPackage, Substitution.contract, PackageMerge.mergedPackage, Generalization.general, Include.addition, ElementImport.importedElement)
# 39: override Class.extension derives Association.endType
def class_extension(self):
    return list(self._factory.select(lambda e: e.isKindOf(Extension) and self in e.endType))

Class.extension = derived('extension', Extension, 0, '*', Association.endType)
...
BehavioralFeature.parameter = derivedunion('parameter', Parameter, 0, '*', BehavioralFeature.returnResult, BehavioralFeature.formalParameter)
Transition.redefintionContext = derivedunion('redefintionContext', Classifier, 1, 1)
# 195: override Component.required
...
# 107: override Constraint.context
