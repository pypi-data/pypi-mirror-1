...
class wxFrame2(wx.Frame):
    ...
    def _init_coll_toolBar1_Tools(self, parent):
        ...
        parent.AddTool(bitmap=wx.Bitmap('backup_section.png',
              wx.BITMAP_TYPE_PNG), id=wxID_WXFRAME2TOOLBAR1TOOLS0,
              isToggle=False, longHelpString='Save this table',
              pushedBitmap=wx.NullBitmap, shortHelpString='Save As')
        parent.DoAddTool(bitmap=wx.Bitmap('gnuplot.png', wx.BITMAP_TYPE_PNG),
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_WXFRAME2, name='', parent=prnt,
              pos=wx.Point(235, 134), size=wx.Size(686, 491),
        ...
        self.toolBar1 = wx.ToolBar(id=wxID_WXFRAME2TOOLBAR1, name='toolBar1',
              parent=self, pos=wx.Point(0, 0), size=wx.Size(96, 50),
        ...
        self.grid1 = wx.grid.Grid(id=wxID_WXFRAME2GRID1, name='grid1',
              parent=self.panel1, pos=wx.Point(0, 0), size=wx.Size(683, 418),
              style=0)
