...
class wxFrame1(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_WXFRAME1, name='', parent=prnt,
              pos=wx.Point(254, 58), size=wx.Size(730, 480),
        ...
        self.toolBar1 = wx.ToolBar(id=wxID_WXFRAME1TOOLBAR1, name='toolBar1',
              parent=self, pos=wx.Point(0, 26), size=wx.Size(142, 50),
    ...
    def OnMenu1items1Menu(self, event):
        ...
        if self.FileName == None:
            ...
            self.modetree.saveFile(filename)
            self.ModLoaded = 1
...
#-------------------------------------------------------------------------------
    ...
    def BuildModel(self, r=0):
        ...
        self.modict['init'] = self.initValInput.GetValue().strip() # Store initial conditions
...
# TODO: extract the values of post_phi at time time for each variable to plot.
    ...
    def OnMenu2Items1Menu(self, event):
        ...
        #Vector.Equations = self.Equations
        Vector.setComboChoices(['y[%s]'%i for i in xrange(self.Neq)])
        Vector.Show()
