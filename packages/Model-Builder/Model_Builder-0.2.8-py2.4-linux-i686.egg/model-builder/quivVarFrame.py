...
class quivVarFrame(wx.MiniFrame):
    def _init_ctrls(self, prnt):
        ...
        self.varList1 = wx.ComboBox(choices=[], id=wxID_QUIVVARFRAMEVARLIST1,
        ...
        self.varList2 = wx.ComboBox(choices=[], id=wxID_QUIVVARFRAMEVARLIST2,
    ...
    def OnPlotButtonButton(self, event):
        ...
        if self.drawTrajCheck.IsChecked():
            ...
            self.calcPlot(traj=0)
        self.Close()
    
    def setComboChoices(self,choices):
        """
        This function updates the choices of the combolists.
        For that, it recreates the widgets
        choices: a list of strings.
        """
        self.choices = choices
        self.varList1 = wx.ComboBox(choices=choices, id=wxID_QUIVVARFRAMEVARLIST1,
              name='varList1', parent=self, pos=wx.Point(16, 40),
              size=wx.Size(128, 24), style=0, value='Select Variable')
        self.varList1.SetLabel('')
        self.varList1.SetToolTipString('Select variable for the X axis.')
        ...
        self.varList2 = wx.ComboBox(choices=choices, id=wxID_QUIVVARFRAMEVARLIST2,
              name='varList2', parent=self, pos=wx.Point(192, 40),
              size=wx.Size(128, 25), style=0, value='Select Variable')
        self.varList2.SetLabel('')
        self.varList2.SetToolTipString('Select Variable for the Y axis.')
        self.varList2.Bind(wx.EVT_COMBOBOX, self.OnVarList2Combobox,
              id=wxID_QUIVVARFRAMEVARLIST2)
# TODO: fix update of combo choices!!
    ...
    def OnVarList1Combobox(self, event):
        self.X = choice = self.varList1.GetValue()
        self.Xselected = 1
        self.var1 = self.choices.index(choice)

    def OnVarList2Combobox(self, event):
        self.Y = choice = self.varList2.GetValue()
        self.Yselected = 1
        self.var2 = self.choices.index(choice)
