...
[wxID_QUIVVARFRAME, wxID_QUIVVARFRAMEDRAWTRAJCHECK, 
 ...
 wxID_QUIVVARFRAMELIMITSTEXT, wxID_QUIVVARFRAMEPANEL1, 
 wxID_QUIVVARFRAMEPLOTBUTTON, wxID_QUIVVARFRAMETRAJBOX, 
 wxID_QUIVVARFRAMETRAJLENSPIN, wxID_QUIVVARFRAMEVARLIST1, 
 wxID_QUIVVARFRAMEVARLIST2, wxID_QUIVVARFRAMEXVARTEXT, 
 wxID_QUIVVARFRAMEYVARTEXT, 
...
class quivVarFrame(wx.MiniFrame):
    def _init_ctrls(self, prnt):
        ...
        wx.MiniFrame.__init__(self, id=wxID_QUIVVARFRAME, name='quivVarFrame',
              parent=prnt, pos=wx.Point(341, 222), size=wx.Size(334, 244),
              style=wx.DEFAULT_FRAME_STYLE, title='Select Variables')
        ...
        self.xvarText = wx.StaticText(id=wxID_QUIVVARFRAMEXVARTEXT,
              label='X - axis', name='xvarText', parent=self,
              pos=wx.Point(16, 16), size=wx.Size(48, 16), style=0)

        self.yvarText = wx.StaticText(id=wxID_QUIVVARFRAMEYVARTEXT,
              label='Y - axis', name='yvarText', parent=self,
              pos=wx.Point(200, 16), size=wx.Size(64, 16), style=0)
        ...
        self.trajlenSpin = wx.SpinCtrl(id=wxID_QUIVVARFRAMETRAJLENSPIN,
              initial=10, max=5000, min=2, name='trajlenSpin',
              parent=self, pos=wx.Point(88, 200), size=wx.Size(72, 24),
        ...
        self.lengthText = wx.StaticText(id=wxID_QUIVVARFRAMELENGTHTEXT,
              label='Length:', name='lengthText', parent=self,
              pos=wx.Point(32, 208), size=wx.Size(56, 16), style=0)
        self.lengthText.Enable(False)

        self.plotButton = wx.lib.buttons.GenButton(ID=wxID_QUIVVARFRAMEPLOTBUTTON,
              label='Plot', name='plotButton', parent=self,
              pos=wx.Point(232, 80), size=wx.Size(89, 31), style=0)
        ...
        self.limitsText = wx.StaticText(id=wxID_QUIVVARFRAMELIMITSTEXT,
              label='Limits:', name='limitsText', parent=self,
              pos=wx.Point(16, 88), size=wx.Size(48, 16), style=0)
