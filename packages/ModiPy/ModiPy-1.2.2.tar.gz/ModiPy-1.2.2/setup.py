#!/usr/bin/python
# $Id: setup.py 100 2009-08-25 22:18:17Z daedalus $
#
##COPYRIGHT##
...
class modipyDistribution(Distribution):
...
setup(
    ...
    distclass = modipyDistribution,

    author="Justin Warren",
    author_email="daedalus@eigenmagic.com",
    description="ModiPy change management system",
    long_description="""ModiPy is a modular, extensible change management system for automating changes in a heterogenous IT environment.""",
    license='LGPL',
    keywords = "change automation",
    url='http://modipy.seafelt.com',
