...
* Inflate the PloneArticle-x.y.z.tgz in the Products directory of
  your Zope instance.
...
* If you use a version of plone not providing jquery by default, go to
  javascript_registry in the ZMI and enable pa_jquery manually.
