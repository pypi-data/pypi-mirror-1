...
pamodel.paplayer = {
    ...
    showImage: function() {
        ...
        pamodel.paplayer.displayButtons();
    },
...
/* remove empty fieldsets on pa view models when user is not author - temp js fix */

removeEmptyPAFielsets = function()  {
    jQuery('#pacontent fieldset.leftPlaced').each(function() {
       if (jQuery('div', this).length==0)  jQuery(this).remove();
    })
}

jQuery(document).ready(removeEmptyPAFielsets);
