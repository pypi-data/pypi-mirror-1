...
class PrimaryKeyConstraint(ConstraintChangeset,schema.PrimaryKeyConstraint):
    ...
    def create(self, *args, **kwargs):
        ...
        visitorcallable = get_engine_visitor(self.table.engine,'constraintgenerator')
        _engine_run_visitor (self.table.engine, visitorcallable, self)
    ...
    def drop(self,*args,**kwargs):
        from migrate.changeset.databases.visitor import get_engine_visitor
        visitorcallable = get_engine_visitor(self.table.engine,'constraintdropper')
        _engine_run_visitor (self.table.engine, visitorcallable, self)
        self.columns.clear()
        return self
