...
_magic_number = 2
_modified_time = 1236245974.019295
_template_filename='/home/mehtap/frla/frla/templates/sonuc2.mako'
_template_uri='/sonuc2.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 1
        context.write(u'<meta http-equiv="Content-Type" content="text/html; charset=utf-8">\n<body text="#ffffff" bgcolor="#000000" link="aa0000" vlink="ff0000" >\n')
        # SOURCE LINE 3
        context.write(unicode(_('anasayfalink2')))
        context.write(u'\n')
        # SOURCE LINE 4
