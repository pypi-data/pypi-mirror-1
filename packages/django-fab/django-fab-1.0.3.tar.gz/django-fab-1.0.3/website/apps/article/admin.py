...
from article.admin.forms import PageForm, PageAddForm
...
from article.models import ArticlePage as ArticlePage
from cms.models import Title, CMSPlugin, PagePermission, \
...
class ArticlePageAdmin(admin.ModelAdmin):
    ...
    add_general_fields = ['title', 'slug', 'language', 'template','body_text']
...
if 'reversion' in settings.INSTALLED_APPS:
    ...
    admin.site.register(ArticlePage, PageAdmin)
