...
__revision__ = "$Rev: 208 $"
__date__ = "$Date: 2008-03-05 22:18:00 +0100 (Mi, 05 Mrz 2008) $"
...
class DocBook2Sla(object):
    ...
    def create(self, docbookfn, scribusfn, output_filename=None, validate=False):
        ...
        docbook_with_ids = self.transform(docbookfn, xsl_generateid)

        #return open(docbook_with_ids, 'r').read()

        # docbook2pageobject : 01_content.id.xml -> pageobjects.xml
        scribus_pageobjects = self.transform(docbook_with_ids, xsl_docbook2pageobject)
