...
<!--
	...
	$Revision: 192 $
	$URL: https://svn.zmag.de/svn/python/docbook2sla/trunk/docbook2sla/xsl/docbook2pageobject.xsl $
...
<xsl:stylesheet version="1.0"
	...
	<!-- simple pageobjects -->
	<xsl:template match="bookinfo/title|bookinfo/pubdate|article/title|article/subtitle|article/blockquote">
