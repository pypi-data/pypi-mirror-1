...
<!--
	...
	Stylesheet to merge a docbook file into a scribus template.

	$Date: 2008-03-03 12:26:29 +0100 (Mo, 03 Mrz 2008) $
	$Revision: 192 $
	$URL: https://svn.zmag.de/svn/python/docbook2sla/trunk/docbook2sla/xsl/merge.xsl $
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <xsl:message>merge.xsl : content.xml + layout.sla -> output.sla</xsl:message>
    <xsl:message>==================================================</xsl:message>
