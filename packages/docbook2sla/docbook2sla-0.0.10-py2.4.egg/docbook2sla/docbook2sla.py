...
__revision__ = "$Rev: 233 $"
__date__ = "$Date: 2008-03-07 15:19:05 +0100 (Fri, 07 Mar 2008) $"
...
class DocBook2Sla(object):
    ...
    def create(self, docbookfn, scribusfn, output_filename=None, validate=False):
        ...
        if _debug:
            LOG.info("DEBUG: docbook_with_ids written to '%s'" % docbook_with_ids)
        ...
        if _debug:
            LOG.info("DEBUG: scribus_pageobjects written to '%s'" % scribus_pageobjects)
