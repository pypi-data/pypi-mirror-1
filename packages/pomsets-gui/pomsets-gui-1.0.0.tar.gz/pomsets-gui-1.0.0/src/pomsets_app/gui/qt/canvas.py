...
Qt.GroupSwitchModifier	0x40000000	X11 only. A Mode_switch key on the keyboard is pressed.
    ...
    def OnSelectionBoundingBox(self, event):
        ...
        self.setSelection(self.initialSelection + objectsInBoundBox)
    ...
    def OnComputeDynamicEdge(self, event):
        self.computeDynamicEdge(Point(self.baseMousePosition.x(),
    ...
    def getEdgeWidth(self):
        ...
        width = max(1, min(int(5.0 / self.zoomMatrix[0,0]), 5))
        return width

    def drawEdge(self, edge):
        glLineWidth(self.getEdgeWidth())
        edge.draw()
        glLineWidth(1)
        return
