PyWebRun - Python Web Runner (version 0.0.1 - 2007.11.04)
"Running Python scripts over HTTP"


Public domain (P) Davide Rognoni 2007
...
TUTORIAL
--------
Unzip the archive PyWebRun-x.x.x.zip and open a console in the unzipped SRC folder:
PyWebRun/src
