...
Tested with Zope 2.8.6, Zope 2.9.3, Windows and Unix and may work
(untested) with previous versions of Zope 2.8 and 2.9 series.
...
Inflate this product in the Products of your instance or some other
place (see the `products` variable of `$INSTANCE/etc/zope.conf`).
...
`The Ingeniweb team <http://www.ingeniweb.com>`_ (c) 2006
