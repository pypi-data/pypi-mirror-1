...
.. note::
    ...
    Stacking of decorator of the same type (ie. :func:`func_args`
    and :func:`func_args`, :func:`func_args` and :func:`method_args`,
    :func:`return_value` and :func:`return_value`) is not possible
    and will cause a :exc:`DecoratorStackingException` to be raised.

    Stacking of different types of decorators (ie. :func:`return_value` and
    :func:`func_args`)
    is possible and will not raise such an exception.
