...
wf.add_transition(_(u'failed'), (action, attente), echec)
wf.add_transition(_(u'wait'), ouvert, attente)
wf.add_transition(_(u'done'), ouvert, succes)
