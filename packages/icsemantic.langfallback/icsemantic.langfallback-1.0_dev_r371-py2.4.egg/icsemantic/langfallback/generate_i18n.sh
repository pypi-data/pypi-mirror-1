...
i18ndude rebuild-pot --pot locales/platecom.langview.pot --create platecom.langview --merge locales/manual.pot ./

for file in `find locales -name *.po`
do
    echo Syncing $file ...
    i18ndude sync --pot locales/platecom.langview.pot $file
