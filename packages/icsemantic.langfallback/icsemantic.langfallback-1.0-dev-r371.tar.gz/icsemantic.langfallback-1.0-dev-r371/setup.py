...
setup(name='icsemantic.langfallback',
	...
	"Operating System :: OS Independent",
      ...
      keywords='icsemantic, platecom, semantic, language, fallback, plone',
      ...
      url='http://www.platecom.com/productos/icsemantic.langfallback/',
      license='GPL',
