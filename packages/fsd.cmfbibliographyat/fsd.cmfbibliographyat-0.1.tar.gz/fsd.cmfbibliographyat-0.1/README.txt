...
publications within the FSD instance where the firstname and fullname match
against the author list of a publication.

Author
======

``fsd.cmfbibliographyat`` was written by Andreas Jung for ZOPYX Ltd. & Co. KG, Tuebingen, Germany.
