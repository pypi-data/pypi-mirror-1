...
$Id: bootstrap.py 70971 2008-09-01 12:02:12Z gawel $
"""
import glob
import os
import shutil
...
eggs_folder = os.path.join(os.path.abspath(os.getcwd()), 'eggs')
if not os.path.exists(eggs_folder):
    os.mkdir(eggs_folder)
sys.path.insert(0, eggs_folder)

downloads_folder = os.path.join(os.path.abspath(os.getcwd()), 'downloads')
