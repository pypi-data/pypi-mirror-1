...
#
# $Id: tests.py 355 2008-11-27 14:30:17Z fresh $
...
class stripogramTests(TestCase):
    ...
    def test_html2safehtml23(self):
        ...
        test(html2safehtml,('<table><tr><th><b></th>aaa</tr><tr><td>bbb</td></tr></table>',['table','tr','th','td','b']),
                            '<table><tr><th><b></b></th>aaa</tr><tr><td>bbb</td></tr></table>')    
try:
    import Testing
    import Zope
    try:
