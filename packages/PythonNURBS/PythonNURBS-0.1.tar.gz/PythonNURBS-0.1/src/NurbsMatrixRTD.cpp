...
struct Matrix_double_wrapper : PLib::Matrix< double >, bp::wrapper< PLib::Matrix< double > > {

    Matrix_double_wrapper(int const r, int const c )
    ...
    Matrix_double_wrapper(::PLib::Matrix< double > const & M )
    ...
    Matrix_double_wrapper(double * p, int const r, int const c )
...
struct MatrixRTd_wrapper : PLib::MatrixRT< double >, bp::wrapper< PLib::MatrixRT< double > > {

    MatrixRTd_wrapper(PLib::MatrixRT<double> const & arg )
    ...
    MatrixRTd_wrapper(double ax, double ay, double az, double x, double y, double z )
    ...
    MatrixRTd_wrapper(::PLib::Matrix< double > const & plM )
...
BOOST_PYTHON_MODULE(NurbsMatrixRTD){
    { //::PLib::Basic2DArray< double >
...
//     bp::implicitly_convertible< PLib::Point_nD< float, 3 > const &, PLib::HPoint_nD< float, 3 > >();
    ...
    { //::PLib::Matrix< double >
        typedef bp::class_< Matrix_double_wrapper, bp::bases< PLib::Basic2DArray< double > > > Matrix_double_exposer_t;
        Matrix_double_exposer_t Matrix_double_exposer = Matrix_double_exposer_t( "Matrix_double" );
        bp::scope Matrix_double_scope( Matrix_double_exposer );
        Matrix_double_exposer.def( bp::init< int, int >(( bp::arg("r"), bp::arg("c") )) );
        Matrix_double_exposer.def( bp::init< >() );
        Matrix_double_exposer.def( bp::init< PLib::Matrix< double > const & >(( bp::arg("M") )) );
        Matrix_double_exposer.def( bp::init< double *, int, int >(( bp::arg("p"), bp::arg("r"), bp::arg("c") )) );
        ...
        Matrix_double_exposer.def( bp::self *= bp::other< double >() );
        Matrix_double_exposer.def( bp::self += bp::self );
        Matrix_double_exposer.def( bp::self += bp::other< double >() );
        Matrix_double_exposer.def( bp::self -= bp::self );
        Matrix_double_exposer.def( bp::self -= bp::other< double >() );
        Matrix_double_exposer.def( bp::self /= bp::other< double >() );
        ...
        { //::PLib::Basic2DArray< double >::init
            ...
            typedef PLib::Matrix< double > exported_class_t;
            typedef void ( Matrix_double_wrapper::*init_function_type )( int const,int const ) ;
            
            Matrix_double_exposer.def( 
                "init"
                , init_function_type( &Matrix_double_wrapper::init )
                , ( bp::arg("r")=(int const)(1), bp::arg("c")=(int const)(1) ) );
        
        }
//         Matrix_double_exposer.def( bp::self != bp::self );
        Matrix_double_exposer.def( bp::self * bp::other< PLib::Vector< double > >() );
        Matrix_double_exposer.def( bp::other< std::complex< double > >() * bp::self );
        Matrix_double_exposer.def( bp::other< double >() * bp::self );
        Matrix_double_exposer.def( bp::self * bp::self );
        Matrix_double_exposer.def( bp::self + bp::self );
        Matrix_double_exposer.def( bp::self - bp::self );
        Matrix_double_exposer.def( bp::self == bp::self );
...
//             , &MatrixInputError_wrapper::default_print );
    ...
    { //::PLib::MatrixRT< double >
        typedef bp::class_< MatrixRTd_wrapper, bp::bases< PLib::Matrix< double > > > MatrixRTd_exposer_t;
        MatrixRTd_exposer_t MatrixRTd_exposer = MatrixRTd_exposer_t( "MatrixRTd" );
        bp::scope MatrixRTd_scope( MatrixRTd_exposer );
        MatrixRTd_exposer.def( bp::init< double, double, double, double, double, double >(( bp::arg("ax"), bp::arg("ay"), bp::arg("az"), bp::arg("x"), bp::arg("y"), bp::arg("z") )) );
        MatrixRTd_exposer.def( bp::init< >() );
        MatrixRTd_exposer.def( bp::init< double * >(( bp::arg("p") )) );
        MatrixRTd_exposer.def( bp::init< PLib::Matrix< double > const & >(( bp::arg("plM") )) );
...
//         }
        { //::PLib::Basic2DArray< double >::init
            ...
            typedef PLib::MatrixRT< double > exported_class_t;
            typedef void ( MatrixRTd_wrapper::*init_function_type )( int const,int const ) ;
            
            MatrixRTd_exposer.def( 
                "init"
                , init_function_type( &MatrixRTd_wrapper::init )
                , ( bp::arg("r")=(int const)(1), bp::arg("c")=(int const)(1) ) );
        
        }
        MatrixRTd_exposer.def( bp::self * bp::self );
    }
