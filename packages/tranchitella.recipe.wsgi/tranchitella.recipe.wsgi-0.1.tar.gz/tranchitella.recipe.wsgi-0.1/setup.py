...
setup(
    ...
    version='0.1',
    url='http://pypi.python.org/pypi/tranchitella.recipe.wsgi',
    license='GPL 2',
    author='Tranchitella Kft.',
    author_email='info@tranchitella.eu',
    description="Buildout recipe to create paste.deploy entry points for mod_wsgi",
    long_description=(
    ...
    test_suite="tranchitella.recipe.wsgi.tests",
    include_package_data=True,
    zip_safe=False,
    entry_points="""
    [zc.buildout]
    default = tranchitella.recipe.wsgi:Recipe
    """
)
