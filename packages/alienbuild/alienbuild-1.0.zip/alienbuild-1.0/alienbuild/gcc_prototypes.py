...
CppPreprocessFilter = FILTER(
	...
	inputExtension            = 'cpp',
	outputExtension           = 'cpp',
	commandLineOptions        = [ '-E' ] + DefaultCompileArguments,
...
Link = FILTER(
	...
	inputExtension            = 'o',
	outputExtension           = 'elf',
	commandLineOptions        = [ '-o {output}', '{input}', '-L{library_paths}', '-l{libraries}', '{bah_libraries}' ],
...
CppFileType = FILETYPE(
	extension  = 'cpp',
	filterList = [ CppPreprocessFilter, CppCompileFilter ]
)
