...
class DeliciousURL(object):
    ...
    Variables:
        ...
        common_tags:
            ...
            tag is a 'str', tag_weight is an 'int'
    ...
    def __str__(self):
        ...
        for user, tags, timestamp in self.bookmarks:
            ...
            for tag in tags:
                total_tags.add(tag)
        return "[%s] %d users (= bookmarks), %d tags (%d unique), %d out of 25 max 'common' tags" % \
...
class DeliciousAPI(object):
    ...
    def get_url(self, url):
        """Returns a DeliciousURL representation of the del.icio.us history of url.
...
__all__ = ['DeliciousAPI', 'DeliciousURL', 'DeliciousError', 'DeliciousThrottleError', 'DeliciousUnknownError', 'DeliciousNotFoundError' , 'Delicious500Error', 'DeliciousMovedTemporarilyWarning']
