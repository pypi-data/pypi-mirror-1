...
class ZestyParser:
	...
	def iter(self, tokens, skip=None, until=None): return ParserIterator(tokens, self, skip, until)
...
class ParserIterator:
	def __init__(self, tokens, parser, skip=None, until=None):
		self.tokens, self.parser, self.skip, self.until = tokens, parser, skip, until
