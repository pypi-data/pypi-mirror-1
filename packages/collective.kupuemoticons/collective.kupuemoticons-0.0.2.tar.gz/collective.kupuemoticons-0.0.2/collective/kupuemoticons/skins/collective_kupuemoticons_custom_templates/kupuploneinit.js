...
// $Id: kupuploneinit.js 3789 2008-08-13 15:54:24Z rbartl $
...
function initPloneKupu(editorId) {
    ...
    /* Emoticons */
    var emoticontool = new EmoticonTool(prefix+'button.kupu-smile',
                                        prefix+'button.kupu-sad',
                                        prefix+'button.kupu-wink',
                                        prefix+'button.kupu-lol',
                                        prefix+'button.kupu-cool');
