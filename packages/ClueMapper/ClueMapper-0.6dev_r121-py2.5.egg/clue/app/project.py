...
class ProjectManager(object):
    ...
    def _get_paths(self, prjid):
        ...
        tracenvpath = os.path.join(base['tracenv_base'], prjid)
        svnrepopath = os.path.join(base['svnrepo_base'], prjid)
        tracadminpath = base.get('tracadminpath',
                                 os.path.join(self._workingdir, 'bin',
                                              'trac-admin'))
    ...
    def fix_paths(self, prjid):
        ...
        tracconfig['account-manager']['password_file'] = \
            clueconfig['base']['auth_file']
        tracconfig['trac']['repository_dir'] = \
            os.path.join(clueconfig['base']['svnrepo_base'], prjid)
        tracconfig.save()
    ...
    def _setup_default_trac(self, prjid):
        ...
        data = f.read()
        f.close()
        dbpath = os.path.join(self._workingdir, 'etc', 'cluemapper.db')
