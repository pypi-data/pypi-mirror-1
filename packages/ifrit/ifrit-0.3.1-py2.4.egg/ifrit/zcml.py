...
class ITraversalAdapter(Interface):
    ...
    bases = Tokens(
        title=u"Classes to be added as bases of adapters",
        description=u"This should be a list of classes",
        value_type=GlobalObject(missing_value=object()),
        required=False,
        )
...
class TraversalAdapterDirective(object):
    ...
    def __call__(self):
        ...
        self._context.action(
            ...
            args=(self.module, self.factory_name, for_,
                  self._markers, self.bases,
                 ),
            )
