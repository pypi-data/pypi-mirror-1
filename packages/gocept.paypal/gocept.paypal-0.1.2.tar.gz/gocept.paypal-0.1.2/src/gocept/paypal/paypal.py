...
class PayPal(object):
    ...
    zope.interface.implements(.interfaces.IPayPal)
    signature_values = {}
    API_ENDPOINT = ""
    PAYPAL_URL = ""
    ...
    def __init__(self):
        ...
        self.CALLBACK_URL = dataprovider.callback_url
        self.CALLBACK_CANCEL_URL = dataprovider.callback_cancel_url
    ...
    def SetExpressCheckout(self, amount):
        params = {
            ...
            'CANCELURL' : self.CALLBACK_CANCEL_URL,
            'AMT' : amount,
        }
