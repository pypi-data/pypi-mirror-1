...
class runner(object):
    ...
    def input_stream(self, name):
        ...
        # construct.
#        def closure_bypass(value_iterator):
#            for real_value in value_iterator:
#                print "got %s" % real_value
#                if real_value in BYPASS_VALS:
#                    self.pass_value(real_value)
#                else:
#                    yield real_value
