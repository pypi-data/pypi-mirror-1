...
License:
  ...
  TextIndexNG 3 contains a copy of ZCTextIndex/WidCopy.py which is published
  ...
  David Lecas und published under the GNU Public License (GPL).
...
Installation:
  ...
  - compile and install the extension modules using::
    ...
    WARNING: the "python2.3" binary must be the *same* Python as the one which
    ...
    If you are running Zope 2.9+ or Zope 3.2+ (which use Python 2.4) you must
    replace 'python2.3' with 'python2.4' above.
  ...
  Installation on Plone:
    ...
    - uncommented all directives in TextIndex3/adapters/configure.zcml (by
      removing the HTML comments '<!--'  and '-->'
...
How to make custom content-types searchable?
...
Running the unittests:
    ...
    For the Zope 2 integration tests::
        ...
        python2.3 test.py --dir lib/python/Products/TextIndexNG3/tests

    For the TextIndexNG core engine::

        python2.3 test.py --dir lib/python/Products/TextIndexNG3/src

    For testing the extension modules::

        python2.3 test.py --dir lib/python/Products/TextIndexNG3/extension_modules

    If your are using Zope 3.2+ or Zope 2.9+ you need to use of course 'python2.4'
