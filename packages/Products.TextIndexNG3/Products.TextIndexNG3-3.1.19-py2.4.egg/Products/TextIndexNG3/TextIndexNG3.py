...
from textindexng.storage import StorageException
...
class TextIndexNG3(SimpleItem, PropertyManager):
    ...
    query_options = ('query', 'encoding', 'parser', 'language', 'field', 'autoexpand', 'similarity_ratio', 'ranking', 'ranking_maxhits', 'thesaurus') 
    ...
    def __init__(self, id, extra, caller):
        ...
        self.index = Index(fields=fields,
                           ...
                           splitter_separators=get(extra, 'splitter_separators', DEFAULT_SEPARATORS),
                           index_unknown_languages=bool(get(extra, 'index_unknown_languages')),
    ...
    def getEntryForObject(self, docid, default=None):
        """ return all informations about a stored document as mapping
            field -> list of indexed words
        """
    ...
    def _apply_index(self, request, cid=''):
        ...
        # options
        options = {}
        for k in ('parser', 'language', 'field', 'autoexpand', 'similarity_ratio', 'thesaurus', 'ranking', 'ranking_maxhits') :
    ...
    def manage_workspace(self, REQUEST):
        ...
        """
        REQUEST.RESPONSE.redirect('manageform')
