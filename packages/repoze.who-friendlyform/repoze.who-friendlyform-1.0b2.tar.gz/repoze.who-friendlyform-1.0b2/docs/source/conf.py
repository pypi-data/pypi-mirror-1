...
project = u'Collection of repoze.who friendly form plugins'
...
htmlhelp_basename = 'repozewhofriendlyformdoc'
...
latex_documents = [
  ('index', 'repozewhofriendlyform.tex',
   u'Collection of repoze.who friendly form plugins',
