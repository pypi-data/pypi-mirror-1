...
class Selector(object):
    ...
    def __call__(self, environ, start_response):
        ...
        app, svars, methods = self.select(environ['PATH_INFO'], 
        ...
        environ['wsgi.url_vars'] = unnamed, named
...
def pliant(func):
    """Decorate an unbound wsgi callable taking args from wsgi.url_vars
    ...
    def wsgi_func(environ, start_response):
        args, kwargs = environ.get('wsgi.url_vars', ([], {}))
        args = list(args)
...
def opliant(meth):
    """Decorate a bound wsgi callable taking args from wsgi.url_vars
