...
setup(
    ...
    long_description = """A runtime type-checking module for Python supporting both parameter-type checking and return-type checking for funcitons, methods and generators.
...
A number of other utility classes exist to aid in type signature creation:
	Any() - you don't care about the type
	IsIterable() - the object can be used in `for` statements, for example
	IsCallable() - the object can be invoked
	HasAttr() - the object has certain attributes; types may also be specified
