...
The testsuite may be invoked by running `python setup.py test`. This will gather all tests/test_*.py files and run them. Alternatively, the test scripts may be run individually.
...
- 20051116 Merged together Iain Lowe and Collin Winter's projects
- 20050929 Added support for old-style classes as types to be checked
- 20050928 Added typecheck.doctest_support

### TERMS OF USE

If you care, this software is Copyright (C) 2005 by Iain Lowe and Collin Winter and is released
