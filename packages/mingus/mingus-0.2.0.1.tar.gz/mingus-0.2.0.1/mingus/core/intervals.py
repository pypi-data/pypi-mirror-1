...
================================================================================
	...
	minor_* and major_* functions. For example: minor_third("F") returns
...
def second(note, key):
	...
	Examples: 
		second("E", "C") returns 'F'. 
		second("E", "D") returns 'F#'.
...
def fourth(note, key):
	...
	Examples:
		fourth("E", "C") returns 'A'
		fourth("E", "B") returns 'A#'
	Raises a KeyError if note is not found in key."""
...
def seventh(note, key):
	...
	Examples:
		seventh("E", "C") returns 'D'
		seventh("E", "B") returns 'D#'
	Raises a KeyError if note is not found in key."""
...
def get_interval(note, interval, key = 'C'):
	...
	use the minor_* and major_* functios to work around the corner cases."""
...
def measure(note1, note2):
	...
	Examples:
		measure("C", "D") returns 2
		measure("D", "C") returns 10"""
...
def augment_or_diminish_until_the_interval_is_right(note1, note2, interval):
	"""A helper function for the minor_* and major_* functions.
...
def determine(note1, note2):
	"""Names the interval between note1 and note2.
	Example:
		determine("C", "E") returns "major third"
		determine("C", "Eb") returns "minor third"
		determine("C", "E#") return "augmented third"
		determine("C", "Ebb") returns "diminished third"
	
	This works for all intervals. Note that there are corner cases
	for 'major' fifths and fourths: 

		determine("C", "G") returns "perfect fifth" 
		determine("C", "F") return "perfect fourth" """
