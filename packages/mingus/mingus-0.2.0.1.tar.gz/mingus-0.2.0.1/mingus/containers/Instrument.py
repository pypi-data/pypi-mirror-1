...
================================================================================
	...
	of tracking whether the entered notes are in the range of the instrument.
...
class Instrument:
	...
	def set_range(self, range):
		"""Sets the range of the instrument. A range is a tuple 
		of two Notes."""
		self.range = range

	def note_in_range(self, note):
		"""Tests whether note is in the range of this Instrument.
	...
	def can_play_notes(self, notes):
		"""Will test if the notes lie within the range of the 
		instrument. Returns True if so, False otherwise."""
		for n in notes:
