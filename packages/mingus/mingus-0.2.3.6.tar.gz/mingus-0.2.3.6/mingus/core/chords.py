...
================================================================================
	...
	recognise a plethora of chords.
...
`from_shorthand("Amin7") == from_shorthand("Am7")`, etc.).
	...
	* Special: *'5'*, *'NC'*, *'hendrix'*
	...
	# Shrink shorthand_string to format chord_shorthand
...
def determine(chord, shorthand = False):
	...
	if chord == []:
		...
		return determine_extended_chord5(chord, shorthand)
	elif len(chord) == 6:
		return determine_extended_chord6(chord, shorthand)
	elif len(chord) == 7:
		return determine_extended_chord7(chord, shorthand)
	else:
