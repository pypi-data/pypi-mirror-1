...
LINKS_CSS_STYLES = (
    (u"links_list", 1, _(u"Links list")),
    (u"links_list_description", 2, _(u"Links list with description")),
    (u"links_list_row", 3, _(u"Links in a row")),
)
...
class LinksCSSVocabulary(object):
    ...
    def __call__(self, context):
        items = [SimpleTerm(value, token, title) for value, token, title in LINKS_CSS_STYLES]
