...
<%def name="content()">
        <div class="editbox">
            ...
            <a href="/permissions" title="${_('Permissions admin')}"
            >Permissions admin <img class="hicon" src="/img/silk/page_white_stack.png" alt=""/></a>  
...
<%def name="lhcolumn()">
    <%include file="adminnav.mak" />
    <%include file="motd.mak" />
</%def>
