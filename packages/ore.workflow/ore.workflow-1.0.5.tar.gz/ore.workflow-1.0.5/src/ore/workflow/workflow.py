...
# Used needed to make the tests pass in the absence of
# interactions.. or when security checks are explicity not requested.
...
class WorkflowInfo(object):
    ...
    def fireTransitionToward(self, state, comment=None, side_effect=None,
                             check_security=True):
        transition_ids = self.getFireableTransitionIdsToward(state, check_security)
    ...
    def getFireableTransitionIds(self, check_security=True):
        return (self.getManualTransitionIds(check_security=check_security) +
