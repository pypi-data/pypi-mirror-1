 ...
 * @final
 */
function LineStartResizeHandle(workflow /*:Workflow*/)
{
  Rectangle.call(this);
...
LineStartResizeHandle.prototype.onDrag = function()
{
  ...
  var objPosX = this.workflow.currentSelection.getStartX();
  var objPosY = this.workflow.currentSelection.getStartY();

  this.workflow.currentSelection.setStartPoint(objPosX-diffX, objPosY-diffY);
}

/**
 * @private
 **/
LineStartResizeHandle.prototype.onKeyDown=function(keyCode /*:int*/)
{
