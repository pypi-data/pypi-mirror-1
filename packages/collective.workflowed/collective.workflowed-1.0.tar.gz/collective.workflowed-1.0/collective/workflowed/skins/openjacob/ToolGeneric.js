 ...
 * @constructor
 */
function ToolGeneric(/*:PaletteWindow*/ palette)
{
  /** @private **/
  this.x   = 0;
  /** @private **/
 ...
 *
 **/
ToolGeneric.prototype.execute=function(x /*:int*/, y/*:int*/)
{
  if(this.enabled)
 ...
 * @private
 **/
ToolGeneric.prototype.setActive=function(flag /*:boolean*/)
{
  if(!this.enabled)
    return;
  if(flag==true)
 ...
 * @private
 **/
ToolGeneric.prototype.setEnabled=function(flag /*:boolean*/)
{
  this.enabled=flag;
  if(this.getImageUrl()!=null)
 ...
 *
 **/
ToolGeneric.prototype.setDimension=function( w /*:int*/, h /*:int*/)
{
  this.width = w;
  this.height= h;
