...
*/
function TransitionFigure(/*:String */ title)
{
  /** @private **/
  if(title)
     this.title =title;
...
TransitionFigure.prototype = new Image;
TransitionFigure.prototype.type="TransitionFigure";

/**
 * @private
 **/
TransitionFigure.prototype.createHTMLElement=function()
{
  var item = Image.prototype.createHTMLElement.call(this);
 ...
 **/
TransitionFigure.prototype.setDimension=function( w /*:int*/, h /*:int*/)
{
  Image.prototype.setDimension.call(this,w,h);
 ...
 * @type int
 **/
TransitionFigure.prototype.getMinWidth=function()
{
  return 50;
}
