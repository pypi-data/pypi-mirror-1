...
function StateWindow(/*:String */ title)
{
  ...
  this.defaultBackgroundColor = new Color(130,230,150);
...
StateWindow.prototype = new CompartmentFigure;
...
StateWindow.prototype.onFigureEnter = function(/*:Figure*/ figure)
{
...
StateWindow.prototype.onFigureLeave = function(/*:Figure*/ figure)
{
...
StateWindow.prototype.onFigureDrop = function(/*:Figure*/ figure)
{
