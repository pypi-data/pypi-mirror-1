...
*/
function ConnectionFigure(/*:String */ title)
{
  /** @private **/
  if(title)
     this.title =title;
...
ConnectionFigure.prototype = new Image;
ConnectionFigure.prototype.type="ConnectionFigure";

/**
 * @private
 **/
ConnectionFigure.prototype.createHTMLElement=function()
{
 ...
 **/
ConnectionFigure.prototype.setDimension=function( w /*:int*/, h /*:int*/)
{
 ...
 * @type int
 **/
ConnectionFigure.prototype.getMinWidth=function()
{
  return 50;
}
