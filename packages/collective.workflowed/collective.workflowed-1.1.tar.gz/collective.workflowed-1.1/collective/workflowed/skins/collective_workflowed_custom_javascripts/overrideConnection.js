...
Connection.prototype.dispose=function()
{
  ...
  if (transition==null) {
    Port.prototype.updateState.call(this,state);
  } else {
    updateTransitionComplete=function() {
    }
    updateTransitionFailed=function() { alert('Error. Unable to update destination state.'); }
    updateTransitionURL="portal_workflow/"+document.location.search.split('=')[1]+"/transitions/"+transition.title+"/updateTransition?new_state_id=";
