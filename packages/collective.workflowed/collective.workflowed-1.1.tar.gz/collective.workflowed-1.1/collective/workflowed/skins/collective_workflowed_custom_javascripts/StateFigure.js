...
*/
function StateFigure(/*:String */ title)
{
  /** @private **/
  if(title)
     this.title =title;
...
StateFigure.prototype = new Image;
StateFigure.prototype.type="StateFigure";

/**
 * @private
 **/
StateFigure.prototype.createHTMLElement=function()
{
 ...
 **/
StateFigure.prototype.setDimension=function( w /*:int*/, h /*:int*/)
{
 ...
 * @type int
 **/
StateFigure.prototype.getMinWidth=function()
{
  return 80;
}
