...
Start.prototype.setWorkflow=function(/*:Workflow*/ workflow)
{
  ...
  if(workflow!=null)
  {
    ...
    this.outputPort.setDirection(1); // The Connector goes first to the right direction
    this.outputPort.setMaxFanOut(1); // It is only possible to add "1" Connector to this port
