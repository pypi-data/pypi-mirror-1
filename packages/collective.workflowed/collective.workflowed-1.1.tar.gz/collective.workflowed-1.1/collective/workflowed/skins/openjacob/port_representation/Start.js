...
Start.prototype.setWorkflow=function(/*:Workflow*/ workflow)
{
  ...
  if(workflow!=null)
  {
    this.outputPort1 = new OutputPort(new Image("port1.png"));
    this.outputPort1.setDirection(1); // The Connector goes first to the right direction
    ...
    this.outputPort2 = new OutputPort(new Image("port2.png"));
    this.outputPort2.setDirection(1); // The Connector goes first to the right direction
