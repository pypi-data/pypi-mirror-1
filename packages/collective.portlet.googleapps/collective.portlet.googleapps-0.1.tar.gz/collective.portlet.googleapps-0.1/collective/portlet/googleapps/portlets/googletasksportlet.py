...
class Assignment(base.Assignment):
    ...
    def __init__(self, header=u"My Google Tasks", hosted_domain=u"", secure_connection=True, portlet_height=u"160", portlet_width=u"100%"):
        self.header = header
...
class EditForm(base.EditForm):
    ...
    label = _(u"Edit Google Tasks Portlet")
    description = _(u"A portlet which displays an interface to Google Tasks")
