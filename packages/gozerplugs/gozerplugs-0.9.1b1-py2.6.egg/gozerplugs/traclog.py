...
from gozerbot.jabber.monitor import jabbermonitor 
...
def init():
    ...
    jcallbacks.add('ALL', jabbertraclogcb, jabberpretraclogcb)
    outmonitor.add('traclog', traclogcb, pretraclogcb)
    jabbermonitor.add('jabbertraclog', jabbertraclogcb, jabberpretraclogcb)
    return 1
...
ievent.arguments[1], ievent.nick, ievent.userhost))
