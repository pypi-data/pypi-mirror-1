...
def handle_chuck(bot, ievent):
    ...
    rand = random.randint(1,len(chuck))
    ievent.reply(chuck[rand-1].strip())

def handle_schneier(bot, ievent):
    """ get schneier fact """
    rand = random.randint(1,len(schneier))
    ievent.reply(schneier[rand-1].strip())

def handle_theo(bot, ievent):
    """ get theo """
    rand = random.randint(1,len(theo))
    ievent.reply(theo[rand-1].strip())
