...
source_path=os.path.join(os.path.dirname(__file__), 'iccommunity', 'mailman')
version=open(os.path.join(source_path, 'version.txt')).read()
long_description=open(os.path.join(source_path, 'README.txt')).read() + '\n\n'

setup(name='iccommunity.mailman',
      version=version,
      description="icSemantic.Mailman",
	...
	"Operating System :: OS Independent",
      ...
      keywords='iccommunity, platecom, community, mailman, plone',
      ...
      url='http://www.platecom.com/productos/iccommunity.mailman/',
      license='GPL',
