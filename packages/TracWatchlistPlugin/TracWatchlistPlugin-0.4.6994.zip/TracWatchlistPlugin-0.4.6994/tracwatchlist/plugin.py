...
__url__      = ur"$URL: http://trac-hacks.org/svn/watchlistplugin/0.11/tracwatchlist/plugin.py $"[6:-2]
__author__   = ur"$Author: martin_s $"[9:-2]
__revision__ = int("0" + r"$Rev: 6974 $"[6:-2])
__date__     = r"$Date: 2009-10-31 03:04:46 +0000 (Sat, 31 Oct 2009) $"[7:-2]
