...
class BrowserDetector(BrowserView):
    ...
    def browser(self):
        if self.isSafari:
            ...
            if self.isFirefox:
                ...
                elif self.isFirefox2:
                    return '%s / Firefox 2.x' % out
                elif self.isFirefox3:
    ...
    @property
    def isFirefox(self):
        return self.isGecko and (self._ua.find('firefox/') > 0)
    
    @property
    def isFirefox1(self):
        return self.isGecko and (self._ua.find('firefox/1') > 0)
    
    @property
    def isFirefox2(self):
        return self.isGecko and (self._ua.find('firefox/2') > 0)
    
    @property
    def isFirefox3(self):
        return self.isGecko and (self._ua.find('firefox/3') > 0)
    ...
    @property
    def isFirefoxOnMac(self):
        return (self.isMac and self.isFirefox)
    
    @property
    def isFirefoxOnLinux(self):
        return (self.isLinux and self.isFirefox)
    
    @property
    def isFirefoxOnWin(self):
        return (self.isWindows and self.isFirefox)
