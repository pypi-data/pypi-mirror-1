...
def main():
    ...
    from processing.test import test_speed
    test_speed.use_dummy = False
    reload(test_speed)
    print "\n\n-------- RUNNING test_speed USING PROCESSES --------"
    test_speed.main()

    test_speed.use_dummy = True
    reload(test_speed)
    print "\n\n-------- RUNNING test_speed USING THREADS --------"
    test_speed.main()
