...
testfiles = [
    ...
    'test/test_newtype.py', 'test/test_doc.py', 'test/test_speed.py'
    ]
...
between processes happens via sockets or (on Windows) named pipes and
...
See ``README.txt`` and ``doc/index.html`` in installed the package for
more information.
'''
    )
