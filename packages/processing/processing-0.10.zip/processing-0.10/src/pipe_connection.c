...
static PyObject *
Connection_wait_and_createfile(PyObject *self, PyObject *args)
{
    char *name;
    HANDLE pipe;
    BOOL success;
    DWORD dwMode, timeout;
...
static PyMethodDef module_methods[] = {
    ...
    {"wait_and_createfile", (PyCFunction)Connection_wait_and_createfile, 
                                                   METH_VARARGS, ""},
    {"connectpipe", (PyCFunction)Connection_connectpipe, METH_VARARGS, ""},
    {NULL}  /* Sentinel */
};
...
initpipe_connection(void) 
{
    ...
    m = Py_InitModule("pipe_connection", module_methods);
    assert(m);
