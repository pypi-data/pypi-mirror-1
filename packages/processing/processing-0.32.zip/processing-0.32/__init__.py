...
__all__ = [
    ...
    'ProcessExit', 'Lock', 'RLock', 'Semaphore', 'BoundedSemaphore',
    'Condition', 'Event', 'Queue', 'Manager', 'LocalManager', 'Pipe'
    ]
...
activeChildren = process.activeChildren
freezeSupport = process.freezeSupport
ProcessExit = process.ProcessExit
