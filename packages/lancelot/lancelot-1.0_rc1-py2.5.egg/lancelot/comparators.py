...
class IsComparator(Comparator):
    ...
    def __init__(self):
        ...
        super(IsComparator, self).__init__(None)
...
class LessThanOrEqual(OrComparator):
    ...
    def __init__(self, prototype):
        ...
        super(LessThanOrEqual, self).__init__(LessThan(prototype), 
                                              EqualsEquals(prototype))
        self._prototype = prototype
...
class GreaterThanOrEqual(OrComparator):
    ...
    def __init__(self, prototype):
        ''' Specify prototype value to be >= other '''
        super(GreaterThanOrEqual, self).__init__(GreaterThan(prototype), 
                                                 EqualsEquals(prototype))
        self._prototype = prototype
