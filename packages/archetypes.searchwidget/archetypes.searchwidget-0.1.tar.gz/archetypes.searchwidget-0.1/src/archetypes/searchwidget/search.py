...
class ImageResultItem(ResultItem):
    def render(self):
        return (ViewPageTemplateFile('searchresult_image.pt').__of__(self.provider))(brain=self.brain)

class FileResultItem(ResultItem):
    def render(self):
        return (ViewPageTemplateFile('searchresult_file.pt').__of__(self.provider))(brain=self.brain)

class DocumentResultItem(ResultItem):
    def render(self):
        return (ViewPageTemplateFile('searchresult_document.pt').__of__(self.provider))(brain=self.brain)

class EventResultItem(ResultItem):
    def render(self):
        return (ViewPageTemplateFile('searchresult_event.pt').__of__(self.provider))(brain=self.brain)

class NewsItemResultItem(ResultItem):
    def render(self):
        return (ViewPageTemplateFile('searchresult_newsitem.pt').__of__(self.provider))(brain=self.brain)
