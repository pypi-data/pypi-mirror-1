...
This release fixes two buglets, one with rotated input pages and 
another with output paths.
...
the file ``pdfnup-0.3.3.tar.gz`` and decompressing it with the following 
command::

  $ tar xfz pdfnup-0.3.3.tar.gz
