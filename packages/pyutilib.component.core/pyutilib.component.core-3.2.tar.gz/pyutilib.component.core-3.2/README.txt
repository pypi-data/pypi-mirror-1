...
:PluginEnvironment:
  A class that maintains the registries for interfaces, extension points and
components.
...
See `The PyUtilib Component Architecture Reference Manual <https://software.sandia.gov/svn/public/pyutilib/pyutilib.component.doc/trunk/doc/component/pca.pdf>`_ for a detailed description of PyUtilib components and examples of their use.
