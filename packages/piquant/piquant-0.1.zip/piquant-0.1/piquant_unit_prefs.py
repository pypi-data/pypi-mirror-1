"""This module is used by the package Piquant for turning units on and off.
...
importing the main Piquant package):

from piquant_unit_prefs import turn_off_units
turn_off_units()
