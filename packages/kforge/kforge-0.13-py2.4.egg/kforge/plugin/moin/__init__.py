"""
Plugin to provide moinmoin wiki services.

This Plugin was tested against moinmoin v1.3 but should worked with later
versions.

## Installation

1. Add the following to your kforge.conf file

[moin]
# where moin system data is installed (htdocs etc)
system_path = /usr/share/moin

2. This plugin will copy data from that location in order to create each new
...
3. Enable this plugin (see the Kforge guide for details if you do not know how
to do this)
"""
