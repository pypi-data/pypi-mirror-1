...
class BasicClientRequest(MockPythonRequest):
    ...
    def setUser(self, user):
        self.user = user  # Just like in the movies.
...
class CookieClientWithCookie(CookieClientAnonymous):
    ...
    def addSessionCookie(self, user):
        ...
        person = view.registry.persons[user]
...
class HandlerTestCase(TestCase):
    ...
    def checkIsAccessAllowed(self):
        self.failUnlessEqual(self.requireAccess, self.handler.isAccessAllowed)
    ...
    def checkAuthuserName(self):
        self.failUnlessEqual(self.requireAuthuserName, self.handler.authuserName)
