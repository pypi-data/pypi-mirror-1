...
class TestPlugin(TestCase):
    ...
    def setUp(self):
        ...
        fixtureName = 'TestAccessControlPlugin'
        if fixtureName in self.registry.persons:
            person = self.registry.persons[fixtureName]
            person.delete()
            person.purge()
        self.person = self.registry.persons.create(fixtureName)
