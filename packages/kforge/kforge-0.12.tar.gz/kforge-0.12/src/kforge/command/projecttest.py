...
class TestProjectDelete(TestCase):
    ...
    def setUp(self):
        ...
        if self.fixtureName in self.registry.projects.all:
...
class TestProjectUndelete(TestCase):
    ...
    def tearDown(self):
        if self.fixtureName in self.registry.projects.all:
            project = self.registry.projects.all[self.fixtureName]
            project.delete()
            project.purge()
        self.command = None

    def testExecute(self):
        self.failUnless(self.fixtureName in self.registry.projects.deleted)
        self.command.execute()
        self.failIf(self.fixtureName in self.registry.projects.deleted)
        self.failUnless(self.fixtureName in self.registry.projects)
...
class TestProjectPurge(TestCase):
    ...
    def testExecute(self):
        ...
        self.failIf(self.fixtureName in self.registry.projects.deleted)
        self.failIf(self.fixtureName in self.registry.projects)
        self.failIf(self.fixtureName in self.registry.projects.all)
