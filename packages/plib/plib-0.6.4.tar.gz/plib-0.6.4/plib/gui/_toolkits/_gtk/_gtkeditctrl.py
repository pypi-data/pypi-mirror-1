...
class PGtkEditControl(gtk.ScrolledWindow, _PGtkWidget, editctrl.PEditControlBase, _PGtkEditMixin):
    ...
    __gsignals__ = {
        _gtksignals[SIGNAL_TEXTCHANGED]: (gobject.SIGNAL_RUN_LAST, gobject.TYPE_NONE, ()),
        _gtksignals[SIGNAL_TEXTSTATECHANGED]: (gobject.SIGNAL_RUN_LAST, gobject.TYPE_NONE, ()) }
    ...
    def delete_selected(self):
        self._edit.get_buffer().delete_selection(True, self._edit.get_editable())
    
    def copy_to_clipboard(self):
        self._edit.get_buffer().copy_clipboard(self._clipboard)
    
    def cut_to_clipboard(self):
        self._edit.get_buffer().cut_clipboard(self._clipboard, self._edit.get_editable())
    
    def paste_from_clipboard(self):
        self._edit.get_buffer().paste_clipboard(self._clipboard, None, self._edit.get_editable())
