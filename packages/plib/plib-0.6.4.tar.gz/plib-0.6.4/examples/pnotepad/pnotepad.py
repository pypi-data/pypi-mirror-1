...
PNotepadAboutData = {
    ...
    'icon': os.path.join(os.path.split(os.path.realpath(__file__))[0], "pnotepad.png") }

class PNotepad(gui.PMainWindow, gui.PTextFileEditor):
    
    aboutdata = PNotepadAboutData
    actionflags = [
        ACTION_FILENEW, ACTION_FILEOPEN, ACTION_FILESAVE, ACTION_FILESAVEAS,
        ACTION_EDITUNDO, ACTION_EDITREDO,
        ACTION_EDITCUT, ACTION_EDITCOPY, ACTION_EDITPASTE, ACTION_EDITDELETE, ACTION_EDITSELECTALL,
