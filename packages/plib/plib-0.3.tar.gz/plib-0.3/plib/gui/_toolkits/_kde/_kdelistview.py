...
from _kdecommon import _PKDEClientWidget, _PKDECommunicator, _kdealignmap
...
class PKDEListViewItem(kdeui.KListViewItem, _PKDEListViewMixin, _PKDECommunicator,
...
class PKDEListView(kdeui.KListView, _PKDEListViewMixin, _PKDEClientWidget,
