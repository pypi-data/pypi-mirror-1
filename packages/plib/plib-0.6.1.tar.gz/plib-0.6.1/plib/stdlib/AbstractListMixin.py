...
class AbstractListMixin(AbstractSequenceMixin):
    """
    Mixin class for fully mutable abstract sequence classes; provides
    default implementations of all mutable sequence methods based on
    the core data get/set/add/delete methods.
    """
