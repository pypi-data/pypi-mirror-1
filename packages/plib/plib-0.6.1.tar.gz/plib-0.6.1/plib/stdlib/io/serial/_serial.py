...
class SerialData(BaseData):
    """
    Basic data handling for serial I/O; intended to
    mixin with a derived class of ``SerialIOBase``.
    """
    
    def dataread(self, bufsize):
        return self.read(self.bufsize) # bufsize = 1 inherited from BaseData
