...
class baselist(AbstractListMixin, abstractlist):
    ...
    basesequence classes are designed on the same principles as above, but with
    all mutability (for basecontainer) or all changes in sequence length (for
    basesequence) disabled.
    """
    pass
