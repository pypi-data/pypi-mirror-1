...
from _gtkcommon import _PGtkClientWidget, _gtksignals

class PGtkTabWidget(gtk.Notebook, _PGtkClientWidget, tabwidget.PTabWidgetBase):
    ...
    def __init__(self, parent, tabs=None, target=None):
        ...
        # The tab changed signal doesn't include a usable pointer to the new widget,
        # so gateway it
        self._initialized = False # this prevents firing an extra event on startup
