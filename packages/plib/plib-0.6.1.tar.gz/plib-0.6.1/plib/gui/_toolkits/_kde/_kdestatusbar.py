...
class PKDEStatusBar(kdeui.KStatusBar, statusbar.PStatusBarBase):
    
    textareaclass = PKDETextLabel
    
    # FIXME: text is centered in status bar, and status bar doesn't show tips for
    # menu and toolbar items like it does in Qt
