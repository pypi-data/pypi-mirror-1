...
# This variable is provided so that if you want to test your own toolkit that's
# not in the supported list, you can still use the other facilities; you just
# need to import this module and set this variable to True before importing
# plib.gui.main. However, note that if you do this, *none* of the standard GUI
# widget classes will be available unless you add them yourself; you can do this
# by setting attributes on this module before importing plib.gui.main, or by
# constructing all your widgets "by hand". The former technique has the advantage
# of allowing you to use PLIB.GUI's other built-in facilities, but it requires you
# to provide classes with all the appropriate names yourself (they can be dummy
# classes if you won't use them, but they must be there). For example:
#
...
#
# Once you do this, you can use the rest of PLIB.GUI normally, including classes
# like PAutoPanel that allow you to define GUI specs declaratively.
gui_test = False
...
if gui_toolkit == 0:
    ...
    if KDE_PRESENT or QT_PRESENT or KDE4_PRESENT or QT4_PRESENT:
        ...
        # if KDE is running, default to KDE if PyKDE is present, otherwise Qt; but make
