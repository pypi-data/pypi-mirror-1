...
from plib.classes import InvalidState, InvalidInput, RecursiveTransition
from plib.stdlib import first
...
class StateMachine(object):
    ...
    def send_input(self, input_data):
        if self.in_transition:
            raise RecursiveTransition, "Overlapping state transitions not allowed."
