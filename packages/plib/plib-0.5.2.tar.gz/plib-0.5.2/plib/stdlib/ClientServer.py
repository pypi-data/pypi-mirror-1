...
class RequestMixin(object):
    ...
    def server_communicate(self):
        ...
        once returns False, it will presumably return False again,
        and the server will block forever in its loop. (The default
        is for read_complete() to be False after the clear_data()
        method has run, but derived classes that may complicate
        their behavior must be aware of the implications.)
        """
