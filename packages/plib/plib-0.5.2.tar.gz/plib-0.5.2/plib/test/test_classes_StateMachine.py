#!/usr/bin/env python
"""
TEST_CLASSES_STATEMACHINE.PY -- test script for sub-package CLASSES of package PLIB
...
from plib.classes import StateMachine, InvalidState, InvalidInput
...
class StateMachineTestBad(unittest.TestCase):
    ...
    def test_machine(self):
        ...
        self.assertRaises(InvalidState, machine.send_input, "")
