...
class PWxPanel(wx.Panel, panel.PPanelBase):
    ...
    def __init__(self, parent, layout=LAYOUT_NONE, style=PANEL_NONE, align=ALIGN_JUST,
        ...
        panel.PPanelBase.__init__(self, parent, layout, style, align, margin, spacing, width, height)
    
    def _addwidget(self, widget):
        # People say that the wxWidgets layout model is simple and easy to use,
