...
class PTCPServer(SigSocketServer.SigForkingTCPServer):
    ...
    def server_close(self):
        SigSocketServer.SigForkingTCPServer.server_close(self)
    ...
    def serve_forever(self):
        """
        Modify method to check termination flag at every loop iteration and to
        do controlled shutdown on a terminating signal.
        """
