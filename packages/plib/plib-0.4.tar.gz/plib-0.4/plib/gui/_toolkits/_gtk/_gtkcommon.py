...
_gtkwrappers = [SIGNAL_ACTIVATED, SIGNAL_CLICKED, SIGNAL_TOGGLED, SIGNAL_SELECTED,
    ...
    SIGNAL_TABCHANGED]
_gtkplain = [SIGNAL_QUERYCLOSE, SIGNAL_CLOSING, SIGNAL_HIDDEN, SIGNAL_BEFOREQUIT]
...
class _PGtkWidgetBase(object):
    """ Mixin class to provide minimal GTK widget methods. """
...
class _PGtkClientWidget(_PGtkCommunicator, _PGtkWidgetBase):
    """ Mixin class for GTK client widgets. """
...
class _PGtkWidget(_PGtkClientWidget):
