...
IDServerBottomPanel = [
    ...
    get_action_button(ACTION_ABOUTTOOLKIT, 'about_toolkit'),
...
class IDServerFrame(gui.PMainPanel):
    ...
    def _createpanels(self):
        ...
        _update_obj(IDServerBottomPanel, 1, self._parent.about_toolkit)
        _update_obj(IDServerBottomPanel, 2, self._parent.exit)
