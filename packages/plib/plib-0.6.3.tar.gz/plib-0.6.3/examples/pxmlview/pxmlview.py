...
class XMLListView(gui.PListView, gui.PEditor):
    ...
    def __init__(self, parent, data):
        ...
        gui.PListView.__init__(self, parent,
            [gui.PHeaderLabel("XML"), gui.PHeaderLabel("Node Type", 150, ALIGN_CENTER)],
            [self._xml.getroot()],
    ...
    if hasattr(gui.PListView, 'edit'):
        
        def edit(self, *args):
            # Distinguish between edit method of PListView and edit method of PEditor
            if len(args) > 0:
                return gui.PListView.edit(self, *args)
            return gui.PEditor.edit(self)
...
class PXMLViewer(gui.PMainWindow):
    ...
    actionflags = [ACTION_FILEOPEN, ACTION_ABOUT, ACTION_ABOUTTOOLKIT, ACTION_EXIT]
