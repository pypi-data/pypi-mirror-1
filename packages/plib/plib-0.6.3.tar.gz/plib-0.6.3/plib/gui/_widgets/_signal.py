...
class _PNotifyControl(_notify._PNotifyBase):
    """
    Base class for controls that can be passed a signal target in
    the constructor. Also defines the common widget API methods.
    """
    ...
    def set_font(self, font_name=None, font_size=None, bold=None, italic=None):
        self._set_font_object(*font_args(self, font_name, font_size, bold, italic))
