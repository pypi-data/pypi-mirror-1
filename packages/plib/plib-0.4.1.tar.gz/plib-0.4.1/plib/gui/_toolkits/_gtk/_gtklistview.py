...
from _gtkcommon import _PGtkClientWidget, _gtkalignmap, _gtksignals
...
class PGtkListView(gtk.TreeView, _PGtkClientWidget, _PGtkListViewMixin, listview.PListViewBase):
    ...
    def __init__(self, parent, labels=None, data=None, target=None):
        ...
        if labels is not None:
            args = [gobject.TYPE_STRING for label in labels] + args
        args = tuple(args)
