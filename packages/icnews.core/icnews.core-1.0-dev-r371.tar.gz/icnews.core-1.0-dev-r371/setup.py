...
setup(name='icnews.core',
	...
	"Programming Language :: Python",
      ...
      keywords='icnews, platecom, news, core, plone',
      ...
      url='http://www.platecom.com/productos/icnews.core/',
      license='GPL',
