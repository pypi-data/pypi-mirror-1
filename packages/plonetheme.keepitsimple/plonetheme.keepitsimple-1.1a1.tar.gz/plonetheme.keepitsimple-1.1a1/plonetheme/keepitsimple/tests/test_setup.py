...
class TestInstall(TestCase):
    ...
    def test_personal_bar_moved_to_top(self):
       ...
       def test_logo_moved_to_intro(self):
           ...
           logo_hidden_in_portalheader = self.is_hidden_viewlet(
               'plone.logo',
               'plone.portalheader',
           )
           self.failIf(logo_hidden_in_portalheader)
    
       def test_plone_plone_logo_is_hidden(self):
           """Check that the ploneplone logo is hidden"""
           plone_plone_logo_hidden_in_portalheader = self.is_hidden_viewlet(
               'plone.plone.plone.logo',
               'plone.portalheader',
           )
           self.failIf(plone_plone_logo_hidden_in_portalheader)
