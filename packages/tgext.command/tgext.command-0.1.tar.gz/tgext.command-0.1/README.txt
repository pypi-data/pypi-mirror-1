...
This extension (tgext.command.tgcommand) is an attempt to make it
easier to create new TG command-line commands.  The idea is that for
each application you will create a BaseCommand class like this:
...
the like is documented in TurboGears official documentation.
