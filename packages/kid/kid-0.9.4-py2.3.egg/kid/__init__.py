...
__revision__ = "$Rev: 422 $"
__date__ = "$Date: 2006-10-22 07:47:06 -0400 (Sun, 22 Oct 2006) $"
...
from kid.et import Element, SubElement, ElementTree, Comment, \
...
import kid.properties
properties = kid.properties
...
__all__ = ['KID_XMLNS', 'BaseTemplate', 'Template',
           ...
           'filter', 'format', 'namespace', 'serialization', 'util', 'properties']
