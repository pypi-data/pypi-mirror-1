...
__revision__ = "$Rev: 338 $"
__date__ = "$Date: 2006-06-08 01:33:55 +0000 (Thu, 08 Jun 2006) $"
            ...
            if ev == START:
                if item.tag == Comment:
                    ...
                    if layout is not None:
                        ...
                        code.line('kw.update(dict([(name, getattr(self, name)) for name in _def_names]))')
