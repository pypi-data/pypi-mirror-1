...
You first need to install the pysvn_ library.
...
Commit messages can contain Unicode characters.

File copies and renames as reflected as well, provided they occur inside the
branch. SVN externals are purposefully ignored and won't be added to your
