...
use_setuptools(version="0.6c1")
from setuptools import setup, find_packages

from hgsvn import base_version, __doc__ as long_description

commands = ['hgimportsvn', 'hgpullsvn']

setup(
    name = "hgsvn",
    author = 'Antoine Pitrou',
    author_email = 'antoine.pitrou@wengo.com',
    ...
    # Conscious decision to have a readable package directory
    zip_safe = False,
