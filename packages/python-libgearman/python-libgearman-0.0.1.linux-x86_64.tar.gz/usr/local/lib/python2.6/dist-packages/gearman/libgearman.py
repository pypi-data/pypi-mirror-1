...
class Gearman(object):
    ...
    def __init__(self, *args): 
        _libgearman.Gearman_swiginit(self,_libgearman.new_Gearman(*args))
...
class Client(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _libgearman.Client_swiginit(self,_libgearman.new_Client(*args))
...
class Worker(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _libgearman.Worker_swiginit(self,_libgearman.new_Worker(*args))
