...
class Client(object):
    ...
    def job_handle(self):
        ...
        return _libgearman.Client_job_handle(self)

    def status(self, *args):
        """status(self, uint32_t numerator, uint32_t denominator)"""
        return _libgearman.Client_status(self, *args)
...
Client.job_handle = new_instancemethod(_libgearman.Client_job_handle,None,Client)
