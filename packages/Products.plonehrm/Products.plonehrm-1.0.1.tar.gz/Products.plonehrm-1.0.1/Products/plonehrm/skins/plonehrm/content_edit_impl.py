...
if context.portal_type == 'Employee':
    # Get personal context and process from
    REQUEST.form['id'] = 'personal'
    new_context.personal.processForm()
...
addStatusMessage(REQUEST, portal_status_message)
#if new_context.aq_parent.portal_type == 'Employee':
#    new_context = new_context.aq_parent
