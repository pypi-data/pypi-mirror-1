...
class BaseSubstitutionView(BrowserView):
    ...
    substitution_translations = {
        ...
        '[company_official_name]': '[company_official_name]',
    ...
    def calcParams(self):
        ...
        if self.employee:
            ...
            if gender == 'man':
                ...
                gender = 'Mevrouw'
        r['[employee_gender]'] = self.employee and gender
        r['[employee_initials]'] = self.employee and \
            self.employee.getInitials()
        ...
        r['[worklocation_address]'] = self.worklocation and \
            '<br />'.join(self.worklocation.getAddress())
        ...
        # Company:
        r['[company_official_name]'] = self.worklocation and \
            self.worklocation.getOfficialName()
        r['[company_address]'] = self.worklocation and \
            '<br />'.join(self.worklocation.getCompanyAddress())
