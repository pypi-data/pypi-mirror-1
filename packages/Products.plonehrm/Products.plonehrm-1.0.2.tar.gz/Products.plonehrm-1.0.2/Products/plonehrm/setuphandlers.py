...
def run_upgrade_steps(site, logger):
    """Run the GenericSetup upgrade steps for this product.

    Mostly from Products.GenericSetup.tool.py:manage_doUpgrades
    """
    setup_tool = getToolByName(site, 'portal_setup')
    profile_id = 'Products.plonehrm:default'
    upgrades = setup_tool.listUpgrades(profile_id)
    steps_to_run = [step['id'] for step in upgrades]
