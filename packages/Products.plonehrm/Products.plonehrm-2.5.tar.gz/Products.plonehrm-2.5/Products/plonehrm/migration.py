...
def update_templates(context):
    ...
    It tries to automatically sets the new type of the tenplate by looking
    were it was used.
    ...
    ------------------------------------------------------------------------------------------
    portal_contract       | never used            | undefined          | portal_contracts
    ------------------------------------------------------------------------------------------
    portal_contract       | contracts only        | contract           | portal_contracts
    ------------------------------------------------------------------------------------------
    portal_contract       | letters only          | letter             | portal_contracts
    ------------------------------------------------------------------------------------------
    portal_contract       | letters and contracts | undefined          | portal_contracts
    ------------------------------------------------------------------------------------------
    ...
    for old_template in old_templates:
        ...
        concerned_interviews = [interview for interview in interviews
                               if interview.getTemplate() == old_template.id]

        concerned_evaluations = [evaluation for evaluation in evaluations
