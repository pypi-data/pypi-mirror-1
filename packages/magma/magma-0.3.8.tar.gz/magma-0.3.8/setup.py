...
The API documentation is available from http://gnuticles.gnufu.net/pymagma/, 
and the code is available from a Mercurial repository: http://freehg.org/u/ArneBab/magma/. 
...
- Updated usage information and instruction for adding alt-locs in sha1_gnutelly.py
...
- Added compatibility section, so the magnet links can also be read out 
  by programs supporting only Magmav0.2
...
setup(name='magma',
      ...
      scripts=["magma/magma_list.py", "magma/magma_creator_cli.py", "magma/sha1_gnutella.py"], 
     )
