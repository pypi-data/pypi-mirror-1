...
class stepper(object):
	...
	def run_to_bottom(self, ns=3, update_T=True):
		...
		self.run_to_change(5+2*m, update_T=update_T)	# get it warmed up.
		...
		while Num.sometrue(Num.less(xchanged,nchg)) or es<1.0 or dotchanged<ndot or (update_T and self.x.T>1.5):
			try:
