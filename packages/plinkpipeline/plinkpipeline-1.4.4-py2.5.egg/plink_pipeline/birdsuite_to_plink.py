...
def main(argv = None): 
    ...
    parser.add_option("-k", "--nodiploid", default=False, action="store_true",
    ...
    parser.add_option("-3", "--thirdStep", default=False, action="store_true",
                      help="Run the steps: Merge Fawkes Data, Fawkes to Gvar")
    parser.add_option("-4", "--fourthStep", default=False, action="store_true",
                      help="Run the steps: Merge Fawkes Data, Fawkes to Diploid, Make Tped, Make Tfam")
    ...
    if dctOptions.verifyfam:
        if not utils.checkFamFile(dctOptions.familyfile, 0.5):
            print "Family file is missing more than 50% of required phenotypes"
            sys.exit(1)
