...
def test_example5_Eval():
    assert_almost_equal(solution(data.xEval), data.yEval, 4)

def test_example5_xySolution():
    assert_almost_equal(solution.mesh, data.xSol)
    assert_almost_equal(solution.solution, data.ySol, 4)

def test_example5_workSolution():
    assert_almost_equal(solution.work, data.workSol, 4)

def test_example5_iworkSolution():
