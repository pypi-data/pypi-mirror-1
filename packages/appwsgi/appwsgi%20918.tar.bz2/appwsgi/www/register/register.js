...
register=
{
 ...
 'login':function()
 {
  http.fml=function(xml)
  {
   ...
   obj.id='picture'
   obj.style.background='url(../download/download.py?picture='+Math.random()+') no-repeat'
   obj.type="application/x-shockwave-flash"
   obj.data="../upload2/upload.swf?url=upload.py"
   obj.innerHTML='<param name="movie" value="../upload2/upload.swf?url=upload.py"/>'+
...
upload=
{
 ...
 'complete':function(n)
 {
  ...
  document.getElementById('picture').style.background='url(../download/download.py?picture='+Math.random()+') no-repeat'
 },
