...
order=
{
  ...
  products=
  {
   ...
   'onselect':function()
   {
    ...
    view.onclick=function()
    {
     ...
     else {document.getElementById('dproducts').style.display='block'; div.load(document.getElementById('dproducts'),'../products/products.py?'+products.selection[1])}
    }
 ...
 {  
  ...
  cart=
  {
   ...
   'onselect':function()
   {
    ...
    {
     if (document.getElementById('dproducts').style.display=='block'){document.getElementById('dproducts').style.display='none'}
     else {document.getElementById('dproducts').style.display='block'; div.load(document.getElementById('dproducts'),'../products/products.py?'+cart.selection[1])}
    }
 ...
 'menu':function()
 {
  ...
  f9.onclick=function()
  {
   div.load(document.getElementById('dproducts'),'../products/products.py?0');
