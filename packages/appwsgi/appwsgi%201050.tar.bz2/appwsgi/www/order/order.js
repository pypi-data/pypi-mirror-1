...
order=
{
 ...
 'total':function()
 {
  if(document.getElementById('cart'))
  {
   ...
   c=document.getElementById('dg-cart')
   if(c.childNodes[1])c.removeChild(c.childNodes[1])
   document.getElementById('dg-cart').appendChild(s)
  }
 },
  ...
  products=
  {
   ...
   'onselect':function()
   {
    ...
    yes.onclick=function()
    {
     ...
     var t
     if(t=document.getElementById('dg-cart'))
     {
      dg.remove(cart,a[0])
    ...
    no.type='button'
    no.value='no'
    no.onclick=function(){dg.select(products,'-1'); order.menu(); document.getElementById('shop').style.display='none';}
    ...
    {
     if (document.getElementById('shop').style.display=='block') {document.getElementById('shop').style.display='none'}
     else {document.getElementById('shop').style.display='block'; div.load(document.getElementById('shop'),'../products/'+products.selection[1]+'.xml')}
    }
 ...
 {  
  var v
  if(v=document.getElementById('dg-cart'))while(v.lastChild)v.removeChild(v.lastChild)
  ...
  cart=
  {
   ...
   'onselect':function()
   {
    ...
    yes.onclick=function()
    {
     ...
     var n,c
     if(cart.table.length==0){if(c=document.getElementById('dg-cart')){while (n=c.childNodes[0]){c.removeChild(n);}}}
    ...
    no.type='button'
    no.value='no'
    no.onclick=function(){if(cart)dg.select(cart,'-1');order.menu();document.getElementById('shop').style.display='none';}
    ...
    {
     if (document.getElementById('shop').style.display=='block'){document.getElementById('shop').style.display='none'}
     else {document.getElementById('shop').style.display='block'; div.load(document.getElementById('shop'),'../products/products.py?'+cart.selection[1])}
    }
 ...
 {
  var n,c
  if(c=document.getElementById('dg-products')){while(n=c.childNodes[0]){c.removeChild(n)}}
  products=
  {
   'id':'products',
   'onselect':function()
   {
    ...
    http.xml+=' <gid>'+document.getElementById('gid').innerHTML+'</gid>\n'
 ...
 'insert':function()
 {
  http.fml=function(xml)
  {
   ...
   window.location='../invoice/invoice.htm?'+order.nr+'-'+document.getElementById('gid').innerHTML
  }
  http.xml ='<?xml version="1.0" encoding="UTF-8"?>\n'
  http.xml+='<root>\n'
 ...
 'remove':function()
 {
  http.fml=function(xml)
  {
   ...
   if(products.table.length==0){if(c=document.getElementById('dg-products')){while (n=c.childNodes[0]){c.removeChild(n)}}}
 ...
 'menu':function()
 {
  ...
  f4.onclick=function()
  {
   ...
   if(document.getElementById('cart'))
   {
    ...
    else window.location='../invoice/invoice.htm?'+order.nr+'-'+document.getElementById('gid').innerHTML
   }
   else 
   {
  ...
  f7.onclick=function()
  {
   ...
   cart=''
   if(c=document.getElementById('dg-products')){while(n=c.childNodes[0]){c.removeChild(n)}}
   if(c=document.getElementById('dg-cart')){while(n=c.childNodes[0]){c.removeChild(n)}}
   document.getElementById('f1').focus()
   document.getElementById('shop').style.display='none'
  }
