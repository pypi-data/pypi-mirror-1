...
def application(environ, response):
    ...
    if data: session.set(db,'picture',data[0],sid)
    ...
    else: xml += "<script>parent.document.getElementById('picture').src='../download/servlet?picture='+Math.random();document.location='upload.htm';</script>"
