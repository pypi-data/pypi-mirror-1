...
appointment=
{
 'name':function()
 {
  http.url='appointment.py'
  http.fml=function(xml)
  {
   document.getElementById('dg-appointments').innerHTML=''
   appointments=
   {
    'id':'appointments',
    'onselect':function()
 ...
 'save':function()
 {
  ...
  http.fml=function(xml)
  {
   ...
   if(c=document.getElementById('dg-appointments'))while(c.lastChild)c.removeChild(c.lastChild)
  }
  http.xml ='<?xml version="1.0" encoding="UTF-8"?>\n'
  http.xml+='<root>\n'
