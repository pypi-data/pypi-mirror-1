...
def application(environ, response):
    ...
    if s.GID=='guest':
        ...
        elif v['cmd']=='name'  : db.execute("SELECT uid,name,adress,city,country,phone FROM users WHERE uid=%s",(v['uid']))
    ...
    if s.GID=='admin':
        ...
        elif v['cmd']=='name'  : db.execute("SELECT uid,name,adress,city,country,phone FROM users WHERE name LIKE %s",('%'+v['una']+'%'))
