...
register=
{
 ...
 'login':function()
 {
  http.fml=function(xml)
  {
   ...
   img.id='picture'
   img.src='../download/servlet?picture='+Math.random()
   ...
   link=['appointment','barcode','forum','invoice','order','query','register-admin','register','fx','smtp','soap'] 
   for(i in link)
   {
  ...
  http.xml+='</root>'
  if(document.getElementById('email').value)http.post()
 },
