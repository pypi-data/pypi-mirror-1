/* Slightly altered by gert cuykens */
...
//             xinter:     the space between two digits 
  ...
  // Parameters
  this.colors   = new Array('../bin/white.png','../bin/black.png');
  this.type     = (argc > 0) ? argv[0] : 'CODE128';
  this.code     = (argc > 1) ? argv[1] : '';
...
// Parameters: barcode:    the code to translate
  ...
  if (barcodeok == false) {
	...
	astr += '<tr><td><img src="'+this.colors[0]+'" width="'+10*this.xsize+'" height="'+this.ysize+'"/></td>\n';
