...
**SELENIUM_INSTANCE_URL** -  the base URL of the Zope instance to be used to run the test 
against. The URL must not contain any path information - only something like::
