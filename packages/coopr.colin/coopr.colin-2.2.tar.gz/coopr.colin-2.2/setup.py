...
"""
Script to generate the installer for coopr.colin.
"""
...
setup(name='coopr.colin',
      version='2.2',
      maintainer='William E. Hart',
      maintainer_email='wehart@sandia.gov',
      url = 'https://software.sandia.gov/svn/public/coopr/coopr.colin',
      license = 'BSD',
      platforms = ["any"],
      description = 'Coopr interfaces for COLIN optimizers',
