...
<axsl:apply-templates select="item" mode="id2292164"/>
</html>
  </axsl:template>
  <axsl:template match="item" mode="id2292164">
    <body xmlns="http://www.w3.org/1999/xhtml">
  <axsl:apply-templates select="journal" mode="id2292168"/>
</body>
  </axsl:template>
  <axsl:template match="journal" mode="id2292168">
    <form xmlns="http://www.w3.org/1999/xhtml" action="" method="POST">
    <axsl:apply-templates select="created" mode="id2292180"/>
    <axsl:apply-templates select="dtstamp" mode="id2292194"/>
    <axsl:apply-templates select="sequence" mode="id2292208"/>
    <axsl:apply-templates select="last-modified" mode="id2292222"/>
    <axsl:apply-templates select="class" mode="id2292237"/>
    <axsl:apply-templates select="related-to" mode="id2292251"/>
    <table align="center" border="0" cellpadding="5" cellspacing="0" width="100%">
      ...
      <tbody>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="summary" mode="id2292325"/>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="description" mode="id2292362"/>
          </td>
        </tr>
        ...
        <tr template:id="datetimes-node" id="{template:this-element()}">
          ...
          <axsl:apply-templates select="dtstart" mode="id2292416"/>
        </tr>
        <axsl:apply-templates select="organizers" mode="id2292747"/>
        <axsl:apply-templates select="attendees" mode="id2292842"/>
        <axsl:apply-templates select="person-search" mode="id2292953"/>
        <axsl:apply-templates select="person-suggestions" mode="id2293009"/>
        <tr>
          <td colspan="3">
  ...
  <axsl:template match="created" mode="id2292180">
    <axsl:choose>
  ...
  <axsl:template match="dtstamp" mode="id2292194">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="sequence" mode="id2292208">
    <axsl:choose>
  ...
  <axsl:template match="last-modified" mode="id2292222">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="class" mode="id2292237">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="related-to" mode="id2292251">
    <axsl:choose>
      <axsl:when test="@uri">
  ...
  <axsl:template match="summary" mode="id2292325">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="description" mode="id2292362">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="dtstart" mode="id2292416">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2292426"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2292426">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              ...
              <axsl:apply-templates select="week" mode="id2292656"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2292656">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2292666"/>
                </tr>
                <tr>
                  <!-- Highlight the day if selected. -->
                  <axsl:apply-templates select="day" mode="id2292701"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2292666">
  ...
  <axsl:template match="day" mode="id2292701">
  ...
  <axsl:template match="organizers" mode="id2292747">
    <axsl:apply-templates select="organizer" mode="id2292747"/>
  </axsl:template>
  <axsl:template match="organizer" mode="id2292747">
  ...
  <axsl:template match="attendees" mode="id2292842">
    <axsl:apply-templates select="attendee" mode="id2292842"/>
  </axsl:template>
  <axsl:template match="attendee" mode="id2292842">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-search" mode="id2292953">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-suggestions" mode="id2293009">
    <axsl:apply-templates select="card" mode="id2293009"/>
  </axsl:template>
  <axsl:template match="card" mode="id2293009">
    <tr xmlns="http://www.w3.org/1999/xhtml">
          <th/>
          <td colspan="2" xml:space="preserve">
            <axsl:apply-templates select="fn" mode="id2293027"/>
            <axsl:apply-templates select="email" mode="id2293061"/>
            <axsl:apply-templates select="uid" mode="id2293091"/>
  ...
  <axsl:template match="fn" mode="id2293027">
  ...
  <axsl:template match="email" mode="id2293061">
    <span xmlns="http://www.w3.org/1999/xhtml">
              &lt;<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>&gt;
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
  </axsl:template>
  <axsl:template match="uid" mode="id2293091">
    <span xmlns="http://www.w3.org/1999/xhtml">
              (<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>)
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
