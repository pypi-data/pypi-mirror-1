...
<axsl:stylesheet xmlns:dyn="http://exslt.org/dynamic" xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:template="http://www.boddie.org.uk/ns/xmltools/template" version="1.0" extension-element-prefixes="dyn">
  ...
  <axsl:template match="/">
    <axsl:for-each select="dyn:evaluate($element-path)">
      <tr xmlns="http://www.w3.org/1999/xhtml" template:id="datetimes-node" id="{template:this-element()}">
          ...
          <axsl:apply-templates select="dtstart" mode="id2311846"/>
        </tr>
    </axsl:for-each>
  </axsl:template>
  <axsl:template match="dtstart" mode="id2311846">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2311855"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2311855">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              ...
              <axsl:apply-templates select="week" mode="id2312087"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2312087">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2312097"/>
                </tr>
                <tr>
                  <!-- Highlight the day if selected. -->
                  <axsl:apply-templates select="day" mode="id2312132"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2312097">
  ...
  <axsl:template match="day" mode="id2312132">
