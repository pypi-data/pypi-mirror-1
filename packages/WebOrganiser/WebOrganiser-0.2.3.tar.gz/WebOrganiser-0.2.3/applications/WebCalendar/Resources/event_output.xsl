...
<axsl:apply-templates select="item" mode="id2300930"/>
</html>
  </axsl:template>
  <axsl:template match="item" mode="id2300930">
    <body xmlns="http://www.w3.org/1999/xhtml">
  <axsl:apply-templates select="event" mode="id2300935"/>
</body>
  </axsl:template>
  <axsl:template match="event" mode="id2300935">
    <form xmlns="http://www.w3.org/1999/xhtml" action="" method="POST">
    <axsl:apply-templates select="created" mode="id2300947"/>
    <axsl:apply-templates select="dtstamp" mode="id2300963"/>
    <axsl:apply-templates select="sequence" mode="id2300978"/>
    <axsl:apply-templates select="last-modified" mode="id2300994"/>
    <axsl:apply-templates select="class" mode="id2301007"/>
    <axsl:apply-templates select="priority" mode="id2301021"/>
    <axsl:apply-templates select="transp" mode="id2301035"/>
    <axsl:apply-templates select="related-to" mode="id2301049"/>
    <table align="center" border="0" cellpadding="5" cellspacing="0" width="100%">
      ...
      <tbody>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="summary" mode="id2301122"/>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="location" mode="id2301156"/>
          </td>
        </tr>
        <tr>
          <th width="10%">
        ...
        <tr template:id="datetimes-node" id="{template:this-element()}">
          ...
          <axsl:apply-templates select="dtstart" mode="id2301214"/>
          <axsl:apply-templates select="dtend" mode="id2301550"/>
        </tr>
        <axsl:apply-templates select="organizers" mode="id2301878"/>
        <axsl:apply-templates select="attendees" mode="id2301977"/>
        <axsl:apply-templates select="person-search" mode="id2302089"/>
        <axsl:apply-templates select="person-suggestions" mode="id2302144"/>
        <tr>
          <td colspan="3">
  ...
  <axsl:template match="created" mode="id2300947">
    <axsl:choose>
  ...
  <axsl:template match="dtstamp" mode="id2300963">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="sequence" mode="id2300978">
    <axsl:choose>
  ...
  <axsl:template match="last-modified" mode="id2300994">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="class" mode="id2301007">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="priority" mode="id2301021">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="transp" mode="id2301035">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="related-to" mode="id2301049">
    <axsl:choose>
      <axsl:when test="@uri">
  ...
  <axsl:template match="summary" mode="id2301122">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="location" mode="id2301156">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="dtstart" mode="id2301214">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2301224"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2301224">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              ...
              <axsl:apply-templates select="week" mode="id2301458"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2301458">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2301468"/>
                </tr>
                <tr>
                  <!-- Highlight the day if marked. -->
                  <axsl:apply-templates select="day" mode="id2301506"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2301468">
  ...
  <axsl:template match="day" mode="id2301506">
  ...
  <axsl:template match="dtend" mode="id2301550">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2301558"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2301558">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              <thead>
                <tr>
                  <th colspan="3">
              ...
              <axsl:apply-templates select="week" mode="id2301786"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2301786">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2301795"/>
                </tr>
                <tr>
                  <!-- Highlight the day if marked. -->
                  <axsl:apply-templates select="day" mode="id2301833"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2301795">
    <td xmlns="http://www.w3.org/1999/xhtml" class="day-header-fixed">
                    <axsl:choose><axsl:when test="@number"><axsl:variable name="this-name">number</axsl:variable><axsl:variable name="this-value" select="@number"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">number</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>
                  </td>
  </axsl:template>
  <axsl:template match="day" mode="id2301833">
    <td xmlns="http://www.w3.org/1999/xhtml" class="day-minimum-fixed {template:choice(@marked = 'true', 'day-region')} {template:choice(@today = 'true', 'day-today')}">
  ...
  <axsl:template match="organizers" mode="id2301878">
    <axsl:apply-templates select="organizer" mode="id2301878"/>
  </axsl:template>
  <axsl:template match="organizer" mode="id2301878">
  ...
  <axsl:template match="attendees" mode="id2301977">
    <axsl:apply-templates select="attendee" mode="id2301977"/>
  </axsl:template>
  <axsl:template match="attendee" mode="id2301977">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-search" mode="id2302089">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-suggestions" mode="id2302144">
    <axsl:apply-templates select="card" mode="id2302144"/>
  </axsl:template>
  <axsl:template match="card" mode="id2302144">
    <tr xmlns="http://www.w3.org/1999/xhtml">
          <th/>
          <td colspan="2" xml:space="preserve">
            <axsl:apply-templates select="fn" mode="id2302163"/>
            <axsl:apply-templates select="email" mode="id2302196"/>
            <axsl:apply-templates select="uid" mode="id2302226"/>
  ...
  <axsl:template match="fn" mode="id2302163">
  ...
  <axsl:template match="email" mode="id2302196">
    <span xmlns="http://www.w3.org/1999/xhtml">
              &lt;<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>&gt;
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
  </axsl:template>
  <axsl:template match="uid" mode="id2302226">
    <span xmlns="http://www.w3.org/1999/xhtml">
              (<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>)
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
