...
<axsl:apply-templates select="item" mode="id2293864"/>
  ...
  <axsl:apply-templates select="to-do" mode="id2293868"/>
</body>
  </axsl:template>
  <axsl:template match="to-do" mode="id2293868">
    <form xmlns="http://www.w3.org/1999/xhtml" action="" method="POST">
    <axsl:apply-templates select="created" mode="id2293880"/>
    <axsl:apply-templates select="dtstamp" mode="id2293895"/>
    <axsl:apply-templates select="sequence" mode="id2293909"/>
    <axsl:apply-templates select="last-modified" mode="id2293923"/>
    <axsl:apply-templates select="class" mode="id2293937"/>
    <axsl:apply-templates select="priority" mode="id2293952"/>
    <axsl:apply-templates select="related-to" mode="id2293966"/>
    <table align="center" border="0" cellpadding="5" cellspacing="0" width="100%">
      ...
      <tbody>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="summary" mode="id2294039"/>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="percent-complete" mode="id2294112"/>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="location" mode="id2294146"/>
          </td>
        </tr>
        <axsl:apply-templates select="organizers" mode="id2294165"/>
        <axsl:apply-templates select="attendees" mode="id2294268"/>
        <axsl:apply-templates select="person-search" mode="id2294380"/>
        <axsl:apply-templates select="person-suggestions" mode="id2294436"/>
        <tr>
          <td colspan="3">
  ...
  <axsl:template match="created" mode="id2293880">
    <axsl:choose>
  ...
  <axsl:template match="dtstamp" mode="id2293895">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="sequence" mode="id2293909">
    <axsl:choose>
  ...
  <axsl:template match="last-modified" mode="id2293923">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="class" mode="id2293937">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="related-to" mode="id2293966">
    <axsl:choose>
      <axsl:when test="@uri">
  ...
  <axsl:template match="summary" mode="id2294039">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="percent-complete" mode="id2294112">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="location" mode="id2294146">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="organizers" mode="id2294165">
    <axsl:apply-templates select="organizer" mode="id2294165"/>
  </axsl:template>
  <axsl:template match="organizer" mode="id2294165">
  ...
  <axsl:template match="attendees" mode="id2294268">
    <axsl:apply-templates select="attendee" mode="id2294268"/>
  </axsl:template>
  <axsl:template match="attendee" mode="id2294268">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-search" mode="id2294380">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-suggestions" mode="id2294436">
    <axsl:apply-templates select="card" mode="id2294436"/>
  </axsl:template>
  <axsl:template match="card" mode="id2294436">
    <tr xmlns="http://www.w3.org/1999/xhtml">
          <th/>
          <td colspan="2" xml:space="preserve">
            <axsl:apply-templates select="fn" mode="id2294454"/>
            <axsl:apply-templates select="email" mode="id2294488"/>
            <axsl:apply-templates select="uid" mode="id2294519"/>
  ...
  <axsl:template match="fn" mode="id2294454">
  ...
  <axsl:template match="email" mode="id2294488">
    <span xmlns="http://www.w3.org/1999/xhtml">
              &lt;<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>&gt;
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
  </axsl:template>
  <axsl:template match="uid" mode="id2294519">
    <span xmlns="http://www.w3.org/1999/xhtml">
              (<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>)
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
