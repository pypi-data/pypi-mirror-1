...
<axsl:stylesheet xmlns:dyn="http://exslt.org/dynamic" xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:template="http://www.boddie.org.uk/ns/xmltools/template" version="1.0" extension-element-prefixes="dyn">
  ...
  <axsl:template match="/">
    <axsl:apply-templates select="items" mode="id2286342"/>
  </axsl:template>
  <axsl:template match="items" mode="id2286342">
    <axsl:apply-templates select="table" mode="id2286342"/>
  </axsl:template>
  <axsl:template match="table" mode="id2286342">
  ...
  <axsl:apply-templates select="item" mode="id2286464"/>
</D:multistatus>
  </axsl:template>
  <axsl:template match="item" mode="id2286464">
