...
<axsl:apply-templates select="item" mode="id2298746"/>
</html>
  </axsl:template>
  <axsl:template match="item" mode="id2298746">
    <body xmlns="http://www.w3.org/1999/xhtml">
  <axsl:apply-templates select="event" mode="id2298751"/>
</body>
  </axsl:template>
  <axsl:template match="event" mode="id2298751">
    <form xmlns="http://www.w3.org/1999/xhtml" action="" method="POST">
    <axsl:apply-templates select="created" mode="id2298764"/>
    <axsl:apply-templates select="dtstamp" mode="id2298780"/>
    <axsl:apply-templates select="sequence" mode="id2298795"/>
    <axsl:apply-templates select="last-modified" mode="id2298810"/>
    <axsl:apply-templates select="class" mode="id2298824"/>
    <axsl:apply-templates select="priority" mode="id2298837"/>
    <axsl:apply-templates select="transp" mode="id2298851"/>
    <axsl:apply-templates select="related-to" mode="id2298865"/>
    <table align="center" border="0" cellpadding="5" cellspacing="0" width="100%">
      ...
      <tbody>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="summary" mode="id2298938"/>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="location" mode="id2298972"/>
          </td>
        </tr>
        <tr>
          <th width="10%">
        ...
        <tr template:id="datetimes-node" id="{template:this-element()}">
          ...
          <axsl:apply-templates select="dtstart" mode="id2299030"/>
          <axsl:apply-templates select="dtend" mode="id2299366"/>
        </tr>
        <axsl:apply-templates select="organizers" mode="id2299695"/>
        <axsl:apply-templates select="attendees" mode="id2299793"/>
        <axsl:apply-templates select="person-search" mode="id2299905"/>
        <axsl:apply-templates select="person-suggestions" mode="id2299961"/>
        <tr>
          <td colspan="3">
  ...
  <axsl:template match="created" mode="id2298764">
    <axsl:choose>
  ...
  <axsl:template match="dtstamp" mode="id2298780">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="sequence" mode="id2298795">
    <axsl:choose>
  ...
  <axsl:template match="last-modified" mode="id2298810">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="class" mode="id2298824">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="priority" mode="id2298837">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="transp" mode="id2298851">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="related-to" mode="id2298865">
    <axsl:choose>
      <axsl:when test="@uri">
  ...
  <axsl:template match="summary" mode="id2298938">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="location" mode="id2298972">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="dtstart" mode="id2299030">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2299040"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2299040">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              ...
              <axsl:apply-templates select="week" mode="id2299275"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2299275">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2299285"/>
                </tr>
                <tr>
                  <!-- Highlight the day if marked. -->
                  <axsl:apply-templates select="day" mode="id2299322"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2299285">
  ...
  <axsl:template match="day" mode="id2299322">
  ...
  <axsl:template match="dtend" mode="id2299366">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2299375"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2299375">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              <thead>
                <tr>
                  <th colspan="3">
              ...
              <axsl:apply-templates select="week" mode="id2299602"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2299602">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2299612"/>
                </tr>
                <tr>
                  <!-- Highlight the day if marked. -->
                  <axsl:apply-templates select="day" mode="id2299650"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2299612">
    <td xmlns="http://www.w3.org/1999/xhtml" class="day-header-fixed">
                    <axsl:choose><axsl:when test="@number"><axsl:variable name="this-name">number</axsl:variable><axsl:variable name="this-value" select="@number"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">number</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>
                  </td>
  </axsl:template>
  <axsl:template match="day" mode="id2299650">
    <td xmlns="http://www.w3.org/1999/xhtml" class="day-minimum-fixed {template:choice(@marked = 'true', 'day-region')} {template:choice(@today = 'true', 'day-today')}">
  ...
  <axsl:template match="organizers" mode="id2299695">
    <axsl:apply-templates select="organizer" mode="id2299695"/>
  </axsl:template>
  <axsl:template match="organizer" mode="id2299695">
  ...
  <axsl:template match="attendees" mode="id2299793">
    <axsl:apply-templates select="attendee" mode="id2299793"/>
  </axsl:template>
  <axsl:template match="attendee" mode="id2299793">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-search" mode="id2299905">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-suggestions" mode="id2299961">
    <axsl:apply-templates select="card" mode="id2299961"/>
  </axsl:template>
  <axsl:template match="card" mode="id2299961">
    <tr xmlns="http://www.w3.org/1999/xhtml">
          <th/>
          <td colspan="2" xml:space="preserve">
            <axsl:apply-templates select="fn" mode="id2299979"/>
            <axsl:apply-templates select="email" mode="id2300013"/>
            <axsl:apply-templates select="uid" mode="id2300043"/>
  ...
  <axsl:template match="fn" mode="id2299979">
  ...
  <axsl:template match="email" mode="id2300013">
    <span xmlns="http://www.w3.org/1999/xhtml">
              &lt;<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>&gt;
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
  </axsl:template>
  <axsl:template match="uid" mode="id2300043">
    <span xmlns="http://www.w3.org/1999/xhtml">
              (<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>)
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
