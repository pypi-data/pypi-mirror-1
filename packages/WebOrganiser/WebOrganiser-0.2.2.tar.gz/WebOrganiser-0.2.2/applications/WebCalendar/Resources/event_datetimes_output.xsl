...
<axsl:stylesheet xmlns:dyn="http://exslt.org/dynamic" xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:template="http://www.boddie.org.uk/ns/xmltools/template" version="1.0" extension-element-prefixes="dyn">
  ...
  <axsl:template match="/">
    <axsl:for-each select="dyn:evaluate($element-path)">
      <tr xmlns="http://www.w3.org/1999/xhtml" template:id="datetimes-node" id="{template:this-element()}">
          ...
          <axsl:apply-templates select="dtstart" mode="id2313441"/>
          <axsl:apply-templates select="dtend" mode="id2313778"/>
        </tr>
    </axsl:for-each>
  </axsl:template>
  <axsl:template match="dtstart" mode="id2313441">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2313451"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2313451">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              ...
              <axsl:apply-templates select="week" mode="id2313686"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2313686">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2313696"/>
                </tr>
                <tr>
                  <!-- Highlight the day if marked. -->
                  <axsl:apply-templates select="day" mode="id2313734"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2313696">
  ...
  <axsl:template match="day" mode="id2313734">
  ...
  <axsl:template match="dtend" mode="id2313778">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2313786"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2313786">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              <thead>
                <tr>
                  <th colspan="3">
              ...
              <axsl:apply-templates select="week" mode="id2314013"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2314013">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2314023"/>
                </tr>
                <tr>
                  <!-- Highlight the day if marked. -->
                  <axsl:apply-templates select="day" mode="id2314061"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2314023">
    <td xmlns="http://www.w3.org/1999/xhtml" class="day-header-fixed">
                    <axsl:choose><axsl:when test="@number"><axsl:variable name="this-name">number</axsl:variable><axsl:variable name="this-value" select="@number"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">number</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>
                  </td>
  </axsl:template>
  <axsl:template match="day" mode="id2314061">
    <td xmlns="http://www.w3.org/1999/xhtml" class="day-minimum-fixed {template:choice(@marked = 'true', 'day-region')} {template:choice(@today = 'true', 'day-today')}">
