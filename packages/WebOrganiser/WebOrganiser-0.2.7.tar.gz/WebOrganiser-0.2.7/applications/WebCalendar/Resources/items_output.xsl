...
<axsl:apply-templates select="items" mode="id2284956"/>
</html>
  </axsl:template>
  <axsl:template match="items" mode="id2284956">
  ...
  <form action="" method="POST">
    <div class="controls">
      ...
      <div class="buttons">
        ...
        <axsl:apply-templates select="new-type" mode="id2285047"/>
      </div>

      <!-- Item type "tabs". -->

      <axsl:apply-templates select="item-types" mode="id2285106"/>
    ...
    <axsl:apply-templates select="table" mode="id2285384"/>
  </form>
</body>
  </axsl:template>
  <axsl:template match="new-type" mode="id2285047">
    <axsl:choose>
      <axsl:when test="@value">
        ...
        <select xmlns="http://www.w3.org/1999/xhtml" name="{template:this-attribute()}">
          <axsl:apply-templates select="new-type-enum" mode="id2285081"/>
        </select>
      </axsl:when>
      <axsl:otherwise>
        <axsl:variable name="this-name">value</axsl:variable>
  ...
  <axsl:template match="new-type-enum" mode="id2285081">
  ...
  <axsl:template match="item-types" mode="id2285106">
    <div xmlns="http://www.w3.org/1999/xhtml" class="types" xml:space="preserve">
        <axsl:apply-templates select="item-type" mode="id2285110"/>
  ...
  <axsl:template match="item-type" mode="id2285110">
  ...
  <axsl:template match="table" mode="id2285384">
    <div xmlns="http://www.w3.org/1999/xhtml" class="view">
      <table align="center" border="0" cellpadding="5" cellspacing="0" width="100%">
        ...
        <axsl:apply-templates select="item" mode="id2285447"/>
      </table>
    </div>
  </axsl:template>
  <axsl:template match="item" mode="id2285447">
          ...
          <axsl:if test="not(related-to) or /items/@related-to"><tr>
            ...
            <td xml:space="preserve">
              ...
              <a href="../{@item-type}/{template:url-encode(template:url-encode(@item-value))}/">
                <axsl:apply-templates select="summary" mode="id2285555"/></a>
              <axsl:choose><axsl:when test="@item-value"><axsl:variable name="this-name">item-value</axsl:variable><axsl:variable name="this-value" select="@item-value"/><a href="../card/{template:url-encode(template:url-encode($this-value))}/"><axsl:apply-templates select="fn" mode="id2285580"/></a></axsl:when><axsl:otherwise><axsl:variable name="this-name">item-value</axsl:variable><axsl:variable name="this-value"/><a href="../card/{template:url-encode(template:url-encode($this-value))}/"><axsl:apply-templates select="fn" mode="id2285580"/></a></axsl:otherwise></axsl:choose>
            ...
            <td>
              <axsl:apply-templates select="created" mode="id2285614"/>
            </td>
          </tr></axsl:if>

        </tbody>
  </axsl:template>
  <axsl:template match="summary" mode="id2285555">
    <axsl:choose>
  ...
  <axsl:template match="fn" mode="id2285580">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="created" mode="id2285614">
    <axsl:choose>
