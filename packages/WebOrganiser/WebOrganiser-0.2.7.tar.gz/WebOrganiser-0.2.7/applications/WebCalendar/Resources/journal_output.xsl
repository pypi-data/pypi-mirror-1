...
<axsl:apply-templates select="item" mode="id2296887"/>
</html>
  </axsl:template>
  <axsl:template match="item" mode="id2296887">
    <body xmlns="http://www.w3.org/1999/xhtml">
  <axsl:apply-templates select="journal" mode="id2296893"/>
</body>
  </axsl:template>
  <axsl:template match="journal" mode="id2296893">
    <form xmlns="http://www.w3.org/1999/xhtml" action="" method="POST">
    <axsl:apply-templates select="created" mode="id2296907"/>
    <axsl:apply-templates select="dtstamp" mode="id2296923"/>
    <axsl:apply-templates select="sequence" mode="id2296941"/>
    <axsl:apply-templates select="last-modified" mode="id2296957"/>
    <axsl:apply-templates select="class" mode="id2296973"/>
    <axsl:apply-templates select="related-to" mode="id2296988"/>
    <table align="center" border="0" cellpadding="5" cellspacing="0" width="100%">
      <thead>
        <tr>
          <th colspan="3" class="header"><axsl:variable name="translation" select="$translations/translations/locale[code/@value=$locale]/translation[@value='Journal']/text()"/><axsl:variable name="translation-default" select="$translations/translations/locale[1]/translation[@value='Journal']/text()"/><axsl:choose><axsl:when test="$translation"><axsl:value-of select="$translation"/></axsl:when><axsl:when test="$translation-default"><axsl:value-of select="$translation-default"/></axsl:when><axsl:otherwise>Journal</axsl:otherwise></axsl:choose></th>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="summary" mode="id2297080"/>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="description" mode="id2297132"/>
          </td>
        </tr>
        ...
        <tr template:section="datetimes-node" id="{template:this-element()}">
          <th width="10%">
          </th>
          <axsl:apply-templates select="dtstart" mode="id2297200"/>
        </tr>
        <axsl:apply-templates select="organizers" mode="id2297582"/>
        <axsl:apply-templates select="attendees" mode="id2297729"/>
        <axsl:apply-templates select="person-search" mode="id2297869"/>
        <axsl:apply-templates select="person-suggestions" mode="id2297912"/>
        <tr>
          <td colspan="3">
  ...
  <axsl:template match="created" mode="id2296907">
    <axsl:choose>
  ...
  <axsl:template match="dtstamp" mode="id2296923">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="sequence" mode="id2296941">
    <axsl:choose>
  ...
  <axsl:template match="last-modified" mode="id2296957">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="class" mode="id2296973">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="related-to" mode="id2296988">
    <axsl:choose>
      <axsl:when test="@uri">
  ...
  <axsl:template match="summary" mode="id2297080">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="description" mode="id2297132">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="dtstart" mode="id2297200">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2297211"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2297211">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              ...
              <axsl:apply-templates select="week" mode="id2297483"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2297483">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2297498"/>
                </tr>
                <tr>
                  <!-- Highlight the day if selected. -->
                  <axsl:apply-templates select="day" mode="id2297541"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2297498">
  ...
  <axsl:template match="day" mode="id2297541">
    <td xmlns="http://www.w3.org/1999/xhtml" class="day-minimum-fixed {template:choice(@start = 'true', 'day-region')} {template:choice(@today = 'true', 'day-today')}">
                    ...
                    <axsl:if test="@date != ''"><input name="{template:other-attributes('date', ../../..)}" value="{@date}" type="radio" onclick="return requestUpdate(                         'journal-datetimes',                         '{template:other-attributes('year', ../..)},{template:other-attributes('number', ../..)},{template:other-attributes('date', ../../..)}',                         '{template:other-elements(../../../..)}',                         '',                         '{template:element-path(template:other-elements(../../../..))}'                         )"><axsl:if test="@start = 'true'"><axsl:attribute name="checked">checked</axsl:attribute></axsl:if></input></axsl:if>
                  </td>
  </axsl:template>
  <axsl:template match="organizers" mode="id2297582">
    <axsl:apply-templates select="organizer" mode="id2297582"/>
  </axsl:template>
  <axsl:template match="organizer" mode="id2297582">
  ...
  <axsl:template match="attendees" mode="id2297729">
    <axsl:apply-templates select="attendee" mode="id2297729"/>
  </axsl:template>
  <axsl:template match="attendee" mode="id2297729">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-search" mode="id2297869">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-suggestions" mode="id2297912">
    <axsl:apply-templates select="card" mode="id2297912"/>
  </axsl:template>
  <axsl:template match="card" mode="id2297912">
    <tr xmlns="http://www.w3.org/1999/xhtml">
          <th/>
          <td colspan="2" xml:space="preserve">
            <axsl:apply-templates select="fn" mode="id2297931"/>
            <axsl:apply-templates select="email" mode="id2297964"/>
            <axsl:apply-templates select="uid" mode="id2297995"/>
  ...
  <axsl:template match="fn" mode="id2297931">
  ...
  <axsl:template match="email" mode="id2297964">
    <span xmlns="http://www.w3.org/1999/xhtml">
              &lt;<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>&gt;
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
  </axsl:template>
  <axsl:template match="uid" mode="id2297995">
    <span xmlns="http://www.w3.org/1999/xhtml">
              (<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>)
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
