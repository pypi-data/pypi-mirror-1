...
<axsl:apply-templates select="item" mode="id2301898"/>
</html>
  </axsl:template>
  <axsl:template match="item" mode="id2301898">
    <body xmlns="http://www.w3.org/1999/xhtml">
  <axsl:apply-templates select="to-do" mode="id2301905"/>
</body>
  </axsl:template>
  <axsl:template match="to-do" mode="id2301905">
    <form xmlns="http://www.w3.org/1999/xhtml" action="" method="POST">
    <axsl:apply-templates select="created" mode="id2301919"/>
    <axsl:apply-templates select="dtstamp" mode="id2301935"/>
    <axsl:apply-templates select="sequence" mode="id2301952"/>
    <axsl:apply-templates select="last-modified" mode="id2301969"/>
    <axsl:apply-templates select="class" mode="id2301985"/>
    <axsl:apply-templates select="priority" mode="id2302001"/>
    <axsl:apply-templates select="related-to" mode="id2302017"/>
    <table align="center" border="0" cellpadding="5" cellspacing="0" width="100%">
      ...
      <tbody>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="summary" mode="id2302104"/>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="description" mode="id2302157"/>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="percent-complete" mode="id2302218"/>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="location" mode="id2302242"/>
          </td>
        </tr>
        <axsl:apply-templates select="organizers" mode="id2302263"/>
        <axsl:apply-templates select="attendees" mode="id2302405"/>
        <axsl:apply-templates select="person-search" mode="id2302546"/>
        <axsl:apply-templates select="person-suggestions" mode="id2302607"/>
        <tr>
          <td colspan="3">
  ...
  <axsl:template match="created" mode="id2301919">
    <axsl:choose>
  ...
  <axsl:template match="dtstamp" mode="id2301935">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="sequence" mode="id2301952">
    <axsl:choose>
  ...
  <axsl:template match="last-modified" mode="id2301969">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="class" mode="id2301985">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="priority" mode="id2302001">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="related-to" mode="id2302017">
    <axsl:choose>
      <axsl:when test="@uri">
  ...
  <axsl:template match="summary" mode="id2302104">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="description" mode="id2302157">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="percent-complete" mode="id2302218">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="location" mode="id2302242">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="organizers" mode="id2302263">
    <axsl:apply-templates select="organizer" mode="id2302263"/>
  </axsl:template>
  <axsl:template match="organizer" mode="id2302263">
  ...
  <axsl:template match="attendees" mode="id2302405">
    <axsl:apply-templates select="attendee" mode="id2302405"/>
  </axsl:template>
  <axsl:template match="attendee" mode="id2302405">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-search" mode="id2302546">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-suggestions" mode="id2302607">
    <axsl:apply-templates select="card" mode="id2302607"/>
  </axsl:template>
  <axsl:template match="card" mode="id2302607">
    <tr xmlns="http://www.w3.org/1999/xhtml">
          <th/>
          <td colspan="2" xml:space="preserve">
            <axsl:apply-templates select="fn" mode="id2302299"/>
            <axsl:apply-templates select="email" mode="id2302677"/>
            <axsl:apply-templates select="uid" mode="id2302717"/>
  ...
  <axsl:template match="fn" mode="id2302299">
  ...
  <axsl:template match="email" mode="id2302677">
    <span xmlns="http://www.w3.org/1999/xhtml">
              &lt;<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>&gt;
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
  </axsl:template>
  <axsl:template match="uid" mode="id2302717">
    <span xmlns="http://www.w3.org/1999/xhtml">
              (<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>)
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
