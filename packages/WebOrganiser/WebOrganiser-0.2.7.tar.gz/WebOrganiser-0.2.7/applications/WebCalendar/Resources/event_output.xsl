...
<axsl:apply-templates select="item" mode="id2307348"/>
</html>
  </axsl:template>
  <axsl:template match="item" mode="id2307348">
    <body xmlns="http://www.w3.org/1999/xhtml">
  <axsl:apply-templates select="event" mode="id2307354"/>
</body>
  </axsl:template>
  <axsl:template match="event" mode="id2307354">
    <form xmlns="http://www.w3.org/1999/xhtml" action="" method="POST">
    <axsl:apply-templates select="created" mode="id2307370"/>
    <axsl:apply-templates select="dtstamp" mode="id2307392"/>
    <axsl:apply-templates select="sequence" mode="id2307410"/>
    <axsl:apply-templates select="last-modified" mode="id2307424"/>
    <axsl:apply-templates select="class" mode="id2307439"/>
    <axsl:apply-templates select="priority" mode="id2307455"/>
    <axsl:apply-templates select="transp" mode="id2307472"/>
    <axsl:apply-templates select="related-to" mode="id2307486"/>
    <table align="center" border="0" cellpadding="5" cellspacing="0" width="100%">
      ...
      <tbody>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="summary" mode="id2307571"/>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="location" mode="id2307613"/>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <axsl:apply-templates select="description" mode="id2307662"/>
          </td>
        </tr>
        <tr>
          <th width="10%">
      ...
      <tbody template:section="datetimes-node" id="{template:this-element()}">
        <tr>
          ...
          <axsl:apply-templates select="dtstart" mode="id2307749"/>
          <axsl:apply-templates select="dtend" mode="id2308135"/>
        </tr>
      </tbody>
      <tbody>
        <tr>
          ...
          <axsl:apply-templates select="dtstart-time" mode="id2308528"/>
          <axsl:apply-templates select="dtend-time" mode="id2308708"/>
        </tr>
      </tbody>
      <tbody>
        ...
        <axsl:apply-templates select="organizers" mode="id2308861"/>
        <axsl:apply-templates select="attendees" mode="id2308954"/>
        <axsl:apply-templates select="person-search" mode="id2309061"/>
        <axsl:apply-templates select="person-suggestions" mode="id2309105"/>
        <tr>
          <td colspan="3">
  ...
  <axsl:template match="created" mode="id2307370">
    <axsl:choose>
  ...
  <axsl:template match="dtstamp" mode="id2307392">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="sequence" mode="id2307410">
    <axsl:choose>
  ...
  <axsl:template match="last-modified" mode="id2307424">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="class" mode="id2307439">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="priority" mode="id2307455">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="transp" mode="id2307472">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="related-to" mode="id2307486">
    <axsl:choose>
      <axsl:when test="@uri">
  ...
  <axsl:template match="summary" mode="id2307571">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="location" mode="id2307613">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="description" mode="id2307662">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="dtstart" mode="id2307749">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2307760"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2307760">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              ...
              <axsl:apply-templates select="week" mode="id2308036"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2308036">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2308050"/>
                </tr>
                <tr>
                  <!-- Highlight the day if marked. -->
                  <axsl:apply-templates select="day" mode="id2308094"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2308050">
  ...
  <axsl:template match="day" mode="id2308094">
  ...
  <axsl:template match="dtend" mode="id2308135">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2308137"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2308137">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              <thead>
                <tr>
                  <th colspan="3">
              ...
              <axsl:apply-templates select="week" mode="id2308431"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2308431">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2308441"/>
                </tr>
                <tr>
                  <!-- Highlight the day if marked. -->
                  <axsl:apply-templates select="day" mode="id2308477"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2308441">
    <td xmlns="http://www.w3.org/1999/xhtml" class="day-header-fixed">
                    <axsl:choose><axsl:when test="@number"><axsl:variable name="this-name">number</axsl:variable><axsl:variable name="this-value" select="@number"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">number</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>
                  </td>
  </axsl:template>
  <axsl:template match="day" mode="id2308477">
    <td xmlns="http://www.w3.org/1999/xhtml" class="day-minimum-fixed {template:choice(@marked = 'true', 'day-region')} {template:choice(@today = 'true', 'day-today')}">
  ...
  <axsl:template match="dtstart-time" mode="id2308528">
    <td xmlns="http://www.w3.org/1999/xhtml">
            ...
            <div xml:space="preserve">
              ...
              <axsl:apply-templates select="hour" mode="id2308608"/>
              <axsl:apply-templates select="minute" mode="id2308640"/>
              <axsl:apply-templates select="second" mode="id2308666"/>
            </div>
          </td>
  </axsl:template>
  <axsl:template match="hour" mode="id2308608">
    <axsl:choose>
      <axsl:when test="@value">
        ...
        <select xmlns="http://www.w3.org/1999/xhtml" name="{template:this-attribute()}">
                <axsl:apply-templates select="hour-enum" mode="id2308632"/>
              </select>
      </axsl:when>
      <axsl:otherwise>
        <axsl:variable name="this-name">value</axsl:variable>
  ...
  <axsl:template match="hour-enum" mode="id2308632">
  ...
  <axsl:template match="minute" mode="id2308640">
    <axsl:choose>
      <axsl:when test="@value">
        <axsl:variable name="this-name">value</axsl:variable>
        <axsl:variable name="this-value" select="@value"/>
        <select xmlns="http://www.w3.org/1999/xhtml" name="{template:this-attribute()}">
                <axsl:apply-templates select="minute-enum" mode="id2308659"/>
              </select>
      </axsl:when>
      <axsl:otherwise>
        <axsl:variable name="this-name">value</axsl:variable>
  ...
  <axsl:template match="minute-enum" mode="id2308659">
    <option xmlns="http://www.w3.org/1999/xhtml" value="{@value}">
      <axsl:if test="@value = ../@value">
        <axsl:attribute name="selected">selected</axsl:attribute>
      </axsl:if>
  ...
  <axsl:template match="second" mode="id2308666">
    <axsl:choose>
      <axsl:when test="@value">
        <axsl:variable name="this-name">value</axsl:variable>
        <axsl:variable name="this-value" select="@value"/>
        <select xmlns="http://www.w3.org/1999/xhtml" name="{template:this-attribute()}">
                <axsl:apply-templates select="second-enum" mode="id2308688"/>
              </select>
      </axsl:when>
      <axsl:otherwise>
        <axsl:variable name="this-name">value</axsl:variable>
  ...
  <axsl:template match="second-enum" mode="id2308688">
    <option xmlns="http://www.w3.org/1999/xhtml" value="{@value}">
      <axsl:if test="@value = ../@value">
        <axsl:attribute name="selected">selected</axsl:attribute>
      </axsl:if>
  ...
  <axsl:template match="dtend-time" mode="id2308708">
    <td xmlns="http://www.w3.org/1999/xhtml">
            <div xml:space="preserve">
              <axsl:choose><axsl:when test="@use-time"><axsl:variable name="this-name">use-time</axsl:variable><axsl:variable name="this-value" select="@use-time"/><input type="radio" value="false" name="{template:this-attribute()}"><axsl:if test="$this-value = 'false'"><axsl:attribute name="checked">checked</axsl:attribute></axsl:if></input></axsl:when><axsl:otherwise><axsl:variable name="this-name">use-time</axsl:variable><axsl:variable name="this-value"/><input type="radio" value="false" name="{template:this-attribute()}"><axsl:if test="$this-value = 'false'"><axsl:attribute name="checked">checked</axsl:attribute></axsl:if></input></axsl:otherwise></axsl:choose>
            ...
            <div xml:space="preserve">
              ...
              <axsl:apply-templates select="hour" mode="id2308764"/>
              <axsl:apply-templates select="minute" mode="id2308785"/>
              <axsl:apply-templates select="second" mode="id2308816"/>
            </div>
          </td>
  </axsl:template>
  <axsl:template match="hour" mode="id2308764">
    <axsl:choose>
      <axsl:when test="@value">
        <axsl:variable name="this-name">value</axsl:variable>
        <axsl:variable name="this-value" select="@value"/>
        <select xmlns="http://www.w3.org/1999/xhtml" name="{template:this-attribute()}">
                <axsl:apply-templates select="hour-enum" mode="id2308778"/>
              </select>
      </axsl:when>
      <axsl:otherwise>
        <axsl:variable name="this-name">value</axsl:variable>
  ...
  <axsl:template match="hour-enum" mode="id2308778">
    <option xmlns="http://www.w3.org/1999/xhtml" value="{@value}">
      <axsl:if test="@value = ../@value">
        <axsl:attribute name="selected">selected</axsl:attribute>
      </axsl:if>
  ...
  <axsl:template match="minute" mode="id2308785">
    <axsl:choose>
      <axsl:when test="@value">
        <axsl:variable name="this-name">value</axsl:variable>
        <axsl:variable name="this-value" select="@value"/>
        <select xmlns="http://www.w3.org/1999/xhtml" name="{template:this-attribute()}">
                <axsl:apply-templates select="minute-enum" mode="id2308805"/>
              </select>
      </axsl:when>
      <axsl:otherwise>
        <axsl:variable name="this-name">value</axsl:variable>
  ...
  <axsl:template match="minute-enum" mode="id2308805">
    <option xmlns="http://www.w3.org/1999/xhtml" value="{@value}">
      <axsl:if test="@value = ../@value">
        <axsl:attribute name="selected">selected</axsl:attribute>
      </axsl:if>
  ...
  <axsl:template match="second" mode="id2308816">
    <axsl:choose>
      <axsl:when test="@value">
        <axsl:variable name="this-name">value</axsl:variable>
        <axsl:variable name="this-value" select="@value"/>
        <select xmlns="http://www.w3.org/1999/xhtml" name="{template:this-attribute()}">
                <axsl:apply-templates select="second-enum" mode="id2308833"/>
              </select>
      </axsl:when>
      <axsl:otherwise>
        <axsl:variable name="this-name">value</axsl:variable>
  ...
  <axsl:template match="second-enum" mode="id2308833">
    <option xmlns="http://www.w3.org/1999/xhtml" value="{@value}">
      <axsl:if test="@value = ../@value">
        <axsl:attribute name="selected">selected</axsl:attribute>
      </axsl:if>
  ...
  <axsl:template match="organizers" mode="id2308861">
    <axsl:apply-templates select="organizer" mode="id2308861"/>
  </axsl:template>
  <axsl:template match="organizer" mode="id2308861">
  ...
  <axsl:template match="attendees" mode="id2308954">
    <axsl:apply-templates select="attendee" mode="id2308954"/>
  </axsl:template>
  <axsl:template match="attendee" mode="id2308954">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-search" mode="id2309061">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="person-suggestions" mode="id2309105">
    <axsl:apply-templates select="card" mode="id2309105"/>
  </axsl:template>
  <axsl:template match="card" mode="id2309105">
    <tr xmlns="http://www.w3.org/1999/xhtml">
          <th/>
          <td colspan="2" xml:space="preserve">
            <axsl:apply-templates select="fn" mode="id2309125"/>
            <axsl:apply-templates select="email" mode="id2309157"/>
            <axsl:apply-templates select="uid" mode="id2309187"/>
  ...
  <axsl:template match="fn" mode="id2309125">
  ...
  <axsl:template match="email" mode="id2309157">
    <span xmlns="http://www.w3.org/1999/xhtml">
              &lt;<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>&gt;
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
  </axsl:template>
  <axsl:template match="uid" mode="id2309187">
    <span xmlns="http://www.w3.org/1999/xhtml">
              (<axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>)
              <axsl:choose><axsl:when test="@details"><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value" select="@details"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">details</axsl:variable><axsl:variable name="this-value"/><input type="hidden" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
            </span>
