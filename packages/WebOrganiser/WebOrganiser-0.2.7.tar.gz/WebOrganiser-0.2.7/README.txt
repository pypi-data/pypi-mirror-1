...
The applications in this distribution make use of sarissa.js from the Sarissa
distribution, release 0.9.8.1. Copies of this file are found in the
Resources/scripts directory within each application's package.
...
New in WebOrganiser 0.2.7 (Changes since WebOrganiser 0.2.6)
------------------------------------------------------------

  * Relicensed under the GPL version 3 or later.
  * Added Ubuntu Feisty (7.04) package support.

New in WebOrganiser 0.2.6 (Changes since WebOrganiser 0.2.5)
------------------------------------------------------------

  * Added the missing description field for events.
  * Updated dependencies to use RDFCalendar 0.2.4 which has improved multiline
    attribute handling.

New in WebOrganiser 0.2.5 (Changes since WebOrganiser 0.2.4)
------------------------------------------------------------

  * Introduced metadata filtering so that calendar views are not full of
    details about the editing of items unless this is desired.
  * Introduced free-busy item filtering, although such information should
    eventually be displayed somehow in the calendar view.
  * Made the Web interface always produce complete iCalendar download files.
