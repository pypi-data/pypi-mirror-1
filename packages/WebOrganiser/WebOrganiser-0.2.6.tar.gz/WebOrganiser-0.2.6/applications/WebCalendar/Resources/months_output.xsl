...
<axsl:stylesheet xmlns:dyn="http://exslt.org/dynamic" xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:template="http://www.boddie.org.uk/ns/xmltools/template" version="1.0" extension-element-prefixes="dyn">
  ...
  <axsl:template match="/">
    <axsl:apply-templates select="months" mode="id2273141"/>
  </axsl:template>
  <axsl:template match="months" mode="id2273141">
  ...
  <axsl:apply-templates select="directory" mode="id2278257"/>
</D:multistatus>
  </axsl:template>
  <axsl:template match="directory" mode="id2278257">
