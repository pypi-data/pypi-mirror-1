...
<axsl:stylesheet xmlns:dyn="http://exslt.org/dynamic" xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:template="http://www.boddie.org.uk/ns/xmltools/template" version="1.0" extension-element-prefixes="dyn">
  ...
  <axsl:template match="/">
    <axsl:apply-templates select="site" mode="id2335381"/>
  </axsl:template>
  <axsl:template match="site" mode="id2335381">
...
<body>
    ...
    <li class="what">
      ...
      <ul class="leftbox">
        <li class="events">
          ...
          <axsl:apply-templates select="events" mode="id2335496"/>
        ...
        <li class="people">
          ...
          <axsl:apply-templates select="cards" mode="id2335609"/>
      ...
      <ul class="rightbox">
        <li class="tasks">
          ...
          <axsl:apply-templates select="tasks" mode="id2335668"/>
        ...
        <li class="e-mails">
          ...
          <axsl:apply-templates select="e-mails" mode="id2335721"/>
        ...
        <li class="journals">
          ...
          <axsl:apply-templates select="journals" mode="id2335774"/>
          <p class="more"><a href="">(See more entries...)</a></p>
        </li>
      </ul>
    </li>
  ...
  <axsl:template match="events" mode="id2335496">
    <ul xmlns="http://www.w3.org/1999/xhtml">
            <axsl:apply-templates select="item" mode="id2335501"/>
          </ul>
  </axsl:template>
  <axsl:template match="item" mode="id2335501">
    <li xmlns="http://www.w3.org/1999/xhtml" class="vevent">
              <a href="" space="preserve">
                <axsl:apply-templates select="summary" mode="id2335519"/>
                (<axsl:apply-templates select="location" mode="id2335536"/>)
              </a>
              <p>
                <axsl:apply-templates select="dtstart" mode="id2335553"/>
                -
                <axsl:apply-templates select="dtend" mode="id2335569"/>
              </p>
            </li>
  </axsl:template>
  <axsl:template match="summary" mode="id2335519">
    <axsl:choose>
  ...
  <axsl:template match="location" mode="id2335536">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="dtstart" mode="id2335553">
    <axsl:choose>
  ...
  <axsl:template match="dtend" mode="id2335569">
    <axsl:choose>
      <axsl:when test="@datetime">
        <axsl:variable name="this-name">datetime</axsl:variable>
        <axsl:variable name="this-value" select="@datetime"/>
  ...
  <axsl:template match="cards" mode="id2335609">
    <ul xmlns="http://www.w3.org/1999/xhtml">
            <axsl:apply-templates select="item" mode="id2335614"/>
          </ul>
  </axsl:template>
  <axsl:template match="item" mode="id2335614">
    <li xmlns="http://www.w3.org/1999/xhtml">
              <a href="">
                <axsl:apply-templates select="fn" mode="id2335624"/>
              </a>
            </li>
  </axsl:template>
  <axsl:template match="fn" mode="id2335624">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="tasks" mode="id2335668">
    <ul xmlns="http://www.w3.org/1999/xhtml">
            <axsl:apply-templates select="item" mode="id2335673"/>
          </ul>
  </axsl:template>
  <axsl:template match="item" mode="id2335673">
    <li xmlns="http://www.w3.org/1999/xhtml">
              <a href="">
                <axsl:apply-templates select="summary" mode="id2335683"/>
              </a>
            </li>
  </axsl:template>
  <axsl:template match="summary" mode="id2335683">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="e-mails" mode="id2335721">
    <ul xmlns="http://www.w3.org/1999/xhtml">
            <axsl:apply-templates select="item" mode="id2335726"/>
          </ul>
  </axsl:template>
  <axsl:template match="item" mode="id2335726">
    <li xmlns="http://www.w3.org/1999/xhtml">
              <a href="">
                <axsl:apply-templates select="summary" mode="id2335736"/>
              </a>
            </li>
  </axsl:template>
  <axsl:template match="summary" mode="id2335736">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
  ...
  <axsl:template match="journals" mode="id2335774">
    <ul xmlns="http://www.w3.org/1999/xhtml">
            <axsl:apply-templates select="item" mode="id2335779"/>
          </ul>
  </axsl:template>
  <axsl:template match="item" mode="id2335779">
    <li xmlns="http://www.w3.org/1999/xhtml">
              <a href="">
                <axsl:apply-templates select="summary" mode="id2335789"/>
              </a>
            </li>
  </axsl:template>
  <axsl:template match="summary" mode="id2335789">
    <axsl:choose>
      <axsl:when test="@details">
        <axsl:variable name="this-name">details</axsl:variable>
        <axsl:variable name="this-value" select="@details"/>
