...
<axsl:stylesheet xmlns:dyn="http://exslt.org/dynamic" xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:template="http://www.boddie.org.uk/ns/xmltools/template" version="1.0" extension-element-prefixes="dyn">
    ...
    <axsl:for-each select="dyn:evaluate($element-path)">
      <tbody xmlns="http://www.w3.org/1999/xhtml" template:id="datetimes-node" id="{template:this-element()}">
        <tr>
          ...
          <axsl:apply-templates select="dtstart" mode="id2317121"/>
          <axsl:apply-templates select="dtend" mode="id2317457"/>
        </tr>
      </tbody>
    </axsl:for-each>
  </axsl:template>
  <axsl:template match="dtstart" mode="id2317121">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2317130"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2317130">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              ...
              <axsl:apply-templates select="week" mode="id2317365"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2317365">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2317375"/>
                </tr>
                <tr>
                  <!-- Highlight the day if marked. -->
                  <axsl:apply-templates select="day" mode="id2317413"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2317375">
  ...
  <axsl:template match="day" mode="id2317413">
  ...
  <axsl:template match="dtend" mode="id2317457">
    <td xmlns="http://www.w3.org/1999/xhtml" width="45%" class="calendar">
            <axsl:apply-templates select="month" mode="id2317465"/>
          </td>
  </axsl:template>
  <axsl:template match="month" mode="id2317465">
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" border="0" align="center">
              <thead>
                <tr>
                  <th colspan="3">
              ...
              <axsl:apply-templates select="week" mode="id2317692"/>
            </table>
  </axsl:template>
  <axsl:template match="week" mode="id2317692">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
                <tr>
                  <axsl:apply-templates select="day" mode="id2317702"/>
                </tr>
                <tr>
                  <!-- Highlight the day if marked. -->
                  <axsl:apply-templates select="day" mode="id2317740"/>
                </tr>
              </tbody>
  </axsl:template>
  <axsl:template match="day" mode="id2317702">
    <td xmlns="http://www.w3.org/1999/xhtml" class="day-header-fixed">
                    <axsl:choose><axsl:when test="@number"><axsl:variable name="this-name">number</axsl:variable><axsl:variable name="this-value" select="@number"/><axsl:value-of select="$this-value"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">number</axsl:variable><axsl:variable name="this-value"/><axsl:value-of select="$this-value"/></axsl:otherwise></axsl:choose>
                  </td>
  </axsl:template>
  <axsl:template match="day" mode="id2317740">
    <td xmlns="http://www.w3.org/1999/xhtml" class="day-minimum-fixed {template:choice(@marked = 'true', 'day-region')} {template:choice(@today = 'true', 'day-today')}">
