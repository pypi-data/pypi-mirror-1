...
interface:
  ...
  >>> from p01.widget.password.widget import PasswordConfirmationWidget
...
We also need to register the template for the widget:
  ...
  >>> import os
  >>> import p01.widget.password
  >>> def getPath(filename):
  ...     return os.path.join(os.path.dirname(p01.widget.password.__file__),
  ...     filename)
