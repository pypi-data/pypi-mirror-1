...
##parameters=basePath,levels=None,types=None,current=None,filter={}
##title=Create the list of sections to show in the navigation
##
    ...
    for part in pathElements:
        ...
        if hasItem(currentList, part):
            ...
            if processedParts == totalParts:
                ...
                # Move the placeholder to the right place; we didn't know what order to put it in before:
                del currentList[idx:idx + 1]
