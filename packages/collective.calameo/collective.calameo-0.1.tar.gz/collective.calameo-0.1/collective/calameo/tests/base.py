...
def setup_product():
    ...
    import collective.calameo
    zcml.load_config('configure.zcml', collective.calameo)
    ...
    ztc.installPackage('collective.calameo')
...
setup_product()
ptc.setupPloneSite(products=['collective.calameo'])
