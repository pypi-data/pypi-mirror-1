    ...
    for attrib in root.attrib:
        ...
        if child_type is str:
            ...
            if root.attrib[attrib] is None or len(root.attrib[attrib]) == 0:
                ...
                attrib_datetime = datetime.strptime(root.attrib[attrib], "%Y-%m-%d")
                attrib_date = date(attrib_datetime.year, attrib_datetime.month, attrib_datetime.day)
                setattr(obj, attrib, attrib_date)
        else:
        ...
        if len(child) == 0:
            ...
            if child_type is str:
                ...
                if child.text is None or len(child.text) == 0:
                    ...
                    attrib_datetime = datetime.strptime(child.text, "%Y-%m-%d")
                    attrib_date = date(attrib_datetime.year, attrib_datetime.month, attrib_datetime.day)
                    value = attrib_date
