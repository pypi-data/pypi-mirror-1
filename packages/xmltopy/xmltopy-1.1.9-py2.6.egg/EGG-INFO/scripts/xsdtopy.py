...
def go(schema_path, module_name, dependencies, generate_base_classes=False, generate_subclass_stubs=False):
    classes = []
    constant_classes = []
...
if __name__ == '__main__':
    opts, args = getopt.getopt(sys.argv[1:], 'f:d:bsn:')
    dependencies = {}
    ...
    go(schema_path, module_name, dependencies, generate_base_classes, generate_subclass_stubs)
