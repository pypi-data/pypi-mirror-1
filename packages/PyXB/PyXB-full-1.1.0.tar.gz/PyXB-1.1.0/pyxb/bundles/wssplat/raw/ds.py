...
# NSM:f1c343a882e7a65fb879f4ee813309f8231f28c8
# Generated 2009-11-30 18:08:44.997379 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:b0a89d9c-de0d-11de-a599-001cc05930fc')
...
SignatureMethodType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SignatureMethodType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'HMACOutputLength'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_strict, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
    ])
...
SPKIDataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SPKIDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SPKISexp'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SPKIDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SPKISexp'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
    ])
...
KeyValueType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=KeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DSAKeyValue'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=KeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'RSAKeyValue'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
RSAKeyValueType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RSAKeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Modulus'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=RSAKeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Exponent'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
X509DataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X509DataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'X509Certificate'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X509DataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'X509CRL'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X509DataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'X509SubjectName'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X509DataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'X509IssuerSerial'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X509DataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'X509SKI'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X509DataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'X509Certificate'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X509DataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'X509CRL'))),
...
KeyInfoType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=KeyInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SPKIData'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=KeyInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'MgmtData'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=KeyInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'KeyValue'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=KeyInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'RetrievalMethod'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=KeyInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'KeyName'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=KeyInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'X509Data'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=KeyInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PGPData'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=KeyInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SPKIData'))),
...
ObjectType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
...
RetrievalMethodType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RetrievalMethodType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Transforms'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
DigestMethodType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
    ])
})
...
ManifestType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ManifestType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Reference'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ManifestType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Reference'))),
    ])
...
ReferenceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Transforms'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DigestMethod'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DigestMethod'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DigestValue'))),
    ])
...
TransformsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TransformsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Transform'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TransformsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Transform'))),
    ])
...
X509IssuerSerialType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X509IssuerSerialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'X509IssuerName'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=X509IssuerSerialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'X509SerialNumber'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
SignaturePropertiesType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SignaturePropertiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SignatureProperty'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SignaturePropertiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SignatureProperty'))),
    ])
...
SignaturePropertyType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
...
TransformType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=TransformType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'XPath'))),
    ])
})
...
SignatureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SignatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SignedInfo'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SignatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Object'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SignatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SignatureValue'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SignatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'KeyInfo'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SignatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Object'))),
    ])
})


CanonicalizationMethodType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_strict, namespace_constraint=pyxb.binding.content.Wildcard.NC_any)),
    ])
})
...
SignedInfoType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SignedInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'CanonicalizationMethod'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SignedInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SignatureMethod'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SignedInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Reference'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SignedInfoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Reference'))),
    ])
...
PGPDataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=PGPDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PGPKeyID'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=PGPDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PGPKeyPacket'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=PGPDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PGPKeyPacket'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/2000/09/xmldsig#'))),
    ])
})
...
DSAKeyValueType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DSAKeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'P'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=DSAKeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'G'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=DSAKeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Y'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=DSAKeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Q'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
    ...
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=DSAKeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Seed'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=DSAKeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'J'))),
    ])
    ...
    , 7 : pyxb.binding.content.ContentModelState(state=7, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DSAKeyValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PgenCounter'))),
    ])
