...
# NSM:f939247c4eea3a1bfab0cd637226c9b45b17deb9
# Generated 2009-11-30 18:08:41.245433 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:ae65ed5a-de0d-11de-bad9-001cc05930fc')
...
Array_._ContentModel = pyxb.binding.content.ContentModel(state_map = {
...
Struct_._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=pyxb.binding.content.Wildcard.NC_any)),
    ])
})
