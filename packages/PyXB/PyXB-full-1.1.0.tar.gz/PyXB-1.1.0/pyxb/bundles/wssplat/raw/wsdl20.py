...
# NSM:19bbf5816d83775dc94d85cfc7c87689406810ec
# Generated 2009-11-30 18:08:33.498761 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:a9c530bc-de0d-11de-a90e-001cc05930fc')
...
class ElementReferenceType (pyxb.binding.basis.STD_union):
    ...
    _MemberTypes = ( pyxb.binding.datatypes.QName, STD_ANON_1, )
...
ElementReferenceType.any = u'#any'                # originally STD_ANON_1.any
ElementReferenceType.none = u'#none'              # originally STD_ANON_1.none
ElementReferenceType.other = u'#other'            # originally STD_ANON_1.other
...
class InterfaceType (ExtensibleDocumentedType):
    ...
    __styleDefault = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'styleDefault'), 'styleDefault', '__httpwww_w3_orgnswsdl_InterfaceType_styleDefault', STD_ANON_3)
...
DocumentedType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=DocumentedType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
    ])
})


ExtensibleDocumentedType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=ExtensibleDocumentedType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
    ])
})


EndpointType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=EndpointType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
...
ImportType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=ImportType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_strict, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_strict, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
...
IncludeType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=IncludeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_strict, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_strict, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
...
InterfaceFaultType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=InterfaceFaultType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
...
DescriptionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'import'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'service'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'include'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'types'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'interface'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'binding'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'import'))),
...
BindingFaultType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=BindingFaultType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
...
InterfaceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=InterfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InterfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'operation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InterfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'fault'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InterfaceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'operation'))),
...
BindingOperationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BindingOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'output'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BindingOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'infault'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BindingOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'input'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BindingOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'outfault'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=BindingOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BindingOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'output'))),
...
BindingType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=BindingType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BindingType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'operation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BindingType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'fault'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BindingType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'operation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BindingType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'fault'))),
...
ServiceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=ServiceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ServiceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'endpoint'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ServiceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'endpoint'))),
...
BindingOperationMessageType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=BindingOperationMessageType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
...
MessageRefType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=MessageRefType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
...
BindingOperationFaultType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=BindingOperationFaultType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
...
MessageRefFaultType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=MessageRefFaultType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
...
TypesType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=TypesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_strict, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_strict, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
...
InterfaceOperationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=InterfaceOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InterfaceOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'input'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InterfaceOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'output'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InterfaceOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'infault'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InterfaceOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'outfault'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, term=pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'http://www.w3.org/ns/wsdl'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InterfaceOperationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'output'))),
...
DocumentationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
