...
# NSM:85f4207e01e7d893444721d35c9ca66d19225092
# Generated 2009-11-30 18:11:43.762466 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:19bf67d4-de0e-11de-a14c-001cc05930fc')
...
CityFurnitureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod3Geometry'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'_GenericApplicationPropertyOfCityObject'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=15, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfCityFurniture'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'externalReference'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'class'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'terminationDate'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'function'))),
        pyxb.binding.content.ContentModelTransition(next_state=19, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod1Geometry'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod2Geometry'))),
        pyxb.binding.content.ContentModelTransition(next_state=14, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=17, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod1TerrainIntersection'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod2TerrainIntersection'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod3TerrainIntersection'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod4Geometry'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod1ImplicitRepresentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=13, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod2ImplicitRepresentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=18, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod3ImplicitRepresentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=15, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod4ImplicitRepresentation'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'generalizesTo'))),
        pyxb.binding.content.ContentModelTransition(next_state=16, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lod4TerrainIntersection'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=CityFurnitureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/citygml/1.0'), u'creationDate'))),
    ])
