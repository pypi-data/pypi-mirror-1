...
# NSM:4eab4d25f54c999b91cd172921f2cc6ee7e6addb
# Generated 2009-11-30 18:11:24.568831 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:0e3a1bac-de0e-11de-8e6f-001cc05930fc')
...
WrapModeType.none = WrapModeType._CF_enumeration.addEnumeration(unicode_value=u'none')
WrapModeType.wrap = WrapModeType._CF_enumeration.addEnumeration(unicode_value=u'wrap')
WrapModeType.mirror = WrapModeType._CF_enumeration.addEnumeration(unicode_value=u'mirror')
WrapModeType.clamp = WrapModeType._CF_enumeration.addEnumeration(unicode_value=u'clamp')
WrapModeType.border = WrapModeType._CF_enumeration.addEnumeration(unicode_value=u'border')
...
class SurfaceDataPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netcitygmlappearance1_0_SurfaceDataPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netcitygmlappearance1_0_SurfaceDataPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_1 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __srsName = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'srsName'), 'srsName', '__httpwww_opengis_netcitygmlappearance1_0_CTD_ANON_1_srsName', pyxb.binding.datatypes.anyURI)
    ...
    __axisLabels = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'axisLabels'), 'axisLabels', '__httpwww_opengis_netcitygmlappearance1_0_CTD_ANON_1_axisLabels', pyxb.bundles.opengis.gml.NCNameList)
    ...
    __srsDimension = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'srsDimension'), 'srsDimension', '__httpwww_opengis_netcitygmlappearance1_0_CTD_ANON_1_srsDimension', pyxb.binding.datatypes.positiveInteger)
    ...
    __uomLabels = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uomLabels'), 'uomLabels', '__httpwww_opengis_netcitygmlappearance1_0_CTD_ANON_1_uomLabels', pyxb.bundles.opengis.gml.NCNameList)
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ring = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ring'), 'ring', '__httpwww_opengis_netcitygmlappearance1_0_CTD_ANON_2_ring', pyxb.binding.datatypes.anyURI, required=True)
...
class TextureAssociationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netcitygmlappearance1_0_TextureAssociationType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netcitygmlappearance1_0_TextureAssociationType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
AbstractSurfaceDataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isFront'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractSurfaceDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
...
X3DMaterialType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ambientIntensity'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfX3DMaterial'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'transparency'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isFront'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'diffuseColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'emissiveColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'specularColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'shininess'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isSmooth'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=X3DMaterialType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
...
AbstractTextureParameterizationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=AbstractTextureParameterizationType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureParameterizationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTextureParameterization'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractTextureParameterizationType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractTextureParameterizationType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureParameterizationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTextureParameterization'))),
    ])
...
SurfaceDataPropertyType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SurfaceDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_SurfaceData'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
AppearancePropertyType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AppearancePropertyType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'_Feature'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AppearancePropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Appearance'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AppearancePropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Appearance'))),
    ])
...
AbstractTextureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'imageURI'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isFront'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
    ])
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wrapMode'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mimeType'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureType'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'borderColor'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AbstractTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'borderColor'))),
...
AppearanceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surfaceDataMember'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfAppearance'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'theme'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surfaceDataMember'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AppearanceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfAppearance'))),
...
TexCoordGenType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'worldToTexture'), CTD_ANON_1, scope=TexCoordGenType))
...
TexCoordGenType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TexCoordGenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'worldToTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=TexCoordGenType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TexCoordGenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTextureParameterization'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TexCoordGenType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TexCoordGenType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TexCoordGenType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexCoordGen'))),
    ])
...
GeoreferencedTextureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'imageURI'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isFront'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=12, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'imageURI'))),
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfGeoreferencedTexture'))),
    ])
    ...
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'orientation'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfGeoreferencedTexture'))),
    ])
    , 7 : pyxb.binding.content.ContentModelState(state=7, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'orientation'))),
        pyxb.binding.content.ContentModelTransition(next_state=13, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfGeoreferencedTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wrapMode'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mimeType'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureType'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'referencePoint'))),
        pyxb.binding.content.ContentModelTransition(next_state=13, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'borderColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'preferWorldFile'))),
    ])
    , 8 : pyxb.binding.content.ContentModelState(state=8, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=13, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=GeoreferencedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'referencePoint'))),
...
TexCoordListType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'textureCoordinates'), CTD_ANON_2, scope=TexCoordListType))
...
TexCoordListType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=TexCoordListType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TexCoordListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTextureParameterization'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=TexCoordListType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=TexCoordListType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TexCoordListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureCoordinates'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TexCoordListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTextureParameterization'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TexCoordListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureCoordinates'))),
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TexCoordListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureCoordinates'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TexCoordListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexCoordList'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TexCoordListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexCoordList'))),
    ])
...
TextureAssociationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TextureAssociationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_TextureParameterization'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
ParameterizedTextureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'imageURI'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isFront'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfParameterizedTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=11, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfSurfaceData'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'imageURI'))),
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfParameterizedTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'borderColor'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wrapMode'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mimeType'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'target'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfParameterizedTexture'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'textureType'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'borderColor'))),
    ])
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ParameterizedTextureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'_GenericApplicationPropertyOfTexture'))),
