...
# NGM:74d7865bc281d02523b2e79f08defec82904da9c
# Incorporated namespaces:
#  http://purl.org/dc/terms/ dct
#  http://www.opengis.net/cat/csw/2.0.2 None
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:0d5f1dcc-de0e-11de-b722-001cc05930fc')
...
_Namespace_dc = pyxb.namespace.NamespaceForURI(u'http://purl.org/dc/elements/1.1/', create_if_missing=True)
...
class DCMIRecordType (AbstractRecordType):
    ...
    __DC_element = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(_Namespace_dc, u'DC-element'), 'DC_element', '__httpwww_opengis_netcatcsw2_0_2_DCMIRecordType_httppurl_orgdcelements1_1DC_element', True)
...
class BriefRecordType (AbstractRecordType):
    ...
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(_Namespace_dc, u'identifier'), 'identifier', '__httpwww_opengis_netcatcsw2_0_2_BriefRecordType_httppurl_orgdcelements1_1identifier', True)
    ...
    __type = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(_Namespace_dc, u'type'), 'type', '__httpwww_opengis_netcatcsw2_0_2_BriefRecordType_httppurl_orgdcelements1_1type', False)
    ...
    __title = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(_Namespace_dc, u'title'), 'title', '__httpwww_opengis_netcatcsw2_0_2_BriefRecordType_httppurl_orgdcelements1_1title', True)
...
class SummaryRecordType (AbstractRecordType):
    ...
    # Element {http://purl.org/dc/elements/1.1/}type uses Python identifier type
    __type = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(_Namespace_dc, u'type'), 'type', '__httpwww_opengis_netcatcsw2_0_2_SummaryRecordType_httppurl_orgdcelements1_1type', False)
    ...
    __subject = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(_Namespace_dc, u'subject'), 'subject', '__httpwww_opengis_netcatcsw2_0_2_SummaryRecordType_httppurl_orgdcelements1_1subject', True)
    ...
    __format = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(_Namespace_dc, u'format'), 'format', '__httpwww_opengis_netcatcsw2_0_2_SummaryRecordType_httppurl_orgdcelements1_1format', True)
    ...
    __relation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(_Namespace_dc, u'relation'), 'relation', '__httpwww_opengis_netcatcsw2_0_2_SummaryRecordType_httppurl_orgdcelements1_1relation', True)
    ...
    # Element {http://purl.org/dc/elements/1.1/}identifier uses Python identifier identifier
    __identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(_Namespace_dc, u'identifier'), 'identifier', '__httpwww_opengis_netcatcsw2_0_2_SummaryRecordType_httppurl_orgdcelements1_1identifier', True)
    ...
    # Element {http://purl.org/dc/elements/1.1/}title uses Python identifier title
    __title = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(_Namespace_dc, u'title'), 'title', '__httpwww_opengis_netcatcsw2_0_2_SummaryRecordType_httppurl_orgdcelements1_1title', True)
...
DCMIRecordType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_dc, u'DC-element'), pyxb.bundles.opengis._dc.SimpleLiteral, abstract=pyxb.binding.datatypes.boolean(1), scope=DCMIRecordType))
DCMIRecordType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=DCMIRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'DC-element'))),
    ])
})
...
RecordType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace, u'AnyText'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=RecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'DC-element'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_ows, u'BoundingBox'))),
    ])
...
BriefRecordType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_dc, u'identifier'), pyxb.bundles.opengis._dc.SimpleLiteral, scope=BriefRecordType, documentation=u'An unambiguous reference to the resource within a given context. \n      Recommended best practice is to identify the resource by means of a \n      string or number conforming to a formal identification system. Formal \n      identification systems include but are not limited to the Uniform \n      Resource Identifier (URI) (including the Uniform Resource Locator \n      (URL)), the Digital Object Identifier (DOI), and the International \n      Standard Book Number (ISBN).'))

BriefRecordType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_dc, u'type'), pyxb.bundles.opengis._dc.SimpleLiteral, scope=BriefRecordType, documentation=u'The nature or genre of the content of the resource. Type includes \n      terms describing general categories, functions, genres, or aggregation \n      levels for content. Recommended best practice is to select a value \n      from a controlled vocabulary (for example, the DCMI Type Vocabulary). \n      To describe the physical or digital manifestation of the resource, \n      use the Format element.'))

BriefRecordType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_dc, u'title'), pyxb.bundles.opengis._dc.SimpleLiteral, scope=BriefRecordType, documentation=u'A name given to the resource. Typically, Title will be a name by \n      which the resource is formally known.'))
BriefRecordType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=BriefRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BriefRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_ows, u'BoundingBox'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=BriefRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'identifier'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=BriefRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'title'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BriefRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_ows, u'BoundingBox'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=BriefRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'type'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=BriefRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'title'))),
    ])
})
...
SummaryRecordType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_dc, u'type'), pyxb.bundles.opengis._dc.SimpleLiteral, scope=SummaryRecordType, documentation=u'The nature or genre of the content of the resource. Type includes \n      terms describing general categories, functions, genres, or aggregation \n      levels for content. Recommended best practice is to select a value \n      from a controlled vocabulary (for example, the DCMI Type Vocabulary). \n      To describe the physical or digital manifestation of the resource, \n      use the Format element.'))
...
SummaryRecordType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_dc, u'subject'), pyxb.bundles.opengis._dc.SimpleLiteral, scope=SummaryRecordType, documentation=u'A topic of the content of the resource. Typically, Subject will be \n      expressed as keywords, key phrases, or classification codes that \n      describe a topic of the resource. Recommended best practice is to \n      select a value from a controlled vocabulary or formal classification \n      scheme.'))
...
SummaryRecordType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_dc, u'format'), pyxb.bundles.opengis._dc.SimpleLiteral, scope=SummaryRecordType, documentation=u'The physical or digital manifestation of the resource. Typically, \n      Format will include the media-type or dimensions of the resource. \n      Format may be used to identify the software, hardware, or other \n      equipment needed to display or operate the resource. Examples of \n      dimensions include size and duration. Recommended best practice is to \n      select a value from a controlled vocabulary (for example, the list \n      of Internet Media Types defining computer media formats).'))

SummaryRecordType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_dc, u'relation'), pyxb.bundles.opengis._dc.SimpleLiteral, scope=SummaryRecordType, documentation=u'A reference to a related resource. Recommended best practice is to \n      identify the referenced resource by means of a string or number \n      conforming to a formal identification system.'))

SummaryRecordType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_dc, u'identifier'), pyxb.bundles.opengis._dc.SimpleLiteral, scope=SummaryRecordType, documentation=u'An unambiguous reference to the resource within a given context. \n      Recommended best practice is to identify the resource by means of a \n      string or number conforming to a formal identification system. Formal \n      identification systems include but are not limited to the Uniform \n      Resource Identifier (URI) (including the Uniform Resource Locator \n      (URL)), the Digital Object Identifier (DOI), and the International \n      Standard Book Number (ISBN).'))
...
SummaryRecordType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_dc, u'title'), pyxb.bundles.opengis._dc.SimpleLiteral, scope=SummaryRecordType, documentation=u'A name given to the resource. Typically, Title will be a name by \n      which the resource is formally known.'))
...
SummaryRecordType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dct, u'spatial'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'subject'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_ows, u'BoundingBox'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'format'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'relation'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dct, u'modified'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dct, u'abstract'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'identifier'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'title'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'type'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'format'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dc, u'subject'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_ows, u'BoundingBox'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SummaryRecordType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_dct, u'spatial'))),
