# ./pyxb/bundles/opengis/raw/ows_1_1.py
# PyXB bindings for NamespaceModule
# NSM:30267ec97faf153699f3ab2e8f18d125f769245d
# Generated 2009-11-30 18:10:49.174475 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:fa24f34e-de0d-11de-8e3b-001cc05930fc')
...
class CTD_ANON_1 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Range = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Range'), 'Range', '__httpwww_opengis_netows1_1_CTD_ANON_1_httpwww_opengis_netows1_1Range', True)
    ...
    __Value = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Value'), 'Value', '__httpwww_opengis_netows1_1_CTD_ANON_1_httpwww_opengis_netows1_1Value', True)
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Exception = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Exception'), 'Exception', '__httpwww_opengis_netows1_1_CTD_ANON_2_httpwww_opengis_netows1_1Exception', True)
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_opengis_netows1_1_CTD_ANON_2_version', STD_ANON_1, required=True)
    ...
    __lang = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.XML, 'lang'), 'lang', '__httpwww_opengis_netows1_1_CTD_ANON_2_httpwww_w3_orgXML1998namespacelang', pyxb.binding.xml_.STD_ANON_lang)
...
class CTD_ANON_3 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __HTTP = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'HTTP'), 'HTTP', '__httpwww_opengis_netows1_1_CTD_ANON_3_httpwww_opengis_netows1_1HTTP', False)
...
class MetadataType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netows1_1_MetadataType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netows1_1_MetadataType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_4 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ServiceContact = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ServiceContact'), 'ServiceContact', '__httpwww_opengis_netows1_1_CTD_ANON_4_httpwww_opengis_netows1_1ServiceContact', False)
    ...
    __ProviderName = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ProviderName'), 'ProviderName', '__httpwww_opengis_netows1_1_CTD_ANON_4_httpwww_opengis_netows1_1ProviderName', False)
    ...
    __ProviderSite = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ProviderSite'), 'ProviderSite', '__httpwww_opengis_netows1_1_CTD_ANON_4_httpwww_opengis_netows1_1ProviderSite', False)
...
class OnlineResourceType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netows1_1_OnlineResourceType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netows1_1_OnlineResourceType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_5 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Post = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Post'), 'Post', '__httpwww_opengis_netows1_1_CTD_ANON_5_httpwww_opengis_netows1_1Post', True)
    ...
    __Get = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Get'), 'Get', '__httpwww_opengis_netows1_1_CTD_ANON_5_httpwww_opengis_netows1_1Get', True)
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ExtendedCapabilities = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ExtendedCapabilities'), 'ExtendedCapabilities', '__httpwww_opengis_netows1_1_CTD_ANON_6_httpwww_opengis_netows1_1ExtendedCapabilities', False)
    ...
    __Operation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Operation'), 'Operation', '__httpwww_opengis_netows1_1_CTD_ANON_6_httpwww_opengis_netows1_1Operation', True)
    ...
    # Element {http://www.opengis.net/ows/1.1}Constraint uses Python identifier Constraint
    __Constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Constraint'), 'Constraint', '__httpwww_opengis_netows1_1_CTD_ANON_6_httpwww_opengis_netows1_1Constraint', True)
    ...
    __Parameter = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Parameter'), 'Parameter', '__httpwww_opengis_netows1_1_CTD_ANON_6_httpwww_opengis_netows1_1Parameter', True)
...
class CTD_ANON_9 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/ows/1.1}Metadata uses Python identifier Metadata
    __Metadata = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Metadata'), 'Metadata', '__httpwww_opengis_netows1_1_CTD_ANON_9_httpwww_opengis_netows1_1Metadata', True)
    ...
    __DCP = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DCP'), 'DCP', '__httpwww_opengis_netows1_1_CTD_ANON_9_httpwww_opengis_netows1_1DCP', True)
    ...
    # Element {http://www.opengis.net/ows/1.1}Parameter uses Python identifier Parameter
    __Parameter = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Parameter'), 'Parameter', '__httpwww_opengis_netows1_1_CTD_ANON_9_httpwww_opengis_netows1_1Parameter', True)
    ...
    # Element {http://www.opengis.net/ows/1.1}Constraint uses Python identifier Constraint
    __Constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Constraint'), 'Constraint', '__httpwww_opengis_netows1_1_CTD_ANON_9_httpwww_opengis_netows1_1Constraint', True)
    ...
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpwww_opengis_netows1_1_CTD_ANON_9_name', pyxb.binding.datatypes.string, required=True)
...
class CTD_ANON_10 (DescriptionType):
    ...
    __Fees = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Fees'), 'Fees', '__httpwww_opengis_netows1_1_CTD_ANON_10_httpwww_opengis_netows1_1Fees', False)
    ...
    __AccessConstraints = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'), 'AccessConstraints', '__httpwww_opengis_netows1_1_CTD_ANON_10_httpwww_opengis_netows1_1AccessConstraints', True)
    ...
    __ServiceTypeVersion = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ServiceTypeVersion'), 'ServiceTypeVersion', '__httpwww_opengis_netows1_1_CTD_ANON_10_httpwww_opengis_netows1_1ServiceTypeVersion', True)
    ...
    __Profile = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Profile'), 'Profile', '__httpwww_opengis_netows1_1_CTD_ANON_10_httpwww_opengis_netows1_1Profile', True)
    ...
    __ServiceType = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ServiceType'), 'ServiceType', '__httpwww_opengis_netows1_1_CTD_ANON_10_httpwww_opengis_netows1_1ServiceType', False)
...
class AbstractReferenceBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netows1_1_AbstractReferenceBaseType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netows1_1_AbstractReferenceBaseType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_11 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.opengis.net/ows/1.1}reference uses Python identifier reference
    __reference = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'reference'), 'reference', '__httpwww_opengis_netows1_1_CTD_ANON_11_httpwww_opengis_netows1_1reference', pyxb.binding.datatypes.anyURI, required=True)
...
ExceptionReport = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ExceptionReport'), CTD_ANON_2, documentation=u'Report message returned to the client that requested any OWS operation when the server detects an error while processing that operation request. ')
...
AllowedValues = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AllowedValues'), CTD_ANON_1, documentation=u'List of all the valid values and/or ranges of values for this quantity. For numeric quantities, signed values should be ordered from negative infinity to positive infinity. ')
Namespace.addCategoryObject('elementBinding', AllowedValues.name().localName(), AllowedValues)

ServiceProvider = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceProvider'), CTD_ANON_4, documentation=u'Metadata about the organization that provides this specific service instance or server. ')
...
OperationsMetadata = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'OperationsMetadata'), CTD_ANON_6, documentation=u'Metadata about the operations and related abilities specified by this service and implemented by this server, including the URLs for operation requests. The basic contents of this section shall be the same for all OWS types, but individual services can add elements and/or change the optionality of optional elements. ')
...
AnyValue = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AnyValue'), CTD_ANON_7, documentation=u'Specifies that any value is allowed for this parameter.')
...
NoValues = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'NoValues'), CTD_ANON_8, documentation=u'Specifies that no values are allowed for this parameter or quantity.')
Namespace.addCategoryObject('elementBinding', NoValues.name().localName(), NoValues)

Operation = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Operation'), CTD_ANON_9, documentation=u'Metadata for one operation that this server implements. ')
...
ServiceIdentification = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceIdentification'), CTD_ANON_10, documentation=u'General metadata for this specific server. This XML Schema of this section shall be the same for all OWS. ')
...
ValuesReference = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ValuesReference'), CTD_ANON_11, documentation=u'Reference to externally specified list of all the valid values and/or ranges of values for this quantity. (Informative: This element was simplified from the metaDataProperty element in GML 3.0.) ')
...
ManifestType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ManifestType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ManifestType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ReferenceGroup'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ManifestType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
...
CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Range'), RangeType, scope=CTD_ANON_1))

CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Value'), ValueType, scope=CTD_ANON_1))
CTD_ANON_1._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Value'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Range'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Value'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Range'))),
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Exception'), ExceptionType, scope=CTD_ANON_2))
CTD_ANON_2._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Exception'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Exception'))),
    ])
...
CTD_ANON_3._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'HTTP'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
UnNamedDomainType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'NoValues'), CTD_ANON_8, scope=UnNamedDomainType, documentation=u'Specifies that no values are allowed for this parameter or quantity.'))

UnNamedDomainType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ValuesReference'), CTD_ANON_11, scope=UnNamedDomainType, documentation=u'Reference to externally specified list of all the valid values and/or ranges of values for this quantity. (Informative: This element was simplified from the metaDataProperty element in GML 3.0.) '))
...
UnNamedDomainType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AnyValue'), CTD_ANON_7, scope=UnNamedDomainType, documentation=u'Specifies that any value is allowed for this parameter.'))

UnNamedDomainType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AllowedValues'), CTD_ANON_1, scope=UnNamedDomainType, documentation=u'List of all the valid values and/or ranges of values for this quantity. For numeric quantities, signed values should be ordered from negative infinity to positive infinity. '))
UnNamedDomainType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'NoValues'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ValuesReference'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AnyValue'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AllowedValues'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'UOM'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ReferenceSystem'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Meaning'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DataType'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'UOM'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ReferenceSystem'))),
    ...
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'UOM'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DefaultValue'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ReferenceSystem'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Meaning'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=UnNamedDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DataType'))),
...
DomainType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'NoValues'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ValuesReference'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AnyValue'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AllowedValues'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'UOM'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ReferenceSystem'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Meaning'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DataType'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'UOM'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ReferenceSystem'))),
    ...
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'UOM'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DefaultValue'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ReferenceSystem'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Meaning'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DataType'))),
...
CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceContact'), ResponsiblePartySubsetType, scope=CTD_ANON_4, documentation=u'Information for contacting the service provider. The OnlineResource element within this ServiceContact element should not be used to reference a web site of the service provider. '))

CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProviderName'), pyxb.binding.datatypes.string, scope=CTD_ANON_4, documentation=u'A unique identifier for the service provider organization. '))

CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProviderSite'), OnlineResourceType, scope=CTD_ANON_4, documentation=u'Reference to the most relevant web site of the service provider. '))
CTD_ANON_4._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProviderName'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProviderSite'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceContact'))),
    ])
...
CTD_ANON_5._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Get'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Post'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Get'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Post'))),
...
CapabilitiesBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'OperationsMetadata'), CTD_ANON_6, scope=CapabilitiesBaseType, documentation=u'Metadata about the operations and related abilities specified by this service and implemented by this server, including the URLs for operation requests. The basic contents of this section shall be the same for all OWS types, but individual services can add elements and/or change the optionality of optional elements. '))

CapabilitiesBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceIdentification'), CTD_ANON_10, scope=CapabilitiesBaseType, documentation=u'General metadata for this specific server. This XML Schema of this section shall be the same for all OWS. '))

CapabilitiesBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceProvider'), CTD_ANON_4, scope=CapabilitiesBaseType, documentation=u'Metadata about the organization that provides this specific service instance or server. '))
CapabilitiesBaseType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CapabilitiesBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OperationsMetadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CapabilitiesBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceProvider'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CapabilitiesBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OperationsMetadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CapabilitiesBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceProvider'))),
...
ContactType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ContactType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ContactInstructions'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ContactType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'HoursOfService'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ContactType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Address'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ContactType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OnlineResource'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ContactType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ContactInstructions'))),
...
CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ExtendedCapabilities'), pyxb.binding.datatypes.anyType, scope=CTD_ANON_6, documentation=u'Individual software vendors and servers can use this element to provide metadata about any additional server abilities. '))

CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Operation'), CTD_ANON_9, scope=CTD_ANON_6, documentation=u'Metadata for one operation that this server implements. '))

CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Constraint'), DomainType, scope=CTD_ANON_6, documentation=u'Optional unordered list of valid domain constraints on non-parameter quantities that each apply to this server. The list of required and optional constraints shall be specified in the Implementation Specification for this service. '))

CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Parameter'), DomainType, scope=CTD_ANON_6, documentation=u'Optional unordered list of parameter valid domains that each apply to one or more operations which this server interface implements. The list of required and optional parameter domain limitations shall be specified in the Implementation Specification for this service. '))
CTD_ANON_6._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operation'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operation'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operation'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ExtendedCapabilities'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Parameter'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Constraint'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Parameter'))),
...
CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Metadata'), MetadataType, scope=CTD_ANON_9))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DCP'), CTD_ANON_3, scope=CTD_ANON_9, documentation=u'Information for one distributed Computing Platform (DCP) supported for this operation. At present, only the HTTP DCP is defined, so this element only includes the HTTP element.\n'))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Parameter'), DomainType, scope=CTD_ANON_9, documentation=u'Optional unordered list of parameter domains that each apply to this operation which this server implements. If one of these Parameter elements has the same "name" attribute as a Parameter element in the OperationsMetadata element, this Parameter element shall override the other one for this operation. The list of required and optional parameter domain limitations for this operation shall be specified in the Implementation Specification for this service. '))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Constraint'), DomainType, scope=CTD_ANON_9, documentation=u'Optional unordered list of valid domain constraints on non-parameter quantities that each apply to this operation. If one of these Constraint elements has the same "name" attribute as a Constraint element in the OperationsMetadata element, this Constraint element shall override the other one for this operation. The list of required and optional constraints for this operation shall be specified in the Implementation Specification for this service. '))
CTD_ANON_9._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DCP'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DCP'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Constraint'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Parameter'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Constraint'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Parameter'))),
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Fees'), pyxb.binding.datatypes.string, scope=CTD_ANON_10, documentation=u'Fees and terms for retrieving data from or otherwise using this server, including the monetary units as specified in ISO 4217. The reserved value NONE (case insensitive) shall be used to mean no fees or terms. '))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'), pyxb.binding.datatypes.string, scope=CTD_ANON_10, documentation=u'Access constraint applied to assure the protection of privacy or intellectual property, or any other restrictions on retrieving or using data from or otherwise using this server. The reserved value NONE (case insensitive) shall be used to mean no access constraints are imposed. '))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceTypeVersion'), VersionType, scope=CTD_ANON_10, documentation=u'Unordered list of one or more versions of this service type implemented by this server. This information is not adequate for version negotiation, and shall not be used for that purpose. '))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Profile'), pyxb.binding.datatypes.anyURI, scope=CTD_ANON_10, documentation=u'Unordered list of identifiers of Application Profiles that are implemented by this server. This element should be included for each specified application profile implemented by this server. The identifier value should be specified by each Application Profile. If this element is omitted, no meaning is implied. '))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceType'), CodeType, scope=CTD_ANON_10, documentation=u'A service type name from a registry of services. For example, the values of the codeSpace URI and name and code string may be "OGC" and "catalogue." This type name is normally used for machine-to-machine communication. '))
CTD_ANON_10._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Title'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Keywords'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceType'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceTypeVersion'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Fees'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceTypeVersion'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Profile'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Fees'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'))),
...
ResponsiblePartyType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'IndividualName'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PositionName'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OrganisationName'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Role'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ContactInfo'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OrganisationName'))),
...
ReferenceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Format'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Format'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
...
ServiceReferenceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ServiceReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ServiceReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ServiceReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Format'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ServiceReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'RequestMessageReference'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ServiceReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ServiceReferenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'RequestMessage'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
...
ReferenceGroupType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ReferenceGroupType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ReferenceGroupType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ReferenceGroupType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractReferenceBase'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ReferenceGroupType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractReferenceBase'))),
    ])
...
ResponsiblePartySubsetType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ResponsiblePartySubsetType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Role'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ResponsiblePartySubsetType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ContactInfo'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=ResponsiblePartySubsetType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PositionName'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ResponsiblePartySubsetType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Role'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ResponsiblePartySubsetType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ContactInfo'))),
...
AddressType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AddressType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PostalCode'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AddressType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AdministrativeArea'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AddressType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'City'))),
