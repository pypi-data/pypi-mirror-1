...
# NSM:fde543a00b9681daae05bbc5a17f3dce9cfacb0c
# Generated 2009-11-30 18:11:20.683699 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
SimpleLiteral._ContentModel = pyxb.binding.content.ContentModel(state_map = {
...
elementContainer._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=elementContainer._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DC-element'))),
    ])
})
