...
# NSM:6a2dbc65b53dd34df1735f2f95a5cdb99288cc6f
# Generated 2009-11-30 18:10:33.147388 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:f126b4b2-de0d-11de-bb56-001cc05930fc')
...
ClassificationType.U = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'U')
ClassificationType.C = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'C')
ClassificationType.S = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'S')
ClassificationType.TS = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'TS')
ClassificationType.R = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'R')
ClassificationType.CTS = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'CTS')
ClassificationType.CTS_B = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'CTS-B')
ClassificationType.CTS_BALK = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'CTS-BALK')
ClassificationType.NU = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'NU')
ClassificationType.NR = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'NR')
ClassificationType.NC = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'NC')
ClassificationType.NS = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'NS')
ClassificationType.NS_S = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'NS-S')
ClassificationType.NS_A = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'NS-A')
ClassificationType.CTSA = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'CTSA')
ClassificationType.NSAT = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'NSAT')
ClassificationType.NCA = ClassificationType._CF_enumeration.addEnumeration(unicode_value=u'NCA')
