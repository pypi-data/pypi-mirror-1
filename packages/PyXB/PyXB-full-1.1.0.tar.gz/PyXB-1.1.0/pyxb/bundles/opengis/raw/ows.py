...
# NSM:0eaa86ae32cb3080e2342e92c025f322bb8eca15
# Generated 2009-11-30 18:10:47.062691 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:f93d674a-de0d-11de-9bfe-001cc05930fc')
...
class CTD_ANON_1 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/ows}Metadata uses Python identifier Metadata
    __Metadata = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Metadata'), 'Metadata', '__httpwww_opengis_netows_CTD_ANON_1_httpwww_opengis_netowsMetadata', True)
    ...
    __DCP = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DCP'), 'DCP', '__httpwww_opengis_netows_CTD_ANON_1_httpwww_opengis_netowsDCP', True)
    ...
    __Parameter = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Parameter'), 'Parameter', '__httpwww_opengis_netows_CTD_ANON_1_httpwww_opengis_netowsParameter', True)
    ...
    __Constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Constraint'), 'Constraint', '__httpwww_opengis_netows_CTD_ANON_1_httpwww_opengis_netowsConstraint', True)
    ...
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpwww_opengis_netows_CTD_ANON_1_name', pyxb.binding.datatypes.string, required=True)
...
class MetadataType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netows_MetadataType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netows_MetadataType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __HTTP = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'HTTP'), 'HTTP', '__httpwww_opengis_netows_CTD_ANON_2_httpwww_opengis_netowsHTTP', False)
...
class CTD_ANON_3 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Exception = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Exception'), 'Exception', '__httpwww_opengis_netows_CTD_ANON_3_httpwww_opengis_netowsException', True)
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_opengis_netows_CTD_ANON_3_version', pyxb.binding.datatypes.string, required=True)
    ...
    __language = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'language'), 'language', '__httpwww_opengis_netows_CTD_ANON_3_language', pyxb.binding.datatypes.language)
...
class OnlineResourceType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netows_OnlineResourceType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netows_OnlineResourceType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_4 (DescriptionType):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = None
    ...
    __ServiceType = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ServiceType'), 'ServiceType', '__httpwww_opengis_netows_CTD_ANON_4_httpwww_opengis_netowsServiceType', False)
    ...
    __AccessConstraints = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'), 'AccessConstraints', '__httpwww_opengis_netows_CTD_ANON_4_httpwww_opengis_netowsAccessConstraints', True)
    ...
    __ServiceTypeVersion = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ServiceTypeVersion'), 'ServiceTypeVersion', '__httpwww_opengis_netows_CTD_ANON_4_httpwww_opengis_netowsServiceTypeVersion', True)
    ...
    __Fees = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Fees'), 'Fees', '__httpwww_opengis_netows_CTD_ANON_4_httpwww_opengis_netowsFees', False)
...
class CTD_ANON_5 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ServiceContact = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ServiceContact'), 'ServiceContact', '__httpwww_opengis_netows_CTD_ANON_5_httpwww_opengis_netowsServiceContact', False)
    ...
    __ProviderName = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ProviderName'), 'ProviderName', '__httpwww_opengis_netows_CTD_ANON_5_httpwww_opengis_netowsProviderName', False)
    ...
    __ProviderSite = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ProviderSite'), 'ProviderSite', '__httpwww_opengis_netows_CTD_ANON_5_httpwww_opengis_netowsProviderSite', False)
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Post = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Post'), 'Post', '__httpwww_opengis_netows_CTD_ANON_6_httpwww_opengis_netowsPost', True)
    ...
    __Get = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Get'), 'Get', '__httpwww_opengis_netows_CTD_ANON_6_httpwww_opengis_netowsGet', True)
...
class CTD_ANON_7 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ExtendedCapabilities = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ExtendedCapabilities'), 'ExtendedCapabilities', '__httpwww_opengis_netows_CTD_ANON_7_httpwww_opengis_netowsExtendedCapabilities', False)
    ...
    __Operation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Operation'), 'Operation', '__httpwww_opengis_netows_CTD_ANON_7_httpwww_opengis_netowsOperation', True)
    ...
    # Element {http://www.opengis.net/ows}Constraint uses Python identifier Constraint
    __Constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Constraint'), 'Constraint', '__httpwww_opengis_netows_CTD_ANON_7_httpwww_opengis_netowsConstraint', True)
    ...
    # Element {http://www.opengis.net/ows}Parameter uses Python identifier Parameter
    __Parameter = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Parameter'), 'Parameter', '__httpwww_opengis_netows_CTD_ANON_7_httpwww_opengis_netowsParameter', True)
...
Operation = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Operation'), CTD_ANON_1, documentation=u'Metadata for one operation that this server implements. ')
...
DCP = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DCP'), CTD_ANON_2, documentation=u'Information for one distributed Computing Platform (DCP) supported for this operation. At present, only the HTTP DCP is defined, so this element only includes the HTTP element.\n')
...
ServiceIdentification = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceIdentification'), CTD_ANON_4, documentation=u'General metadata for this specific server. This XML Schema of this section shall be the same for all OWS. ')
...
ServiceProvider = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceProvider'), CTD_ANON_5, documentation=u'Metadata about the organization that provides this specific service instance or server. ')
...
DomainType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Value'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Value'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
    ])
...
CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Metadata'), MetadataType, scope=CTD_ANON_1))

CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DCP'), CTD_ANON_2, scope=CTD_ANON_1, documentation=u'Information for one distributed Computing Platform (DCP) supported for this operation. At present, only the HTTP DCP is defined, so this element only includes the HTTP element.\n'))
...
CTD_ANON_1._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DCP'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DCP'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Parameter'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Constraint'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Parameter'))),
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'HTTP'), CTD_ANON_6, scope=CTD_ANON_2, documentation=u'Connect point URLs for the HTTP Distributed Computing Platform (DCP). Normally, only one Get and/or one Post is included in this element. More than one Get and/or Post is allowed to support including alternative URLs for uses such as load balancing or backup. '))
CTD_ANON_2._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'HTTP'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_3._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Exception'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Exception'))),
    ])
...
DescriptionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Title'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Keywords'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Keywords'))),
...
CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceType'), CodeType, scope=CTD_ANON_4, documentation=u'A service type name from a registry of services. For example, the values of the codeSpace URI and name and code string may be "OGC" and "catalogue." This type name is normally used for machine-to-machine communication. '))

CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'), pyxb.binding.datatypes.string, scope=CTD_ANON_4, documentation=u'Access constraint applied to assure the protection of privacy or intellectual property, or any other restrictions on retrieving or using data from or otherwise using this server. The reserved value NONE (case insensitive) shall be used to mean no access constraints are imposed. '))

CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceTypeVersion'), VersionType, scope=CTD_ANON_4, documentation=u'Unordered list of one or more versions of this service type implemented by this server. This information is not adequate for version negotiation, and shall not be used for that purpose. '))

CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Fees'), pyxb.binding.datatypes.string, scope=CTD_ANON_4, documentation=u'Fees and terms for retrieving data from or otherwise using this server, including the monetary units as specified in ISO 4217. The reserved value NONE (case insensitive) shall be used to mean no fees or terms. '))
CTD_ANON_4._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceType'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Title'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Keywords'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceTypeVersion'))),
    ])
    ...
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceTypeVersion'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Fees'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AccessConstraints'))),
    ])
...
IdentificationType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=IdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Title'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=IdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'BoundingBox'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=IdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OutputFormat'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=IdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=IdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AvailableCRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=IdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Keywords'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=IdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=IdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
...
CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceContact'), ResponsiblePartySubsetType, scope=CTD_ANON_5, documentation=u'Information for contacting the service provider. The OnlineResource element within this ServiceContact element should not be used to reference a web site of the service provider. '))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProviderName'), pyxb.binding.datatypes.string, scope=CTD_ANON_5, documentation=u'A unique identifier for the service provider organization. '))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProviderSite'), OnlineResourceType, scope=CTD_ANON_5, documentation=u'Reference to the most relevant web site of the service provider. '))
CTD_ANON_5._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProviderName'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServiceContact'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ProviderSite'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
...
CapabilitiesBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceIdentification'), CTD_ANON_4, scope=CapabilitiesBaseType, documentation=u'General metadata for this specific server. This XML Schema of this section shall be the same for all OWS. '))

CapabilitiesBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ServiceProvider'), CTD_ANON_5, scope=CapabilitiesBaseType, documentation=u'Metadata about the organization that provides this specific service instance or server. '))
...
CTD_ANON_7._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Operation'), CTD_ANON_1, scope=CTD_ANON_7, documentation=u'Metadata for one operation that this server implements. '))
...
CTD_ANON_7._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operation'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operation'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operation'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Constraint'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Parameter'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ExtendedCapabilities'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Constraint'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Parameter'))),
...
ResponsiblePartyType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'IndividualName'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ContactInfo'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Role'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ContactInfo'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=ResponsiblePartyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Role'))),
...
GetCapabilitiesType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GetCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AcceptFormats'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GetCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Sections'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GetCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AcceptFormats'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GetCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Sections'))),
