...
# NSM:22a469f3e316cf44da81d828959bab128bf769b5
# Generated 2009-11-30 18:11:18.699921 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:0aeb9c50-de0e-11de-a07f-001cc05930fc')
...
class CTD_ANON_1 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __OtherSource = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'OtherSource'), 'OtherSource', '__httpwww_opengis_netwcs1_1_CTD_ANON_1_httpwww_opengis_netwcs1_1OtherSource', True)
    ...
    __CoverageSummary = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'CoverageSummary'), 'CoverageSummary', '__httpwww_opengis_netwcs1_1_CTD_ANON_1_httpwww_opengis_netwcs1_1CoverageSummary', True)
    ...
    __SupportedFormat = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SupportedFormat'), 'SupportedFormat', '__httpwww_opengis_netwcs1_1_CTD_ANON_1_httpwww_opengis_netwcs1_1SupportedFormat', True)
    ...
    __SupportedCRS = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SupportedCRS'), 'SupportedCRS', '__httpwww_opengis_netwcs1_1_CTD_ANON_1_httpwww_opengis_netwcs1_1SupportedCRS', True)
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Key = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Key'), 'Key', '__httpwww_opengis_netwcs1_1_CTD_ANON_2_httpwww_opengis_netwcs1_1Key', True)
    ...
    __Identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Identifier'), 'Identifier', '__httpwww_opengis_netwcs1_1_CTD_ANON_2_httpwww_opengis_netwcs1_1Identifier', False)
...
class ImageCRSRefType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netwcs1_1_ImageCRSRefType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netwcs1_1_ImageCRSRefType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_3 (pyxb.bundles.opengis.ows_1_1.GetCapabilitiesType):
    ...
    __service = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'service'), 'service', '__httpwww_opengis_netwcs1_1_CTD_ANON_3_service', pyxb.bundles.opengis.ows_1_1.ServiceType, fixed=True, unicode_default=u'WCS', required=True)
...
class CTD_ANON_5 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __AxisSubset = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AxisSubset'), 'AxisSubset', '__httpwww_opengis_netwcs1_1_CTD_ANON_5_httpwww_opengis_netwcs1_1AxisSubset', True)
    ...
    __InterpolationType = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'InterpolationType'), 'InterpolationType', '__httpwww_opengis_netwcs1_1_CTD_ANON_5_httpwww_opengis_netwcs1_1InterpolationType', False)
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Default = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Default'), 'Default', '__httpwww_opengis_netwcs1_1_CTD_ANON_6_httpwww_opengis_netwcs1_1Default', False)
    ...
    __InterpolationMethod = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'InterpolationMethod'), 'InterpolationMethod', '__httpwww_opengis_netwcs1_1_CTD_ANON_6_httpwww_opengis_netwcs1_1InterpolationMethod', True)
...
class CTD_ANON_7 (pyxb.bundles.opengis.ows_1_1.CapabilitiesBaseType):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = None
    ...
    __Contents = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Contents'), 'Contents', '__httpwww_opengis_netwcs1_1_CTD_ANON_7_httpwww_opengis_netwcs1_1Contents', False)
...
class CTD_ANON_8 (RequestBaseType):
    ...
    # Element {http://www.opengis.net/wcs/1.1}Identifier uses Python identifier Identifier
    __Identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Identifier'), 'Identifier', '__httpwww_opengis_netwcs1_1_CTD_ANON_8_httpwww_opengis_netwcs1_1Identifier', True)
...
class CTD_ANON_9 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/wcs/1.1}Key uses Python identifier Key
    __Key = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Key'), 'Key', '__httpwww_opengis_netwcs1_1_CTD_ANON_9_httpwww_opengis_netwcs1_1Key', True)
...
class CTD_ANON_10 (RequestBaseType):
    ...
    __Output = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Output'), 'Output', '__httpwww_opengis_netwcs1_1_CTD_ANON_10_httpwww_opengis_netwcs1_1Output', False)
    ...
    # Element {http://www.opengis.net/ows/1.1}Identifier uses Python identifier Identifier
    __Identifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'), 'Identifier', '__httpwww_opengis_netwcs1_1_CTD_ANON_10_httpwww_opengis_netows1_1Identifier', False)
    ...
    __DomainSubset = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DomainSubset'), 'DomainSubset', '__httpwww_opengis_netwcs1_1_CTD_ANON_10_httpwww_opengis_netwcs1_1DomainSubset', False)
    ...
    __RangeSubset = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'RangeSubset'), 'RangeSubset', '__httpwww_opengis_netwcs1_1_CTD_ANON_10_httpwww_opengis_netwcs1_1RangeSubset', False)
...
AxisSubset = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AxisSubset'), CTD_ANON_2, documentation=u'List of selected Keys for this axis, to be used for selecting values in a vector range field. TBD. ')
Namespace.addCategoryObject('elementBinding', AxisSubset.name().localName(), AxisSubset)

Contents = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Contents'), CTD_ANON_1, documentation=u'Contents section of WCS service metadata (or Capabilities) XML document. For the WCS, these contents are brief metadata about the coverages available from this server, or a reference to another source from which this metadata is available. ')
...
GetCapabilities = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'GetCapabilities'), CTD_ANON_3, documentation=u'Request to a WCS server to perform the GetCapabilities operation. This operation allows a client to retrieve a Capabilities XML document providing metadata for the specific WCS server. In this XML encoding, no "request" parameter is included, since the element name specifies the specific operation. ')
...
DescribeCoverage = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DescribeCoverage'), CTD_ANON_8, documentation=u'Request to a WCS to perform the DescribeCoverage operation. This operation allows a client to retrieve descriptions of one or more coverages. In this XML encoding, no "request" parameter is included, since the element name specifies the specific operation. ')
...
AvailableKeys = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AvailableKeys'), CTD_ANON_9, documentation=u'List of all the available (valid) key values for this axis. For numeric keys, signed values should be ordered from negative infinity to positive infinity. ')
Namespace.addCategoryObject('elementBinding', AvailableKeys.name().localName(), AvailableKeys)

GetCoverage = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'GetCoverage'), CTD_ANON_10, documentation=u'Request to a WCS to perform the GetCoverage operation. This operation allows a client to retrieve a subset of one coverage. In this XML encoding, no "request" parameter is included, since the element name specifies the specific operation. ')
...
CoverageDomainType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CoverageDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SpatialDomain'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CoverageDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TemporalDomain'))),
    ])
...
CoveragesType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CoveragesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Coverage'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CoveragesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Coverage'))),
    ])
...
CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'OtherSource'), pyxb.bundles.opengis.ows_1_1.OnlineResourceType, scope=CTD_ANON_1, documentation=u'Unordered list of references to other sources of coverage metadata. This list shall be included unless one or more CoverageSummaries are included. '))

CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CoverageSummary'), CoverageSummaryType, scope=CTD_ANON_1))

CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SupportedFormat'), pyxb.bundles.opengis.ows_1_1.MimeType, scope=CTD_ANON_1, documentation=u'Unordered list of identifiers of formats in which GetCoverage operation response may be encoded. This list of SupportedFormats shall be the union of all of the supported formats in all of the nested CoverageSummaries. Servers should include this list since it reduces the work clients need to do to determine that they can interoperate with the server. There may be a dependency of SupportedCRS on SupportedFormat, as described in clause 10.3.5. The full list of formats supported by a coverage shall be the union of the CoverageSummary\u2019s own SupportedFormats and those supported by all its ancestor CoverageSummaries. '))

CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SupportedCRS'), pyxb.binding.datatypes.anyURI, scope=CTD_ANON_1, documentation=u'Unordered list of references to GridBaseCRSs in which GetCoverage operation requests and responses may be expressed. This list of SupportedCRSs shall be the union of all of the supported CRSs in all of the nested CoverageSummaries. Servers should include this list since it reduces the work clients need to do to determine that they can interoperate with the server. There may be a dependency of SupportedCRS on SupportedFormat, as described in Subclause 10.3.5. The full list of GridBaseCRSs supported by a coverage shall be the union of the CoverageSummary\u2019s own SupportedCRSs and those supported by all its ancestor CoverageSummaries. This full list shall be an exact copy of the equivalent parameters in the CoverageDescription, and shall include zero or more SupportedCRS elements. '))
CTD_ANON_1._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'CoverageSummary'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OtherSource'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SupportedFormat'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SupportedCRS'))),
    ])
})



CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Key'), IdentifierType, scope=CTD_ANON_2, documentation=u'Unordered list of (at least one) Key, to be used for selecting values in a range vector field. The Keys within this list shall be unique. '))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Identifier'), IdentifierType, scope=CTD_ANON_2))
CTD_ANON_2._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Key'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Key'))),
    ])
...
ImageCRSRefType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ImageCRSRefType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'ImageCRS'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
GridCrsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GridCrsType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'srsName'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GridCrsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'GridBaseCRS'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GridCrsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'GridBaseCRS'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GridCrsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'GridOffsets'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=GridCrsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'GridType'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=GridCrsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'GridOrigin'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=GridCrsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'GridCS'))),
    ])
...
RangeSubsetType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FieldSubset'), CTD_ANON_5, scope=RangeSubsetType, documentation=u'Unordered list of one or more desired subsets of range fields. TBD. '))
RangeSubsetType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RangeSubsetType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'FieldSubset'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RangeSubsetType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'FieldSubset'))),
    ])
...
CoverageSummaryType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CoverageSummaryType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CoverageSummaryType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Keywords'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CoverageSummaryType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CoverageSummaryType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CoverageSummaryType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'WGS84BoundingBox'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CoverageSummaryType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SupportedFormat'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CoverageSummaryType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CoverageSummaryType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SupportedCRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CoverageSummaryType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'CoverageSummary'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
...
FieldType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'InterpolationMethods'), CTD_ANON_6, scope=FieldType, documentation=u'List of the interpolation method(s) that may be used when continuous grid coverage resampling is needed. '))
...
FieldType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=FieldType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=FieldType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Keywords'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=FieldType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=FieldType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FieldType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Axis'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=FieldType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Definition'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=FieldType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'NullValue'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FieldType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'InterpolationMethods'))),
    ])
})
...
TimeSequenceType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TimeSequenceType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'timePosition'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TimeSequenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TimePeriod'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TimeSequenceType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'timePosition'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TimeSequenceType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TimePeriod'))),
...
CTD_ANON_3._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'AcceptVersions'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'AcceptFormats'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Sections'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'AcceptFormats'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Sections'))),
...
CTD_ANON_4._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'CoverageDescription'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'CoverageDescription'))),
    ])
...
OutputType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OutputType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'GridCRS'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
TimePeriodType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TimePeriodType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'EndPosition'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TimePeriodType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TimeResolution'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
    ])
})
...
AxisType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AvailableKeys'), CTD_ANON_9, scope=AxisType, documentation=u'List of all the available (valid) key values for this axis. For numeric keys, signed values should be ordered from negative infinity to positive infinity. '))
...
AxisType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=AxisType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=AxisType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=AxisType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Keywords'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=AxisType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AvailableKeys'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=AxisType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Meaning'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AxisType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'DataType'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AxisType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'UOM'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AxisType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'ReferenceSystem'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AxisType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=AxisType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'DataType'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=AxisType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'UOM'))),
...
CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AxisSubset'), CTD_ANON_2, scope=CTD_ANON_5, documentation=u'List of selected Keys for this axis, to be used for selecting values in a vector range field. TBD. '))
...
CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'InterpolationType'), pyxb.binding.datatypes.string, scope=CTD_ANON_5, documentation=u'Optional identifier of the spatial interpolation type to be applied to this range field. This interpolation type shall be one that is identified for this Field in the CoverageDescription. When this parameter is omitted, the interpolation method used shall be the default method specified for this Field, if any. '))
CTD_ANON_5._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'InterpolationType'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AxisSubset'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AxisSubset'))),
    ])
...
RangeType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RangeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Field'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=RangeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Field'))),
    ])
...
SpatialDomainType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SpatialDomainType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'BoundingBox'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SpatialDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'GridCRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SpatialDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ImageCRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SpatialDomainType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'BoundingBox'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SpatialDomainType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'Polygon'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SpatialDomainType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'_CoordinateOperation'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SpatialDomainType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ImageCRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SpatialDomainType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'_CoordinateOperation'))),
...
DomainSubsetType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DomainSubsetType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'BoundingBox'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=DomainSubsetType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TemporalSubset'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Default'), pyxb.binding.datatypes.string, scope=CTD_ANON_6, documentation=u'Identifier of interpolation method that will be used if the client does not specify one. '))

CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'InterpolationMethod'), InterpolationMethodType, scope=CTD_ANON_6, documentation=u'Unordered list of identifiers of all other supported spatial interpolation methods. '))
CTD_ANON_6._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'InterpolationMethod'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Default'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_7._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'ServiceIdentification'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'OperationsMetadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Contents'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'ServiceProvider'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'OperationsMetadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Contents'))),
...
CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Identifier'), IdentifierType, scope=CTD_ANON_8))
CTD_ANON_8._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
    ])
...
CoverageDescriptionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CoverageDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Title'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CoverageDescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Identifier'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CoverageDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CoverageDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Keywords'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CoverageDescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SupportedCRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CoverageDescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SupportedFormat'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CoverageDescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Range'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CoverageDescriptionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Metadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CoverageDescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Domain'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CoverageDescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SupportedCRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CoverageDescriptionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SupportedFormat'))),
...
CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Key'), IdentifierType, scope=CTD_ANON_9, documentation=u'Valid key value for this axis. There will normally be more than one key value for an axis, but one is allowed for special circumstances. '))
CTD_ANON_9._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Key'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Key'))),
    ])
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Output'), OutputType, scope=CTD_ANON_10))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'), pyxb.bundles.opengis.ows_1_1.CodeType, scope=CTD_ANON_10, documentation=u'Unique identifier or name of this dataset. '))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DomainSubset'), DomainSubsetType, scope=CTD_ANON_10))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'RangeSubset'), RangeSubsetType, scope=CTD_ANON_10, documentation=u"Optional selection of a subset of the coverage's range. "))
CTD_ANON_10._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows/1.1'), u'Identifier'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DomainSubset'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Output'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'RangeSubset'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
