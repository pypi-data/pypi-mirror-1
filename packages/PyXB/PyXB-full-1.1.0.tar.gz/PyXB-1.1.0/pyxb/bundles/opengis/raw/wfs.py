...
# NSM:eac7f5293585184de4c856df1b5ca308e1a93caf
# Generated 2009-11-30 18:11:14.849494 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:088bf1b2-de0e-11de-81c9-001cc05930fc')
...
IdentifierGenerationOptionType.UseExisting = IdentifierGenerationOptionType._CF_enumeration.addEnumeration(unicode_value=u'UseExisting')
IdentifierGenerationOptionType.ReplaceDuplicate = IdentifierGenerationOptionType._CF_enumeration.addEnumeration(unicode_value=u'ReplaceDuplicate')
IdentifierGenerationOptionType.GenerateNew = IdentifierGenerationOptionType._CF_enumeration.addEnumeration(unicode_value=u'GenerateNew')
...
ResultTypeType.results = ResultTypeType._CF_enumeration.addEnumeration(unicode_value=u'results')
ResultTypeType.hits = ResultTypeType._CF_enumeration.addEnumeration(unicode_value=u'hits')
...
STD_ANON_1.textxml = STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'text/xml')
STD_ANON_1.texthtml = STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'text/html')
STD_ANON_1.textsgml = STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'text/sgml')
STD_ANON_1.textplain = STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'text/plain')
...
STD_ANON_2.TC211 = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'TC211')
STD_ANON_2.FGDC = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'FGDC')
STD_ANON_2.n19115 = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'19115')
STD_ANON_2.n19139 = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'19139')
...
OperationType.Insert = OperationType._CF_enumeration.addEnumeration(unicode_value=u'Insert')
OperationType.Update = OperationType._CF_enumeration.addEnumeration(unicode_value=u'Update')
OperationType.Delete = OperationType._CF_enumeration.addEnumeration(unicode_value=u'Delete')
OperationType.Query = OperationType._CF_enumeration.addEnumeration(unicode_value=u'Query')
OperationType.Lock = OperationType._CF_enumeration.addEnumeration(unicode_value=u'Lock')
OperationType.GetGmlObject = OperationType._CF_enumeration.addEnumeration(unicode_value=u'GetGmlObject')
...
AllSomeType.ALL = AllSomeType._CF_enumeration.addEnumeration(unicode_value=u'ALL')
AllSomeType.SOME = AllSomeType._CF_enumeration.addEnumeration(unicode_value=u'SOME')
...
class CTD_ANON_1 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __traverseXlinkExpiry = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'traverseXlinkExpiry'), 'traverseXlinkExpiry', '__httpwww_opengis_netwfs_CTD_ANON_1_traverseXlinkExpiry', pyxb.binding.datatypes.positiveInteger)
    ...
    __traverseXlinkDepth = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'traverseXlinkDepth'), 'traverseXlinkDepth', '__httpwww_opengis_netwfs_CTD_ANON_1_traverseXlinkDepth', pyxb.binding.datatypes.string, required=True)
...
class MetadataURLType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'type'), 'type', '__httpwww_opengis_netwfs_MetadataURLType_type', STD_ANON_2, required=True)
    
    type = property(__type.value, __type.set, None, None)

    
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpwww_opengis_netwfs_MetadataURLType_format', STD_ANON_1, required=True)
...
XlinkPropertyName = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'XlinkPropertyName'), CTD_ANON_1, documentation=u'\n            This element may be used in place of an wfs:PropertyName element\n            in a wfs:Query element in a wfs:GetFeature element to selectively\n            request the traversal of nested XLinks in the returned element for\n            the named property. This element may not be used in other requests\n            -- GetFeatureWithLock, LockFeature, Insert, Update, Delete -- in\n            this version of the WFS specification.\n         ')
...
DeleteElementType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=DeleteElementType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'Filter'))),
    ])
...
InsertedFeatureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InsertedFeatureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'FeatureId'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InsertedFeatureType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'FeatureId'))),
    ])
...
OutputFormatListType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OutputFormatListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Format'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OutputFormatListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Format'))),
    ])
...
InsertElementType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InsertElementType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'_Feature'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InsertElementType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'_Feature'))),
    ])
...
GetFeatureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GetFeatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Query'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GetFeatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Query'))),
    ])
...
GMLObjectTypeListType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GMLObjectTypeListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'GMLObjectType'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GMLObjectTypeListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'GMLObjectType'))),
    ])
...
FeatureCollectionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=FeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'featureMembers'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=FeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'featureMember'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=FeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=FeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'boundedBy'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=FeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'location'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=FeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'featureMembers'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=FeatureCollectionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'featureMember'))),
...
LockType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=LockType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'Filter'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
PropertyType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=PropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Name'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=PropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Value'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
TransactionSummaryType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TransactionSummaryType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'totalInserted'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TransactionSummaryType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'totalUpdated'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TransactionSummaryType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'totalDeleted'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TransactionSummaryType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'totalUpdated'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TransactionSummaryType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'totalDeleted'))),
...
GetGmlObjectType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GetGmlObjectType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'GmlObjectId'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
OperationsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OperationsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operation'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=OperationsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operation'))),
    ])
...
TransactionResultsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=TransactionResultsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Action'))),
    ])
})
...
GetCapabilitiesType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GetCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'AcceptVersions'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GetCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'Sections'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GetCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'AcceptFormats'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GetCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'Sections'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GetCapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'AcceptFormats'))),
...
InsertResultsType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InsertResultsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Feature'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=InsertResultsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Feature'))),
    ])
...
LockFeatureResponseType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=LockFeatureResponseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'LockId'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=LockFeatureResponseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'FeaturesLocked'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=LockFeatureResponseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'FeaturesNotLocked'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=LockFeatureResponseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'FeaturesNotLocked'))),
    ])
...
FeaturesLockedType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FeaturesLockedType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'FeatureId'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FeaturesLockedType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'FeatureId'))),
    ])
...
FeatureTypeType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'NoSRS'), CTD_ANON_2, scope=FeatureTypeType))
...
FeatureTypeType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Name'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'MetadataURL'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OtherSRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OutputFormats'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operations'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'WGS84BoundingBox'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Title'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DefaultSRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'NoSRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'Keywords'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DefaultSRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'NoSRS'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=FeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'Keywords'))),
    ])
...
FeatureTypeListType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FeatureTypeListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Operations'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=FeatureTypeListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'FeatureType'))),
    ])
...
TransactionResponseType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TransactionResponseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TransactionSummary'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TransactionResponseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TransactionResults'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TransactionResponseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'InsertResults'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TransactionResponseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'InsertResults'))),
    ])
...
WFS_CapabilitiesType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=WFS_CapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'OperationsMetadata'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=WFS_CapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'FeatureTypeList'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=WFS_CapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServesGMLObjectTypeList'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=WFS_CapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'ServiceProvider'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=WFS_CapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SupportsGMLObjectTypeList'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=WFS_CapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'ServiceIdentification'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=WFS_CapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'Filter_Capabilities'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=WFS_CapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ServesGMLObjectTypeList'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=WFS_CapabilitiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SupportsGMLObjectTypeList'))),
...
FeaturesNotLockedType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FeaturesNotLockedType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'FeatureId'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=FeaturesNotLockedType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'FeatureId'))),
    ])
...
QueryType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'XlinkPropertyName'), CTD_ANON_1, scope=QueryType, documentation=u'\n            This element may be used in place of an wfs:PropertyName element\n            in a wfs:Query element in a wfs:GetFeature element to selectively\n            request the traversal of nested XLinks in the returned element for\n            the named property. This element may not be used in other requests\n            -- GetFeatureWithLock, LockFeature, Insert, Update, Delete -- in\n            this version of the WFS specification.\n         '))
QueryType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=QueryType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'XlinkPropertyName'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=QueryType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PropertyName'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=QueryType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'Function'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=QueryType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'Filter'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=QueryType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'SortBy'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=QueryType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'SortBy'))),
    ])
...
DescribeFeatureTypeType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=DescribeFeatureTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TypeName'))),
    ])
})
...
ActionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ActionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Message'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
LockFeatureType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=LockFeatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Lock'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=LockFeatureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Lock'))),
    ])
...
TransactionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TransactionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Delete'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TransactionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Native'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TransactionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'LockId'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TransactionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Insert'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TransactionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Update'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TransactionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Delete'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TransactionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Insert'))),
...
GetFeatureWithLockType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GetFeatureWithLockType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Query'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GetFeatureWithLockType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Query'))),
    ])
...
UpdateElementType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=UpdateElementType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Property'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=UpdateElementType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Property'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=UpdateElementType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ogc'), u'Filter'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
GMLObjectTypeType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=GMLObjectTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Name'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=GMLObjectTypeType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'Keywords'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=GMLObjectTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=GMLObjectTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Title'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=GMLObjectTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'OutputFormats'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=GMLObjectTypeType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/ows'), u'Keywords'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=GMLObjectTypeType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Abstract'))),
