...
# NSM:f1da75586f8f2412f0605d01316001be0779ca84
# Generated 2009-11-30 18:10:04.544110 by PyXB version 1.1.0
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:de510cd4-de0d-11de-befe-001cc05930fc')
...
class CTD_ANON_1 (AbstractDataComponentType):
    ...
    __constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'constraint'), 'constraint', '__httpwww_opengis_netswe1_0_CTD_ANON_1_httpwww_opengis_netswe1_0constraint', False)
    ...
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_1_httpwww_opengis_netswe1_0quality', True)
    ...
    __value = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'value'), 'value_', '__httpwww_opengis_netswe1_0_CTD_ANON_1_httpwww_opengis_netswe1_0value', False)
    ...
    __axisID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'axisID'), 'axisID', '__httpwww_opengis_netswe1_0_CTD_ANON_1_axisID', pyxb.binding.datatypes.token)
    ...
    __referenceFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceFrame'), 'referenceFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_1_referenceFrame', pyxb.binding.datatypes.anyURI)
...
class BlockEncodingPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_BlockEncodingPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_BlockEncodingPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_2 (AbstractEncodingType):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_EMPTY
    _Abstract = False
    _ExpandedName = None
    ...
    __tokenSeparator = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'tokenSeparator'), 'tokenSeparator', '__httpwww_opengis_netswe1_0_CTD_ANON_2_tokenSeparator', textSeparator, required=True)
    ...
    __decimalSeparator = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'decimalSeparator'), 'decimalSeparator', '__httpwww_opengis_netswe1_0_CTD_ANON_2_decimalSeparator', decimalSeparator, required=True)
    ...
    __blockSeparator = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'blockSeparator'), 'blockSeparator', '__httpwww_opengis_netswe1_0_CTD_ANON_2_blockSeparator', textSeparator, required=True)
...
class CTD_ANON_3 (AbstractDataComponentType):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = None
    ...
    # Element {http://www.opengis.net/swe/1.0}quality uses Python identifier quality
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_3_httpwww_opengis_netswe1_0quality', True)
    ...
    __uom = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'uom'), 'uom', '__httpwww_opengis_netswe1_0_CTD_ANON_3_httpwww_opengis_netswe1_0uom', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}value uses Python identifier value_
    __value = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'value'), 'value_', '__httpwww_opengis_netswe1_0_CTD_ANON_3_httpwww_opengis_netswe1_0value', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}constraint uses Python identifier constraint
    __constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'constraint'), 'constraint', '__httpwww_opengis_netswe1_0_CTD_ANON_3_httpwww_opengis_netswe1_0constraint', False)
    ...
    # Attribute axisID uses Python identifier axisID
    __axisID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'axisID'), 'axisID', '__httpwww_opengis_netswe1_0_CTD_ANON_3_axisID', pyxb.binding.datatypes.token)
    ...
    # Attribute referenceFrame uses Python identifier referenceFrame
    __referenceFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceFrame'), 'referenceFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_3_referenceFrame', pyxb.binding.datatypes.anyURI)
...
class QualityPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_QualityPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    actuate = property(__actuate.value, __actuate.set, None, u"\n        The 'actuate' attribute is used to communicate the desired timing \n        of traversal from the starting resource to the ending resource; \n        it's value should be treated as follows:\n        onLoad - traverse to the ending resource immediately on loading \n                 the starting resource \n        onRequest - traverse from the starting resource to the ending \n                    resource only on a post-loading event triggered for \n                    this purpose \n        other - behavior is unconstrained; examine other markup in link \n                for hints \n        none - behavior is unconstrained\n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_QualityPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_4 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __valueList = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'valueList'), 'valueList', '__httpwww_opengis_netswe1_0_CTD_ANON_4_httpwww_opengis_netswe1_0valueList', True)
    ...
    # Attribute id uses Python identifier id
    __id = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'id'), 'id', '__httpwww_opengis_netswe1_0_CTD_ANON_4_id', pyxb.binding.datatypes.ID)
...
class CTD_ANON_5 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __min = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'min'), 'min', '__httpwww_opengis_netswe1_0_CTD_ANON_5_httpwww_opengis_netswe1_0min', False)
    ...
    __max = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'max'), 'max', '__httpwww_opengis_netswe1_0_CTD_ANON_5_httpwww_opengis_netswe1_0max', False)
    ...
    __interval = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'interval'), 'interval', '__httpwww_opengis_netswe1_0_CTD_ANON_5_httpwww_opengis_netswe1_0interval', True)
...
class CTD_ANON_6 (AbstractDataComponentType):
    ...
    # Element {http://www.opengis.net/swe/1.0}value uses Python identifier value_
    __value = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'value'), 'value_', '__httpwww_opengis_netswe1_0_CTD_ANON_6_httpwww_opengis_netswe1_0value', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}uom uses Python identifier uom
    __uom = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'uom'), 'uom', '__httpwww_opengis_netswe1_0_CTD_ANON_6_httpwww_opengis_netswe1_0uom', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}constraint uses Python identifier constraint
    __constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'constraint'), 'constraint', '__httpwww_opengis_netswe1_0_CTD_ANON_6_httpwww_opengis_netswe1_0constraint', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}quality uses Python identifier quality
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_6_httpwww_opengis_netswe1_0quality', False)
    ...
    # Attribute referenceFrame uses Python identifier referenceFrame
    __referenceFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceFrame'), 'referenceFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_6_referenceFrame', pyxb.binding.datatypes.anyURI)
    ...
    __localFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'localFrame'), 'localFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_6_localFrame', pyxb.binding.datatypes.anyURI)
    ...
    __referenceTime = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceTime'), 'referenceTime', '__httpwww_opengis_netswe1_0_CTD_ANON_6_referenceTime', timeIso8601)
...
class TimeAggregatePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeAggregatePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeAggregatePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_7 (AbstractDataComponentType):
    ...
    # Element {http://www.opengis.net/swe/1.0}value uses Python identifier value_
    __value = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'value'), 'value_', '__httpwww_opengis_netswe1_0_CTD_ANON_7_httpwww_opengis_netswe1_0value', False)
...
class TimeIntervalGridPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeIntervalGridPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeIntervalGridPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_8 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __high = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'high'), 'high', '__httpwww_opengis_netswe1_0_CTD_ANON_8_httpwww_opengis_netswe1_0high', False)
    ...
    __low = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'low'), 'low', '__httpwww_opengis_netswe1_0_CTD_ANON_8_httpwww_opengis_netswe1_0low', False)
...
class DataComponentPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_DataComponentPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_DataComponentPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class TimeInstantGridPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeInstantGridPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeInstantGridPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_9 (AbstractDataComponentType):
    ...
    # Element {http://www.opengis.net/swe/1.0}quality uses Python identifier quality
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_9_httpwww_opengis_netswe1_0quality', True)
    ...
    # Attribute axisID uses Python identifier axisID
    __axisID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'axisID'), 'axisID', '__httpwww_opengis_netswe1_0_CTD_ANON_9_axisID', pyxb.binding.datatypes.token)
...
class AllowedTimesPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_AllowedTimesPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_AllowedTimesPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CodeSpacePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_CodeSpacePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_CodeSpacePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_10 (AbstractDataComponentType):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = None
    ...
    # Element {http://www.opengis.net/swe/1.0}constraint uses Python identifier constraint
    __constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'constraint'), 'constraint', '__httpwww_opengis_netswe1_0_CTD_ANON_10_httpwww_opengis_netswe1_0constraint', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}value uses Python identifier value_
    __value = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'value'), 'value_', '__httpwww_opengis_netswe1_0_CTD_ANON_10_httpwww_opengis_netswe1_0value', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}quality uses Python identifier quality
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_10_httpwww_opengis_netswe1_0quality', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}uom uses Python identifier uom
    __uom = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'uom'), 'uom', '__httpwww_opengis_netswe1_0_CTD_ANON_10_httpwww_opengis_netswe1_0uom', False)
    ...
    # Attribute referenceFrame uses Python identifier referenceFrame
    __referenceFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceFrame'), 'referenceFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_10_referenceFrame', pyxb.binding.datatypes.anyURI)
    ...
    # Attribute localFrame uses Python identifier localFrame
    __localFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'localFrame'), 'localFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_10_localFrame', pyxb.binding.datatypes.anyURI)
    ...
    # Attribute referenceTime uses Python identifier referenceTime
    __referenceTime = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceTime'), 'referenceTime', '__httpwww_opengis_netswe1_0_CTD_ANON_10_referenceTime', timeIso8601)
...
class AnyScalarPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_AnyScalarPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_AnyScalarPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class AllowedValuesPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_AllowedValuesPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_AllowedValuesPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class VectorPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_VectorPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_VectorPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_11 (AbstractDataComponentType):
    ...
    __codeSpace = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'codeSpace'), 'codeSpace', '__httpwww_opengis_netswe1_0_CTD_ANON_11_httpwww_opengis_netswe1_0codeSpace', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}value uses Python identifier value_
    __value = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'value'), 'value_', '__httpwww_opengis_netswe1_0_CTD_ANON_11_httpwww_opengis_netswe1_0value', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}constraint uses Python identifier constraint
    __constraint = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'constraint'), 'constraint', '__httpwww_opengis_netswe1_0_CTD_ANON_11_httpwww_opengis_netswe1_0constraint', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}quality uses Python identifier quality
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_11_httpwww_opengis_netswe1_0quality', False)
    ...
    # Attribute axisID uses Python identifier axisID
    __axisID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'axisID'), 'axisID', '__httpwww_opengis_netswe1_0_CTD_ANON_11_axisID', pyxb.binding.datatypes.token)
    ...
    # Attribute referenceFrame uses Python identifier referenceFrame
    __referenceFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceFrame'), 'referenceFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_11_referenceFrame', pyxb.binding.datatypes.anyURI)
...
class CTD_ANON_12 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __encryption = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'encryption'), 'encryption', '__httpwww_opengis_netswe1_0_CTD_ANON_12_encryption', pyxb.binding.datatypes.anyURI)
    ...
    __paddingBytes_after = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'paddingBytes-after'), 'paddingBytes_after', '__httpwww_opengis_netswe1_0_CTD_ANON_12_paddingBytes_after', pyxb.binding.datatypes.nonNegativeInteger, unicode_default=u'0')
    ...
    __compression = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'compression'), 'compression', '__httpwww_opengis_netswe1_0_CTD_ANON_12_compression', pyxb.binding.datatypes.anyURI)
    ...
    __byteLength = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'byteLength'), 'byteLength', '__httpwww_opengis_netswe1_0_CTD_ANON_12_byteLength', pyxb.binding.datatypes.positiveInteger)
    ...
    __paddingBytes_before = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'paddingBytes-before'), 'paddingBytes_before', '__httpwww_opengis_netswe1_0_CTD_ANON_12_paddingBytes_before', pyxb.binding.datatypes.nonNegativeInteger, unicode_default=u'0')
    ...
    __ref = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ref'), 'ref', '__httpwww_opengis_netswe1_0_CTD_ANON_12_ref', pyxb.binding.datatypes.token, required=True)
...
class CTD_ANON_13 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/swe/1.0}Count uses Python identifier Count
    __Count = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Count'), 'Count', '__httpwww_opengis_netswe1_0_CTD_ANON_13_httpwww_opengis_netswe1_0Count', False)
    ...
    # Attribute ref uses Python identifier ref
    __ref = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ref'), 'ref', '__httpwww_opengis_netswe1_0_CTD_ANON_13_ref', pyxb.binding.datatypes.IDREF)
...
class CTD_ANON_14 (AbstractDataComponentType):
    ...
    # Element {http://www.opengis.net/swe/1.0}value uses Python identifier value_
    __value = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'value'), 'value_', '__httpwww_opengis_netswe1_0_CTD_ANON_14_httpwww_opengis_netswe1_0value', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}quality uses Python identifier quality
    __quality = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quality'), 'quality', '__httpwww_opengis_netswe1_0_CTD_ANON_14_httpwww_opengis_netswe1_0quality', False)
    ...
    # Attribute axisID uses Python identifier axisID
    __axisID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'axisID'), 'axisID', '__httpwww_opengis_netswe1_0_CTD_ANON_14_axisID', pyxb.binding.datatypes.token)
    
    axisID = property(__axisID.value, __axisID.set, None, u'Specifies the reference axis using the gml:axisID. The reference frame URI is inherited from parent Vector')

    
    # Attribute referenceFrame uses Python identifier referenceFrame
    __referenceFrame = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'referenceFrame'), 'referenceFrame', '__httpwww_opengis_netswe1_0_CTD_ANON_14_referenceFrame', pyxb.binding.datatypes.anyURI)
...
class TimeGeometricComplexPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeGeometricComplexPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeGeometricComplexPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_15 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/swe/1.0}TimeRange uses Python identifier TimeRange
    __TimeRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), 'TimeRange', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netswe1_0TimeRange', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Quantity uses Python identifier Quantity
    __Quantity = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), 'Quantity', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netswe1_0Quantity', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}CountRange uses Python identifier CountRange
    __CountRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), 'CountRange', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netswe1_0CountRange', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Category uses Python identifier Category
    __Category = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Category'), 'Category', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netswe1_0Category', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Text uses Python identifier Text
    __Text = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Text'), 'Text', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netswe1_0Text', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}AbstractDataArray uses Python identifier AbstractDataArray
    __AbstractDataArray = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'), 'AbstractDataArray', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netswe1_0AbstractDataArray', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Count uses Python identifier Count
    __Count = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Count'), 'Count', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netswe1_0Count', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}QuantityRange uses Python identifier QuantityRange
    __QuantityRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), 'QuantityRange', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netswe1_0QuantityRange', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}AbstractDataRecord uses Python identifier AbstractDataRecord
    __AbstractDataRecord = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'), 'AbstractDataRecord', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netswe1_0AbstractDataRecord', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Time uses Python identifier Time
    __Time = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Time'), 'Time', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netswe1_0Time', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Boolean uses Python identifier Boolean
    __Boolean = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), 'Boolean', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netswe1_0Boolean', False)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}href uses Python identifier href
    __href = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'href'), 'href', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_w3_org1999xlinkhref', pyxb.binding.datatypes.anyURI)
    
    href = property(__href.value, __href.set, None, None)

    
    # Attribute {http://www.opengis.net/gml}remoteSchema uses Python identifier remoteSchema
    __remoteSchema = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'remoteSchema'), 'remoteSchema', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_opengis_netgmlremoteSchema', pyxb.binding.datatypes.anyURI)
    
    remoteSchema = property(__remoteSchema.value, __remoteSchema.set, None, u'Reference to an XML Schema fragment that specifies the content model of the propertys value. This is in conformance with the XML Schema Section 4.14 Referencing Schemas from Elsewhere.')

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    actuate = property(__actuate.value, __actuate.set, None, u"\n        The 'actuate' attribute is used to communicate the desired timing \n        of traversal from the starting resource to the ending resource; \n        it's value should be treated as follows:\n        onLoad - traverse to the ending resource immediately on loading \n                 the starting resource \n        onRequest - traverse from the starting resource to the ending \n                    resource only on a post-loading event triggered for \n                    this purpose \n        other - behavior is unconstrained; examine other markup in link \n                for hints \n        none - behavior is unconstrained\n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}role uses Python identifier role
    __role = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'role'), 'role', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_w3_org1999xlinkrole', pyxb.binding.datatypes.anyURI)
    
    role = property(__role.value, __role.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpwww_opengis_netswe1_0_CTD_ANON_15_name', pyxb.binding.datatypes.token, required=True)
    
    name = property(__name.value, __name.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}arcrole uses Python identifier arcrole
    __arcrole = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'arcrole'), 'arcrole', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_w3_org1999xlinkarcrole', pyxb.binding.datatypes.anyURI)
    
    arcrole = property(__arcrole.value, __arcrole.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}title uses Python identifier title
    __title = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'title'), 'title', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_w3_org1999xlinktitle', pyxb.binding.datatypes.string)
    
    title = property(__title.value, __title.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}type uses Python identifier type
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'type'), 'type', '__httpwww_opengis_netswe1_0_CTD_ANON_15_httpwww_w3_org1999xlinktype', pyxb.binding.datatypes.string, fixed=True, unicode_default=u'simple')
...
class DataValuePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_DataValuePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    actuate = property(__actuate.value, __actuate.set, None, u"\n        The 'actuate' attribute is used to communicate the desired timing \n        of traversal from the starting resource to the ending resource; \n        it's value should be treated as follows:\n        onLoad - traverse to the ending resource immediately on loading \n                 the starting resource \n        onRequest - traverse from the starting resource to the ending \n                    resource only on a post-loading event triggered for \n                    this purpose \n        other - behavior is unconstrained; examine other markup in link \n                for hints \n        none - behavior is unconstrained\n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_DataValuePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_16 (AbstractDataComponentType):
    ...
    # Element {http://www.opengis.net/swe/1.0}uom uses Python identifier uom
    __uom = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'uom'), 'uom', '__httpwww_opengis_netswe1_0_CTD_ANON_16_httpwww_opengis_netswe1_0uom', False)
...
class UomPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_UomPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_UomPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_17 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/swe/1.0}Count uses Python identifier Count
    __Count = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Count'), 'Count', '__httpwww_opengis_netswe1_0_CTD_ANON_17_httpwww_opengis_netswe1_0Count', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Quantity uses Python identifier Quantity
    __Quantity = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), 'Quantity', '__httpwww_opengis_netswe1_0_CTD_ANON_17_httpwww_opengis_netswe1_0Quantity', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Time uses Python identifier Time
    __Time = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Time'), 'Time', '__httpwww_opengis_netswe1_0_CTD_ANON_17_httpwww_opengis_netswe1_0Time', False)
    ...
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpwww_opengis_netswe1_0_CTD_ANON_17_name', pyxb.binding.datatypes.token, required=True)
...
class DataBlockDefinitionPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_DataBlockDefinitionPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_DataBlockDefinitionPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class AllowedTokensPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_AllowedTokensPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_AllowedTokensPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class PhenomenonPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_PhenomenonPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_PhenomenonPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_18 (AbstractEncodingType):
    ...
    # Element {http://www.opengis.net/swe/1.0}member uses Python identifier member
    __member = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'member'), 'member', '__httpwww_opengis_netswe1_0_CTD_ANON_18_httpwww_opengis_netswe1_0member', True)
    ...
    # Attribute byteLength uses Python identifier byteLength
    __byteLength = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'byteLength'), 'byteLength', '__httpwww_opengis_netswe1_0_CTD_ANON_18_byteLength', pyxb.binding.datatypes.positiveInteger)
    ...
    __byteOrder = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'byteOrder'), 'byteOrder', '__httpwww_opengis_netswe1_0_CTD_ANON_18_byteOrder', byteOrder, required=True)
    
    byteOrder = property(__byteOrder.value, __byteOrder.set, None, None)

    
    # Attribute byteEncoding uses Python identifier byteEncoding
    __byteEncoding = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'byteEncoding'), 'byteEncoding', '__httpwww_opengis_netswe1_0_CTD_ANON_18_byteEncoding', byteEncoding, required=True)
...
class TimeGeometricPrimitivePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeGeometricPrimitivePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeGeometricPrimitivePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_19 (AbstractEncodingType):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_EMPTY
    _Abstract = False
    _ExpandedName = None
    ...
    __mimeType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mimeType'), 'mimeType', '__httpwww_opengis_netswe1_0_CTD_ANON_19_mimeType', pyxb.binding.datatypes.token, required=True)
...
class CTD_ANON_20 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __paddingBits_after = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'paddingBits-after'), 'paddingBits_after', '__httpwww_opengis_netswe1_0_CTD_ANON_20_paddingBits_after', pyxb.binding.datatypes.nonNegativeInteger, unicode_default=u'0')
    
    paddingBits_after = property(__paddingBits_after.value, __paddingBits_after.set, None, None)

    
    # Attribute encryption uses Python identifier encryption
    __encryption = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'encryption'), 'encryption', '__httpwww_opengis_netswe1_0_CTD_ANON_20_encryption', pyxb.binding.datatypes.anyURI)
    
    encryption = property(__encryption.value, __encryption.set, None, None)

    
    # Attribute ref uses Python identifier ref
    __ref = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ref'), 'ref', '__httpwww_opengis_netswe1_0_CTD_ANON_20_ref', pyxb.binding.datatypes.token, required=True)
    
    ref = property(__ref.value, __ref.set, None, None)

    
    # Attribute dataType uses Python identifier dataType
    __dataType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'dataType'), 'dataType', '__httpwww_opengis_netswe1_0_CTD_ANON_20_dataType', pyxb.binding.datatypes.anyURI)
    ...
    __significantBits = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'significantBits'), 'significantBits', '__httpwww_opengis_netswe1_0_CTD_ANON_20_significantBits', pyxb.binding.datatypes.positiveInteger)
    ...
    __bitLength = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'bitLength'), 'bitLength', '__httpwww_opengis_netswe1_0_CTD_ANON_20_bitLength', pyxb.binding.datatypes.positiveInteger)
    ...
    __paddingBits_before = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'paddingBits-before'), 'paddingBits_before', '__httpwww_opengis_netswe1_0_CTD_ANON_20_paddingBits_before', pyxb.binding.datatypes.nonNegativeInteger, unicode_default=u'0')
...
class DataStreamDefinitionPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_DataStreamDefinitionPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_DataStreamDefinitionPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class CTD_ANON_21 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/swe/1.0}Text uses Python identifier Text
    __Text = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Text'), 'Text', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0Text', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Quantity uses Python identifier Quantity
    __Quantity = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), 'Quantity', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0Quantity', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Boolean uses Python identifier Boolean
    __Boolean = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), 'Boolean', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0Boolean', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}CountRange uses Python identifier CountRange
    __CountRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), 'CountRange', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0CountRange', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}TimeRange uses Python identifier TimeRange
    __TimeRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), 'TimeRange', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0TimeRange', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Category uses Python identifier Category
    __Category = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Category'), 'Category', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0Category', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}AbstractDataRecord uses Python identifier AbstractDataRecord
    __AbstractDataRecord = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'), 'AbstractDataRecord', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0AbstractDataRecord', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Time uses Python identifier Time
    __Time = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Time'), 'Time', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0Time', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}Count uses Python identifier Count
    __Count = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Count'), 'Count', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0Count', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}AbstractDataArray uses Python identifier AbstractDataArray
    __AbstractDataArray = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'), 'AbstractDataArray', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0AbstractDataArray', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}QuantityRange uses Python identifier QuantityRange
    __QuantityRange = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), 'QuantityRange', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netswe1_0QuantityRange', False)
    ...
    # Attribute {http://www.opengis.net/gml}remoteSchema uses Python identifier remoteSchema
    __remoteSchema = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'remoteSchema'), 'remoteSchema', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_opengis_netgmlremoteSchema', pyxb.binding.datatypes.anyURI)
    
    remoteSchema = property(__remoteSchema.value, __remoteSchema.set, None, u'Reference to an XML Schema fragment that specifies the content model of the propertys value. This is in conformance with the XML Schema Section 4.14 Referencing Schemas from Elsewhere.')

    
    # Attribute {http://www.w3.org/1999/xlink}type uses Python identifier type
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'type'), 'type', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_w3_org1999xlinktype', pyxb.binding.datatypes.string, fixed=True, unicode_default=u'simple')
    
    type = property(__type.value, __type.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}title uses Python identifier title
    __title = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'title'), 'title', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_w3_org1999xlinktitle', pyxb.binding.datatypes.string)
    
    title = property(__title.value, __title.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}role uses Python identifier role
    __role = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'role'), 'role', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_w3_org1999xlinkrole', pyxb.binding.datatypes.anyURI)
    
    role = property(__role.value, __role.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}arcrole uses Python identifier arcrole
    __arcrole = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'arcrole'), 'arcrole', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_w3_org1999xlinkarcrole', pyxb.binding.datatypes.anyURI)
    
    arcrole = property(__arcrole.value, __arcrole.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    actuate = property(__actuate.value, __actuate.set, None, u"\n        The 'actuate' attribute is used to communicate the desired timing \n        of traversal from the starting resource to the ending resource; \n        it's value should be treated as follows:\n        onLoad - traverse to the ending resource immediately on loading \n                 the starting resource \n        onRequest - traverse from the starting resource to the ending \n                    resource only on a post-loading event triggered for \n                    this purpose \n        other - behavior is unconstrained; examine other markup in link \n                for hints \n        none - behavior is unconstrained\n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}href uses Python identifier href
    __href = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'href'), 'href', '__httpwww_opengis_netswe1_0_CTD_ANON_21_httpwww_w3_org1999xlinkhref', pyxb.binding.datatypes.anyURI)
...
class TimeGridPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeGridPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    actuate = property(__actuate.value, __actuate.set, None, u"\n        The 'actuate' attribute is used to communicate the desired timing \n        of traversal from the starting resource to the ending resource; \n        it's value should be treated as follows:\n        onLoad - traverse to the ending resource immediately on loading \n                 the starting resource \n        onRequest - traverse from the starting resource to the ending \n                    resource only on a post-loading event triggered for \n                    this purpose \n        other - behavior is unconstrained; examine other markup in link \n                for hints \n        none - behavior is unconstrained\n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeGridPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_22 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.opengis.net/swe/1.0}min uses Python identifier min
    __min = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'min'), 'min', '__httpwww_opengis_netswe1_0_CTD_ANON_22_httpwww_opengis_netswe1_0min', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}max uses Python identifier max
    __max = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'max'), 'max', '__httpwww_opengis_netswe1_0_CTD_ANON_22_httpwww_opengis_netswe1_0max', False)
    ...
    # Element {http://www.opengis.net/swe/1.0}valueList uses Python identifier valueList
    __valueList = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'valueList'), 'valueList', '__httpwww_opengis_netswe1_0_CTD_ANON_22_httpwww_opengis_netswe1_0valueList', True)
    ...
    # Element {http://www.opengis.net/swe/1.0}interval uses Python identifier interval
    __interval = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'interval'), 'interval', '__httpwww_opengis_netswe1_0_CTD_ANON_22_httpwww_opengis_netswe1_0interval', True)
    ...
    # Attribute id uses Python identifier id
    __id = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'id'), 'id', '__httpwww_opengis_netswe1_0_CTD_ANON_22_id', pyxb.binding.datatypes.ID)
...
class MultiplexedStreamFormatPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_MultiplexedStreamFormatPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_MultiplexedStreamFormatPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class SimpleDataPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_SimpleDataPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_SimpleDataPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
class TimeObjectPropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_TimeObjectPropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_TimeObjectPropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
...
class CTD_ANON_24 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ConditionalValue = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ConditionalValue'), 'ConditionalValue', '__httpwww_opengis_netswe1_0_CTD_ANON_24_httpwww_opengis_netswe1_0ConditionalValue', False)
    ...
    # Attribute {http://www.opengis.net/gml}remoteSchema uses Python identifier remoteSchema
    __remoteSchema = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'remoteSchema'), 'remoteSchema', '__httpwww_opengis_netswe1_0_CTD_ANON_24_httpwww_opengis_netgmlremoteSchema', pyxb.binding.datatypes.anyURI)
    
    remoteSchema = property(__remoteSchema.value, __remoteSchema.set, None, u'Reference to an XML Schema fragment that specifies the content model of the propertys value. This is in conformance with the XML Schema Section 4.14 Referencing Schemas from Elsewhere.')

    
    # Attribute {http://www.w3.org/1999/xlink}role uses Python identifier role
    __role = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'role'), 'role', '__httpwww_opengis_netswe1_0_CTD_ANON_24_httpwww_w3_org1999xlinkrole', pyxb.binding.datatypes.anyURI)
    
    role = property(__role.value, __role.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_CTD_ANON_24_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
    
    actuate = property(__actuate.value, __actuate.set, None, u"\n        The 'actuate' attribute is used to communicate the desired timing \n        of traversal from the starting resource to the ending resource; \n        it's value should be treated as follows:\n        onLoad - traverse to the ending resource immediately on loading \n                 the starting resource \n        onRequest - traverse from the starting resource to the ending \n                    resource only on a post-loading event triggered for \n                    this purpose \n        other - behavior is unconstrained; examine other markup in link \n                for hints \n        none - behavior is unconstrained\n      ")

    
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_CTD_ANON_24_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    
    show = property(__show.value, __show.set, None, u"\n        The 'show' attribute is used to communicate the desired presentation \n        of the ending resource on traversal from the starting resource; it's \n        value should be treated as follows: \n        new - load ending resource in a new window, frame, pane, or other \n              presentation context\n        replace - load the resource in the same window, frame, pane, or \n                  other presentation context\n        embed - load ending resource in place of the presentation of the \n                starting resource\n        other - behavior is unconstrained; examine other markup in the \n                link for hints \n        none - behavior is unconstrained \n      ")

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpwww_opengis_netswe1_0_CTD_ANON_24_name', pyxb.binding.datatypes.token, required=True)
    
    name = property(__name.value, __name.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}title uses Python identifier title
    __title = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'title'), 'title', '__httpwww_opengis_netswe1_0_CTD_ANON_24_httpwww_w3_org1999xlinktitle', pyxb.binding.datatypes.string)
    
    title = property(__title.value, __title.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}href uses Python identifier href
    __href = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'href'), 'href', '__httpwww_opengis_netswe1_0_CTD_ANON_24_httpwww_w3_org1999xlinkhref', pyxb.binding.datatypes.anyURI)
    
    href = property(__href.value, __href.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}type uses Python identifier type
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'type'), 'type', '__httpwww_opengis_netswe1_0_CTD_ANON_24_httpwww_w3_org1999xlinktype', pyxb.binding.datatypes.string, fixed=True, unicode_default=u'simple')
    
    type = property(__type.value, __type.set, None, None)

    
    # Attribute {http://www.w3.org/1999/xlink}arcrole uses Python identifier arcrole
    __arcrole = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'arcrole'), 'arcrole', '__httpwww_opengis_netswe1_0_CTD_ANON_24_httpwww_w3_org1999xlinkarcrole', pyxb.binding.datatypes.anyURI)
...
class CTD_ANON_25 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Component = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Component'), 'Component', '__httpwww_opengis_netswe1_0_CTD_ANON_25_httpwww_opengis_netswe1_0Component', False)
    ...
    __Block = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Block'), 'Block', '__httpwww_opengis_netswe1_0_CTD_ANON_25_httpwww_opengis_netswe1_0Block', False)
...
class CTD_ANON_26 (AbstractVectorType):
    ...
    # Element {http://www.opengis.net/swe/1.0}member uses Python identifier member
    __member = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'member'), 'member', '__httpwww_opengis_netswe1_0_CTD_ANON_26_httpwww_opengis_netswe1_0member', True)
    ...
    __name_ = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name_', '__httpwww_opengis_netswe1_0_CTD_ANON_26_name', pyxb.binding.datatypes.token)
...
class EnvelopePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute {http://www.w3.org/1999/xlink}show uses Python identifier show
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'show'), 'show', '__httpwww_opengis_netswe1_0_EnvelopePropertyType_httpwww_w3_org1999xlinkshow', pyxb.bundles.opengis.misc.xlinks.STD_ANON_1)
    ...
    # Attribute {http://www.w3.org/1999/xlink}actuate uses Python identifier actuate
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.w3.org/1999/xlink'), u'actuate'), 'actuate', '__httpwww_opengis_netswe1_0_EnvelopePropertyType_httpwww_w3_org1999xlinkactuate', pyxb.bundles.opengis.misc.xlinks.STD_ANON_2)
...
TextBlock = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TextBlock'), CTD_ANON_2)
...
AllowedValues = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AllowedValues'), CTD_ANON_5, documentation=u'List of allowed values (There is an implicit AND between all members)')
...
Boolean = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_14, documentation=u'Scalar component used to express truth: True or False, 0 or 1')
...
Quantity = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_16, documentation=u'Decimal number with optional unit and constraints')
Namespace.addCategoryObject('elementBinding', Quantity.name().localName(), Quantity)

CountRange = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_9, documentation=u'Integer pair used for specifying a count range')
...
TimeRange = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_10, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)')
...
StandardFormat = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'StandardFormat'), CTD_ANON_19)
...
BinaryBlock = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'BinaryBlock'), CTD_ANON_18)
...
QuantityRange = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_3, documentation=u'Decimal pair for specifying a quantity range with constraints')
Namespace.addCategoryObject('elementBinding', QuantityRange.name().localName(), QuantityRange)

ObservableProperty = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ObservableProperty'), CTD_ANON_23, documentation=u'ObservableProperty should be used to identify (through reference only) stimuli or measurable property types. The consequence is that it does not have a uom because it has not been measured yet.  This is used to define sensor/detector/actuator inputs and outputs, for instance.')
...
Text = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_7, documentation=u'Free textual component')
...
Category = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Category'), CTD_ANON_11, documentation=u'A simple token identifying a term or category (single spaces allowed); definition attribute should provide dictionary entry useful for interpretation of the value')
Namespace.addCategoryObject('elementBinding', Category.name().localName(), Category)

Time = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_6, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin')
Namespace.addCategoryObject('elementBinding', Time.name().localName(), Time)

Count = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_1, documentation=u'Integer number used for a counting value')
...
AbstractDataArrayType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'elementCount'), CTD_ANON_13, scope=AbstractDataArrayType, documentation=u'Specifies the size of the array (i.e. the number of elements of the defined type it contains)'))
...
CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), pyxb.binding.datatypes.integer, scope=CTD_ANON_1, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))
CTD_ANON_1._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
...
BlockEncodingPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'StandardFormat'), CTD_ANON_19, scope=BlockEncodingPropertyType))

BlockEncodingPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'BinaryBlock'), CTD_ANON_18, scope=BlockEncodingPropertyType))

BlockEncodingPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TextBlock'), CTD_ANON_2, scope=BlockEncodingPropertyType))
...
CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'quality'), QualityPropertyType, scope=CTD_ANON_3, documentation=u'The quality property provides an indication of the reliability of estimates of the asociated value'))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'uom'), UomPropertyType, scope=CTD_ANON_3, documentation=u'Unit of measure'))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), decimalPair, scope=CTD_ANON_3, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'constraint'), AllowedValuesPropertyType, scope=CTD_ANON_3, documentation=u'The constraint property defines the permitted values, as a range or enumerated list'))
CTD_ANON_3._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'uom'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
...
TimeGridType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=TimeGridType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=TimeGridType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TimeGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extent'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=TimeGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'offsetDuration'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=TimeGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'offsetInterval'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
    ...
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TimeGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'duration'))),
    ])
})
...
TimeInstantGridType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=TimeInstantGridType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=TimeInstantGridType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TimeInstantGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extent'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=TimeInstantGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'offsetDuration'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=TimeInstantGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'offsetInterval'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
    ...
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TimeInstantGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'duration'))),
    ])
})



QualityPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_16, scope=QualityPropertyType, documentation=u'Decimal number with optional unit and constraints'))

QualityPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_3, scope=QualityPropertyType, documentation=u'Decimal pair for specifying a quantity range with constraints'))

QualityPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_7, scope=QualityPropertyType, documentation=u'Free textual component'))

QualityPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Category'), CTD_ANON_11, scope=QualityPropertyType, documentation=u'A simple token identifying a term or category (single spaces allowed); definition attribute should provide dictionary entry useful for interpretation of the value'))
...
BooleanPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_14, scope=BooleanPropertyType, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))
...
CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'min'), pyxb.binding.datatypes.double, scope=CTD_ANON_5, documentation=u'Specifies minimum allowed value for an open interval (no max)'))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'max'), pyxb.binding.datatypes.double, scope=CTD_ANON_5, documentation=u'Specifies maximum allowed value for an open interval (no min)'))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'interval'), decimalPair, scope=CTD_ANON_5, documentation=u'Range of allowed values (closed interval) for this component'))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'valueList'), decimalList, scope=CTD_ANON_5, documentation=u'List of allowed values for this component'))
CTD_ANON_5._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'min'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'interval'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'max'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'valueList'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
...
CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), timePositionType, scope=CTD_ANON_6, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))
...
CTD_ANON_6._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'uom'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
...
CTD_ANON_7._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), pyxb.binding.datatypes.string, scope=CTD_ANON_7, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))
CTD_ANON_7._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
...
TimeIntervalGridType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=TimeIntervalGridType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=TimeIntervalGridType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TimeIntervalGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extent'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TimeIntervalGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'origin'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TimeIntervalGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'originPos'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=True, transitions=[
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
    ...
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TimeIntervalGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'windowDuration'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=TimeIntervalGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'windowInterval'))),
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=TimeIntervalGridType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'duration'))),
    ])
...
TimeGridEnvelopePropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeGridEnvelope'), CTD_ANON_8, scope=TimeGridEnvelopePropertyType, documentation=u'Grid extent specified in grid coordinates - i.e. 2 integers'))
...
CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'high'), pyxb.binding.datatypes.integer, scope=CTD_ANON_8))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'low'), pyxb.binding.datatypes.integer, scope=CTD_ANON_8))
CTD_ANON_8._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'low'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'high'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_10, scope=DataComponentPropertyType, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)'))

DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_16, scope=DataComponentPropertyType, documentation=u'Decimal number with optional unit and constraints'))

DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Category'), CTD_ANON_11, scope=DataComponentPropertyType, documentation=u'A simple token identifying a term or category (single spaces allowed); definition attribute should provide dictionary entry useful for interpretation of the value'))

DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_9, scope=DataComponentPropertyType, documentation=u'Integer pair used for specifying a count range'))

DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_7, scope=DataComponentPropertyType, documentation=u'Free textual component'))

DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_1, scope=DataComponentPropertyType, documentation=u'Integer number used for a counting value'))

DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_3, scope=DataComponentPropertyType, documentation=u'Decimal pair for specifying a quantity range with constraints'))
...
DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_6, scope=DataComponentPropertyType, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))

DataComponentPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_14, scope=DataComponentPropertyType, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))
...
CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'constraint'), AllowedValuesPropertyType, scope=CTD_ANON_9, documentation=u'The constraint property defines the permitted values, as a range or enumerated list'))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), countPair, scope=CTD_ANON_9, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))
CTD_ANON_9._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'constraint'), AllowedTimesPropertyType, scope=CTD_ANON_10, documentation=u'The constraint property defines the permitted values, as a range or enumerated list'))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), timePair, scope=CTD_ANON_10, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'quality'), QualityPropertyType, scope=CTD_ANON_10, documentation=u'The quality property provides an indication of the reliability of estimates of the asociated value'))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'uom'), UomPropertyType, scope=CTD_ANON_10, documentation=u'Unit of measure'))
CTD_ANON_10._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'uom'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
...
SquareMatrixType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=SquareMatrixType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=SquareMatrixType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
    ...
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=SquareMatrixType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'encoding'))),
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=SquareMatrixType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'values'))),
    ])
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=True, transitions=[
    ])
    , 6 : pyxb.binding.content.ContentModelState(state=6, is_final=False, transitions=[
...
AnyScalarPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_16, scope=AnyScalarPropertyType, documentation=u'Decimal number with optional unit and constraints'))

AnyScalarPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_6, scope=AnyScalarPropertyType, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))

AnyScalarPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_1, scope=AnyScalarPropertyType, documentation=u'Integer number used for a counting value'))

AnyScalarPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_14, scope=AnyScalarPropertyType, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))

AnyScalarPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Category'), CTD_ANON_11, scope=AnyScalarPropertyType, documentation=u'A simple token identifying a term or category (single spaces allowed); definition attribute should provide dictionary entry useful for interpretation of the value'))

AnyScalarPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_7, scope=AnyScalarPropertyType, documentation=u'Free textual component'))
...
TypedValueType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TypedValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'property'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TypedValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
})
...
AllowedValuesPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AllowedValues'), CTD_ANON_5, scope=AllowedValuesPropertyType, documentation=u'List of allowed values (There is an implicit AND between all members)'))
...
CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'codeSpace'), CodeSpacePropertyType, scope=CTD_ANON_11, documentation=u'Provides link to dictionary or rule set to which the value belongs'))

CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), pyxb.binding.datatypes.token, scope=CTD_ANON_11, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))

CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'constraint'), AllowedTokensPropertyType, scope=CTD_ANON_11, documentation=u'The constraint property defines the permitted values, as an enumerated list'))

CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'quality'), QualityPropertyType, scope=CTD_ANON_11, documentation=u'The quality property provides an indication of the reliability of estimates of the asociated value'))
CTD_ANON_11._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'codeSpace'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
...
QuantityRangePropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_3, scope=QuantityRangePropertyType, documentation=u'Decimal pair for specifying a quantity range with constraints'))
...
CTD_ANON_13._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_1, scope=CTD_ANON_13, documentation=u'Integer number used for a counting value'))
...
CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_14, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'quality'), QualityPropertyType, scope=CTD_ANON_14, documentation=u'The quality property provides an indication of the reliability of estimates of the asociated value'))
CTD_ANON_14._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
...
PositionType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'angularVelocity'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'velocity'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'acceleration'))),
        pyxb.binding.content.ContentModelTransition(next_state=10, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'angularAcceleration'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'time'))),
        pyxb.binding.content.ContentModelTransition(next_state=6, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'state'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'orientation'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=PositionType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'velocity'))),
...
TypedValueListPropertyType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TypedValueListPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TypedValueList'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_10, scope=CTD_ANON_15, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)'))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_16, scope=CTD_ANON_15, documentation=u'Decimal number with optional unit and constraints'))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_9, scope=CTD_ANON_15, documentation=u'Integer pair used for specifying a count range'))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Category'), CTD_ANON_11, scope=CTD_ANON_15, documentation=u'A simple token identifying a term or category (single spaces allowed); definition attribute should provide dictionary entry useful for interpretation of the value'))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_7, scope=CTD_ANON_15, documentation=u'Free textual component'))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'), AbstractDataArrayType, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_15, documentation=u'Implemetation of ISO-11404 Array datatype. This defines an array of identical data components with a elementCount. Values are given as a block and can be encoded in different ways'))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_1, scope=CTD_ANON_15, documentation=u'Integer number used for a counting value'))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_3, scope=CTD_ANON_15, documentation=u'Decimal pair for specifying a quantity range with constraints'))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'), AbstractDataRecordType, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_6, scope=CTD_ANON_15, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_14, scope=CTD_ANON_15, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))
CTD_ANON_15._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Quantity'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Category'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Text'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Count'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'CountRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Time'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Boolean'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'uom'), UomPropertyType, scope=CTD_ANON_16, documentation=u'Unit of measure'))
...
CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'value'), pyxb.binding.datatypes.double, scope=CTD_ANON_16, documentation=u'Value is optional, to enable structure to act in a schema for values provided using other encodings'))
CTD_ANON_16._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'uom'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'constraint'))),
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quality'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
...
VectorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'coordinate'), CTD_ANON_17, scope=VectorType))
...
ConditionalDataType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'case'), CTD_ANON_24, scope=ConditionalDataType))
ConditionalDataType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ConditionalDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'case'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ConditionalDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ConditionalDataType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ConditionalDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'case'))),
    ])
...
CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_1, scope=CTD_ANON_17, documentation=u'Integer number used for a counting value'))

CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_16, scope=CTD_ANON_17, documentation=u'Decimal number with optional unit and constraints'))

CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_6, scope=CTD_ANON_17, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))
CTD_ANON_17._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Count'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Quantity'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Time'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
QuantityPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_16, scope=QuantityPropertyType, documentation=u'Decimal number with optional unit and constraints'))
...
TimeGeometricComplexType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TimeGeometricComplexType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TimeGeometricComplexType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'primitive'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TimeGeometricComplexType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TimeGeometricComplexType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TimeGeometricComplexType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'primitive'))),
...
TypedValueListType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TypedValueListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'property'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TypedValueListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TypedValueListType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'value'))),
    ])
...
TimeAggregateType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TimeAggregateType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TimeAggregateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'member'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=TimeAggregateType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TimeAggregateType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'member'))),
    ])
...
CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'member'), CTD_ANON_25, scope=CTD_ANON_18))
CTD_ANON_18._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_18._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'member'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_18._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'member'))),
    ])
...
SimpleDataRecordType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataRecordType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataRecordType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SimpleDataRecordType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'field'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataRecordType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=SimpleDataRecordType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'field'))),
...
CountPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_1, scope=CountPropertyType, documentation=u'Integer number used for a counting value'))
...
AbstractConditionalType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'condition'), CTD_ANON_15, scope=AbstractConditionalType, documentation=u'Specifies one or more conditions for which the given value is valid'))
...
ConditionalValueType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'data'), CTD_ANON_21, scope=ConditionalValueType))
ConditionalValueType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ConditionalValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'condition'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ConditionalValueType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=ConditionalValueType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=ConditionalValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'condition'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=ConditionalValueType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'data'))),
    ])
    , 3 : pyxb.binding.content.ContentModelState(state=3, is_final=True, transitions=[
    ])
    , 4 : pyxb.binding.content.ContentModelState(state=4, is_final=False, transitions=[
...
TimeRangePropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_10, scope=TimeRangePropertyType, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)'))
...
CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_7, scope=CTD_ANON_21, documentation=u'Free textual component'))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_16, scope=CTD_ANON_21, documentation=u'Decimal number with optional unit and constraints'))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_14, scope=CTD_ANON_21, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_9, scope=CTD_ANON_21, documentation=u'Integer pair used for specifying a count range'))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_10, scope=CTD_ANON_21, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)'))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Category'), CTD_ANON_11, scope=CTD_ANON_21, documentation=u'A simple token identifying a term or category (single spaces allowed); definition attribute should provide dictionary entry useful for interpretation of the value'))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'), AbstractDataRecordType, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_21))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_6, scope=CTD_ANON_21, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_1, scope=CTD_ANON_21, documentation=u'Integer number used for a counting value'))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'), AbstractDataArrayType, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_21, documentation=u'Implemetation of ISO-11404 Array datatype. This defines an array of identical data components with a elementCount. Values are given as a block and can be encoded in different ways'))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_3, scope=CTD_ANON_21, documentation=u'Decimal pair for specifying a quantity range with constraints'))
CTD_ANON_21._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'CountRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Count'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Boolean'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Category'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Time'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Text'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Quantity'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
NormalizedCurveType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=5, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extrapolationMethod'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'interpolationMethod'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=8, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'function'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
        ...
        pyxb.binding.content.ContentModelTransition(next_state=9, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'inputGain'))),
        pyxb.binding.content.ContentModelTransition(next_state=4, element_use=NormalizedCurveType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'inputBias'))),
...
SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_6, scope=SimpleDataPropertyType, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Quantity'), CTD_ANON_16, scope=SimpleDataPropertyType, documentation=u'Decimal number with optional unit and constraints'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Boolean'), CTD_ANON_14, scope=SimpleDataPropertyType, documentation=u'Scalar component used to express truth: True or False, 0 or 1'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'), CTD_ANON_10, scope=SimpleDataPropertyType, documentation=u'Time value pair for specifying a time range (can be a decimal or ISO 8601)'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_7, scope=SimpleDataPropertyType, documentation=u'Free textual component'))
...
SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Category'), CTD_ANON_11, scope=SimpleDataPropertyType, documentation=u'A simple token identifying a term or category (single spaces allowed); definition attribute should provide dictionary entry useful for interpretation of the value'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Count'), CTD_ANON_1, scope=SimpleDataPropertyType, documentation=u'Integer number used for a counting value'))
...
SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_9, scope=SimpleDataPropertyType, documentation=u'Integer pair used for specifying a count range'))

SimpleDataPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'), CTD_ANON_3, scope=SimpleDataPropertyType, documentation=u'Decimal pair for specifying a quantity range with constraints'))
SimpleDataPropertyType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Time'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Boolean'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TimeRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Text'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataArray'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Category'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'CountRange'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Count'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AbstractDataRecord'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Quantity'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=SimpleDataPropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'QuantityRange'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_23._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'metaDataProperty'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
    ])
...
TimePropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Time'), CTD_ANON_6, scope=TimePropertyType, documentation=u'Either ISO 8601 (e.g. 2004-04-18T12:03:04.6Z) or time relative to a time origin'))
...
CTD_ANON_24._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ConditionalValue'), ConditionalValueType, scope=CTD_ANON_24, documentation=u'Qualifies data (scalar or not) with one or more conditions'))
CTD_ANON_24._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ConditionalValue'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CountRangePropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CountRange'), CTD_ANON_9, scope=CountRangePropertyType, documentation=u'Integer pair used for specifying a count range'))
...
CTD_ANON_25._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Component'), CTD_ANON_20, scope=CTD_ANON_25))

CTD_ANON_25._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Block'), CTD_ANON_12, scope=CTD_ANON_25))
CTD_ANON_25._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Component'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Block'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
TypedValuePropertyType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=TypedValuePropertyType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'TypedValue'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
    ])
})
...
CTD_ANON_26._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'name'))),
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'member'))),
        pyxb.binding.content.ContentModelTransition(next_state=3, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml'), u'description'))),
    ])
    , 2 : pyxb.binding.content.ContentModelState(state=2, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'member'))),
    ])
...
TextPropertyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Text'), CTD_ANON_7, scope=TextPropertyType, documentation=u'Free textual component'))
