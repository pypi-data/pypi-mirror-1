# $Id: session.py 2013 2005-12-31 03:19:39Z zzzeek $
...
import Cookie
import hmac, md5, time, random, os, re, UserDict
...
class Session(UserDict.DictMixin):
    ...
    def __init__(self, request, id = None, invalidate_corrupt = False, use_cookies = True, type = None, data_dir = None, key = 'myghty_session_id', timeout = None, secret = None, log_file = None, namespace_class = None, **params):
        if type is None:
            if data_dir is None:
                self.type = 'memory'
            else:
