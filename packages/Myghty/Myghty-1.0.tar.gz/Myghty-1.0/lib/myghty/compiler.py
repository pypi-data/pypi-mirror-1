# $Id: compiler.py,v 1.1.1.1 2006/01/12 20:54:38 classic Exp $
...
class Compiler:
    ...
    def get_object_id(self):
        ...
        return "%s|%s|%s" % (self.lexer.get_object_id(), "Myghty.Compiler", self.get_magic_number())

    def get_magic_number(self):
        return Compiler.MAGIC_NUMBER
