# $Id: interp.py,v 1.1.1.1 2006/01/12 20:54:38 classic Exp $
...
import weakref, imp, py_compile, StringIO
    ...
    class CompileRecord:
        ...
        def get_compiled_source(self):
            if self.compiledsource is not None:
                return StringIO.StringIO(self.compiledsource)
            else:
