# $Id: objgen.py,v 1.1.1.1 2006/01/12 20:54:38 classic Exp $
...
class PythonGenerator:
    ...
    def _generate_module_header(self, compiled):
        ...
        if (compiled.flags.has_key('encoding')):
            self.printer.print_comment("-*- coding: %s -*-" % eval(compiled.flags['encoding']))
        ...
        self.printer.print_python_line("_MAGIC_NUMBER = %d" % self.compiler.get_magic_number())
