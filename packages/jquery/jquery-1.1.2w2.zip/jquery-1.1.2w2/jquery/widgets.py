...
tooltip_js = JSLink("jquery", "jquery.tooltip.js")
tabs_css = CSSLink("jquery/css", "tabs.css",
                    media = "print, projection, screen")
tabs_pack_js = JSLink("jquery/plugins", "jquery.tabs.pack.js")
tooltip_pack_js = JSLink("jquery/plugins", "jquery.tooltip.pack.js")
...
class jqtooltip(Widget):
    javascript = [jquery_js, tooltip_pack_js]
