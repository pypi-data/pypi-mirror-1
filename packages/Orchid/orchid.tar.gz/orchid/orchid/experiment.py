...
if __name__ == '__main__':
    ...
    seed = { 'www.free-daily-jigsaw-puzzles.com':['http://www.free-daily-jigsaw-puzzles.com/'],
             '69.42.67.28': ['http://69.42.67.28/traffic2/?VFJDSz0xMjcz'],
             'www.easywarez.com': ['http://www.easywarez.com/'],
             'www.pichunter.com' : ['http://www.pichunter.com/']}
    ...
    u = Orchid(seed, 5, 10000, 15, 2, Malcontent, [[cssRule, popUnderRule, ExternalIframeRule()]])
    u.crawl()
