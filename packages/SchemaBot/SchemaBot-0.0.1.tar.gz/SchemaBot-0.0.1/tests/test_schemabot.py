...
from schemabot import SchemaBot, SchemaChange
...
class TestSchemaBot(unittest.TestCase):
    ...
    def test_schemabot_version_check_default(self):
        schemabot = SchemaBot(self.metadata, create_table=True)
        schemabot.define_schema(0, upgrade=[], downgrade=[], engine_name=None)
