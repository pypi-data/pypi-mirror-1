...
$Id: testIndex.py 2054 2009-03-14 10:11:29Z ajung $
"""
...
from zopyx.txng3.core.interfaces import IIndex, IIndexContentCollector, IIndexableContent, IObjectWrapper
...
class MultilingualTests(TextIndexNGTestCase):
    ...
    def testSplitterWithAdditionalChars(self):
        I = Index(fields='text', languages=('en',), splitter_additional_chars='.-+')
        I.index_object(Mock('en', text=u'c++ hello-world algol68'), 1)
