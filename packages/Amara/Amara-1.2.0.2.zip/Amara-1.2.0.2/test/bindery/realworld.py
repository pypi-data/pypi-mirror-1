...
class TestLM050319(TestBase):
    ...
    #http://lists.fourthought.com/pipermail/4suite/2007-March/008236.html
...
class TestBob070514(TestBase):
    #Bob reported bug when a string object gets into a binding
    #http://lists.fourthought.com/pipermail/4suite/2007-May/008259.html
    def testStringInElementChildren(self):
        import amara
        top = amara.parse("<A/>")
        top.A.a = u"one"
        top.A.a = "two"
        top.A.a = u"three"
        self.assertEqual(top.A.a, u"three")
        return
