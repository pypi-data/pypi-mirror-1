...
def create_element(xmlnaming_rule, xmlqname, xmlns=None, xmlename=None):
    ...
    #From this point on, it's safe to not use the "xml" prefix for locals
    #i.e. "instance" is plainly named
    instance = xmlclass()
    instance.nodeName = xmlqname
    if xmlns:
        instance.xmlnsUri = xmlns
        instance.xmlnsPrefix = xmlprefix
        instance.xmlnsLocalName = xmllocal
    return instance
