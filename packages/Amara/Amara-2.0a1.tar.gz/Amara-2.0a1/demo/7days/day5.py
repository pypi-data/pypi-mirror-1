...
<labels xmlns:eg="http://examplotron.org/0/" xmlns:ak="http://purl.org/dc/org/xml3k/akara">
  <label id="tse" eg:occurs="*" ak:resource="@id">
    <quote>What thou lovest well remains, the rest is dross</quote>
    <name ak:rel="'name'" ak:value=".">Ezra Pound</name>
    <address ak:rel="'place'" ak:value="concat(city, ',', state)">
...
print '---------' 'Luis\'s metadata extraction'

BOOK_MODEL = '''<?xml version="1.0" encoding="UTF-8"?>
<books xmlns:ak="http://purl.org/dc/org/xml3k/akara">
