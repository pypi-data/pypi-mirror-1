...
class FormField(InputWidget):
    ...
    # Use genshi by default (to use Mako templates process-wide this class
    # attribute can be monkey-patched and set to 'mako')
    # To use mako only for certain form fields this attribute can be overriden
    # when initializing or displaying the form field.
    engine_name = "genshi"
...
class Form(ContainerMixin, FormField):
    ...
    FileField
    """
    template = "toscawidgets.widgets.forms.templates.form"
...
class FieldSet(ContainerMixin, FormField):
    ...
    """
    template = "toscawidgets.widgets.forms.templates.fieldset"
    params = ["legend"]
...
class ListForm(Form, ListMixin):
    ...
    """
    template = "toscawidgets.widgets.forms.templates.list_form"

class TableForm(Form, TableMixin):
    """
    A form that renders it's fields in a table
    """
    template = "toscawidgets.widgets.forms.templates.table_form"
...
class ListFieldSet(FieldSet, ListMixin):
    ...
    """
    template = "toscawidgets.widgets.forms.templates.list_fieldset"
...
class TableFieldSet(FieldSet, TableMixin):
    ...
    """
    template = "toscawidgets.widgets.forms.templates.table_fieldset"
...
class TextArea(FormField):
    ...
    template = "toscawidgets.widgets.forms.templates.textarea"
    rows = 7
    cols = 50
...
class InputField(FormField):
    ...
    params = ["type"]
    template = "toscawidgets.widgets.forms.templates.input_field"
...
class SelectionList(ListMixin, SelectionField):
    ...
    template = "toscawidgets.widgets.forms.templates.selection_list"
...
class SingleSelectField(SingleSelectionMixin, SelectionField):
    ...
    template = "toscawidgets.widgets.forms.templates.select_field"
...
class CheckBoxTable(CheckBoxList):
    ...
    """
    template = "toscawidgets.widgets.forms.templates.check_box_table"
    params = ["num_cols"]
    num_cols = 1
