...
setup(
    name='mm2s5',
    version='0.1.0',
    description="Comver a FreeMind mind-map (mm) into an S5 (html) presentation.",
    long_description=
"""This is a simple utility to convert a FreeMind min-map (.mm) into an S5 (html) presentation.  
