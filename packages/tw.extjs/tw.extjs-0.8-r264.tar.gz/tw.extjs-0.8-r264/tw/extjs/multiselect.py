...
ddview_js = JSLink(modname=__name__, filename='static/DDView.js', javascript=[])
multiselect_css = CSSLink(modname=__name__, filename='static/resources/css/Multiselect.css')
multiselect_js = JSLink(modname=__name__, filename='static/Multiselect.js', javascript=[ddview_js], css=[multiselect_css,])
