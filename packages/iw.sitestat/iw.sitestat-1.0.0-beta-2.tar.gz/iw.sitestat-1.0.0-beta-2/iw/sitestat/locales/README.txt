...
Easy::
  ...
  $ cd .../iw.sitestat/iw/sitestat/locales # Here ;)
  $ mkdir -p xx/LC_MESSAGES
  $ cp iw.sitestat.pot xx/LC_MESSAGES/iw.sitestat.po
  $ $EDITOR xx/LC_MESSAGES/iw.sitestat.po
...
got iw.sitestat with a subversion checkout.
