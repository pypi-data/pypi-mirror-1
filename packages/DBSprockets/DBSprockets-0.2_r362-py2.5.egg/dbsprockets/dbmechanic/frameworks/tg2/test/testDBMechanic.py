...
<input type="hidden" name="dbsprockets_id" class="hiddenfield" id="tableDef__tg_user_dbsprockets_id">
</table>
      </div>""" in value, value
...
#                           u'created': datetime.datetime(2008, 2, 23, 11, 59, 35, 144897), 
    ...
    def testCreateRelationshipsManyMany(self):
        ...
        user_group_table.insert(tg_group=1, tg_user=1)
        resp = app.get('/dbmechanic/edit/user_group', params=dict(user_id=1, group_id=2))
