...
""",
      ...
      url='https://ingeniweb.svn.sourceforge.net/svnroot/ingeniweb/IngeniSkel',
      ...
      iw_plone = ingeniskel:IWPlone
      iw_python = ingeniskel:IWPython
      iw_content = ingeniskel:IWContent
      """,
      )
