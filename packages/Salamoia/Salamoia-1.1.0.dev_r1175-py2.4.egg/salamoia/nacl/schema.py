...
class Definition(Element):
    ...
    attributes = ['interface', 'container', 'keyAttribute']
    ...
    def init(self):
        ...
        for i in self.children:
            if isinstance(i, Ldap):
                self.ldap = i 
                break

        self.containerClass = None
        if self.container:            
            self.containerClass = interface.classMap[self.container]
...
class Singleton(Definition):
    ...
    def absoluteDN(self):
        ...
        parent = interface.classMap[self.container]
...
class Entity(Definition):
    def init(self):
        ...
        SchemaClass.__name__ = str(self.interface)



class Schema(RootElement):
