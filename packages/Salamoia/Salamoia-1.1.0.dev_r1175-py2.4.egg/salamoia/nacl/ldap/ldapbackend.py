...
class LDAPBackend(NACLBackend):
    ...
    def controlClass(self):
        return LDAPBackendModularService
...
class LDAPBackendService(BackendService):
    ...
    def baseFetch(self, id):
        ...
        type = TypeSpec.fromObjectClass(res[0][1]['objectClass'])
        if not type:
    ...
    def search(self, searchSpec):
        ...
        searchSpec.setBackendContext(self)
...
Backend.registerBackend("ldap", LDAPBackend)
