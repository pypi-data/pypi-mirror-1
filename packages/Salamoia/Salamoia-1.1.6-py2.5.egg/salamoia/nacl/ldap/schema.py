    ...
    def schemaClass(self):
        class SchemaClass(LDAPObject):
            def __init__(self, service=None):
                ...
                # TODO: fix this using closure local variable
                super(self.__class__, self).__init__()

                # USE templateFetch instead!
                #for attr in self.schema.attributes:
                #    initial = attr.evalInitial(self)
                #    
                #    if initial and attr.required:
        ...
        try:
            ...
            # cannot crash here, potential deadlock in authentication, may run without hooks
