# private. imported at the end of utility.tpg
from tpg import *
import salamoia.utility
import os
...
def GenerateParser(externParser):
    ...
    #print >>out, "from salamoia.utility.decorators.makeconstants import *"
    print >>out, "class %s(salamoia.utility.tpg.Parser):" % (cls.__name__)
    #print >>out, "class %s(salamoia.utility.tpg.VerboseParser):" % (cls.__name__)
