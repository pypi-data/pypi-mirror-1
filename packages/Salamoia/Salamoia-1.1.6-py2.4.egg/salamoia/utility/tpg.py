...
class TPGParser(tpg.Parser):
    ...
    class Or(NotEmpty):
        ...
        def gen_code(self, indent, counters, pos):
            ...
            return [
                ...
                indent + "except salamoia.utility.tpg.WrongToken:",
        ...
        def gen_code(self, indent, counters, pos):
            ...
            # A*
                ...
                return [
                    ...
                    indent + tab + "except salamoia.utility.tpg.WrongToken:",
    ...
    def gen(self, options, tokens, rules):
        ...
        yield self.make_code("init_lexer",
            ...
            tab + "lexer = salamoia.utility.tpg.%s(%s, %s)"%(lexer.__name__, word_bounded, lexer_options),
...
from tpgext import *
#from salamoia.salamoia.utility.decorators.makeconstants import *
#import sys
