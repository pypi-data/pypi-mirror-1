...
class TPGParser(tpg.Parser):
    ...
    class Options:
        ...
        def lexer_compile_options(self):
            ...
            return "+".join([ "salamoia.h2o.tpg.re.%s"%opt for opt in options if opt ]) or 0
    ...
    class Or(NotEmpty):
        ...
        def gen_code(self, indent, counters, pos):
            ...
            return [
                ...
                indent + "except salamoia.h2o.tpg.WrongToken:",
        ...
        def gen_code(self, indent, counters, pos):
            ...
            # A*
                ...
                return [
                    ...
                    indent + tab + "except salamoia.h2o.tpg.WrongToken:",
    ...
    def gen(self, options, tokens, rules):
        ...
        yield self.make_code("init_lexer",
            ...
            tab + "lexer = salamoia.h2o.tpg.%s(%s, %s)"%(lexer.__name__, word_bounded, lexer_options),
...
from tpgext import *
#from salamoia.salamoia.h2o.decorators.makeconstants import *
#import sys
