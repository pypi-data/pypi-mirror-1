...
class Handler(BaseHandler):
    def __init__(self, filepath, environ):
        ...
        # Add description.
        if (self.config.has_section('metadata') and
                'description' in self.config.options('metadata')):
    ...
    def _parseconstraints(self, constraints=None):
        ...
        if self.config.has_section('NC_GLOBAL'):
        ...
        if (self.config.has_section('metadata') and 
                'name' in self.config.options('metadata')):
