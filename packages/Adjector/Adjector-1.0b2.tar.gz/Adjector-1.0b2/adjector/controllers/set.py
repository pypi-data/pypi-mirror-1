...
class SetController(ContainerObjectController):
    ...
    def add_set(self, id):
        raise ForwardRequestException('/new/set?parent_id=%i' % id)
    
    def add_creative(self, id):
        raise ForwardRequestException('/new/creative?parent_id=%i' % id)
