...
import logging #IGNORE:W0611

from adjector.lib.base import *

log = logging.getLogger(__name__)

class LocationController(ContainerObjectController):
    ...
    def add_location(self, id):
        raise ForwardRequestException('/new/location?parent_id=%i' % id)
    
    def add_zone(self, id):
        raise ForwardRequestException('/new/zone?parent_id=%i' % id)