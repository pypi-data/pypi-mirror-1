...
#define ArmID_Object_Check(v)	((v)->ob_type == &ArmID_Type)
#define ArmHandle_Object_Check(v)	((v)->ob_type == &ArmHandle_Type)
#define ArmCorrelator_Object_Check(v)	((v)->ob_type == &ArmCorrelator_Type)
#define ArmArrivalTime_Object_Check(v)	((v)->ob_type == &ArmArrivalTime_Type)
#define ArmBuffer_Object_Check(v)	((v)->ob_type == &ArmBuffer_Type)
#define ArmSubbufferCharset_Object_Check(v)	((v)->ob_type == &ArmSubbufferCharset_Type)
#define ArmSubbufferAppIdentity_Object_Check(v)	((v)->ob_type == &ArmSubbufferAppIdentity_Type)
#define ArmSubbufferAppContext_Object_Check(v)	((v)->ob_type == &ArmSubbufferAppContext_Type)
#define ArmSubbufferTranIdentity_Object_Check(v)	((v)->ob_type == &ArmSubbufferTranIdentity_Type)
#define ArmSubbufferTranContext_Object_Check(v)	((v)->ob_type == &ArmSubbufferTranContext_Type)
#define ArmSubbufferArrivalTime_Object_Check(v)	((v)->ob_type == &ArmSubbufferArrivalTime_Type)
#define ArmSubbufferMetricBindings_Object_Check(v)	((v)->ob_type == &ArmSubbufferMetricBindings_Type)
#define ArmSubbufferMetricValues_Object_Check(v)	((v)->ob_type == &ArmSubbufferMetricValues_Type)
#define ArmSubbufferUser_Object_Check(v)	((v)->ob_type == &ArmSubbufferUser_Type)
#define ArmSubbufferSystemAddress_Object_Check(v)	((v)->ob_type == &ArmSubbufferSystemAddress_Type)
#define ArmSubbufferDiagDetail_Object_Check(v)	((v)->ob_type == &ArmSubbufferDiagDetail_Type)

/* This contains the status of the last call? */
static PyObject *errorStatus;
static int	g_enable_exceptions = 0; /* Non-zero if exceptions are enabled */
...
arm_get_correlator_flags(
	...
	status = arm_get_correlator_flags(
		...
		flag_num,
		&flag);
	if (g_enable_exceptions && (status != ARM_SUCCESS))
	{
...
static PyObject *
ArmCorrelator_getattr(ArmCorrelator *self, char *name)
{
	if (self->x_attr != NULL) {
	...
	return Py_FindMethod(ArmCorrelator_methods, (PyObject *)self, name);
}

static int
ArmCorrelator_setattr(ArmCorrelator *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmCorrelator attribute");
		return rv;
	}
	else
...
static PyTypeObject ArmCorrelator_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmCorrelator_getattr, /*tp_getattr*/
	(setattrfunc)ArmCorrelator_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
static PyObject *
ArmSubbufferAppIdentity_getattr(ArmSubbufferAppIdentity *self, char *name)
{
	if (self->x_attr != NULL) {
		PyObject *v = PyDict_GetItemString(self->x_attr, name);
		if (v != NULL) {
	...
	return Py_FindMethod(ArmSubbufferAppIdentity_methods, (PyObject *)self, name);
}

static int
ArmSubbufferAppIdentity_setattr(ArmSubbufferAppIdentity *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
		self->x_attr = PyDict_New();
		if (self->x_attr == NULL)
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmSubbufferAppIdentity attribute");
		return rv;
	}
	else
		return PyDict_SetItemString(self->x_attr, name, v);
...
static PyTypeObject ArmSubbufferAppIdentity_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmSubbufferAppIdentity_getattr, /*tp_getattr*/
	(setattrfunc)ArmSubbufferAppIdentity_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
#if 0
static void dump_app_context (ArmSubbufferAppContext *self)
{
	int i;

	printf ("arm_subbuffer_app_context_t\n");
	printf ("\t%d\n", self->arm_buffer.context_value_count);

	for (i = 0; i < self->arm_buffer.context_value_count; i++)
	{
		printf ("\t%d: %s\n", i, self->arm_buffer.context_value_array [i]);
	}
}
#endif
...
static PyObject *
ArmSubbufferAppContext_getattr(ArmSubbufferAppContext *self, char *name)
{
	if (self->x_attr != NULL) {
		PyObject *v = PyDict_GetItemString(self->x_attr, name);
		if (v != NULL) {
	...
	return Py_FindMethod(ArmSubbufferAppContext_methods, (PyObject *)self, name);
}

static int
ArmSubbufferAppContext_setattr(ArmSubbufferAppContext *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
		self->x_attr = PyDict_New();
		if (self->x_attr == NULL)
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmSubbufferAppContext attribute");
		return rv;
	}
	else
		return PyDict_SetItemString(self->x_attr, name, v);
...
static PyTypeObject ArmSubbufferAppContext_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmSubbufferAppContext_getattr, /*tp_getattr*/
	(setattrfunc)ArmSubbufferAppContext_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
static PyObject *
ArmSubbufferTranIdentity_getattr(ArmSubbufferTranIdentity *self, char *name)
{
	if (self->x_attr != NULL) {
		PyObject *v = PyDict_GetItemString(self->x_attr, name);
		if (v != NULL) {
	...
	return Py_FindMethod(ArmSubbufferTranIdentity_methods, (PyObject *)self, name);
}

static int
ArmSubbufferTranIdentity_setattr(ArmSubbufferTranIdentity *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
		self->x_attr = PyDict_New();
		if (self->x_attr == NULL)
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmSubbufferTranIdentity attribute");
		return rv;
	}
	else
		return PyDict_SetItemString(self->x_attr, name, v);
...
static PyTypeObject ArmSubbufferTranIdentity_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmSubbufferTranIdentity_getattr, /*tp_getattr*/
	(setattrfunc)ArmSubbufferTranIdentity_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
static PyObject *
ArmSubbufferTranContext_getattr(ArmSubbufferTranContext *self, char *name)
{
	if (self->x_attr != NULL) {
		PyObject *v = PyDict_GetItemString(self->x_attr, name);
		if (v != NULL) {
	...
	return Py_FindMethod(ArmSubbufferTranContext_methods, (PyObject *)self, name);
}

static int
ArmSubbufferTranContext_setattr(ArmSubbufferTranContext *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
		self->x_attr = PyDict_New();
		if (self->x_attr == NULL)
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmSubbufferTranContext attribute");
		return rv;
	}
	else
		return PyDict_SetItemString(self->x_attr, name, v);
...
static PyTypeObject ArmSubbufferTranContext_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmSubbufferTranContext_getattr, /*tp_getattr*/
	(setattrfunc)ArmSubbufferTranContext_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
static PyObject *
ArmSubbufferArrivalTime_getattr(ArmSubbufferArrivalTime *self, char *name)
{
	if (self->x_attr != NULL) {
		PyObject *v = PyDict_GetItemString(self->x_attr, name);
		if (v != NULL) {
	...
	return Py_FindMethod(ArmSubbufferArrivalTime_methods, (PyObject *)self, name);
}

static int
ArmSubbufferArrivalTime_setattr(ArmSubbufferArrivalTime *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
		self->x_attr = PyDict_New();
		if (self->x_attr == NULL)
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmSubbufferArrivalTime attribute");
		return rv;
	}
	else
		return PyDict_SetItemString(self->x_attr, name, v);
...
static PyTypeObject ArmSubbufferArrivalTime_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmSubbufferArrivalTime_getattr, /*tp_getattr*/
	(setattrfunc)ArmSubbufferArrivalTime_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
static PyObject *
ArmSubbufferMetricBindings_getattr(ArmSubbufferMetricBindings *self, char *name)
{
	if (self->x_attr != NULL) {
		PyObject *v = PyDict_GetItemString(self->x_attr, name);
		if (v != NULL) {
	...
	return Py_FindMethod(ArmSubbufferMetricBindings_methods, (PyObject *)self, name);
}

static int
ArmSubbufferMetricBindings_setattr(ArmSubbufferMetricBindings *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
		self->x_attr = PyDict_New();
		if (self->x_attr == NULL)
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmSubbufferMetricBindings attribute");
		return rv;
	}
	else
		return PyDict_SetItemString(self->x_attr, name, v);
...
static PyTypeObject ArmSubbufferMetricBindings_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmSubbufferMetricBindings_getattr, /*tp_getattr*/
	(setattrfunc)ArmSubbufferMetricBindings_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
static PyObject *
ArmSubbufferMetricValues_getattr(ArmSubbufferMetricValues *self, char *name)
{
	if (self->x_attr != NULL) {
		PyObject *v = PyDict_GetItemString(self->x_attr, name);
		if (v != NULL) {
	...
	return Py_FindMethod(ArmSubbufferMetricValues_methods, (PyObject *)self, name);
}

static int
ArmSubbufferMetricValues_setattr(ArmSubbufferMetricValues *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
		self->x_attr = PyDict_New();
		if (self->x_attr == NULL)
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmSubbufferMetricValues attribute");
		return rv;
	}
	else
		return PyDict_SetItemString(self->x_attr, name, v);
...
static PyTypeObject ArmSubbufferMetricValues_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmSubbufferMetricValues_getattr, /*tp_getattr*/
	(setattrfunc)ArmSubbufferMetricValues_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
static PyObject *
ArmSubbufferUser_getattr(ArmSubbufferUser *self, char *name)
{
	if (self->x_attr != NULL) {
		PyObject *v = PyDict_GetItemString(self->x_attr, name);
		if (v != NULL) {
	...
	return Py_FindMethod(ArmSubbufferUser_methods, (PyObject *)self, name);
}

static int
ArmSubbufferUser_setattr(ArmSubbufferUser *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
		self->x_attr = PyDict_New();
		if (self->x_attr == NULL)
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmSubbufferUser attribute");
		return rv;
	}
	else
		return PyDict_SetItemString(self->x_attr, name, v);
...
static PyTypeObject ArmSubbufferUser_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmSubbufferUser_getattr, /*tp_getattr*/
	(setattrfunc)ArmSubbufferUser_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
static PyObject *
ArmSubbufferSystemAddress_getattr(ArmSubbufferSystemAddress *self, char *name)
{
	if (self->x_attr != NULL) {
		PyObject *v = PyDict_GetItemString(self->x_attr, name);
		if (v != NULL) {
	...
	return Py_FindMethod(ArmSubbufferSystemAddress_methods, (PyObject *)self, name);
}

static int
ArmSubbufferSystemAddress_setattr(ArmSubbufferSystemAddress *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
		self->x_attr = PyDict_New();
		if (self->x_attr == NULL)
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmSubbufferSystemAddress attribute");
		return rv;
	}
	else
		return PyDict_SetItemString(self->x_attr, name, v);
...
static PyTypeObject ArmSubbufferSystemAddress_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmSubbufferSystemAddress_getattr, /*tp_getattr*/
	(setattrfunc)ArmSubbufferSystemAddress_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
static PyObject *
ArmSubbufferDiagDetail_getattr(ArmSubbufferDiagDetail *self, char *name)
{
	if (self->x_attr != NULL) {
		PyObject *v = PyDict_GetItemString(self->x_attr, name);
		if (v != NULL) {
	...
	return Py_FindMethod(ArmSubbufferDiagDetail_methods, (PyObject *)self, name);
}

static int
ArmSubbufferDiagDetail_setattr(ArmSubbufferDiagDetail *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
		self->x_attr = PyDict_New();
		if (self->x_attr == NULL)
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmSubbufferDiagDetail attribute");
		return rv;
	}
	else
		return PyDict_SetItemString(self->x_attr, name, v);
...
static PyTypeObject ArmSubbufferDiagDetail_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmSubbufferDiagDetail_getattr, /*tp_getattr*/
	(setattrfunc)ArmSubbufferDiagDetail_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
#if 0
static void dump_buffer (ArmBuffer *self)
{
	int i;
	arm_subbuffer_t *sub_ptr;

	/* Used for debugging */
	printf ("count = %d\n", self->arm_buffer.count);
	for (i = 0; i < self->arm_buffer.count; i++)
	{
		sub_ptr = self->arm_buffer.subbuffer_array [i];
		printf ("%d: %d\n", i, sub_ptr->format);
		if (sub_ptr->format == ARM_SUBBUFFER_APP_CONTEXT)
		{
			int j;
			arm_subbuffer_app_context_t *context_ptr = (arm_subbuffer_app_context_t *) sub_ptr;

			printf ("\tcount %d\n", context_ptr->context_value_count);
			for (j = 0; j < context_ptr->context_value_count; j++)
			{
				const char *value_ptr = context_ptr->context_value_array [j];
				printf ("\t%d: %s\n", j, value_ptr);
			}
			dump_app_context (self->app_context_ptr);
		}
	}
}
#endif
...
static PyObject *
ArmBuffer_getattr(ArmBuffer *self, char *name)
{
	if (self->x_attr != NULL) {
		PyObject *v = PyDict_GetItemString(self->x_attr, name);
		if (v != NULL) {
	...
	return Py_FindMethod(ArmBuffer_methods, (PyObject *)self, name);
}

static int
ArmBuffer_setattr(ArmBuffer *self, char *name, PyObject *v)
{
	if (self->x_attr == NULL) {
		self->x_attr = PyDict_New();
		if (self->x_attr == NULL)
	...
	if (v == NULL) {
		...
		if (rv < 0)
			PyErr_SetString(PyExc_AttributeError,
			        "delete non-existing ArmBuffer attribute");
		return rv;
	}
	else
		return PyDict_SetItemString(self->x_attr, name, v);
...
static PyTypeObject ArmBuffer_Type = {
	...
	0,						/*tp_print*/
	(getattrfunc)ArmBuffer_getattr, /*tp_getattr*/
	(setattrfunc)ArmBuffer_setattr, /*tp_setattr*/
	0,						/*tp_compare*/
	0,						/*tp_repr*/
	0,						/*tp_as_number*/
	0,						/*tp_as_sequence*/
...
arm_get_arrival_time(
	...
	/* Retrun a ArmArrivalTime object */
...
initarm4(void)
{
	...
	errorStatus = PyErr_NewException("arm4.error", NULL, NULL);
    Py_INCREF(errorStatus);
    PyModule_AddObject(m, "error", errorStatus);
}
