...
class Recipe:
    ...
    def __init__(self, buildout, name, options):
        ...
        self.maildrop_location = os.path.join(self.location, 'MaildropHost')
        self.securemaildrop_egg = zc.recipe.egg.Egg(buildout,
    ...
    def install(self):
        ...
        try:
            ...
            if os.path.isdir(self.maildrop_location):
                shutil.rmtree(self.maildrop_location)
            shutil.move(os.path.join(tmp, files[0]), self.maildrop_location)
        finally:
            shutil.rmtree(tmp)

        self.securemaildrop_egg.install()
    ...
    def _build_config(self):
        ...
        config_filename = os.path.join(self.maildrop_location, 'config.py')
    ...
    def _build_script(self):
        ...
        config = dict(base=self.maildrop_location,
                      pidfile=os.path.join(self.mail_dir, 'maildrop.pid'))

        zc.buildout.easy_install.scripts(
            [('maildropctl', 'topp.recipes.securemaildrop.ctl', 'main')],
