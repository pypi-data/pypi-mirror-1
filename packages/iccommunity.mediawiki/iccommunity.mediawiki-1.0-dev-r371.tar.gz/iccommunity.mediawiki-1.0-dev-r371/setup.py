...
source_path=os.path.join(os.path.dirname(__file__), 'iccommunity', 'mediawiki')
version=open(os.path.join(source_path, 'version.txt')).read()
long_description=open(os.path.join(source_path, 'README.txt')).read() + '\n\n'

setup(name='iccommunity.mediawiki',
      version=version,
      description="icCommunity.Mediawiki",
	...
	"Operating System :: OS Independent",
      ...
      keywords='iccommunity, platecom, icsemantic, mediawiki, integration',
      ...
      url='http://www.platecom.com/productos/iccommunity.mediawiki/',
      license='GPL',
