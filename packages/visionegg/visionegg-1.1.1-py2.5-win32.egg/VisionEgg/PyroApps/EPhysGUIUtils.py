...
#
# $Id: EPhysGUIUtils.py 1500 2008-09-18 18:17:33Z astraw $
...
__cvs__ = '$Revision: 1500 $'.split()[1]
__date__ = ' '.join('$Date: 2008-09-18 11:17:33 -0700 (Thu, 18 Sep 2008) $'.split()[1:3])
