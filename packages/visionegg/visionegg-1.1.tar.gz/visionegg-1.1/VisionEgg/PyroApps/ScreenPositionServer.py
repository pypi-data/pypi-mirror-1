...
#
# $Id: ScreenPositionServer.py 1461 2008-06-07 16:31:16Z astraw $
...
__cvs__ = string.split('$Revision: 1461 $')[1]
__date__ = string.join(string.split('$Date: 2008-06-07 09:31:16 -0700 (Sat, 07 Jun 2008) $')[1:3], ' ')
