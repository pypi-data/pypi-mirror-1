...
#
# $Id: ScreenPositionServer.py 1500 2008-09-18 18:17:33Z astraw $
...
__cvs__ = string.split('$Revision: 1500 $')[1]
__date__ = string.join(string.split('$Date: 2008-09-18 11:17:33 -0700 (Thu, 18 Sep 2008) $')[1:3], ' ')
