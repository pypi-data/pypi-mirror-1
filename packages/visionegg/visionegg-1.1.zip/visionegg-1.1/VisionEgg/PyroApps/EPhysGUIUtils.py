...
#
# $Id: EPhysGUIUtils.py 1461 2008-06-07 16:31:16Z astraw $
...
__cvs__ = '$Revision: 1461 $'.split()[1]
__date__ = ' '.join('$Date: 2008-06-07 09:31:16 -0700 (Sat, 07 Jun 2008) $'.split()[1:3])
