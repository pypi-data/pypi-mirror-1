...
ptc.setupPloneSite(
    extension_profiles=('collective.transform.docbook:default',)
)
...
def test_suite():
    return unittest.TestSuite([
        ...
        #    'README.txt', package='collective.transform.docbook',
        #    setUp=testing.setUp, tearDown=testing.tearDown),

        #doctestunit.DocTestSuite(
        #    module='collective.transform.docbook.mymodule',
        #    setUp=testing.setUp, tearDown=testing.tearDown),
        ...
        #    'browser.txt', package='collective.transform.docbook',
        #    test_class=TestCase),
