...
from ljsync.lj_api import LiveJournalClient
...
def crosspost(sender, instance, **kw):
    " Cross-post a Post to LiveJournal and return an LJPost instance on success. To be called on post_save. "
    ...
    if BLOG_ENTRY_CROSSPOST_FIELD:
        try:
            ...
            raise AttributeError, 'Wrong LJ_BLOG_ENTRY_CROSSPOST_FIELD setting: %s' % e.message
        else:
