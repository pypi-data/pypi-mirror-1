...
__version__ = "$Id: cloghandler.py 5490 2008-05-22 19:03:46Z lowell $"
...
from logging.handlers import BaseRotatingHandler, codecs
...
class ConcurrentRotatingFileHandler(BaseRotatingHandler):
    ...
    def __init__(self, filename, mode='a', maxBytes=0, backupCount=0,
        ...
        paramerers are provided to each instance of this class.  If, for
        example, two different processes are using this class, but with
        different values for 'maxBytes' or 'backupCount', then odd behaviour is
        ...
        # the user if they provide a relative path.
