...
[ -d $ROOT/var ] || mkdir -p $ROOT/var/ejabberd
...
sh -c "$ERL -name %(ejabberd_node)s -noinput -pa $PART/lib/ejabberd/ebin -mnesia dir \\"\\\\\\"$HOME\\\\\\"\\" -s ejabberd -sasl sasl_error_logger \\\\{file,\\\\\\"$HOME/ejabberd_sasl.log\\\\\\"\\\\} +K true -smp auto +P 250000"
""" % locals()
