...
#	self.selenium = selenium("localhost", 4444, "*chrome", "http://localhost:8080/eduCommons/login_form")
	...
	import pdb;pdb.set_trace()
    	...
    	sel.type("form.portal_banner","/home/zerin/eduCommons-3.2.1/src/enpraxis.educommons/enpraxis/educommons/tests/seleniumtests/test_headerBackground.png.jpeg")
