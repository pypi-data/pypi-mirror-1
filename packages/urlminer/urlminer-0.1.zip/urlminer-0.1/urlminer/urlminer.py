...
HTTP_REDIRECT_CODES = {301: 'Moved Permanently',
                       302: 'Found',
                       303: 'See Other'}
...
class Resource(object):
    ...
    def __init__(self,parent_app=None,match_object=None):
        "This class is instantiated by its `parent`s __call__ method (unless at the application root)."
    ...
    def index(self, environ, start_response):
        ...
        If REQUEST_METHOD mathes a method name, use that, otherwise return a 404 resonse.
        """
