...
def setup_product():
    ...
    import humboldt.cmfbibliographyat
    zcml.load_config('configure.zcml', humboldt.cmfbibliographyat)
    ...
    ztc.installPackage('humboldt.cmfbibliographyat')
...
setup_product()
ptc.setupPloneSite(products=['humboldt.cmfbibliographyat'])
