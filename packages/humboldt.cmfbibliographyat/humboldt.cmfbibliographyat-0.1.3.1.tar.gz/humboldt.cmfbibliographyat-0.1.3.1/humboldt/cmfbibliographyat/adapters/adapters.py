...
class BibReferenceEntry(BaseFeedEntry):
    ...
    def getBody(self):
        ...
        """ Look up a view from request/detail_view providing additional information
            for the adapted bibliographic item. 'simple_entry_view' and 'full_entry_view'
            are page-templates provided out-of-the-box.
        """

        view_name = self.context.REQUEST.get('detail_view', 'simple_entry_viedw')
