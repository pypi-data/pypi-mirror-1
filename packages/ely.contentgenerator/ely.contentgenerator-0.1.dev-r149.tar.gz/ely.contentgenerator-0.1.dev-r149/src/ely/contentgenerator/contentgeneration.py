...
def markDepth(element, nesting_depth=0):
    element.nesting_depth=nesting_depth
    for kid in element.getchildren():
        markDepth(kid, nesting_depth + 1)
