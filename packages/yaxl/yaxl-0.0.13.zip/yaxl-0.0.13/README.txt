# YAXL #
## Yet Another (Pythonic) XML Library v0.0.13 ##
...
The latest version of YAXL is available in the following formats:
	...
	* [Python Egg](dist/yaxl-0.0.13-py2.4.egg) for use with [setuptools](http://peak.telecommunity.com/DevCenter/setuptools)
	* [Windows installer](dist/yaxl-0.0.13.win32.exe) for use on Windows
	* [Source distribution](dist/yaxl-0.0.13.zip) if you want to hack around
