# YAXL #
## Yet Another (Pythonic) XML Library v0.0.14 ##
...
The latest version of YAXL is available in the following formats:
	...
	* [Python Egg](dist/yaxl-0.0.14-py2.4.egg) for use with [setuptools](http://peak.telecommunity.com/DevCenter/setuptools)
	* [Windows installer](dist/yaxl-0.0.14.win32.exe) for use on Windows
	* [Source distribution](dist/yaxl-0.0.14.zip) if you want to hack around
...
The following people have submitted bug reports or enhancement suggestions: Marc, "Crest", Marcus Gnaﬂ and [Damian Cugley](http://www.blogger.com/profile/3448376). Thank you all for your contribution!
