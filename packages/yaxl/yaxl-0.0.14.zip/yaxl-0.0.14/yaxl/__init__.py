...
class Element(object, XPathMixin):
	...
	def append(self, qname, attributes=None, text=None, namespaces={}):
		...
		elem = Element(qname, attributes, namespaces=namespaces, text=text, _parent=self)
	...
	def __repr__(self, asdoc=False, encoding='UTF8', pretty=False):
		...
		If the `pretty` parameter set to `True`, this method returns
		pretty-printed XML.
		"""
