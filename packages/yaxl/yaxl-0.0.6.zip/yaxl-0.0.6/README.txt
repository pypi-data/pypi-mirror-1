...
I also publish YAXL in the following formats:
	...
	* [Python Egg](dist/yaxl-0.0.6-py2.4.egg) for use with [setuptools](http://peak.telecommunity.com/DevCenter/setuptools)
	* [Source distribution](dist/yaxl-0.0.6.zip) if you want to hack around
