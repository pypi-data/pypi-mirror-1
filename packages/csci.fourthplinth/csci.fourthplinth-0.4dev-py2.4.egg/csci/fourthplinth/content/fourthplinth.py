...
fourthplinthSchema = schemata.ATContentTypeSchema.copy() + atapi.Schema((
    ...
    atapi.StringField(
        ...
        widget=atapi.StringWidget(
            label=_(u"Username"),
            description=_(u"Twitter login username"),
        ),
    ),
    ...
    atapi.StringField(
        ...
        storage=atapi.AnnotationStorage(),
        widget=atapi.StringWidget(
            label=_(u"End tag for tweets"),
            description=_(u"this could be a url to a web page"),
        ),
    ),
...
class fourthplinth(base.ATCTContent):
    ...
    endtag = atapi.ATFieldProperty('endtag')
