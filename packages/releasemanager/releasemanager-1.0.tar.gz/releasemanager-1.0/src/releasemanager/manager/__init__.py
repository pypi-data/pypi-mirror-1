...
class ReleaseManager(object):
    ...
    def finish_transaction(self, trans_id, status):
    ...
    def make_history(self, credentials, request_data):
        """who else thinks a function named make_history is hilarious?  anyone?  ...shut up."""
    ...
    def builderCallback(self, data, history, request_data):
        ...
        if status:
            ...
            self.finish_transaction(trans_id, trans_status)
            return resource
        self.finish_transaction(trans_id, trans_status)
        return False
