...
__all__ = ["Bunch", "TASKS", "task", "Task", "needs", "dry", "info", 
           "debug", "call_task", "require_keys", "sh", "options", 
...
def sh(command, capture=False):
    ...
    command will be captured and returned as a string.
    ...
    if capture:
        ...
        dry(command, subprocess.call, command, shell=True)
