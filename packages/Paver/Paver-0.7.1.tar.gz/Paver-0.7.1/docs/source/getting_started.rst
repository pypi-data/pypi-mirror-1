...
to build a source distribution::
  ...
  -rw-r--r--  1 admin  staff  804 May  8 06:51 TheOldWay-1.0.tar.gz
  # {{{end}}}
...
equivalent output file::
  ...
  # }}}
  total 8
  -rw-r--r--  1 admin  staff  2606 May  8 06:51 TheNewWay-1.0.tar.gz
  # {{{end}}}
...
Worried about bloating your package? The paver-minilib is not large::
  ...
  # }}}
  -rw-r--r--  1 admin  staff  27183 May  8 06:51 docs/samples/started/newway/paver-minilib.zip
  # {{{end}}}
