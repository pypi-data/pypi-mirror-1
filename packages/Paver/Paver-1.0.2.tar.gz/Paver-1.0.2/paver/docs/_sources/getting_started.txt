...
to build a source distribution::
  ...
  # ==>
  total 8
  -rw-r--r--  1 admin  staff  623 Mar  8 11:04 TheOldWay-1.0.tar.gz
  # <==end==>
...
equivalent output file::
  ...
  # ==>
  total 72
  -rw-r--r--  1 admin  staff  32812 Mar  8 11:04 TheNewWay-1.0.tar.gz
  # <==end==>
...
Worried about bloating your package? The paver-minilib is not large::
  ...
  # ==>
  -rw-r--r--  1 admin  staff  27303 Mar  8 11:04 docs/samples/started/newway/paver-minilib.zip
  # <==end==>
