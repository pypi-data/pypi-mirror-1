...
to build a source distribution::
  ...
  -rw-r--r--  1 admin  staff  805 May  8 10:45 TheOldWay-1.0.tar.gz
  # {{{end}}}
...
equivalent output file::
  ...
  # }}}
  total 8
  -rw-r--r--  1 admin  staff  2607 May  8 10:45 TheNewWay-1.0.tar.gz
  # {{{end}}}
...
Worried about bloating your package? The paver-minilib is not large::
  ...
  # }}}
  -rw-r--r--  1 admin  staff  19516 May  8 10:45 docs/samples/started/newway/paver-minilib.zip
  # {{{end}}}
