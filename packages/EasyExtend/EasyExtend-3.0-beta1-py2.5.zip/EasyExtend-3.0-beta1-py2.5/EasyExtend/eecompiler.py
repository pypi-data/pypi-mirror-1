...
class EECompiler(eeoptions.EEShow):
    ...
    def parse_file(self, filename):
        ...
        @param grammarObj: language specific grammarObj read from parsetable.py
        '''
    ...
    def compile_cst(self, node, **kwd):
        if node[0] != self.langlet.symbol.file_input:
    ...
    def compile_suite(self, source, **kwd):
        ...
        @param grammarObj: language specific grammarObj read from parsetable.py
        @param langlet: module object containing language definitions
        '''
        cst = self.parse_suite(source)
