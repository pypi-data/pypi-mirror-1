...
MoneyField.prototype.initialize = function(options) {
    ...
    this.options = Object.extend({
      'decimal_precision': 2,
      'thousand_separator': ',', // not implemented yet
      'decimal_separator': '.' // not implemented yet
    }, options || {});
}
...
MoneyField.prototype.format_price = function(value) {
    ...
    value = parseFloat(value).toFixed(this.options.decimal_precision);
    
    return '$' + this.add_commas(value);
}

MoneyField.prototype.add_commas = function(nStr) {
    nStr += '';
