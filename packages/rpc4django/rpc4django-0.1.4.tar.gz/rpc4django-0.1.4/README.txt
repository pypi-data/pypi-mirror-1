...
Contributors
------------
- `David Fischer <mailto:rpc4django@davidfischer.name>`_
...
``RPC4DJANGO_RESTRICT_REST=True|False`` (default False) **[new in 0.1.4]**
    If ``RPC4DJANGO_RESTRICT_RPCTEST=True``, RPC4Django does not attempt to convert any of the method summary docstrings to restructured text.
