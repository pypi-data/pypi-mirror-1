<div xmlns:py="http://purl.org/kid/ns#" id="${id}" class="yuimenubar yuimenubarnav">
<div class="bd">
	<ul class="first-of-type">
	<li py:for="i, barmenu in enumerate(entries)"
	    class="yuimenubaritem${i==0 and ' first-of-type' or ''}">
		<a href="${barmenu[1]}" class="yuimenubaritemlabel">${barmenu[0]}</a>
