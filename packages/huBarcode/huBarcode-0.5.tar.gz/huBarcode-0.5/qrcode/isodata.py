...
class MatrixInfo:
    ...
    def __init__(self, version, ecl):
        ...
        data_module = __import__('qrcode.data.qrv%d_%d' % (version, ecl),
                                    [], [], 'qrcode.data')
        self.byte_num = data_module.__dict__['byte_num']
        self.matrix_d = copy.deepcopy(data_module.__dict__['matrix_d'])
        self.format_info = copy.deepcopy(data_module.__dict__['format_info'])
        self.rs_ecc_codewords = data_module.__dict__['rs_ecc_codewords']
        self.rs_block_order = \
                        copy.deepcopy(data_module.__dict__['rs_block_order'])
        self.rs_cal_table = \
                          copy.deepcopy(data_module.__dict__['rs_cal_table'])
        self.frame_data = copy.deepcopy(data_module.__dict__['frame_data'])
    # end def __init__
