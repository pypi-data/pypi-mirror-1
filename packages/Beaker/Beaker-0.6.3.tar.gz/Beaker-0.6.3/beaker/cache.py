...
try:
    ...
    cache_manager = StackedObjectProxy(name="Cache Manager")
except:
    pass
...
class Cache:
    ...
    """
    def __init__(self, cache_info=None, type=None, container_class=None , debug_file=None, **params):
    ...
    def get_value(self, key, **params):
        if isinstance(key, unicode):
            key = str(key.decode('utf8', 'ignore'))
...
class CacheMiddleware(object):
    def __init__(self, app, global_conf=None, **params):
        self.app = app
