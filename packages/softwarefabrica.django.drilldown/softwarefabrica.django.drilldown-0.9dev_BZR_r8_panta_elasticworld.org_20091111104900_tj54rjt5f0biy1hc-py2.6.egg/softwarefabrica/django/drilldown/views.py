...
class DrillDownInfo(object):
    def __init__(self, vcall, request, url, queryset, drilldown_fields, view_name,
    ...
    def _trim_view_arguments(self):
        ...
        for k in ('request', 'url', 'queryset', 'fields', 'paginate_by', 'page',
                  'template_name', 'template_loader', 'extra_context',
                  'login_required', 'context_processors', 'mimetype',
                  'lookup_kwargs', 'ddinfo_class', 'ddfield_class',
                  'template_object_name', 'view_name'):
...
class DrillDownView(GenericView):
    ...
    def __call__(self, request, url, *args, **kwargs):
        ...
        ddinfo = ddinfo_class(vcall, request, url, queryset, drilldown_fields,
        ...
        #self.populate_xheaders(vcall, request, response, model, object_id)
        return response
    ...
    def get_template(self, vcall, template_name = None, template_loader = None):
        ...
        vcall.c_template_name = template_name
        return super(DrillDownView, self).get_template(vcall,
