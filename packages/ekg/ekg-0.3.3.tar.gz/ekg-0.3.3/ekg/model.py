...
engine = create_engine('sqlite:///sqllite.db') #, echo=True)
metadata = MetaData()
...
__all__ = ['Stream', 'FPMailman', 'FHMailman', 'RHMailman', 'Source', 'Fact', 'session', 'Session', 'metadata', 'engine', 'stream_classes']
