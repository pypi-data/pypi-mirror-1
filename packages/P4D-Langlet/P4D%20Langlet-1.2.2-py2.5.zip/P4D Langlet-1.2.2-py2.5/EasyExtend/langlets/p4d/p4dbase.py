...
__all__ = ["P4D", "P4DNode", "P4D", "P4DList", "P4DName", "P4DNamespace", "P4DAccessError"]
...
class P4D(object):
    ...
    '''
    __slots__ = ['_tree', '_parent', '_text', '_children', '_idx', '_parent', 'tag', '_attrs', '_name']
    parser   = None
    p4d_kwd  = False
    ListType = P4DList
    def __init__(self, tree, parent = None):
        ...
        self._name  = None
        if IGNOREWHITESPACE:
            self._text  = text # p4dutils.ignore_whitespace(text)
        else:
            self._text  = text
    ...
    def _remap(self):
        self._tree = [self.tag, self._attrs, self._children, self._text]
