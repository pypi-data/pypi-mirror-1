...
class LangletTransformer(Transformer):
    ...
    def build_p4d_expr(self, node):
        ...
        if _expr_list:
            [self.build_p4d_expr(item) for item in _expr_list]
...
__publish__ = ["mapeval", "P4DNode", "P4D", "P4DList", "P4DName", "P4DNamespace", "P4DAccessError", "Bytelet", "ByteletSchema", "LEN", "Hex", "Bin", "VAL", "RAWLEN"]
