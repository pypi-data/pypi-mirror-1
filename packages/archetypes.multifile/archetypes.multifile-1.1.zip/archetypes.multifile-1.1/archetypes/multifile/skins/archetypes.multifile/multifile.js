...
function addEvent(fieldname)
{
    ...
    newdiv.innerHTML = "<input type=\"file\" onchange=\"return addEvent('"+fieldname+"')\" size=\"30\" tabindex=\"\"     name=\""+fieldname+":list\" id=\""+fieldname+":list\">&nbsp;<a href=\"javascript:;\" onclick=\"return removeEvent(\'"+divIdName+"\',\'"+fieldname+"\')\">Remove</a><br>";
