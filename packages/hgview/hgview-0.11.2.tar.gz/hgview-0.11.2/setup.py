...
## need to copy __pkginfo__.py in the resource of hgview.
## this file is indispensable when building the distribution's
## packages with lgp command
if exists('./__pkginfo__.py'):
    shutil.copy('./__pkginfo__.py', './hgview/__pkginfo__.py')

# import required features
try:
    from __pkginfo__ import short_desc, long_desc, license, version, modname, web
except ImportError:
    license = 'GPL'
...
try:
    from __pkginfo__ import author, author_email
except ImportError:
    author = "Logilab"
...
if __name__ == '__main__' :
    install()
    ## no need any more for this file, our package is
    ## already builded
    dest='./hgview/__pkginfo__.py'
    if exists(dest):
        os.remove(dest)
