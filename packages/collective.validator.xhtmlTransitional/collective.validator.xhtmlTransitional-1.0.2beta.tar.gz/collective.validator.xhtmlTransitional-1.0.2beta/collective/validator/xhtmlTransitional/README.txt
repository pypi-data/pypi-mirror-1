----------------------------------------------------------------------------------------------------------
|--XHTML Transitional Validator--|
----------------------------------------------------------------------------------------------------------

This product is an XHTML Transitional Validator for the collective.validator.base package.
This egg extends base functionalities and allows to validate all the css registered in portal_css.

To use it, you should only register it in buildout.cfg.

All the tests are in tests folder and translations in i18n folder.
...
|--Contacts--|
----------------------------------------------------------------------------------------------------------
Andrea Cecchi: legolasc85@gmail.com
