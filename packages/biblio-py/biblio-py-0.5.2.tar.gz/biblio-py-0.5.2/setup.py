...
setup(name="biblio-py",
      ...
      license = "GPLv2",
      url = "http://cabcat2.cnea.gov.ar/grupos/gases/staff/fiol/biblio-py.html",
      download_url="http://cabcat2.cnea.gov.ar/grupos/gases/staff/fiol/files/biblio-py-%s.tar.gz"%(VERSION),
