...
source_path=os.path.join(os.path.dirname(__file__), 'icsemantic', 'thesaurus')
version=open(os.path.join(source_path, 'version.txt')).read()
long_description=open(os.path.join(source_path, 'README.txt')).read() + '\n\n'

setup(name='icsemantic.thesaurus',
      version=version,
      description="icSemantic.Thesaurus",
	...
	"Operating System :: OS Independent",
      ...
      keywords='icsemantic, platecom, semantic, thesaurus, owl, rdf, skos, core, queries',
      ...
      url='http://www.platecom.com/productos/icsemantic.thesaurus/',
      license='GPL',
