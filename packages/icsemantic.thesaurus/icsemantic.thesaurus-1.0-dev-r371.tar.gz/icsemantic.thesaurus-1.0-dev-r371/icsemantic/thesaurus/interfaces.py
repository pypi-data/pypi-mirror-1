...
class IicSemanticManagementThesaurusUpload( Interface ):
    ...
    default_language = schema.Choice(
		    ...
		    description = _(u"description_site_language",
			    default=u"If the uploaded thesaurus has no language, please enter the language in this field"),
		    required = True,
		    vocabulary="icsemantic.languages")
    thesaurus_context = schema.TextLine(
		    title = _(u"heading_thesaurus_context",
			    u"Default Context"),
		    description = _(u"description_thesaurus_context",
			    default=u"if the uploaded thesaurus has no context, please enter the context in this field"),
...
class IicSemanticThesaurusConfiguration( Interface ):
    ...
    keywords_incrementalsearchwidget = schema.Bool(
            title = _(u"heading_keywords_incrementalsearchwidget",
			    u"Keywords widget"),
		    description = _(u"description_keywords_incrementalsearchwidget",
			    u"Use incremental search widget to choose thesaurus terms at documents properties form.\nWarning: This option aplies to the whole plone instance."),
		    required = True,
		    )
