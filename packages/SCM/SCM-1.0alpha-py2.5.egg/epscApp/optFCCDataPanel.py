...
#        self.chkbox_hkl.Enable(False)
        ...
        for i in range(2) :
            ...
            for j in range(4) :
                ...
                self.text_initial_voceFCC[i].append(wx.TextCtrl(self, -1,size=(50,-1)))
...
#                self.controller.epscData.matParam.setMatrix(i,j,self.text_initial_voceFCC[i][j])
