...
class TestRatingAsAnonymous(RatingTestCase):
    ...
    def testRate_1(self):
        ...
        rm.rate(id=u"score", user=None, score=u"1", ipaddress=u"127.0.0.1")
        rm.rate(id=u"score", user=None, score=u"2", ipaddress=u"127.0.0.2")
        rm.rate(id=u"score", user=None, score=u"3", ipaddress=u"127.0.0.3")
