...
VERSION = "0.0.12" # The current version of pyspread
...
icons = {"FileNew": ICONPREFIX + "icons/actions/filenew.png", \
         ...
         "FormatTextBold": ICONPREFIX + "icons/actions/format-text-bold.png",
         "FormatTextItalic": ICONPREFIX + "icons/actions/format-text-italic.png",
         "FormatTextUnderline": ICONPREFIX + "icons/actions/format-text-underline.png",
         "FormatTextStrikethrough": ICONPREFIX + "icons/actions/format-text-strikethrough.png",
         "AlignTop": ICONPREFIX + "icons/actions/format-text-aligntop.png",
         "AlignCenter": ICONPREFIX + "icons/actions/format-text-aligncenter.png", 
         "AlignBottom": ICONPREFIX + "icons/actions/format-text-alignbottom.png", 
         "Freeze": ICONPREFIX + "icons/actions/frozen_small.png",
         "SearchDirectionUp": ICONPREFIX + "icons/toggles/go-down.png",
         "SearchDirectionDown": ICONPREFIX + "icons/toggles/go-up.png",
         "SearchCaseSensitive": ICONPREFIX + "icons/toggles/aA.png",
         "SearchRegexp": ICONPREFIX + "icons/toggles/regex.png",
         "SearchWholeword": ICONPREFIX + "icons/toggles/wholeword.png",
         }
...
column_width_tag = '{urn:oasis:names:tc:opendocument:xmlns:style:1.0}column-width'
row_height_tag = '{urn:oasis:names:tc:opendocument:xmlns:style:1.0}row-height'
