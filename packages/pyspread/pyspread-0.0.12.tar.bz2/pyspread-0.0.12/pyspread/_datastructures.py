...
class PyspreadGrid(object):
    ...
    def __init__(self, dimensions=(10, 10, 10)):
        ...
        self._tabukeys = [] # Cycle detection key, use only in _get_single_item
    ...
    def _get_single_item(self, key):
        ...
        # Detect cycles
        if key in self._tabukeys:
            return "KeyError: 'Infinite recursion detected.'"
        self._tabukeys.append(key)
    ...
    def _get_ndim_itemlist(self, key):
        ...
        listkeys = self._get_list_keys(key, list_dim)
        
        list_range = numpy.array([ndim_method(listkey) for listkey in listkeys])
