var normativalivesearch = function (){
    ...
    function _searchfactory($form, $inputnode) {
        ...
        var $request = null;
        var $cache = {};
        var $querytarget = "normativa_livesearch_reply?q=";
        ...
        function _hide_delayed() {
            ...
            window.setTimeout("normativalivesearch.hide('"+$form.id+"')", _hide_delay);
        };
        ...
        function _search_delayed() {
            ...
            window.setTimeout("normativalivesearch.search('"+$form.id+"')", _search_delay);
        };
    ...
    function _keyhandlerfactory($form) {
        ...
        function _handler($event) {
            ...
            switch ($event.keyCode) {
                ...
                default: {
                    $timeout = window.setTimeout("normativalivesearch.search('"+$form.id+"')", _search_delay);
                }
            }
        };
    ...
    function _setup($inputnode, $number) {
        ...
        $form.id = "normativalivesearch"+$number;
    ...
    function _init() {
        ...
        var $gadgets = _cssQuery("#normativasearchGadget, input.normativa-portlet-search-gadget");
