qi.jabberHelpdesk Package Readme
=========================
...
* A free account on the chatblox.com site in which case you don't need your own server
or 
...
If you are using `buildout`_ to manage your instance installing qi.jabberHelpdesk is very simple, just add qi.jabberHelpdesk in the eggs and register it in the zcml sections. 
