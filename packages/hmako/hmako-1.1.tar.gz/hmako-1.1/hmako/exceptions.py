    ...
    def _init(self, trcback):
        ...
        for filename, lineno, function, line in rawrecords:
            try:
                ...
                try:
                    info = htmlmako.template._get_module_info(filename)
...
def text_error_template(lookup=None):
    ...
    import htmlmako.template
    return htmlmako.template.Template(r"""
<%page args="traceback=None"/>
<%!
    from htmlmako.exceptions import RichTraceback
%>\
<%
