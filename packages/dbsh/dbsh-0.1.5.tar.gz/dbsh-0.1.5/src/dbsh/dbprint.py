...
class PrintOutput:
  ...
  def printXML(self,tList,oList,lList,msg=None):
  ...
  def printHTML(self,tList,oList,lList,msg=None):
  ...
  def printCSV(self,tList,oList,lList,msg=None):
      for t in tList:
          if t!=tList[:-1]: print "%s,"%t,
          else: print t
      print
      for item in oList:
          for o in item:
              if o!=oList[:-1]: print "%s,"%o,
              else: print o
