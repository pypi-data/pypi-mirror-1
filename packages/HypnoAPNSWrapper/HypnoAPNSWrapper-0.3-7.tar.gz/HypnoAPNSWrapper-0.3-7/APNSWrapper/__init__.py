...
class APNSConnection(object):
    ...
    """
    def __init__(self, certificate=None, timeout=None):
        self.socket = None
...
class APNSNotificationWrapper(object):
    ...
    def __init__(self, certificate=None, sandbox=True, timeout=None):
        self.connection = APNSConnection(certificate, timeout=timeout)
...
class APNSNotification(object):
    ...
    def _build(self):
        ...
        if self.alertObject != None:
            apsKeys.append('"alert":"%s"' % self.alertObject)
