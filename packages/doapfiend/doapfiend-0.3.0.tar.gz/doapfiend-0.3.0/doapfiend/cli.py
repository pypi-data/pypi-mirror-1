...
class DoapFiend(object):
        ...
        if search_func:
            ...
            if doap:
                if self.options.follow:
                    ...
                    #found and then print all found.
                    self.print_doap(doap)
                    return follow_homepages(doap)
                elif self.options.show_links:
                    return show_links(doap)
                else:
    ...
    def setup_opt_parser(self):
        ...
        group_output.add_option('-b', '--brief', action='store_true',
                dest='brief', default=False, help='Show less output.')
