...
==================================
  ...
  Now you can use data.createUser in several ways:
   ...
   - Create a user and simultaneously create a permission with given
     arguments::
          ...
          user = data.createUser(use_permission = {'name': 'new permission'})
 ...
 ------
  ...
  create a permission with a specific name::
       ...
       account = data.createAccount(use_user = {'use_permission': {'name':
                                     'specific permission' } } )
  ...
  method::
       ...
       @register
       def addUserToAccount(data, account, user = createUser):
...
=======================
 ...
 "register_as" in a loop::
      ...
      for specialName in [...]:
          def testFunction(data, arg1, arg2):
