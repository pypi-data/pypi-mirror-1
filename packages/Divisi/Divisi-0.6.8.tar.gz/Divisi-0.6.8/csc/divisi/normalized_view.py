from csc.divisi.tensor import View, InvalidLayeringException
...
class ZeroMeanView(View):
    ...
    mirrored along mode 0 is:
        ...
        0  0 -3  0
    '''
    # FIXME: It would be better to simply multiply the indices by 2.
    # TODO: allow mirroring on multiple modes, e.g., all of them.
