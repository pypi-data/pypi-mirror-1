...
from csc.divisi.normalized_view import NormalizedView, TfIdfView, ZeroMeanView
...
class NormalizedViewTest(unittest.TestCase):
    def setUp(self):
    ...
    def test_result(self):
        assertTensorEqual(self.tensor, normalize_expected_result)
...
class ZeroMeanViewTest(unittest.TestCase):
    def setUp(self):
