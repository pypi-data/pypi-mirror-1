...
but easily for human. So some site require it to ban robot.
  pickey is a WSGI middle which can generate this keycode for the application
wrapped. Many options are supported to adjust the outlooking of the generated
picture.
