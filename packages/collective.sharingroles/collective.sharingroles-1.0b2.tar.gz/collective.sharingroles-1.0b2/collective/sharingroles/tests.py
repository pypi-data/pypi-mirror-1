...
from collective.sharingroles.exportimport import import_sharing, export_sharing
from collective.sharingroles.exportimport import SharingXMLAdapter

from plone.app.workflow.interfaces import ISharingPageRole
from collective.sharingroles.role import PersistentSharingPageRole
...
class ExportImportTest(unittest.TestCase):
    ...
    def setUp(self):
        provideAdapter(SharingXMLAdapter, name='sharing')
