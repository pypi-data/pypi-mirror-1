...
# Our time tracker. A bit cooler than pygame's.
clock = gui.Clock(fps_limit=30)
...
#
# Ok, that's all! Read the docs for more information about the widgets and
# stuff.
