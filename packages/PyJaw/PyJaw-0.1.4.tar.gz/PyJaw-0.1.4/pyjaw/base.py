...
class RejawClient(object):
    ...
    def create_session(self, username=None, password=None):
        ...
        result = self._post('session/create', {'api_key': self.api_key,
    ...
    def get_people(self, p_type, username=None, page=1, per_page=10, detail=None):
        ...
        return self._get('user/get_people', {'type': p_type, 'username': username,
                                            'page': page, 'per_page': 10, 'detail': detail})
        
    def get_inbox(self, inbox_type='shouts_all', page=1, per_page=10, detail=None, include_replies=None):
        """Relationship lists: get inbox"""
        return self._get('user/get_inbox', {'type': inbox_type, 'page': page, 'per_page': per_page,
                                            'detail': detail, 'include_replies': include_replies})
