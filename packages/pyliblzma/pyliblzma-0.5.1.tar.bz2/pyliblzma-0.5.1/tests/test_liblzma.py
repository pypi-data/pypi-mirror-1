...
class TestLZMA(unittest.TestCase):
    ...
    def test_decompress_lzma_alone_format(self):
        infile = open('tests/data/teststring.lzma')
        outstring = lzma.decompress(infile.read())
        infile.close()
        self.assertEqual(self.plain, outstring)

    def test_decompress_xz_format(self):
        infile = open('tests/data/teststring.xz')
        outstring = lzma.decompress(infile.read())
        infile.close()
        self.assertEqual(self.plain, outstring)
