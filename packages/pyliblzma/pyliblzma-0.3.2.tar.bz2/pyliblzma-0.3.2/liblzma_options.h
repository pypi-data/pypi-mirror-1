...
#define MEMBER_DESCRIPTOR(name, type, variable, text) (PyMemberDef){name, type, offsetof(libLZMAOptionsObject, variable), RO, PyString_AsString(PyString_Format(PyString_FromString((char*)text), (PyObject*)self->variable))}
...
} libLZMAOptionsObject;

extern PyTypeObject libLZMAOptions_Type;

bool init_lzma_options(const char *funcName, PyObject *kwargs, lzma_options_lzma *options);
PyObject *libLZMA_options_get(lzma_options_lzma lzma_options);
