...
PyDoc_STRVAR(libLZMAComp_compress__doc__,
...
static PyObject *
libLZMAComp_compress(libLZMACompObject *self, PyObject *args)
{
	Py_ssize_t inplen, length = DEFAULTALLOC;
    uint8_t *input;
...
PyDoc_STRVAR(libLZMAComp_flush__doc__,
...
static PyObject *
libLZMAComp_flush(libLZMACompObject *self, PyObject *args)
{
	...
	switch(flushmode){
		...
		case(LZMA_FULL_FLUSH):
			PyErr_Format(libLZMAError, "%d is not supported as flush mode for LZMA_Alone format", flushmode);
			goto error;
...
PyDoc_STRVAR(libLZMAComp_reset__doc__,
...
static PyObject *
libLZMAComp_reset(libLZMACompObject *self, __attribute__((unused)) PyObject *args, PyObject *kwargs)
{
	...
	if(!init_lzma_options("reset", kwargs, &self->alone.lzma))
		return NULL;
	self->lzma_options = libLZMA_options_get(self->alone.lzma);
...
PyDoc_STRVAR(libLZMAComp_lzma_options__doc__,
"Dictionary containing the lzma encoder options.");

static PyMemberDef libLZMAComp_members[] = {
	{"lzma_options", T_OBJECT, offsetof(libLZMACompObject, lzma_options),
		RO, libLZMAComp_lzma_options__doc__},
	{NULL, 0, 0, 0, NULL}	/* Sentinel */
};

static PyMethodDef libLZMAComp_methods[] =
{
    {"compress", (PyCFunction)libLZMAComp_compress, METH_VARARGS,
		libLZMAComp_compress__doc__},
    {"flush", (PyCFunction)libLZMAComp_flush, METH_VARARGS,
		libLZMAComp_flush__doc__},
    {"reset", (PyCFunction)libLZMAComp_reset, METH_VARARGS | METH_KEYWORDS,
		libLZMAComp_reset__doc__},
    {0, 0, 0, 0}
};

static int8_t
libLZMAComp_init(libLZMACompObject *self, __attribute__((unused)) PyObject *args, PyObject *kwargs)
{
	lzma_stream *lzus = &self->lzus;
	lzma_ret lzuerror;
...
static PyObject *
libLZMACompObject_new(PyTypeObject *type, __attribute__((unused)) PyObject *args, __attribute__((unused)) PyObject *kwargs)
{
    libLZMACompObject *self;
    self = (libLZMACompObject *)type->tp_alloc(type, 0);
    if (self != NULL){
...
static void
libLZMAComp_dealloc(libLZMACompObject *self)
{
#ifdef WITH_THREAD
	if (self->lock)
		PyThread_free_lock(self->lock);
...
PyDoc_STRVAR(libLZMAComp__doc__,
...
PyTypeObject libLZMAComp_Type = {
	PyObject_HEAD_INIT(NULL)
	0,										/*ob_size*/
	"liblzma.LZMACompressor",				/*tp_name*/
	sizeof(libLZMACompObject),				/*tp_basicsize*/
	0,										/*tp_itemsize*/
	(destructor)libLZMAComp_dealloc,		/*tp_dealloc*/
	0,										/*tp_print*/
	0,										/*tp_getattr*/
	0,										/*tp_setattr*/
	0,										/*tp_compare*/
	...
	0,										/*tp_iter*/
	0,										/*tp_iternext*/
	libLZMAComp_methods,					/*tp_methods*/
	libLZMAComp_members,					/*tp_members*/
	0,										/*tp_getset*/
	0,										/*tp_base*/
	0,										/*tp_dict*/
	0,										/*tp_descr_get*/
	0,										/*tp_descr_set*/
	0,										/*tp_dictoffset*/
	(initproc)libLZMAComp_init,				/*tp_init*/
	PyType_GenericAlloc,					/*tp_alloc*/
	libLZMACompObject_new,					/*tp_new*/
