...
# Just for fun..
warnflags = ['-Wall', '-Wextra', '-Wdeclaration-after-statement', '-Wstrict-prototypes', '-Wformat-y2k', '-Wformat-nonliteral', '-Wformat-security', '-Wformat=2', '-Winit-self', '-Wswitch-enum', '-Wunused-label', '-Wunused-parameter', '-Wunused-variable', '-Wunused', '-Wstrict-overflow=5', '-Wfloat-equal', '-Wunreachable-code', '-Wnested-externs', '-Wvariadic-macros', '-Wdisabled-optimization', '-Wundef', '-Wshadow', '-Wbad-function-cast', '-Wunsafe-loop-optimizations', '-Wunused-macros', '-Wendif-labels', '-Wvolatile-register-var', '-Wlong-long', '-Winvalid-pch', '-Winline', '-Wpacked', '-Wmissing-format-attribute', '-Wmissing-noreturn', '-Wmissing-declarations', '-Wmissing-prototypes', '-Wold-style-definition', '-Waggregate-return', '-Wcast-qual', '-Wcast-align', '-Wc++-compat', '-Wbad-function-cast']
compile_args = []
...
setup(
    ...
    url = "http://sourceforge.net/projects/lzmautils",
    license = 'LGPL 3 ',
