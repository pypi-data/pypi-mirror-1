...
class FileValidator(validators.FancyValidator):
    ...
    def _from_python(self, value, state):
        ...
        file = self.make_temp_file(value)
        hash = md5.new()
        hash.update(value)
        size = len(value)
...
class FileField(widgets.FormField):
    ...
    def __init__(self, name='', base64=False, use_scriptaculous=True, *args, 
                 **kw):
    ...
    def update_params(self, d):
        ...
        if d['value']:
            ...
            d['file_url'] = url('/file_server', id=d['value']['id'])
