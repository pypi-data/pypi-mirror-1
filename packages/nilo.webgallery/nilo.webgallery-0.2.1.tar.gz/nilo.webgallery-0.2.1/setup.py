...
setup(name='nilo.webgallery',
      ...
      long_description="To use, simply start the 'webgallery' script in a directory you want to serve. More info at webgallery --help. It will then be browsable via http://localhost:8000/. To end, press ctrl-c.",
