...
class IImport(Interface):
    ...
    wp_url = TextLine(title=u"WordPress URL",
                           description=u"The base url of your WordPress Blog.",
                           required=True)

    wp_username = TextLine(title=u'User Name',
                                 description=_(u'Your WordPress user name'),
                                 required=True)

    wp_password = TextLine(title=u'Password',
