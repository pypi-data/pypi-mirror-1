...
class Index(object):
    def __init__(self, name, db, index_type=BTREE, sep='^'):
        ...
        self.__index.open(self.__name, None, self.__index_type, bdb.DB_CREATE | bdb.DB_AUTO_COMMIT | bdb.DB_THREAD)
        self.__sep = sep
...
class DB(object):
    ...
    def __init__(self, db_path, main_thread=False, backup_path=None, checkpoint_interval=600.0, backup_interval=3600.0*24.0, cachesize=2**26, fatal_recovery=False):
        """
