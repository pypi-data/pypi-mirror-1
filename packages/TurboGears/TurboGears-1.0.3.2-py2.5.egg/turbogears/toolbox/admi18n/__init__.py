...
class Internationalization(controllers.RootController):
    ...
    def google_translate(self, code, from_lang, to_lang, args):
        ...
        for arg in args:
            ...
            translated = turbogears.i18n.utils.google_translate(
    ...
    language_management = turbogears.expose(
            template='%s.languageManagement'% baseTemplate)(language_management)
    ...
    string_collection = turbogears.expose(
            template='%s.stringCollection'% baseTemplate)(string_collection)
    
    def index(self):
        return dict()
    index = turbogears.expose(
            template='%s.internationalization'% baseTemplate)(index)
