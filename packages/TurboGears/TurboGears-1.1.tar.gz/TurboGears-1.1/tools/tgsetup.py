...
# TGBEGIN
win32 = """
The recommended Python version for TurboGears 1.1 is Python 2.6.2.
...
http://python.org/ftp/python/2.6.2/Python-2.6.2.tar.bz2
"""
...
def check_python():
    if sys.version_info < (2, 4):
        print "Python 2.4 or higher is required to run TurboGears 1.1."
