...
class Browse(controllers.Controller):
    ...
    @expose(template='kid:turbogears.toolbox.catwalk.browse_grid', allow_json=True)
    ...
    @expose(template='kid:turbogears.toolbox.catwalk.columns', allow_json=True)
