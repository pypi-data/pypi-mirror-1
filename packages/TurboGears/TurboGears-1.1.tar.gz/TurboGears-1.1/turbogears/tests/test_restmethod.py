...
class TestREST(testutil.TGTest):
    ...
    # this test cannot work as-is because webtest needs to be patched
    # see http://trac.pythonpaste.org/pythonpaste/ticket/316 or
    # http://trac.pythonpaste.org/pythonpaste/ticket/298
    # for a patch. Whichever gets in first.
    # with one of the patch it just works...

    # TODO: reactivate the test when we have a working WebTest.
    '''
    def test_unsupported_method(self):
        """Check that we receive a 405 error on deletes"""
        # Really this resource doesn't exist, and so should raise a 404.  It's
        # not obvious how to fix this, perhaps by using a different approach to
        # resources than the default method?
