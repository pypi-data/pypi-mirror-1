...
class TestDatabasePagination(TestPagination):
    ...
    class MyRoot(RootController):
        ...
        basic1 = expose("kid:turbogears.tests.paginate")(basic1)

        # default_order = list
        basic2 = paginate("data", default_order=["id"])(__common)
        basic2 = expose("kid:turbogears.tests.paginate")(basic2)

        # default_order = basestring
        reversed1 = paginate("data", default_order="-id")(__common)
        reversed1 = expose("kid:turbogears.tests.paginate")(reversed1)

        # default_order = list
        reversed2 = paginate("data", default_order=["-id"])(__common)
        reversed2 = expose("kid:turbogears.tests.paginate")(reversed2)

        # +/+
        default_compound_ordering1 = paginate("data", default_order=["city", "street"])(__common)
        default_compound_ordering1 = expose("kid:turbogears.tests.paginate")(default_compound_ordering1)

        # +/-
        default_compound_ordering2 = paginate("data", default_order=["city", "-street"])(__common)
        default_compound_ordering2 = expose("kid:turbogears.tests.paginate")(default_compound_ordering2)

        # -/+
        default_compound_ordering3 = paginate("data", default_order=["-city", "street"])(__common)
        default_compound_ordering3 = expose("kid:turbogears.tests.paginate")(default_compound_ordering3)

        # -/-
        default_compound_ordering4 = paginate("data", default_order=["-city", "-street"])(__common)
        default_compound_ordering4 = expose("kid:turbogears.tests.paginate")(default_compound_ordering4)

        @expose("kid:turbogears.tests.paginate")
