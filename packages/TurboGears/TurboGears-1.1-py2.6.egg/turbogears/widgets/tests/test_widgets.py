import itertools
import cherrypy
from turbogears import widgets, validators, view, testutil, controllers, expose
...
def test_calendardatepicker():
    """CalendarDatePicker widget is wrapped in a SPAN element with proper class
    """
...
def test_calendardatepicker():
    """CalendarDatePicker widget is wrapped in SPAN element with proper class
    """
    w = widgets.CalendarDatePicker(
       name = 'test_cdp',
       field_class = 'cdp',
...
def test_autocompletefield():
    """AutoCompleteField widget is wrapped in SPAN element with proper class/id
    """
...
def test_autocompletetextfield():
    """AutoCompleteTextField widget is wrapped in SPAN element with proper class/id
    """
