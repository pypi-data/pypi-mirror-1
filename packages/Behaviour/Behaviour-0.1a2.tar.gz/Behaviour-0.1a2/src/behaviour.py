...
+==================================+===================================+===================================+=============================================+
| Java                             | Smalltalk                         | Ruby                              | Python                                      |
+----------------------------------+-----------------------------------+-----------------------------------+---------------------------------------------+
| jUnit                            | sbSpec                            | rSpec                             | Behaviour                                   |
+==================================+===================================+===================================+=============================================+
| assertEquals( expected, actual ) | actual shouldEqual: expected      | actual.should_equal expected      | shouldEqual( actual, expected )             |
+----------------------------------+-----------------------------------+-----------------------------------+---------------------------------------------+
| assertNull( result )             | result shouldbeNil                | result.should_be_nil              | shouldBeNone( result )                      |
+----------------------------------+-----------------------------------+-----------------------------------+---------------------------------------------+
| try {                            | [2 / 0] shouldThrow: DivideByZero | [2 / 0].should_throw DividebyZero | def DivByZero():                            |
|     2 / 0;                       |                                   |                                   |     return 2 / 0                            |
|     fail();                      |                                   |                                   | shouldRaise( ZeroDivisionError, DivByZero ) |
| }                                |                                   |                                   |                                             |
...
class Behaviour( unittest.TestCase ):
	"""
	A class whose instances are single bahaviours.
	"""
	...
	def shouldEqual( self, actual, expected, exceptionMsg=None ):
		...
		Acts as a façade over failUnlessEqual.

		Parameters
		----------

		: actual : The value which is being produced. May be of any type.
		: expected : The value which should be produced. May be of any type, but
			must be comparable to actual.

		Keyword Parameters
		------------------

		: exceptionMsg : An option message to be returned if the behaviour is not
			verified, overriding the default generated message (rarely needed).

		Returns
		-------

		: boolean : True if the specified behaviour matched the exhibited
			behaviour (i.e., actual == expected).

		Raises
		------

		: AssertionError : Indicates the behaviour exhibited was not the behaviour
	...
	def shouldNotEqual( self, actual, unexpected, exceptionMsg=None ):
		...
		Acts as a façade over failIfEqual.

		Parameters
		----------

		: actual : The value which is being produced. May be of any type.
		: unexpected : The value which should be produced. May be of any type, but
			must be comparable to actual.
		...
		: boolean : True if the specified behaviour matched the exhibited
			behaviour (i.e., actual != unexpected).

		Raises
		------

		: AssertionError : Indicates the behaviour exhibited was not the behaviour
			specified (i.e., actual == unexpected).
		"""
	...
	def _mustBeNumeric( self, value, calledFrom ):
		...
		: value : The value to check is numeric.
		: calledFrom : The method which is requesting the check.

		Returns
		-------

		: boolean : True if the value is numeric.

		Raises
		------

		: TypeError : Indicates the value was not numeric.
		"""
		...
		def _failMustBeNumeric( value, calledFrom ):
			...
			raise TypeError, """Behaviour.%s: Type (%s) value (%s) cannot be used, must be a numeric.""" % \
	...
	def shouldApproximatelyEqual( self, actual, expected, significantDigits=15, exceptionMsg=None ):
		...
		|	  File "/Users/aelfric/Development/dev/MediaLib/Behaviour/behaviour.py", line 96, in shouldEqual
		|		self.failUnlessEqual( actual, expected, _formatShouldEqualMessage( actual, expected, exceptionMsg ) )
		...
		: actual : The value which is being produced. Should be a float, but may
			be of any numeric type.
		: expected : The value which should be produced. Should be a float, but
			may be of any numeric type.

		Keyword Parameters
		------------------

		: significantDigits : The number of significant digits to which the actual
			and expected value should equal. Should be an positive integer, but may
			be any numeric type. Negative values make no sense (less than 1 significant
		...
		: AssertionError : Indicates the behaviour exhibited was not the behaviour
			specified (i.e., actual !≠ expected).
		: TypeError : Indicates a non-numeric type was passed as a parameter.
		...
		|	>>> b.shouldApproximatelyEqual( 100000000000000.0, 100000000000001.0 )
		|	>>> b.shouldApproximatelyEqual( 0.1000000000, 0.1000000001 )
		|	Traceback (most recent call last):
		|	  File "<stdin>", line 1, in <module>
		|	  File "/Users/aelfric/Development/dev/MediaLib/Behaviour/behaviour.py", line 157, in shouldApproximatelyEqual
		|		>>> fp = behaviour.Behaviour()
		|	  File "/Library/Frameworks/Python.framework/Versions/2.5/lib/python2.5/unittest.py", line 305, in failIf
		|		if expr: raise self.failureException, msg
		|	AssertionError: Behaviour.shouldEqual: Actual value (0.1) should approximately equal expected value (0.1000000001) to 10 significant digits. Allowable difference is 1.000000001e-11, actual difference is 9.99999943962e-11.
		|	>>>

		unittest uses decimal places (i.e., a count of the digits after the decimal
		point)::
		...
		|	...
		|	>>> u = tc()
		|	>>> u.failUnlessAlmostEqual( 100000000000000.0, 100000000000001.0 )
		|	Traceback (most recent call last):
		|	  File "<stdin>", line 1, in <module>
		|	  File "/Library/Frameworks/Python.framework/Versions/2.5/lib/python2.5/unittest.py", line 354, in failUnlessAlmostEqual
		|		(msg or '%r != %r within %r places' % (first, second, places))
		|	AssertionError: 100000000000000.0 != 100000000000001.0 within 7 places
>>> u.failUnlessAlmostEqual( 0.1000000000, 0.1000000001 )
	...
	def shouldNotApproximatelyEqual( self, actual, unexpected, significantDigits=10, exceptionMsg=None ):
		"""
		Verify that the actual value and the unexpected values are not equal.
		...
		: actual : The value which is being produced. Should be a float, but may
			be of any numeric type.
		: unexpected : The value which should not be produced. Should be a float,
			but may be of any numeric type.
	...
	def shouldBeSameAs( self, actual, expected, exceptionMsg=None ):
		...
		: actual : The object which is being produced. May be of any type.
		: expected : The object which should be produced. May be of any type.
	...
	def shouldNotBeSameAs( self, actual, unexpected, exceptionMsg=None ):
		...
		: actual : The object which is being produced. May be of any type.
		: unexpected : The object which should be produced. May be of any type.
	...
	def _mustBeString( self, value, calledFrom ):
		...
		: value : The value to check is a string.
		: calledFrom : The method which is requesting the check.
		...
		: TypeError : Indicates the value was not a string.
		"""
	...
	def shouldMatch( self, actual, pattern, exceptionMsg=None ):
		...
		: actual : The value which is being produced. Must be a string.
		: pattern : The pattern which must be matched. Must be a string (should
		...
		: TypeError : Indicates a non-string type was passed as a parameter.
		"""
	...
	def shouldNotMatch( self, actual, pattern, exceptionMsg=None ):
		...
		: actual : The value which is being produced. Must be a string.
		: pattern : The pattern which should not be matched. Must be a string
	...
	def shouldBeNone( self, actual, exceptionMsg=None ):
		...
		: actual : The value which is being produced. May be any type.
	...
	def shouldBeZero( self, actual, exceptionMsg=None ):
		...
		: actual : The value which is being produced. Must be numeric.
	...
	def _mustBeBoolean( self, value, calledFrom ):
		...
		: value : The value to check is a boolean.
		: calledFrom : The method which is requesting the check.
		...
		: TypeError : Indicates the value was not a boolean.
		"""
	...
	def shouldBeTrue( self, actual, exceptionMsg=None ):
		...
		: actual : The value which is being produced. Should be a boolean.
		...
		: TypeError : Indicates a non-boolean type was passed as a parameter.
		"""
	...
	def shouldBeFalse( self, actual, exceptionMsg=None ):
		...
		def _formatSBFMessage( actual, msg=None ):
			"""
			Format an appropriate error message if one isn't provided.
			"""
		...
		self.failUnlessEqual( actual, False, _formatSBFMessage( actual, exceptionMsg ) )
		return True
	...
	def _isStringType( self, value ):
		...
		: value : The value which is being checked. Should be a string.

		Returns
		-------

		: boolean : True if the value to be checked is string-compatible, otherwise
			False.
		"""
	...
	def _isTupleType( self, value ):
		...
		: value : The value which is being checked. Should be a tuple.

		Returns
		-------

		: boolean : True if the value to be checked is tuple-compatible, otherwise
			False.
		"""
	...
	def _isListType( self, value ):
		...
		: value : The value which is being checked. Should be a list.

		Returns
		-------

		: boolean : True if the value to be checked is list-compatible, otherwise
			False.
		"""
	...
	def _isDictType( self, value ):
		...
		: value : The value which is being checked. Should be a dictionary.

		Returns
		-------

		: boolean : True if the value to be checked is dictionary-compatible, otherwise
			False.
		"""
	...
	def _mustBeMemberType( self, value, calledFrom ):
		...
		: value : The value which is being checked. Should be a sequence (string,
			tuple, or list compatible) or mapping (dictionary compatible).
		: calledFrom : The method which is requesting the check.

		Returns
		-------

		: boolean : True if the value to be checked is sequence or mapping compatile.
		
		Raises
		------
		
		: TypeError : Indicates the value was not sequence or mapping compatible.
		"""

		def _failMustMemberType( value, calledFrom ):
			"""
			Format an error message and fail.
			"""
		...
		if self._isStringType( value ) or self._isTupleType( value ) or \
			...
			_failMustMemberType( value, calledFrom )
	...
	def shouldBeEmpty( self, actual, exceptionMsg=None ):
		...
		: actual : The value which is being produced. Must be a sequence or mapping.
		...
		: TypeError : Indicates a non-sequence, non-mapping type was passed.
		"""
		...
		self.failIf( actual, _formatShouldBeEmptyMessage( actual ) )  # Empty sequences/mappings are False
		return True
	...
	def shouldNotBeEmpty( self, actual, exceptionMsg=None ):
		...
		self.failUnless( actual, _formatShouldNotBeEmptyMessage( actual ) )
		return True
	...
	def _mustBe2Tuple( self, item, calledFrom ):
		...
		: value : The value to check is a 2-tuple.
		: calledFrom : The method which is requesting the check.

		Returns
		-------

		: boolean : True if the value is a 2-tuple.

		Raises
		------

		: AssertionError : Indicates the value was not a 2-tuple.
		"""
	...
	def shouldInclude( self, collection, wanted, exceptionMsg=None ):
		...
		: collection : The object which is being produced. Must be a sequence or mapping.
		: wanted : The item to check for membership in the collection. If the collection is a
		...
		: TypeError : Indicates a non-sequence, non-mapping type was passed as the collection,
			or for a dictionary the item was not a 2-tuple.
		"""

		def _formatShouldIncludeSequenceMessage( collection, item, msg=None ):
			"""
			Format an appropriate error message if one isn't provided.
			"""
	...
	def shouldNotInclude( self, collection, unwanted, exceptionMsg=None ):
		...
		: collection : The object which is being produced. Must be a sequence or mapping.
		: unwanted : The item to check for membership in the collection. If the collection is
			a sequence, this may be any type that can be inserted in the collection. If the
			collection is a dictionary, the item must be a 2-tuple consisting of a key-value
			pair.
		...
		def _formatShouldNotIncludeSequenceMessage( collection, unwanted, msg=None ):
			"""
			Format an appropriate error message if one isn't provided.
			"""
		...
		def _formatShouldNotIncludeMappingMessage( collection, unwanted, msg=None ):
			"""
			Format an appropriate error message if one isn't provided.
			"""

			return msg or """Behaviour.shouldInclude: Dictionary (%s) should not include key (%s) data (%s).""" % \
  						  ( str( collection ), str( unwanted[0] ), str( unwanted[1] ) )
	...
	def shouldRaiseException( self, exceptionType, executable, *args, **kwargs ):
		...
		: exceptionType : The exception type that should be raised.
		: executable : The executable to verify.
		: args : A list of arguments to pass to executable.
		: kwargs : A list of keyword arguments to pass to executable. There are three
		keyword arguments, listed below, which are trapped out and not passed.

		Keyword Parameters
		------------------

		: exceptionArgs : A tuple of arguments to check against the raised exception's
			arguments (i.e., ensure that not only is the correct exception raised, but
			that it receives the right arguments)..
		: exceptionMsg : A regular expression to match against the raised exception's
			text value (i.e., ensure that not only is the correct exception raised, but
			that it raises the correct error message).
		: exceptionMsg : An option message to be returned if the behaviour is not
			verified, overriding the default generated message (rarely needed).
		...
		: boolean : True if the specified behaviour matched the exhibited
			behaviour (i.e., the correct exception was raised, optionally with the
			correct arguments and error message).

		Raises
		------

		: AssertionError : Indicates the behaviour exhibited was not the behaviour
			specified (i.e., no exception was raised, the wrong exception was raised,
			or optionally the right exception was raised with the wrong arguments or
