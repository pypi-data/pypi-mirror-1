...
yy53:
#line 302 "mwlib/_uscan.re"
	{RET(t_special);}
#line 569 "mwlib/_uscan.cc"
yy54:
	++YYCURSOR;
	if ((yych = *YYCURSOR) == 'a') goto yy315;
	goto yy125;
yy55:
...
yy289:
	...
	if (yych <= '>') {
		...
		if (yych <= '\\') {
			...
			if (yych <= ']') goto yy291;
			if (yych != 0x007F) goto yy289;
		}
	}
yy291:
#line 254 "mwlib/_uscan.re"
	{RET(t_http_url);}
#line 1447 "mwlib/_uscan.cc"
yy292:
	yych = *++YYCURSOR;
	if (yych != 'p') goto yy125;
	yyaccept = 5;
...
#line 246 "mwlib/_uscan.re"
	{RET(t_http_url);}
#line 1647 "mwlib/_uscan.cc"
yy327:
	++YYCURSOR;
#line 260 "mwlib/_uscan.re"
	{RET(t_2box_open);}
#line 1652 "mwlib/_uscan.cc"
yy329:
	yych = *++YYCURSOR;
