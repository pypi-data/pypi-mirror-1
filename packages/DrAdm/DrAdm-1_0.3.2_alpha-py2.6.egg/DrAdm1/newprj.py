...
def main():
    ...
    try:
        ...
        errexit(err.msg)
    cli = optparse.OptionParser(description="Setup directory for the new project. Part of DrAdm1 utilities pack.",
                                version=VERSION, usage="%prog [options] <project>", epilog="More docs at http://dradm.org")
