================================
Zope3 UI Layer, resource and 
viewlets bundles for 
ExtJS v3 JavaScript library
================================
...
Or derive/implement your own managers for 
falkolab.ext3.layer.IExtLayerCSS 
and 
falkolab.ext3.layer.IExtLayerJavaScript 
interfaces.
