    ...
    def update_trends(self):
        ...
        if self.context.postresults:
            ...
            if self.context.debugmode:
                ...
                print '-----post news item---'
                root_app = self.context.restrictedTraverse('news')
                news_id = 'Top tweets ' +str(today) +str(int(random.random()*100))
                ...
                news_item = root_app.invokeFactory(type_name='News Item',
                                                   id=news_id,
                                                   title='Top Words on ' +str(today) +str(int(random.random()*100)),
                ...
                post_history = str(today) + ' - debug test complete - '
                ...
                if today != self.context.lastpost:
                    ...
                    if now_date > when_date:
                        ...
                        try:
                            ...
                            post_history += ' Tlogin FAIL' + ' '+str(sys.exc_info()[0])
                        #post the message
                        try:
                            #construct the post
                            twit_text = 'http://tiny.cc/MeYTX Top Tweets Today: '
                            ...
                            post_history += ' Tpost FAIL' + ' '+str(sys.exc_info()[0])
                        ...
                        try:
                            ...
                            post_history += ' News FAIL' + ' '+str(sys.exc_info()[0])
