...
class DarcsVer(setuptools.Command):
    ...
    user_options = [
        ...
        ('quiet', 'q', "Be quiet (deprecated: use --verbose instead)."),
        ('verbose', 'v', "Be verbose (the default is to be not-verbose)."),
        ]
    ...
    def run(self):
        if self.verbose and not self.quiet:
            ...
            verbose = False
        (rc, verstr) = darcsvermodule.update(self.project_name, self.version_file, self.count_all_patches, verbose=verbose, EXE_NAME="setup.py darcsver")
