...
def update(pkgname, verfilename, revision_number=False, verbose=False, EXE_NAME="darcsver"):
    """
    ...
    if not last_tag:
        if os.path.exists(verfilename):
            ...
            if verbose:
                print "%s: I'm unable to find a tag in the darcs history matching \"%s\", and %s doesn't exist." % (EXE_NAME, regexstr, verfilename,)
            return (0, None)
