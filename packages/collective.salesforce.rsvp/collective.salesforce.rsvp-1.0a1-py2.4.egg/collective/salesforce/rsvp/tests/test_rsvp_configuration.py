...
class TestRSVPConfigurationInteractivity(SFRSVPTestCase):
    ...
    def test_toggle_available_field_options(self):
        ...
        num_leads_str = """<option value="NumberOfConvertedLeads">Converted Leads</option>"""
        ...
        event_field_option = """<option value="DurationInMinutes">Duration</option>"""
    ...
    def test_custom_form_widget_visibility_on_load(self):
        ...
        self.assertTrue('<kukit:param name="value">hiddenStructure</kukit:param>' in returned_command)
    ...
    def test_toggle_capacity_field_visibility(self):
        ...
        self.assertEquals(len(LIMIT_CAPACITY_HIDABLE), returned_disable_command.count('<kukit:param name="value">hiddenStructure</kukit:param>'))
    ...
    def test_capacity_field_widgets_visibility_on_load(self):
        ...
        self.assertEquals(len(LIMIT_CAPACITY_HIDABLE), returned_command.count('<kukit:param name="value">hiddenStructure</kukit:param>'))
