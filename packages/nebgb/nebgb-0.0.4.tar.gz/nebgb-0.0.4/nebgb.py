...
MULTI_QUALIFIERS = set("""
    allele db_xref ec_number go_component go_process go_function transl_except
""".split())
#
# Parse Actions
#
...
_q_exception = _qual_default
_q_function = lambda d: " ".join(d.split())
