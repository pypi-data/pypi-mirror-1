...
class Absence6WeekRepeatEvent(AbsenceEvent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # XXX We need a link to the absence that this belongs to, as
        # we want to create an EvaluationInterview inside that
        # absence, not inside the employee.

        ## link_url is the link for the 'a' tag that is set around the
        ## subject.
        #self.link_url = self.object.absolute_url()
