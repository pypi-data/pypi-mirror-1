...
class AbsenceAddView(PloneKSSView):
    ...
    def add_absence(self, text, start_date, start_date_year,
        ...
        if message:
            ...
            # Show an error in the status message.
...
class AbsenceCloseView(PloneKSSView):
    ...
    def close_absence(self, length, end_date, end_date_year,
        ...
        if message:
            ...
            # Show an error in the status message.
            status = translate(_(u'msg_absence_error_close',
                                 u'Error have been found while closing the absence'),
                                target_language=lang)
...
class AbsenceKssView(PloneKSSView):
    ...
    @kssaction
    def kss_absence_control(self, dostate, hide_status=False):
