...
class ConfigParser(fixture.Base):
    ...
    def test_table_config(self):
        ...
        default_text=Repository.prepare_config(template.default_repository(as_pkg=True,as_str=True),
            Repository._config,'repository_name')
        specified_text=Repository.prepare_config(template.default_repository(as_pkg=True,as_str=True),
