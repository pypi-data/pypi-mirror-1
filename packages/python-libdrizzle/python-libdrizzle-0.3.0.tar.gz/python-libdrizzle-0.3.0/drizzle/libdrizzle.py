...
class Drizzle(object):
    ...
    __repr__ = _swig_repr
    def __init__(self): 
        _libdrizzle.Drizzle_swiginit(self,_libdrizzle.new_Drizzle())
...
ResultClientBuffered.get_row_field = new_instancemethod(_libdrizzle.ResultClientBuffered_get_row_field,None,ResultClientBuffered)
...
ResultClientUnbuffered.row_current = new_instancemethod(_libdrizzle.ResultClientUnbuffered_row_current,None,ResultClientUnbuffered)
