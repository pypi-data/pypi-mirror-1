...
try:
    asl = coopr.plugins.mip.ASL(keepFiles=True, options={'solver':'cplexamp'})
    cplexamp_available= (not asl.executable() is None) and asl.available(False)
...
class mock_all(pyutilib.th.TestCase):
    ...
    def do_setup(self,flag):
        ...
        if flag:
            self.asl = coopr.plugins.mip.ASL(keepFiles=True)
        else:
            self.asl = coopr.plugins.mip.MockASL(keepFiles=True)
    ...
    def test_path(self):
        ...
        if type(self.asl) is 'ASL':
           self.failUnlessEqual(self.asl.executable.split(os.sep)[-1],"ASL"+coopr.util.executable_extension)
    ...
    def Xtest_solve1(self):
        ...
        self.failUnlessFileEqualsBaseline(currdir+"test_solve1.txt", currdir+"test1_asl.txt")
    ...
    def Xtest_solve2a(self):
        ...
        self.failUnlessFileEqualsBaseline(currdir+"test_solve2a.txt", currdir+"test1_asl.txt")
    ...
    def Xtest_solve2b(self):
        ...
        self.failUnlessFileEqualsBaseline(currdir+"test_solve2b.txt", currdir+"test1_asl.txt")
    ...
    def Xtest_solve3(self):
        ...
        self.failUnlessFileEqualsBaseline(currdir+"test_solve3.txt", currdir+"test2_asl.txt")
    ...
    def test_solve4(self):
        ...
        if pico_convert_available:
            ...
            self.failUnlessFileEqualsBaseline(currdir+"test_solve4.txt", currdir+"test4_asl.txt")
        else:
            try:
                results = self.asl.solve(currdir+"test4.nl", logfile=currdir+"test_solve4.log")
    ...
    def Xtest_options(self):
        ...
        self.failUnlessFileEqualsBaseline(currdir+"test_options.txt", currdir+  "test4_asl.txt")
        #os.remove(currdir+"test4.sol")
        #os.remove(currdir+"test_solve4.log")
    ...
    def Xtest_mock5(self):
        ...
        self.failUnlessFileEqualsBaseline(currdir+"test_mock5.txt", currdir+"test4_asl.txt")
        os.remove(currdir+"test4.sol")
