...
setup(name='coopr.plugins',
      ...
      entry_points = {
        'coopr.opt': [
            ...
            'solver.cbc = coopr.plugins.mip.CBC',
            'solver.cplex = coopr.plugins.mip.CPLEX',
            'solver.pico = coopr.plugins.mip.PICO',
            'solver.glpk = coopr.plugins.mip.GLPK',
            'solver.asl = coopr.plugins.mip.ASL',
        ]
      }
      )
