...
class Test(pyutilib.th.TestCase):
    ...
    def test_nl_lp1(self):
        ...
        try:
           ...
           return
        except ConverterError, err:
           if not pyutilib.services.registered_executable("pico_convert") is None:
              self.fail("Unexpected ConverterError - pico_convert is enabled but not available: '%s'" % str(err))
           return
        self.failUnlessEqual(ans[0][0][-15:],"pico_convert.lp")
        self.failUnlessFileEqualsBaseline(ans[0][0], currdir+"test1_convert.lp")
    ...
    def test_mod_lp1(self):
        ...
        try:
           ...
           return
        self.failUnlessEqual(ans[0],("glpsol.lp",))
        self.failUnlessFileEqualsBaseline(ans[0][0], currdir+"test2_convert.lp")
    ...
    def test_mod_lp2(self):
        ...
        try:
           ...
           return
        self.failUnlessEqual(ans[0],("glpsol.lp",))
        self.failUnlessFileEqualsBaseline(ans[0][0], currdir+"test3_convert.lp")
    ...
    def test_mock_lp1(self):
        ...
        self.failIfEqual(re.match(".*tmp.*pyomo.lp$",ans[0][0]), None)
    ...
    def test_mock_mps1(self):
        ...
        try:
           ...
           if pyutilib.services.registered_executable("pico_convert") is None:
                ...
                self.fail("Expected ApplicationError because pico_convert is not available: '%s'" % str(err))
        self.failUnlessEqual(ans[0][0][-16:],"pico_convert.mps")
        os.remove(ans[0][0])
    ...
    def test_mock_nl1(self):
        ...
        self.failIfEqual(re.match(".*tmp.*pyomo.nl$",ans[0][0]), None)
        os.remove(ans[0][0])
