...
dojo.declare("dojox.data.QueryReadStore",null,{url:"",requestMethod:"get",xhrArgs:null,_className:"dojox.data.QueryReadStore",_items:[],_lastServerQuery:null,_numRows:-1,lastRequestHash:null,doClientPaging:false,doClientSorting:false,_itemsByIdentity:null,_identifier:null,_features:{"dojo.data.api.Read":true,"dojo.data.api.Identity":true},_labelAttr:"label",constructor:function(_1){
dojo.mixin(this,_1);
this.xhrArgs=this.xhrArgs||{};
...
var _36={url:this.url,handleAs:"json-comment-optional",content:_32};
dojo.mixin(_36,this.xhrArgs);
var _37=_35(_36);
_37.addCallback(dojo.hitch(this,function(_38){
this._xhrFetchHandler(_38,_2f,_30,_31);
}));
