...
long_description = (
    ...
    '**********************\n'
    + '\n' +
    read('iw', 'recipe', 'pound', 'docs', 'building.txt')
    + '\n' +
    read('iw', 'recipe', 'pound', 'docs' , 'configuring.txt')
    + '\n' +
    'Contributors\n'
    '************\n'
    + '\n' +
...
entry_points = {"zc.buildout": ["build = iw.recipe.pound:BuildRecipe",
                                "config = iw.recipe.pound:ConfigureRecipe",]}
