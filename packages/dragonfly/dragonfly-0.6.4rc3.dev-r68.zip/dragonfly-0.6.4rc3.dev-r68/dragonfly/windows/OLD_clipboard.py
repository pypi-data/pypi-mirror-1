...
class Clipboard(object):
    ...
    def has_text(self):
        ...
        return (self.unicode_format in self._contents
                or self.text_format in self._contents)
    ...
    def get_text(self):
        ...
        """
        if self.unicode_format in self._contents:
            return self._contents[self.unicode_format]
        elif self.text_format in self._contents:
            return self._contents[self.text_format]
        else:
            return None

    def set_text(self, content):
        return self._contents[self.unicode_format] = unicode(content)
