...
def setup_product():
    ...
    import collective.simpleeditbutton
    zcml.load_config('configure.zcml', collective.simpleeditbutton)
    ...
    ztc.installPackage('collective.simpleeditbutton')
...
setup_product()
ptc.setupPloneSite(products=['collective.simpleeditbutton'])
