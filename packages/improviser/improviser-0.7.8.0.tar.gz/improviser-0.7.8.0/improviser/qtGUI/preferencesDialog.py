...
#
# Created: Wed Jan 14 19:40:09 2009
...
class Ui_preferencesDialog(object):
    def setupUi(self, preferencesDialog):
        ...
        preferencesDialog.resize(417, 418)
        preferencesDialog.setModal(True)
        self.buttonBox = QtGui.QDialogButtonBox(preferencesDialog)
        self.buttonBox.setGeometry(QtCore.QRect(60, 370, 341, 32))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 180, 391, 171))
        self.groupBox_2.setObjectName("groupBox_2")
        self.label = QtGui.QLabel(self.groupBox_2)
        self.label.setGeometry(QtCore.QRect(20, 90, 71, 17))
        self.label.setObjectName("label")
        self.label_2 = QtGui.QLabel(self.groupBox_2)
        self.label_2.setGeometry(QtCore.QRect(20, 130, 61, 17))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtGui.QLabel(self.groupBox_2)
        self.label_3.setGeometry(QtCore.QRect(20, 20, 351, 61))
        self.label_3.setLineWidth(1)
        self.label_3.setWordWrap(True)
        self.label_3.setObjectName("label_3")
        self.username = QtGui.QLineEdit(self.groupBox_2)
        self.username.setGeometry(QtCore.QRect(130, 90, 221, 23))
        self.username.setObjectName("username")
        self.password = QtGui.QLineEdit(self.groupBox_2)
        self.password.setGeometry(QtCore.QRect(130, 130, 221, 23))
    ...
    def retranslateUi(self, preferencesDialog):
        ...
        self.label_3.setText(QtGui.QApplication.translate("preferencesDialog", "Enter a username and password if you want to be able to upload your songs, blocks, instruments and/or progressions to the site.", None, QtGui.QApplication.UnicodeUTF8))
