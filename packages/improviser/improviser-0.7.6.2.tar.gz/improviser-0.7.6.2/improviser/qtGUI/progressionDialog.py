...
#
# Created: Wed Jan 14 11:56:26 2009
...
class Ui_progressionDialog(object):
    def setupUi(self, progressionDialog):
        ...
        self.progressionsequence.setGeometry(QtCore.QRect(10, 60, 211, 71))
        self.progressionsequence.setObjectName("progressionsequence")
        self.progressionname = QtGui.QLineEdit(self.groupBox_3)
        self.progressionname.setGeometry(QtCore.QRect(90, 30, 191, 23))
        ...
        self.clearsequence.setGeometry(QtCore.QRect(230, 140, 61, 27))
        self.clearsequence.setObjectName("clearsequence")
        self.removesequence = QtGui.QPushButton(self.groupBox_3)
        self.removesequence.setGeometry(QtCore.QRect(160, 140, 61, 27))
        self.removesequence.setObjectName("removesequence")
        self.upsequence = QtGui.QPushButton(self.groupBox_3)
        self.upsequence.setGeometry(QtCore.QRect(10, 140, 61, 27))
        self.upsequence.setObjectName("upsequence")
        self.downsequence = QtGui.QPushButton(self.groupBox_3)
        self.downsequence.setGeometry(QtCore.QRect(80, 140, 61, 27))
        self.downsequence.setObjectName("downsequence")
        self.updateprogression = QtGui.QPushButton(self.groupBox_3)
        self.updateprogression.setGeometry(QtCore.QRect(230, 100, 61, 27))
        self.updateprogression.setObjectName("updateprogression")
        self.addprogression = QtGui.QPushButton(self.groupBox_3)
        self.addprogression.setGeometry(QtCore.QRect(230, 60, 61, 27))
    ...
    def retranslateUi(self, progressionDialog):
        ...
        self.updatechord.setText(QtGui.QApplication.translate("progressionDialog", "Update", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.updateprogression.setText(QtGui.QApplication.translate("progressionDialog", "Update", None, QtGui.QApplication.UnicodeUTF8))
