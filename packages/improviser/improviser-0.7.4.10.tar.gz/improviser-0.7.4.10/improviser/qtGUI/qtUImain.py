...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.projectname.setGeometry(QtCore.QRect(120, 20, 111, 23))
        self.projectname.setObjectName("projectname")
        self.label_5 = QtGui.QLabel(self.tab)
        self.label_5.setGeometry(QtCore.QRect(280, 110, 56, 17))
        self.label_5.setObjectName("label_5")
        self.loop = QtGui.QSpinBox(self.tab)
        self.loop.setGeometry(QtCore.QRect(400, 110, 111, 23))
        self.loop.setMaximum(10000)
        self.loop.setProperty("value", QtCore.QVariant(1))
        self.loop.setObjectName("loop")
        self.label_8 = QtGui.QLabel(self.tab)
        self.label_8.setGeometry(QtCore.QRect(20, 110, 81, 17))
        self.label_8.setObjectName("label_8")
        self.movement = QtGui.QComboBox(self.tab)
        self.movement.setGeometry(QtCore.QRect(120, 110, 121, 22))
        self.movement.setObjectName("movement")
        self.label_9 = QtGui.QLabel(self.tab)
        self.label_9.setGeometry(QtCore.QRect(20, 50, 81, 17))
        self.label_9.setObjectName("label_9")
        self.soundfont = QtGui.QLineEdit(self.tab)
        self.soundfont.setGeometry(QtCore.QRect(120, 50, 391, 23))
        self.soundfont.setObjectName("soundfont")
        self.label_10 = QtGui.QLabel(self.tab)
        self.label_10.setGeometry(QtCore.QRect(280, 20, 81, 17))
        self.label_10.setObjectName("label_10")
        self.driver = QtGui.QComboBox(self.tab)
        self.driver.setGeometry(QtCore.QRect(400, 20, 111, 22))
        self.driver.setObjectName("driver")
        self.label_11 = QtGui.QLabel(self.tab)
        self.label_11.setGeometry(QtCore.QRect(20, 80, 91, 17))
        self.label_11.setObjectName("label_11")
        self.visualization = QtGui.QComboBox(self.tab)
        self.visualization.setGeometry(QtCore.QRect(120, 80, 391, 22))
