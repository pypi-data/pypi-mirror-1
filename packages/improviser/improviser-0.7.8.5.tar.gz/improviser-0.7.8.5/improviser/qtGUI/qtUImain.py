...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.removeblock.setGeometry(QtCore.QRect(700, 290, 80, 27))
        ...
        self.removeinstrument.setGeometry(QtCore.QRect(700, 290, 80, 27))
        ...
        self.removeprogression.setGeometry(QtCore.QRect(700, 290, 80, 27))
        ...
        self.exportprogressions = QtGui.QPushButton(self.tab_4)
        self.exportprogressions.setGeometry(QtCore.QRect(700, 130, 80, 27))
        self.exportprogressions.setObjectName("exportprogressions")
        self.importprogression = QtGui.QPushButton(self.tab_4)
        self.importprogression.setGeometry(QtCore.QRect(700, 90, 80, 27))
        self.importprogression.setObjectName("importprogression")
        ...
        MainWindow.setTabOrder(self.editprogression, self.importprogression)
        MainWindow.setTabOrder(self.importprogression, self.exportprogressions)
        MainWindow.setTabOrder(self.exportprogressions, self.copyprogression)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.exportprogressions.setText(QtGui.QApplication.translate("MainWindow", "Export", None, QtGui.QApplication.UnicodeUTF8))
        self.importprogression.setText(QtGui.QApplication.translate("MainWindow", "Import", None, QtGui.QApplication.UnicodeUTF8))
