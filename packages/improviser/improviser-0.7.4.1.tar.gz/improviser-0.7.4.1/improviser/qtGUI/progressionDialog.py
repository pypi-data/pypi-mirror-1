...
#
# Created: Wed Jan  7 12:55:42 2009
...
class Ui_progressionDialog(object):
    ...
    def retranslateUi(self, progressionDialog):
        progressionDialog.setWindowTitle(QtGui.QApplication.translate("progressionDialog", "Dialog", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.progressionname.setStatusTip(QtGui.QApplication.translate("progressionDialog", "Name of the progression sequence", None, QtGui.QApplication.UnicodeUTF8))
