...
root = os.path.split(
    os.path.split(os.path.dirname(wheeljack.__file__))[0])[0]

DATABASE_ENGINE = 'sqlite3'    # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
DATABASE_NAME = os.path.join(root, 'var', 'wheeljack.db')
...
BUILDER = os.path.join(root, 'bin', 'wheeljack')
BUILDER_USER = 'admin'
BUILDER_PASSWORD = 'admin'
