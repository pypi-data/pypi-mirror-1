## import asciiporn3k; reload(asciiporn3k); from asciiporn3k import *

from __future__ import py3k_sugar
import asciiporn3k; from asciiporn3k import *; from asciiporn3k import _asciiporn3k; from asciiporn3k._asciiporn3k import *
...
class marray(_asciiporn3k._marray):
  ...
  def __new__(self, tcode, arr = None, shape0 = 1, shape1 = -1):
    if isinstance(tcode, _asciiporn3k._marray): return tcode.__copy__(self)
  ...
  def copy_base(self): return self.__copy__(_asciiporn3k._marray)
  ...
  @staticmethod
  def test():
    # _asciiporn3k._marray.__getattribute__ ..print()
...
def quicktest(ipath = ""):
  ## img2txt
  if not ipath: ipath = os.path.join(asciiporn3k.__path__[0], "mario.png")
  ipath ..print()
  png2txt(ipath) ..print()
  # marray.test()
