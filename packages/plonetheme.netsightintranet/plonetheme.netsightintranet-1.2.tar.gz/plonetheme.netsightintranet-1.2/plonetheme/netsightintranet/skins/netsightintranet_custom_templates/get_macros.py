...
# This is to check that in case we are using a browser view template instead of a skin one
if hasattr(versionPreviewTemplate, 'macros'):
  return versionPreviewTemplate.macros['main']
if hasattr(versionPreviewTemplate, 'index'):
  return versionPreviewTemplate.index.macros['main']