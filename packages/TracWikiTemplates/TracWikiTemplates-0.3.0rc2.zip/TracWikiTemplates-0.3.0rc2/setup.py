...
# $Id: setup.py 72 2006-09-22 23:50:55Z s0undt3ch $
...
"""
HOME_PAGE = 'http://wikitmplates.ufsoft.org'
LICENSE = 'BSD'
...
setup(name=PACKAGE,
      ...
      license=LICENSE,
      platforms="OS Independent - Anywhere Python and Trac >=0.10b1 is known to run.",
