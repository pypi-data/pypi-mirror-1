Translations for aws.inlineuserpref
===================================
...
may need to run::
  ...
  (i18ndude)$ cd .../aws.inlineuserpref/locales
  (i18ndude)$ python updatelocales.py

If some msgids are missing from the synched ".po" files, you may need to add
these msgids to "aws.inlineuserpref-manual.pot" (for 'aws.inlineuserpref'
domain). Then re-run the above commands.

Having aws.inlineuserpref in your language
------------------------------------------
...
Easy::
  ...
  $ cd .../aws.inlineuserpref/iw/sitestat/locales # Here ;)
  $ mkdir -p xx/LC_MESSAGES
  $ cp aws.inlineuserpref.pot xx/LC_MESSAGES/aws.inlineuserpref.po
  $ $EDITOR xx/LC_MESSAGES/aws.inlineuserpref.po
...
got aws.inlineuserpref with a subversion checkout.
