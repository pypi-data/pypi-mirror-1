...
class Install(BaseSubcommand):
    ...
    def __init__(self, subparsers):
        ...
        # FIXME: support --prefix and --exec-prefix!
        # (workaround for now: use virtualenv)
    ...
    def main(self, args, cfg):
        ...
        # Perform an install command against all checkouts.
        command = 'cd %%s && %s '  % sys.executable +\
            'setup.py easy_install --no-deps .'
