...
- batch_length: (maximum) number of items shown on each page (default
  is 10);

- batch_n_pages: (maximum) number of pages to be shown. Default value
  is 10, as in the example above. If this value was 5, the navigation
...
$Id: batch.py 25 2008-05-30 16:52:45Z damien.baty $
"""
