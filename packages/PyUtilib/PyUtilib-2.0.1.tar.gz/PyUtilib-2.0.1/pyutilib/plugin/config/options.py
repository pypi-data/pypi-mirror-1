...
def declare_option(name,cls=Option,**kwds):
    ...
    if locals_ is not frame.f_globals:
        ...
        if '__module__' in locals_:
            ...
            # classi, create it.  Create an Option instance in this instance.
            #
...
class DictOption(Option):
    ...
    class SectionWrapper(object):
        ...
        def __init__(self,section):
            ...
            self.__dict__["data"] = ExtensionPoint(IOptionDataProvider)
    ...
    def __init__(self, **kwds):
        ...
        self.default = DictOption.SectionWrapper(self.section)
