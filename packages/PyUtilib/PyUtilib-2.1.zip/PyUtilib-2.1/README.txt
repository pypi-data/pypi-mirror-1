...
The PyUtilib Python package includes a variety of Python utilities.

  data     - Interfaces to data sources
  misc     - Miscellaneous utilities
  plugin   - A general plugin framework, with extensions to support
             Python applications (e.g. config files, loading eggs, etc).
  pyro     - A distributed task dispatcher that uses Pyro's communication
             protocol
