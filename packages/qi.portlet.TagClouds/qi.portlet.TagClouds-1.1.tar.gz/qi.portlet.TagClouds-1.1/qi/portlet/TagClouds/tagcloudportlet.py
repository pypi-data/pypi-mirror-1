...
class Assignment(base.Assignment):
	...
	def __init__(self, portletTitle="TagCloud", levels=5, shouldRestrictBySubject=True, restrictSubjects=[], shouldRestrictByType=True, restrictTypes=[],root=u"",refreshInterval=3600):
