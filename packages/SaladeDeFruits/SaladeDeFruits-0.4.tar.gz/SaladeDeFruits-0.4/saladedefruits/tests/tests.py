...
class Tests(unittest.TestCase):
    ...
    def test_hosts(self):
        ...
        resp = self.app.get('/app/', extra_environ={'HTTP_HOST':'127.0.0.1:8080', 'X-Forwarded-Host':'www.gawel.org', 'X-Forwarded-Port':'443'})
        resp.mustcontain('https://www.gawel.org/app/#anchor')

        resp = self.app.get('/app/', extra_environ={'HTTP_HOST':'127.0.0.1:8080', 'X-Forwarded-Host':'www.gawel.org', 'X-Forwarded-Port':'8080'})
        ...
        resp = self.app.get('/app/', extra_environ={'HTTP_HOST':'127.0.0.1:9080', 'SCRIPT_NAME':'/toto',
                                                    'X-Forwarded-Host':'www.gawel.org', 'X-Forwarded-Port':'8080'})
