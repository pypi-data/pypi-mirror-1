...
'''pbandj/__init__.py - Mapping of Django model classes to Protocol Buffer 
...
class ProtocolBuffer(object):
    ...
    class Field(object):
        ...
        STRING = PB_TYPE_STRING
        DOUBLE = PB_TYPE_DOUBLE
        INT32  = PB_TYPE_INT32
        FLOAT  = PB_TYPE_FLOAT
        BOOL   = PB_TYPE_BOOL
    ...
    def startServices(self):
        ...
        for service in self.services.values():
            ...
            server = SocketRpcServer(service.port,host=gethostname())
