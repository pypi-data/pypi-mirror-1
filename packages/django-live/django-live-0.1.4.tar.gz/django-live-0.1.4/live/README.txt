...
You need orbited>=0.7 [0] installed and you need to run morbid (orbited's STOMP queue manager).
...
You need to set up your orbited.cfg file to allow access to the morbid port.
...
You may choose to run morbid separately or uncomment the stomp line in the orbited.cfg file to have it run automatically. You will also need to change the default orbited port if you will be running Django's web server on port 8000.
