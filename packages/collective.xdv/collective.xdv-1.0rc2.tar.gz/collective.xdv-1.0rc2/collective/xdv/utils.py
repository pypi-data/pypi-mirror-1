...
def compile_theme(theme, rules, boilerplate=None, absolute_prefix=None, compiler=COMPILER):
    ...
    string.
    """
    return xdvcompiler.compile_theme(compiler, theme, rules, boilerplate, absolute_prefix)