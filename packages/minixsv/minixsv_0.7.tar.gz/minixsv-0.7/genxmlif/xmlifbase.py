...
#++++++++++++ methods concerning the tag name ++++++++++++++++++++++++
    ...
    def getNsName (self):
        return NsNameTupleFactory( (self.getNamespaceURI(), self.getLocalName(),) )
...
#++++++++++++ methods concerning the children of the current node ++++++++++++++++++++++++
    ...
    ##########################################################
    #  create a new child node and append it to the children of the current node
    ...
    ##########################################################
    #  create a new child node and insert it before the given reference child of the current node
    #  returns the element wrapper of the created child
...
#++++++++++++ methods concerning the attributes of the current node ++++++++++++++++++++++++
    ...
    def getQNameAttribute (self, tupleOrAttrName):
        ...
        return self.qName2NsName(qName, useDefaultNs=1)
...
#++++++++++++ limited XPath support ++++++++++++++++++++
    ...
    def getXPathList (self, xPath, namespaceRef=None):
        ...
        return completeChildList, attrNodeList, attrNsName
