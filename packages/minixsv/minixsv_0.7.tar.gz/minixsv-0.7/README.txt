Release Notes for minixsv, Release 0.7

minixsv is a XML schema validator written in "pure" Python
(minixsv requires Python 2.4)
...
- uniqueness of attribute/attributeGroup/type IDs not checked
- some problems with different target namespaces (planned to be fixed in next release!)
