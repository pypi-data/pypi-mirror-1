...
- extract minixsv-0.8.tar.gz or minixsv-0.8.zip file into a temporary directory
- call: python setup.py install

2. Python-Egg for Python 2.4
- call: easy_install minixsv-0.8-py2.4.egg

3. Python-Egg for Python 2.5
- call: easy_install minixsv-0.8-py2.5.egg
