...
-->
  ...
  <xsl:template match="a:feed">
    <html 
        ...
        -->
            ...
            <link rel="stylesheet" type="text/css" media="screen,projection" href="static/two-tenths/css/screen.css" />
        </head>
        <body id="bhome">            
            <div id="topnav">                
                <ul>
            ...
            <div id="foot">
                <div id="site-info">                
                    <p>
                        ...
                        Webdesign by <a href="http://www.nikhedonia.com/">Sadhana Ganapathiraju</a> | 
  ...
  <xsl:template match="a:link" mode="atom-icon">
    <a href="{@href}"><img  style="padding-left:20px" border="0" src="static/atom.png" alt="Atom Feed"/></a>
  </xsl:template>
</xsl:stylesheet>
