...
# EasyPublisherMaker.py is part of The Ming Mods
...
from TheMingServer.EasyPublisher import PurchaseButton
from TheMingServer import lib
import os

class EasyPublisherMaker(HTMLMaker):
	NAME = "EasyPublisherMaker"
	...
	def __parse_content(self, content):
		pre = (content[0].find("<pre>") != -1) and 1 or 0
