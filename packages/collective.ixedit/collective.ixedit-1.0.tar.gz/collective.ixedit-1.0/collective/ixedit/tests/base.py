...
def setup_product():
    ...
    import collective.ixedit
    zcml.load_config('configure.zcml', collective.ixedit)
    ...
    ztc.installPackage('collective.ixedit')
...
setup_product()
ptc.setupPloneSite(products=['collective.ixedit'])
