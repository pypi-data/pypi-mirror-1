...
class ICurrencyInformation(Interface):
    code = Choice(
            title=_(u"label_curren_currency",
                default=u"Currency"),
            description=_(u"help_currency_currency",
                default=u"The main currency is used as the default currency "
                        u"as well as the base for currency rates. If you "
                        u"change the main currency all rates will be "
...
class IGlobalCurrencySettings(Interface):
    currency = Choice(
            title=_(u"label_currencymanager_currency",
                default=u"Main currency"),
            description=_(u"help_currencymanager_currency",
                default=u"The main currency is used as the default currency "
