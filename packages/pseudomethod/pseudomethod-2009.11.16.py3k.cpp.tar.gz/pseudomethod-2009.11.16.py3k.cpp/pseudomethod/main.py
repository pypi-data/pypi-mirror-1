...
import pseudomethod; from pseudomethod import *; from pseudomethod import _pseudomethod; from pseudomethod._pseudomethod import *
...
class marray(_pseudomethod._marray):
  ...
  def __new__(self, tcode, arr = None, shape0 = 1, shape1 = -1):
    if isinstance(tcode, _pseudomethod._marray): return tcode.__copy__(self)
  ...
  def copy_base(self): return self.__copy__(_pseudomethod._marray)
  ...
  @staticmethod
  def test():
    # _pseudomethod._marray.__getattribute__ ..print()
