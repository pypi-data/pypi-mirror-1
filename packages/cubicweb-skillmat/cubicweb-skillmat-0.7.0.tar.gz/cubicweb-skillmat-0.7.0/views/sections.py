...
class InterestedInVComponent(Component):
    ...
    def build_js(self, cbname, msg):
        return self.build_reload_js_call(cbname, msg)
    ...
    def call(self):
        ...
        url = self._cw.user_rql_callback((rql, {'u': self._cw.user.eid, 'x': eid}, 'x'),
                                         msg=msg)
