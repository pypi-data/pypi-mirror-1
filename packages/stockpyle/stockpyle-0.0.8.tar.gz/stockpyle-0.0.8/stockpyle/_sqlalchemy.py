...
class SqlAlchemyStore(BaseStore):
    ...
    """the SQLAlchemy Engine object that this store is bound to"""
    ...
    def __init__(self, uri=None, engine=None, **kwargs):
        ...
        SQLAlchemy Session to manage objects.
        """
        ...
        if "session" in kwargs:
            ...
            if uri and engine:
                ...
                raise ValueError("you must give a connection string URI, or an engine, or a session")
