...
since you will have to *merge()* stockpyle-retrieved object into your session::
    ...
    # you must merge the object into my_session
    # before you can commit it with SQLAlchemy
