...
if __HAVE_SA:
    ...
    class SqlAlchemyStoreTestCase(StoreFixture, TestCase):
        ...
        def test_instantiation_with_nothing_raises_error(self):
            self.assertRaises(ValueError, lambda: SqlAlchemyStore())
    ...
    class ChainedStoreWithSqlAlchemyTestCase(TestCase):
        ...
        def setUp(self):
            ...
            self.__session = sessionmaker(autoflush=True, extension=ext, bind=self.__sa.engine)()
