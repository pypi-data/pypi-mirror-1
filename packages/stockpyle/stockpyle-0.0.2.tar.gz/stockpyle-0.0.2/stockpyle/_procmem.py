...
class ProcessMemoryStore(MemcacheStore):
    
    def __init__(self):
        super(ProcessMemoryStore, self).__init__(client=ProcessMemoryMemcacheClient())


class ProcessMemoryMemcacheClient(object):
