...
DeclarativeBase.metadata.bind = engine_from_config({"sqlalchemy.url": "sqlite:///:memory:"})
...
class ExpiringStoreFixture(object):
    ...
    def test_can_store_and_expire_later(self):
        ...
        self.store.configure(classes=[Foobar], lifetime=_DUMMY_EXPIRE_TIME)
    ...
    def test_can_store_and_expire_later_with_datetime(self):
        ...
        self.store.configure(classes=[Foobar], lifetime=d)
    ...
    def test_can_store_and_expire_later_with_timedelta(self):
        ...
        self.store.configure(classes=[Foobar], lifetime=td)
