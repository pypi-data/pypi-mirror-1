...
class styleObj(_object):
    ...
    __swig_setmethods__["_geomtransformexpression"] = _mapscript.styleObj__geomtransformexpression_set
    __swig_getmethods__["_geomtransformexpression"] = _mapscript.styleObj__geomtransformexpression_get
    if _newclass:_geomtransformexpression = _swig_property(_mapscript.styleObj__geomtransformexpression_get, _mapscript.styleObj__geomtransformexpression_set)
    __swig_setmethods__["_geomtransform"] = _mapscript.styleObj__geomtransform_set
    __swig_getmethods__["_geomtransform"] = _mapscript.styleObj__geomtransform_get
    if _newclass:_geomtransform = _swig_property(_mapscript.styleObj__geomtransform_get, _mapscript.styleObj__geomtransform_set)
