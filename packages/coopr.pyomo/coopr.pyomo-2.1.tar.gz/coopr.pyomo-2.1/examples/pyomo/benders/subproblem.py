...
def unit_interval_validate(value, model):
   return (value >= 0.0) and (value <= 1.0)
model.prob = Param(validate=unit_interval_validate)

# inventory at end of first period.
model.inv1 = Param(model.PROD, within=NonNegativeReals)
