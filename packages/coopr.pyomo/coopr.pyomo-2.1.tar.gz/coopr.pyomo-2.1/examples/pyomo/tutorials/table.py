...
data.add_table("tab/A.tab")
data.add_table("tab/B.tab")
data.add_table("tab/C.tab", set="C")
data.add_table("tab/D.tab", set="D", format="array")
data.add_table("tab/E.tab", set="E")
data.add_table("tab/I.tab")
data.add_table("tab/Z.tab", param="Z")
data.add_table("tab/Y.tab")
data.add_table("tab/XW.tab")
data.add_table("tab/T.tab", param="T", format="transposed_array")
data.add_table("tab/U.tab", param="U", format="array")
data.add_table("tab/S.tab")
data.add_table("tab/RQ.tab", index="H")
data.add_table("tab/PO.tab", index="J", param=("P","O"))
data.add_table("tab/PP.tab", param="PP")
data.read()
