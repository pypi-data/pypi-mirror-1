...
data.add("tab/A.tab")
data.add("tab/B.tab")
data.add("tab/C.tab", set="C")
data.add("tab/D.tab", set="D", format="set_array")
data.add("tab/E.tab", set="E")
data.add("tab/I.tab")
data.add("tab/Z.tab", param="Z")
data.add("tab/Y.tab")
data.add("tab/XW.tab")
data.add("tab/T.tab", param="T", format="transposed_array")
data.add("tab/U.tab", param="U", format="array")
data.add("tab/S.tab")
data.add("tab/RQ.tab", index="H")
data.add("tab/PO.tab", index="J", param=("P","O"))
data.add("tab/PP.tab", param="PP")
data.read()
