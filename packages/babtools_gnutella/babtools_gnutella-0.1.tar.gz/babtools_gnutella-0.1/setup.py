...
"""babtools_gnutella - Tools for Gnutella. 
...
from babtools_gnutella import __doc__ as babtools__doc__

# Also get version and changelog. Changelog is read from the file Changelog.txt
from babtools_gnutella import __version__, __changelog__
...
setup(name=NAME,
      ...
      url='http://freehg.org/u/ArneBab/babtools_gnutella',
      #packages = find_packages('.'), 
      py_modules=['babtools_gnutella'],
      scripts=["babkeywords_from_dir.py"]
     )
