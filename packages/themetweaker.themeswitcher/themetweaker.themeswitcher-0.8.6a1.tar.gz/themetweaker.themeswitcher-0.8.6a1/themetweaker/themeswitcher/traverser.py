...
class Traverser(DefaultPublishTraverse):
    ...
    """
    adapts(IContentish, IHTTPRequest)
    ...
    def publishTraverse(self, request, name):
        ...
        # request = ISwitchSetter(request).mark(Interface)
        if IThemeSwitcher.providedBy(self.context):
            # Apply the prefered browser layer rather than the
