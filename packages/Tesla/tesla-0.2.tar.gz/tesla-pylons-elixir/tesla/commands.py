...
class SqlCommand(Command):
    ...
    def command(self):
        ...
        try:
            ...
            package = __import__(base_package + '.models')
...
class ModelCommand(Command):
    ...
    Example usage::
        ...
        Creating yourproj/yourproj/models/user.py
    ...
    created for you::
        ...
        Creating yourproj/models/user
        Creating yourproj/yourproj/models/user/permissions.py
    ...
    def command(self):
        ...
        try:
            ...
            file_op.copy_file(template='model.py_tmpl',
                         dest=os.path.join('models', directory), 
                         filename=name)
...
class MigrateCommand(Command):
    ...
    def command(self):
        ...
        dburi = self.options.dburi or util.config_get('sqlalchemy.dburi')
        try:
