...
from cubicweb.schema import (
    RQLConstraint, RQLVocabularyConstraint, StaticVocabularyConstraint,
...
class Ticket(WorkflowableEntityType):
    ...
    priority = String(required=True, internationalizable=True,
                      constraints=[StaticVocabularyConstraint((_('important'), _('normal'), _('minor')))],
                      description=_("importance"), default='normal')
    type = String(required=True, internationalizable=True,
                  constraints=[StaticVocabularyConstraint((_('bug'), _('story')))],
