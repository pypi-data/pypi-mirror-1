...
from cubicweb.devtools.apptest import ControllerTC, RepositoryBasedTC
...
class TrackerBaseTC(TrackerTCMixIn, ControllerTC):
    def setup_database(self):
        self.cubicweb = self.add_entity('Project', name=u'cubicweb',
                                        description=u"cubicweb c'est beau")


class SecurityTC(TrackerTCMixIn, RepositoryBasedTC):
