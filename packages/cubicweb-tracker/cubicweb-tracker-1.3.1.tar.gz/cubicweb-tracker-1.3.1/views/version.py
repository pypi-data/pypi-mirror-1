...
class VersionPrimaryView(primary.PrimaryView):
    ...
    def render_entity_title(self, entity):
        self.render_entity_toolbox(entity) # XXX remove when 3.6 is out
        self.req.add_css('cubes.tracker.css')
    ...
    def _ticket_table(self, title, ticketrql, nbcol, divid):
        ...
        self.w(u'<div class="dynamicFragment" cubicweb:loadurl="%s"></div>'
               % xml_escape(self.req.build_url('json', **params)))
    ...
    def render_entity_relations(self, entity):
        ...
        if entity.conflicts:
            w(u"<div class='entityDescr'><b>%s</b>:<ul>"
              % display_name(self.req, 'conflicts', context='Version'))
        ...
        self._ticket_table(self.req._('Ticket_plural'), entity.tickets_rql(),
                           entity.tickets_rql_nb_displayed_cols, 'tickets'),
        self._ticket_table(self.req._('Defects detected on this version'),
                           entity.defects_rql(),
