...
def setup_product():
    ...
    import Mlango
    zcml.load_config('configure.zcml', Mlango)
...
setup_product()
ptc.setupPloneSite(products=['Products.Mlango'])

class MlangoTestCase(ptc.PloneTestCase):
    """We use this base class for all the tests in this package. If necessary,
    we can put common utility or setup code in here. This applies to unit 
    test cases.
    """

class MlangoFunctionalTestCase(ptc.FunctionalTestCase):
