...
class TaskList(list):
    ...
    def append(self, task):
        ...
        #task.call_on_exit(self.remove, task)
    ...
    def _install(self, fibra):
        """
        Install an fibra and start a nanothread, within the context of 
        this list. 
        """
        th = _install(fibra)
        self.append(th)
    ...
    def pause(self):
        for th in self: th.pause()
            
    def resume(self):
        for th in self: th.resume()
...
class TaskQueue(object):
    ...
    def run(self, task):
        th = self.tasks._install(task)
        th.call_on_exit(self.next_task)
