...
def setup_product():
    ...
    import proteon.exporterimporter
    zcml.load_config('configure.zcml', proteon.exporterimporter)
    ...
    ztc.installPackage('proteon.exporterimporter')
...
setup_product()
ptc.setupPloneSite(products=['proteon.exporterimporter'])
