...
then compare them visually. That is impractical for all but the simplest universes.
...
control system and you will be able to see what changed between any two versions of 
the the universe.
