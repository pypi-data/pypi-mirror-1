...
class SiteManagerTreeViewlet(tree.SimpleJSONTreeViewlet):
    ...
    z3cJSONTreeId = u'zmiSiteManagerTree'
    z3cJSONTreeName = u'zmiSiteManagerTree'
    ...
    def getParents(self):
        ...
        root = self.getRoot()
        return z3c.jsontree.util.getParentsFromContextToObject(self.context,
            root)
    ...
    def registrations(self):
        registrations = [
            zope.component.getMultiAdapter((r, self.request),
                interfaces.IRegistrationDisplay)
...
class UtilityRegistrationDisplay(object):
    ...
    zope.interface.implements(interfaces.IRegistrationDisplay)
...
class SiteRegistrationView(RegistrationView):
    ...
    def registrations(self):
        registrations = [
            zope.component.getMultiAdapter((r, self.request),
                interfaces.ISiteRegistrationDisplay)
...
class UtilitySiteRegistrationDisplay(UtilityRegistrationDisplay):
    ...
    zope.interface.implementsOnly(interfaces.ISiteRegistrationDisplay)
