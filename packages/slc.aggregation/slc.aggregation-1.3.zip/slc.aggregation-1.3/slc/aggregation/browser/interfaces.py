...
class IAggregatorConfiguration(Interface):
    ...
    restrict_language = schema.Bool(
            title=_(u"Restrict to current language"),
            description=_(u'Check this box if you want to restrict the '
            'language of the aggregated items, to the language in which '
            'the user is viewing the site.'),
            required=False,
            )
