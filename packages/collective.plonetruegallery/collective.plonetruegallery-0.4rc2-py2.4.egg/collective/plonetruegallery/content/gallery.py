...
class validateGalleryType:
    ...
    def __call__(self, value, *args, **kwargs):
        ...
        req = kwargs['REQUEST']
        gallerytype = gallery.getGalleryType(req.get('type'))
        return gallerytype.validate()
...
copied_fields['title'].widget.validators = (validateGalleryType(),)
...
schema = Schema((
    ...
    StringField(
        ...
        widget=SelectionWidget(
            label="Type",
            description="Select the type of gallery you want this to be."
        ),
...
class Gallery(ATFolder):
    ...
    def __init__(self, arg1):
        ...
        self.gallery_types = GALLERY_TYPES
