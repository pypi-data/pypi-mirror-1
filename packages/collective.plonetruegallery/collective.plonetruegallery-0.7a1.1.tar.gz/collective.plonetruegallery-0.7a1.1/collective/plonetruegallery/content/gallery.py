...
schema = Schema(
    ...
    StringField(
        ...
        vocabulary=(
            ('classic', _(u"label_classic_display_type", default=u"Classic")),
            ('slideshow', _(u"label_slideshow_display_type", default=u"Slideshow 2"))
        ),
        default="classic",
        enforceVocabulary = True,
    ),
...
for t in GalleryTypes:
    GallerySchema = GallerySchema.copy() + t.schema.copy()
