...
from collective.plonetruegallery.galleryadapters.flickr import FlickrAdapter, add_condition as flickr_add_condition
from collective.plonetruegallery.galleryadapters.picasa import PicasaAdapter, add_condition as picasa_add_condition
