...
class IGeoreferencedEvent(IObjectModifiedEvent):
    """An event fired when georeferenced.
    """
    
    object = Attribute("""The content object that was saved.""")
...
class IGeoreferenced(Interface):
    ...
    crs = Attribute = Attribute("""A coordinate reference system as a dict.
