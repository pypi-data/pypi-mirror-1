...
function slide_click(){
    ...
    var finish_button = $("<div class='finish-button'><a href='' onclick='return false'>Click here when you are finished</a><p class='discreet'>Make sure you save first</p></div>");
    var iframe = $("<iframe src='" + $(ele).attr('href') + 
        "' width='700' height='400' border='0'>Your browser does not support iframes</iframe>");
