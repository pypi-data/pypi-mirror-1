...
(function($) {
	...
	$.fn.easySlider = function(options){
		...
		this.each(function() {  
			...
			$('div#easySlider-goToButtons a').click(function(){
			    animate(parseInt($(this).attr('id').substring(options.goToButtonId.length)), true);
			});
			
			if(options.goToButtons) $("#" + options.goToButtonId + "0").addClass('active');
			...
			function animate(dir,clicked){
				...
				if(options.goToButtons){
				    $("div#easySlider-goToButtons a").removeClass("active");
