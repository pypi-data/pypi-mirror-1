...
class tabarray(numpy.core.records.recarray):
	...
	**Invariants**
	...
	def saveSV(self, fname, comments=None, delimiter=None, linebreak=None, metadata=None, printmetadict=None, strongmetadata=False):
		"""
		...
		"""
		io.saveSV(fname=fname, X=self, comments=comments, delimiter=delimiter, linebreak=linebreak, metadata=metadata, printmetadict=printmetadict, strongmetadata=strongmetadata)
