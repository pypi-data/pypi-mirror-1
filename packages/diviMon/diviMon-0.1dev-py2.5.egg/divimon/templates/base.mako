...
<div id="menu">
    ...
    <ul>
        ...
        <li><a href="${g.base_url}/delivery_confirm/" title="List of Confirmed Sale Deliveries">Delivery Confirm</a></li>
        <li>Stocks</li>
...
<!--         <li><a href="${g.base_url}/classification/" title="List of Classifications">Classifications</a></li> -->
    ...
    <ul>
        ...
        <li><a href="${g.base_url}/purchase_order/" title="List of Purchase Orders">Purchase Order</a></li>
        <li><a href="${g.base_url}/purchase_receipt/" title="List of Receipt Purchase Deliveries">Purchase Receipt</a></li>
        <li><a href="${g.base_url}/purchase_return/" title="List of Returned Purchases">Purchase Return</a></li>
