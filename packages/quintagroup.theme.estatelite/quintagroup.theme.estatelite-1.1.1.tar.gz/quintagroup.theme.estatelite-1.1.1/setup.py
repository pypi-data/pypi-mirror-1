# -*- coding: utf-8 -*-
"""
This module contains the tool of quintagroup.theme.estatelite
"""
import os
...
setup(name='quintagroup.theme.estatelite',
      version=version,
      ...
      url='http://skins.quintagroup.com/estate-lite',
      license='GPL',
      ...
      test_suite = 'quintagroup.theme.estatelite.tests',
      entry_points="""
      # -*- entry_points -*- 
      ...
      """,
      paster_plugins = ["ZopeSkel", "PasteScript"],
      setup_requires = ["setuptools", "ZopeSkel", "PasteScript"],
      theme_vars = {'skinname': 'Estatelite Theme',
