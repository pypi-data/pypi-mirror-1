...
========
 ...
 - Version 2.0.0 (subversion version 8) is completely revised, see version 1.4.0 (subversion version 6) for the old algorithm.

 - It is now clear that I should use both new and old algorithms (see ToDo list).
...
>>> from htmllist.repeat_pattern import RepeatPattern
>>> hl = HtmlList()
>>> hl.set_text(html_taxt)
