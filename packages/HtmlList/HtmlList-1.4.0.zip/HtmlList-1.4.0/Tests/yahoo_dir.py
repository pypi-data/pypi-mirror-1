...
class Test (MyBaseTest):
	def runTest (self):
		...
		# Like dmoz - not all occurrences are correct
		# Here there is another more prevalent pattern with TD tags.
		lst = self.Init ('opensource_yahoodir_20.html', args = {'max_stdv_indx': 0.001})
