...
Conclusions from the tests:
	...
	configuration. For example Dmoz need a "max_stdv_indx", Yahoo Directory need
	also higher value for "max_stdv_ptrn", the Blackwood Productions links page
	needs a different set of "pattern_tags" and also "structural_attrs".
