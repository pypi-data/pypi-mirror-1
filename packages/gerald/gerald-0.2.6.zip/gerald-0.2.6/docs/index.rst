...
::
    ...
    svn checkout http://halfcooked.svn.sourceforge.net/svnroot/halfcooked/tags/release-0.2.6/gerald/ gerald/
...
This is release 0.2.6 of Gerald. It's still alpha code, but it is in use on and does provide some value.
