...
class TestSchemaNew(object):
    ...
    def test_version_attribute(self):
        ...
        assert hasattr(PostgresSchema(self.schema_name), 'schema_api_version')
...
class TestTableFromDbAttributes(object):
...
class TestViewAttributesFromDb(object):
    def setup_class(self):
        "Create our view in the designated database"
        self.view_name = 'test_view_from_db'
        self.dummy_table_name = 'empty_table'
