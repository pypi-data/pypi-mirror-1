...
::
    ...
    svn checkout http://halfcooked.svn.sourceforge.net/svnroot/halfcooked/tags/release-0.3.6/gerald/ gerald/
...
This is release 0.3.6 of Gerald. It's still alpha code, but it is in use on and does provide some value.
...
:Last Updated: Sunday the 14th of February, 2010.
