...
if HAS_MAPS:
    GeoLocationMixinSchema = atapi.Schema((
            LocationField('geolocation',
                ...
                schemata='map',
                widget=LocationWidget(label=_(u'GeoLocation'),
                                      ),
                ),
    ))
else:
...
ImageMixinSchema = atapi.Schema((
    atapi.ImageField('image',
         ...
         widget = atapi.ImageWidget(preview_scale = 'thumb',
                                    description = _(u'Image will be scaled to several different sizes.'),
                                    label= _(u'Image'),
                                    ),
         ),
))
...
class BaseProfile(object):
    ...
    #A lot of views have text-fields in them. Rather than crashing, this at least returns something useful.
