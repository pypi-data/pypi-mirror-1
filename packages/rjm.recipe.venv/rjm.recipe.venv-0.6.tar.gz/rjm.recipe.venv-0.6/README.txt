...
no_site_packages:
    ...
    If this is set to a true value then the --no-site-packages option
    will be used to ensure that none of the python packages installed
    at the system level will be available in the virtualenv sandbox.
...
site packages.  It then installs egenix-mx-base using distutils, and
the latest version of Pylons and all of its dependencies using pip::
