...
# @param breakWords If this is set to true, words will be allowed to be broken
#                   in half if it may look neater (annotated with a hyphen).
#                   If not, words will only break if absolutely necessary
def WordWrap(app, text, font, width, breakWords = True):
    lines = text.split('\n')
