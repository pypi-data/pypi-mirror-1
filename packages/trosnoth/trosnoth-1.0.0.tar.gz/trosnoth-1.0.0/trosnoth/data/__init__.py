...
import os
from trosnoth.data import sprites
...
def loadSprite(filename):
    import pygame
    return pygame.image.load(getPath(sprites, filename)).convert()
            
def loadSpriteWithAlpha(filename):
    import pygame
    return pygame.image.load(getPath(sprites, filename)).convert_alpha()
