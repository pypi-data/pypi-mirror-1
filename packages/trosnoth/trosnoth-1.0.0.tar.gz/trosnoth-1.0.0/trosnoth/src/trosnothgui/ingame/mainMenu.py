...
from trosnoth.src.gui.common import ScaledSize
...
class MainMenu(MenuDisplay):
    def __init__(self, app, location, interface, keymapping):
        ...
        autosize = True
        hidable = True
        size = ScaledSize(175, 10)   # Height doesn't matter when autosize is set.
