...
from trosnoth.src.gui.fonts import fontcache
...
class Font(object):
    ...
    # TODO: could cache resulting images        
    ...
    def _getFont(self, app):
        return fontcache.get(self._name, self._size)
...
class ScaledFont(Font):
    def _getFont(self, app):
        return fontcache.get(self._name, int(self._size * app.screenManager.scaleFactor + 0.5))
