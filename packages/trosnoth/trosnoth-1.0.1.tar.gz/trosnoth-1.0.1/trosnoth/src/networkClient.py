...
class UDPMulticastClient(DatagramProtocol):
    ...
    def datagramReceived(self, datagram, address):
        ...
        # We don't recognise this command
            ...
            print "Multicast client doesn't understand: ", datagram
...
class NetworkClient(object):
    ...
    def __init__(self, mainInterface):
        self.multicastClient = UDPMulticastClient(self)
        self.udpClient = None
    ...
    def refreshServerList(self, delay=1.):
        ...
        self.multicastClient.askForServers()
        self.serverDetails = {}
    ...
    def connect(self, server):
        ...
        if self.tcpFactory is not None or self.udpClient is not None:
    ...
    def gotHostIPAddress(self, ipAddr, port):
        ...
        if self.tcpFactory is not None or self.udpClient is not None:
            self.connectingDeferred.errback(Exception('Already connected'))
            return
    ...
    def connected(self, settings):
        ...
        try:
            ...
            self.udpClient.connect(self.serverSettings['udpPort'], ipAddr)
        except Exception, e:
            logging.writeException()
            self.connectingDeferred.errback(e)
            return
    ...
    def sendUDP(self, message):
        self.udpClient.sendDatagram(message)
    ...
    def abandonTransaction(self, team):
        ...
        initiating player.'''
        tId = team.id
        self.udpClient.sendDatagram('Abandon' + tId)
    ...
    def requestTransactionInfo(self, team):
        self.udpClient.sendDatagram('reqTrans' + team.id)
