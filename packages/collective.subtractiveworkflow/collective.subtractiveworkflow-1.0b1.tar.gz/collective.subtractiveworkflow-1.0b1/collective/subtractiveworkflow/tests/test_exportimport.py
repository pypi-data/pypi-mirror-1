...
# Tests copied from test_exportimport and adjusted to prove compatibility
...
class ExportImportZCMLLayer:
    ...
    def setUp(cls):
        ...
        zcml.load_config('configure.zcml', collective.subtractiveworkflow)
...
class _WorkflowSetup(WorkflowSetupBase):
    ...
    def _initDCWorkflow( self, workflow_id ):
        ...
        wf_tool._setObject( workflow_id, SubtractiveWorkflowDefinition( workflow_id ) )
...
class WorkflowDefinitionConfiguratorTests( _WorkflowSetup, _GuardChecker ):
    ...
    def _getTargetClass( self ):
        from collective.subtractiveworkflow.exportimport import SubtractiveWorkflowDefinitionConfigurator
        return SubtractiveWorkflowDefinitionConfigurator
    ...
    def test_getWorkflowInfo_dcworkflow_defaults( self ):
        ...
        self.assertEqual( info[ 'meta_type' ], SubtractiveWorkflowDefinition.meta_type )
...
<object name="portal_workflow" meta_type="Dummy Workflow Tool">
 ...
 <object name="dcworkflow" meta_type="Subtractive Workflow"/>
 <bindings>
  <default/>
 </bindings>
</object>
...
<object name="portal_workflow" meta_type="Dummy Workflow Tool">
 <property name="title"></property>
 <object name="Non-DCWorkflow" meta_type="Dummy Workflow"/>
 <object name="%(workflow_id)s" meta_type="Subtractive Workflow"/>
 <bindings>
  <default/>
 </bindings>
</object>
...
<object name="portal_workflow" meta_type="Dummy Workflow Tool">
 <property name="title"></property>
 <object name="name with spaces" meta_type="Subtractive Workflow"/>
 <bindings>
  <default/>
 </bindings>
</object>
...
class Test_importWorkflow(_WorkflowSetup, _GuardChecker):
    ...
    def test_import_twice_nopurge(self):
        ...
        self.assertEqual(workflow.meta_type, SubtractiveWorkflowDefinition.meta_type)
