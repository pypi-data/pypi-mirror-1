...
class Recipe:
    def __init__(self, buildout, name, options):
        ...
        # make a copy before we add extra junk
        self.ocopy = self.options.copy()
        # and delete a couple of extraneous keys
        del self.ocopy['recipe']
        self.ocopy.pop('backends', None)
