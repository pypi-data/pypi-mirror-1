...
class RemoteProcessor(contained.Contained, persistent.Persistent):
    ...
    _scheduler -- stores scheduled items whihc know when a job should get
    ...
    def addJob(self, name, job):
        """Add a new job as available jobs."""
        self._jobs[name] = job
    ...
    def pullNextJob(self, now=None):
        ...
        if item is not None:
            ...
            # since we will ad the job to the _jobs container.
