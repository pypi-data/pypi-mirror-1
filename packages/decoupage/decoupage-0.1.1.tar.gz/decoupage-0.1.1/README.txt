...
`genshi <http://genshi.edgewall.org>`_ template for that section.  I
plan to make this pluggable with setuptools ``entry_points``, and
cascadable as well.  But that's for later, probably when I need it.
In the mean time, I have a disc to recover and a website to set up.
