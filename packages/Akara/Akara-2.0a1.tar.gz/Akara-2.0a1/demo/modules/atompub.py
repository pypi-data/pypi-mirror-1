...
Stores only XML document given it, in memory.  No known issues.
...
'''
From: http://lenzconsulting.com/xquery-reinventing/
...
ALso, we should support doc frags via XPointer
'''
