...
class IImagePortlet(IPortletDataProvider):
    ...
    header = schema.TextLine(title=_(u"Title"),
                             description=_(u"Title for the image"),
                             required=False)

    display_title = schema.Bool(title=_(u'Display Title'),
                                description=_(u"Select to display the title"),
                                required=False,
                                default=True)
    ...
    external_url = schema.TextLine(title=_(u"External url"),
                              description=_(u"If target object is not selected the image will link to this url"),
                              required=False)
