...
import os, sys
from WebStack.Helpers.Request import MessageBodyStream, get_body_fields, \
    decode_value, get_storage_items, Cookie, HeaderDict
...
class Transaction(WebStack.Generic.Transaction):
    ...
    def commit(self):
        ...
        cookie_str = str(self.cookies_out)
        if cookie_str:
            self.output.write(cookie_str + "\n")
        self.output.write("\n")
    ...
    def get_content_charsets(self):
        ...
        return self.parse_content_preferences(self.get_headers().get("accept-charset"))
    ...
    def get_content_languages(self):
        ...
        return self.parse_content_preferences(self.get_headers().get("accept-language"))
