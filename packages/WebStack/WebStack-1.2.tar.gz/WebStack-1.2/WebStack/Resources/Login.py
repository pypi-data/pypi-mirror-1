...
class LoginResource:
    ...
    def respond(self, trans):
        ...
        if fields_body.has_key("login"):
            if self.authenticator.authenticate(trans, fields_body.get("username"), fields_body.get("password")):
...
def get_target(trans, urlencoding, encoding):

    """
    Return the application, path and query string for 'trans' using the given
