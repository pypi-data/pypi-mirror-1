...
cdef class _DVBaseSpriteAttr_(DV):
    cdef BaseSprite sprite
    def __init__(self, BaseSprite sprite not None):
        self.sprite = sprite

cdef class _DVBaseSpriteAttr_x(_DVBaseSpriteAttr_):
    cdef float g(self):
        return self.sprite._x.g()

cdef class _DVBaseSpriteAttr_y(_DVBaseSpriteAttr_):
    cdef float g(self):
        return self.sprite._y.g()

cdef class _DVBaseSpriteAttr_rot(_DVBaseSpriteAttr_):
    cdef float g(self):
        return self.sprite._rot.g()

cdef class _DVBaseSpriteAttr_scale(_DVBaseSpriteAttr_):
    cdef float g(self):
        return self.sprite._scale.g()

cdef class _DVBaseSpriteAttr_red(_DVBaseSpriteAttr_):
    cdef float g(self):
        return self.sprite._red.g()

cdef class _DVBaseSpriteAttr_green(_DVBaseSpriteAttr_):
    cdef float g(self):
        return self.sprite._green.g()

cdef class _DVBaseSpriteAttr_blue(_DVBaseSpriteAttr_):
    cdef float g(self):
        return self.sprite._blue.g()

cdef class _DVBaseSpriteAttr_alpha(_DVBaseSpriteAttr_):
    cdef float g(self):
        return self.sprite._alpha.g()


_base_sprite_attr_getters = dict(
    x=_DVBaseSpriteAttr_x,
    y=_DVBaseSpriteAttr_y,
    rot=_DVBaseSpriteAttr_rot,
    scale=_DVBaseSpriteAttr_scale,
    red=_DVBaseSpriteAttr_red,
    green=_DVBaseSpriteAttr_green,
    blue=_DVBaseSpriteAttr_blue,
    alpha=_DVBaseSpriteAttr_alpha)
...
cdef class Sprite(BaseSprite):
    ...
    def attrgetter(self, name):
        if name == "u":
            return _DVSpriteAttr_u(self)
        elif name == "v":
            return _DVSpriteAttr_v(self)
        else:
