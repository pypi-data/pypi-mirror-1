...
def copytree(src, dst, symlinks=0, allowed_basenames=None):
    ...
    for name in names:
        ...
        try:
            if symlinks and os.path.islink(srcname):
                ...
                copytree(srcname, dstname, symlinks, allowed_basenames)
...
class Recipe(zc.recipe.egg.Eggs):
    ...
    def setup_bin(self, ws):
        ...
        self.write_server_script(self.name, gae_server, sys_path)
    ...
    def copy_packages(self, ws, lib):
        ...
        for key in entries.keys():
            ...
            if not os.path.exists(dir):
                os.mkdir(dir)
            copytree(src, dir, True, allowed_basenames=allowed_basenames)
