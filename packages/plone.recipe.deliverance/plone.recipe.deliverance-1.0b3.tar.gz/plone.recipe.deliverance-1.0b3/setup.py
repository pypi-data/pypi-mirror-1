...
Other possible options for the deliverance section include:
 ...
 paster -- Path to a script to use to run 'paster'. Defaults to the generated
  'paster' script. This option is only needed if you disable script generation
  and there is no bin/paster in the buildout.
