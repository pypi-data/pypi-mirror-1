...
if pywt.use_numpy():
    ...
    print "Using array.array module"
...
myWavelet = pywt.Wavelet(name="UserSuppliedWavelet", filterBank=myBank)
...
myWavelet = pywt.Wavelet(name="UserSuppliedWavelet", filterBank=builtinWavelet)
