...
class PipeReader( threading.Thread ):
    ...
    def run( self ):
        ...
        try:
            ...
            self.result.append( tmp.getvalue() )
        finally:
            self.pipe.close(); tmp.close()
...
#        self.add_edge(u,v)
    ...
    def layout(self,prog='neato',args='',fmt='dot'):
        ...
        # needs threading to avoid blocking
        # needs a temporary file because writing must be finished before starting to read
        data = []
        errors = []
