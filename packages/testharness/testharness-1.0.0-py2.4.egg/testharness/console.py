...
class Console(cmd.Cmd):
	...
	def __init__(self, startup_command = '', script_filename = ''):
		self.log = logging.getLogger("Console.Console")
	...
	def exit(self, params):
		"""
		Called by do_exit(). The user must overide this
		function if they need any function called at exit
		time.
		"""
		pass
	...
	def process(self, fileobject):
		...
		try:
			...
			import sys
			print "e >>", sys.exc_type, sys.exc_value
