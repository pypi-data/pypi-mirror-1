...
class TestHarness:
    ...
    def __init__(self, command_console, config_file_text):
        """
        """
        self.log = logging.getLogger("TestHarness.TestHarness")
    ...
    def load(self, python_module_name):
        ...
        if not module_dictionary == {}:
            ...
            self.log.error("load <%s> contains no modules!" % (python_module_name))
    ...
    def evaluate(self, dict):
        ...
        """
        try:
            the_module = self.__moduleDictionary[dict['module.class']]
            ...
            #   raise MethodNotFound, "The method \"%s\" was not found in the module \"%s\"." % (dict['method'], the_module)
