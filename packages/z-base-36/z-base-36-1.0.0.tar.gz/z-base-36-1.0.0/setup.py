...
VERSIONFILE = "base36/_version.py"
verstr = "unknown"
try:
...
# version stamp in z-base-36/_version.py, with a version number derived from
...
setup(name="z-base-36",
      version=verstr,
      description='base36 encoder/decoder',
      long_description='Encodes strings of binary bytes (base-256) into strings of alphanumerics chars (base-36) and decodes them again.',
      author='Zooko O\'Whielacronx',
      author_email='zooko@zooko.com',
      url='http://zooko.com/repos/z-base-36',
      license='BSD',
      packages=find_packages(),
      setup_requires=setup_requires,
      install_requires=['pyutil'],
      classifiers=trove_classifiers,
      test_suite="base36.test",
