########################################################################
# $Header: /var/local/cvsroot/4Suite/Ft/Xml/Xslt/_4xslt.py,v 1.50 2006-08-11 15:39:13 jkloth Exp $
"""
...
class XsltCommandLineApp(CommandLineApp.CommandLineApp):
    ...
    def __init__(self):
        CommandLineApp.CommandLineApp.__init__(
            self,
            '4xslt',
            ('command-line tool for performing XSLT transformations on XML'
             'documents'),
