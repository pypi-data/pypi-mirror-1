########################################################################
# $Header: /var/local/cvsroot/4Suite/Ft/Xml/XPath/ParsedExpr.py,v 1.47 2006-08-16 21:20:44 jkloth Exp $
"""
...
def _nodeset_compare(compare, a, b, relational=False):
    ...
    if isinstance(a, Types.NodesetType) and isinstance(b, Types.NodesetType):
        ...
        if not(a and b):
            ...
            # relational, and both node-sets are nonempty
            coerce = Conversions.NumberValue
        else:
            # not relational, and both node-sets are nonempty
