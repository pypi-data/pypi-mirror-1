...
__all__ = ['Localization', 'FileList', 'Script', 'ExecutableScript',
           'Executable', 'File', 'ModulesDocument', 'ExtensionsDocument',
           'Document']
...
class ExecutableScript:
    ...
    def __repr__(self):
        return 'ExecutableScript(%r, %r)' % (self.name, self.source)
