########################################################################
# $Header: /var/local/cvsroot/4Suite/Ft/Lib/DistExt/BuildDocs.py,v 1.49 2006-08-17 19:35:34 jkloth Exp $
"""
...
class BuildDocs(Command):
    ...
    def finalize_options(self):
        ...
        if self.inplace is None:
            ...
            self.inplace = self.build_dir.startswith(build_base)
    ...
    def get_outputs(self):
        return [ document.source for document in self.documents ]
    ...
    def get_source_files(self):
        ...
        for doc in self.distribution.doc_files:
            if isinstance(doc, Structures.File):
                ...
                sources.extend(self.find_xml_includes(source_uri))
        if self.inplace:
    ...
    def build_commandline(self):
        ...
        for script in self.scripts:
            ...
            title = '%s - %s' % (script.name, app.description)
            docs.append(Structures.Document(xmlfile, stylesheet=category,
    ...
    def build_index(self, documents):
        ...
        xmlfile = 'index-' + self.distribution.get_name() + '.xml'
        xmlfile = os.path.join(self.build_dir, xmlfile)
