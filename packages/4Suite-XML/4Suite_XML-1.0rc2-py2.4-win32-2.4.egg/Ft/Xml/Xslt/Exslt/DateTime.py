########################################################################
# $Header: /var/local/cvsroot/4Suite/Ft/Xml/Xslt/Exslt/DateTime.py,v 1.25 2006-01-04 16:00:55 jkloth Exp $
"""
    ...
    def repl(match):
        ...
        if groups['symbol'] is not None:
            ...
            if symbol == 'G':           # era designator
                ...
                rt = u'%0.*d' % (width, DayOfWeekInMonth(context, dateTime))
...
class _DateTime(object):
    ...
    def __repr__(self):
        return '%s(%r, %r, %r, %r, %r, %r, %r, %r, %r)' % (
            ...
            self.hour, self.minute, self.second, self.fraction, self.timezone)
