########################################################################
# $Header: /var/local/cvsroot/4Suite/Ft/Xml/Xslt/__init__.py,v 1.39 2006/08/13 22:22:57 mbrown Exp $
"""
...
def Transform(source, stylesheet, params=None, output=None):
    ...
    return processor.run(source, topLevelParams=params, stream=output)
