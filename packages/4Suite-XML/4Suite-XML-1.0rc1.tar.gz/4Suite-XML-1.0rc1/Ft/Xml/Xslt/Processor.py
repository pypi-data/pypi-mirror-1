########################################################################
# $Header: /var/local/cvsroot/4Suite/Ft/Xml/Xslt/Processor.py,v 1.77 2005/12/11 20:13:35 jclark Exp $
"""
...
class Processor(object):
    ...
    def __writerChanged(self, newWriter):
        """
        Private callback function to allow the OutputHandler to replace
        itself in the writer stack. See addHandler().
        """
