...
``tg_mochikit.version -- 1.3.1``
    ...
    with version 1.3.1 and several snapshots of the 1.4 development version.
...
``tg_mochikit.draganddrop -- False``
    Selects whether the ``turbogears.mochikit`` widget should include the
    ``DragAndDrop.js`` file.

Version selection
-----------------

The selection of a proper version of MochiKit is a bit more elaborated due to 
the fact that MockiKit hasn't had a proper 1.4 release for a few years now.
