...
__revision__  = "$Revision: 53814 $"
__version__   = '$Revision: 53814 $'[11:-2]

from zope import interface

from collective.beancounter.interfaces import IBeanCounter

PLONE_FIELDS="constrainTypesMode locallyAllowedTypes immediatelyAddableTypes".split()

def countable_fields(content):
    schema = content.Schema()
    return [f for f in schema.fields() if f.schemata=="default" and f.mode =="rw" and f.getName() not in PLONE_FIELDS]
