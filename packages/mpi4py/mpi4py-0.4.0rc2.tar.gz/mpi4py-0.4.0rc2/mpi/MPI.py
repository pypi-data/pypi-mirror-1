...
__version__   = '0.4.0'
__revision__  = '$Id: MPI.py,v 1.76 2006/11/04 01:00:01 dalcinl Exp $'
...
BOTTOM = _mpi.BOTTOM
"""Special address for buffers, `MPI_BOTTOM`"""
...
class Win(_mpi.Win):
    ...
    def Put(self, origin_buf, target_rank,
            target_disp=0, target_count=-1, target_datatype=None):
        """
