/* $Id: marshal.c,v 1.8 2006/10/15 18:17:47 dalcinl Exp $ */ 
...
marshal_dump(PyObject* self, PyObject* args) {
  ...
  if (buf != NULL && buf != Py_None) {
    void *bufptr, *resptr;
    Py_ssize_t buflen, reslen;
    resptr = (void*) PyString_AS_STRING(res);
    reslen = PyString_GET_SIZE(res);
...
marshal_load(PyObject* self, PyObject* args) {
  ...
  if (PyString_Check(obj)) {
    ...
    if (PyObject_AsReadBuffer(obj, (const void**)&str, &len) < 0)
      return NULL;
  }
