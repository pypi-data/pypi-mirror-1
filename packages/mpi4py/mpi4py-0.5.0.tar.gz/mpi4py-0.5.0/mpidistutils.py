...
# Id:        $Id: mpidistutils.py 106 2007-07-31 18:11:02Z dalcinl $
...
ConfigTests = [
    ...
    ('MPI_APPNUM',
     'int keyval = MPI_KEYVAL_INVALID; keyval = MPI_APPNUM;'),
    ('MPI_UNIVERSE_SIZE',
     'int keyval = MPI_KEYVAL_INVALID; keyval = MPI_UNIVERSE_SIZE;'),
    ('MPI_ERRCODES_IGNORE',
     'int* ec; ec = MPI_ERRCODES_IGNORE;'),
    ('MPI_COMM_SPAWN',
...
class build_ext(cmd_build_ext.build_ext):
    ...
    def finalize_options(self):
        ...
        # XXX I have to figure out why this is needed
        import sys, os
        if (sys.platform.startswith('linux') and
            ...
            try:
                ...
                pass
            pylib_dir = os.path.join(sys.prefix, "lib")
...
class build_exe(_build_ext):
    ...
    def build_extension (self, ext):
        ...
        # Just in (default) case libpythonX.X.a is a static library
        ldshflag = sysconfig.get_config_var('LINKFORSHARED')
        if ldshflag is not None:
