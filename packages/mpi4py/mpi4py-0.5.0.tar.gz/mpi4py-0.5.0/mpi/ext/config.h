/* $Id: config.h 53 2007-07-24 01:15:35Z dalcinl $ */
...
#if HAVE_MPI_2 || defined(MPI_WCHAR)
...
#if HAVE_MPI_2 || defined(MPI_SIGNED_CHAR)
...
#if HAVE_LONG_LONG || defined(MPI_LONG_LONG)
...
#if HAVE_LONG_LONG || defined(MPI_LONG_LONG_INT)
...
#if HAVE_LONG_LONG && (HAVE_MPI_2 || defined(MPI_UNSIGNED_LONG_LONG))
...
#if HAVE_MPI_2 || defined(MPI_STATUS_IGNORE)
...
#if HAVE_MPI_2 || defined(MPI_STATUSES_IGNORE)
...
#if HAVE_MPI_2 || defined(MPI_IN_PLACE)
...
#if HAVE_MPI_2 || defined(MPI_ROOT)
...
#if HAVE_MPI_2 || defined(MPI_UNIVERSE_SIZE)
...
#if HAVE_MPI_2 || defined(MPI_ERR_INFO)
...
#if HAVE_MPI_2 || defined(MPI_ERR_INFO_KEY)
...
#if HAVE_MPI_2 || defined(MPI_ERR_INFO_VALUE)
...
#if HAVE_MPI_2 || defined(MPI_ERR_INFO_NOKEY)
...
#if HAVE_MPI_2 || defined(MPI_MODE_NOCHECK)
...
#if HAVE_MPI_2 || defined(MPI_MODE_NOSTORE)
...
#if HAVE_MPI_2 || defined(MPI_MODE_NOPUT)
...
#if HAVE_MPI_2 || defined(MPI_MODE_NOPRECEDE)
...
#if HAVE_MPI_2 || defined(MPI_MODE_NOSUCCEED)
...
#if HAVE_MPI_2 || defined(MPI_LOCK_EXCLUSIVE)
...
#if HAVE_MPI_2 || defined(MPI_LOCK_SHARED)
...
#if HAVE_MPI_2 || defined(MPI_ERR_WIN)
...
#if HAVE_MPI_2 || defined(MPI_ERR_BASE)
...
#if HAVE_MPI_2 || defined(MPI_ERR_SIZE)
...
#if HAVE_MPI_2 || defined(MPI_ERR_DISP)
...
#if HAVE_MPI_2 || defined(MPI_ERR_LOCKTYPE)
...
#if HAVE_MPI_2 || defined(MPI_ERR_ASSERT)
...
#if HAVE_MPI_2 || defined(MPI_ERR_RMA_CONFLICT)
...
#if HAVE_MPI_2 || defined(MPI_ERR_RMA_SYNC)
...
#if HAVE_MPI_2 || defined(MPI_REPLACE)
...
#if HAVE_MPI_2 || defined(MPI_MODE_RDONLY)
...
#if HAVE_MPI_2 || defined(MPI_MODE_RDWR)
...
#if HAVE_MPI_2 || defined(MPI_MODE_WRONLY)
...
#if HAVE_MPI_2 || defined(MPI_MODE_CREATE)
...
#if HAVE_MPI_2 || defined(MPI_MODE_EXCL)
...
#if HAVE_MPI_2 || defined(MPI_MODE_DELETE_ON_CLOSE)
...
#if HAVE_MPI_2 || defined(MPI_MODE_UNIQUE_OPEN)
...
#if HAVE_MPI_2 || defined(MPI_MODE_SEQUENTIAL)
...
#if HAVE_MPI_2 || defined(MPI_MODE_APPEND)
...
#if HAVE_MPI_2 || defined(MPI_SEEK_SET)
...
#if HAVE_MPI_2 || defined(MPI_SEEK_CUR)
...
#if HAVE_MPI_2 || defined(MPI_SEEK_END)
...
#if HAVE_MPI_2 || defined(MPI_DISPLACEMENT_CURRENT)
...
#if HAVE_MPI_2 || defined(MPI_ERR_FILE)
...
#if HAVE_MPI_2 || defined(MPI_MAX_DATAREP_STRING)
...
#if HAVE_MPI_2 || defined(MPI_ERR_NO_MEM)
...
#if HAVE_MPI_2 || defined(MPI_APPNUM)
...
#if HAVE_MPI_2 || defined(MPI_ERRCODES_IGNORE)
...
#if HAVE_MPI_2 || defined(MPI_ERR_NAME)
...
#if HAVE_MPI_2 || defined(MPI_ERR_PORT)
...
#if HAVE_MPI_2 || defined(MPI_ERR_SERVICE)
...
#if HAVE_MPI_2 || defined(MPI_ERR_SPAWN)
...
#if HAVE_MPI_2 || defined(MPI_MAX_OBJECT_NAME)
...
#if HAVE_MPI_2 || defined(MPI_ERR_KEYVAL)
