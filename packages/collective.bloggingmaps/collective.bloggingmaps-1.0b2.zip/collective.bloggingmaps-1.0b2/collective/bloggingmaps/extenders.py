...
from collective.bloggingmaps.interfaces import IBloggingMapsSpecific
    ...
    fields = [
        ...
        GeoLocationField(
            ...
            widget=LocationWidget(
                label=_(u'label_geolocation', default=u'Location'),
            ),
        ),
        ...
        MarkerIconField(
            ...
            widget=SelectionWidget(
                format="select",
                label=_(u'label_markericon', default=u'Marker icon'),
            ),
        ),
    ]
