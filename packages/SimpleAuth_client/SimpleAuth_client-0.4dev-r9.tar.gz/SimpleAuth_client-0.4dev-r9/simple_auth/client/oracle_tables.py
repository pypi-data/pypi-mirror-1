...
def make_tables(engine):
    ...
    services = Table('services', metadata,
        Column('id', Integer, Sequence('services_seq'), primary_key=True),
        Column('name', String(64), nullable=False, unique=True),
    )
    ...
    resources = Table('resources', metadata, 
        Column('id', Integer, Sequence('resources_seq'), primary_key=True),
        Column('name', String(64), nullable=False, unique=True),
    )
 
    resource_users = Table('resource_users', metadata, 
        Column('id', Integer, Sequence('resource_users_seq'), primary_key=True),
