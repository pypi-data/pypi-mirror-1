...
class DummyComponent(object):
    ...
    def __init__(self, input=None):
        ...
        self.parameters.url = "http://www.example.com/parameters"
        self.version = 0.1
        self.full_type = "%s.%s" % (self.__module__, self.__class__.__name__)
        self.input = input
...
class ShelveDataStoreTest(unittest.TestCase):
    ...
    def test_with_really_long_key(self):
        ds = ShelveDataStore('/tmp')
        c = DummyComponent()
        c.parameters.url = 'http://www.example.com/liurfsnlieugcns9g8cy4h43icpw349chgwp938gn93gcw398cgnw398gc39qcgwccg3o87cgnq48w37qgcf478gf249gvpn9347gfnc9w58gn954wgv7nwp937gvn9w34gv7nw3579gntvw9p35gntvw59pgvn5937gc5gdnergfdnw3497fgn547gcfw7np349gvnp5947cgn9ericneirscfgserciwrugniwerugnciwergcwnregc'
