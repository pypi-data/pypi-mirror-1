...
class ParameterSet(dict):
    ...
    def read_from_str(str):
        """
        ParameterSet definition str should be a Python dict definition
        ...
        global_dict.update(dict(ParameterRange=ParameterRange,
                                ...
                                pi=numpy.pi))            
        try:
            D = eval(str, global_dict)
        except SyntaxError:
            raise SyntaxError("Invalid string for ParameterSet definition: %s" % str)
        return D or {}
