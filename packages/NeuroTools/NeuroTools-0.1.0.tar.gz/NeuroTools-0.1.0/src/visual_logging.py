...
def _plot_fig(ydata, xdata, xlabel, ylabel, title):
    _reopen()
...
def debug(ydata, xdata=None, xlabel='', ylabel='', title=''):
    if _level <= DEBUG:
        _plot_fig(ydata, xdata, xlabel, ylabel, title)

def info(ydata, xdata=None, xlabel='', ylabel='', title=''):
    if _level <= INFO:
        _plot_fig(ydata, xdata, xlabel, ylabel, title)

def warning(ydata, xdata=None, xlabel='', ylabel='', title=''):
    if _level <= WARNING:
        _plot_fig(ydata, xdata, xlabel, ylabel, title)

def error(ydata, xdata=None, xlabel='', ylabel='', title=''):
    if _level <= ERROR:
        _plot_fig(ydata, xdata, xlabel, ylabel, title)

def critical(ydata, xdata=None, xlabel='', ylabel='', title=''):
    if _level <= CRITICAL:
        _plot_fig(ydata, xdata, xlabel, ylabel, title)

def exception(ydata, xdata=None, xlabel='', ylabel='', title=''):
    if _level <= ERROR:
        _plot_fig(ydata, xdata, xlabel, ylabel, title)

def log(level, ydata, xdata=None, xlabel='', ylabel='', title=''):
    if _level <= level:
        _plot_fig(ydata, xdata, xlabel, ylabel, title)
