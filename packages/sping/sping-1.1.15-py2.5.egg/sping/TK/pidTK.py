...
# $Id: pidTK.py,v 1.2 2008/08/12 17:58:40 sabren Exp $
...
# - fixed argument names so that argument keywords agreed with pid.py (passes discipline.py)
#
#
# ToDo: for TKCanvas
...
#     
# $Log: pidTK.py,v $
# Revision 1.2  2008/08/12 17:58:40  sabren
# batch: code cleanup and formatting
#
# Revision 1.1  2002/01/22 02:53:04  clee
# SVG, WX, TK backends
#
...
# - TKCanvas now uses multiple inheritance from Tkinter.Canvas and pid.Canvas
