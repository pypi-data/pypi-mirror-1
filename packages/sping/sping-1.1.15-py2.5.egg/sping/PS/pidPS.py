...
# $Id: pidPS.py,v 1.1 2002/01/22 02:51:42 clee Exp $
#
...
class PSCanvas(Canvas):
    ...
    def __init__(self,size=(300,300),name='spingPS',
                 PostScriptLevel=2,
       ...
       try:
           ...
           # print "importing _psAccelerators", self._AsciiHexEncode
       except ImportError:
           pass
...
### for now just define EPSCanvas like this
EPSCanvas = PSCanvas        
