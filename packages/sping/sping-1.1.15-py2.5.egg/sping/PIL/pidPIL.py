# pidPIL.py -- a Python Imaging Library backend for PIDDLE
...
class PILCanvas( Canvas ):
    ...
    def drawLine(self, x1,y1, x2,y2, color=None, width=None):
        ...
        if w > 1:
            ...
            # self._pen.line(x1,y1,x2,y2) # no longer support pre1.0 PIL
    ...
    def drawString(self, s, x,y, font=None, color=None, angle=0):
        ...
        # tmpsize was originally 1.2* stringWidth, added code to give enough room for single
        #         character strings (sping bug#121995)
        sHeight = (self.fontAscent(font) + self.fontDescent(font))
        sWidth = self.stringWidth(s, font)
        tempsize = max(sWidth*1.2, sHeight*2.0) # heuristic
