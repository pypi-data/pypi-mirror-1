...
# $Id: pid.py,v 1.3 2008/08/12 17:46:55 sabren Exp $
# Generic Plug-In-Drawing: defines
...
"""
sping.pid >> Simple Platform INdependent Graphics) <<
          >>  the Plug-In Drawing module (p.i.d.)  <<
...
February-March 1999, revised 2001-02
...
__version_maj_number__ = "1.0" # if release should match "$SPING_MAJNUM$"
__version_min_number__ = "0"  # should match "$SPING_MINNUM$"
__version__ =  __version_maj_number__ + "." + __version_min_number__ # c.f. "$SPING_RVERSION$"

from types import StringType, IntType, InstanceType
from sping.colors import *

inch = 72		# 1 SPING drawing unit == 1/72 imperial inch
...
class Font:
    ...
    def __setattr__(self, name, value):
        raise TypeError, "pid.Font has read-only attributes"
...
class Canvas:
	...
	def __init__(self, size=(300,300), name="SPING"):
