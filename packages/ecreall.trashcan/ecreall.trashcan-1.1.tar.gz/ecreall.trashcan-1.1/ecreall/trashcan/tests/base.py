...
def setup_product():
    ...
    import ecreall.trashcan
    zcml.load_config('configure.zcml', ecreall.trashcan)
    ...
    ztc.installPackage('ecreall.trashcan')
...
setup_product()
ptc.setupPloneSite(products=['ecreall.trashcan'])
