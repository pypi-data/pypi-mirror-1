...
from ecreall.trashcan import config
...
def moveObjectsToTrashcanByPaths(self, paths, handle_errors=True, REQUEST=None):
    failure = {}
    success = []
...
def restoreObjectsFromTrashcanByPaths(self, paths, handle_errors=True, REQUEST=None):
    failure = {}
    success = []
    # use the portal for traversal in case we have relative paths
    portal = getToolByName(self, 'portal_url').getPortalObject()
