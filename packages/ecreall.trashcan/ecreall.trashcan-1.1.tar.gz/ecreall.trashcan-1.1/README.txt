...
This product customizes livesearch_reply.py and queryCatalog.py from Plone.
It has been tested on Plone 3.2, 3.2.1, 3.2.2.
It should work on Plone 3.3 if the two scripts have not changed.
