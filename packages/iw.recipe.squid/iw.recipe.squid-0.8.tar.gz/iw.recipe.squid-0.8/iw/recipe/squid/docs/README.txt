...
- bind_apache_http : binding port of apache (80 by default in http)
- bind_apache_https : binding port of apache (443 by default in https)
...
+++++++++++++++++++++++++++++++++++++
    ...
    <BLANKLINE>
        RewriteEngine On
        RewriteLog /home/youenn/recipe/iw.recipe.squid/iw/recipe/squid/tests/squid/log/rewrite_www.mysite.com.log
        RewriteLogLevel 0
    <BLANKLINE>
        CustomLog /home/youenn/recipe/iw.recipe.squid/iw/recipe/squid/tests/squid/log/access_www.mysite.com.log common
        ErrorLog /home/youenn/recipe/iw.recipe.squid/iw/recipe/squid/tests/squid/log/error_www.mysite.com.log
    <BLANKLINE>
