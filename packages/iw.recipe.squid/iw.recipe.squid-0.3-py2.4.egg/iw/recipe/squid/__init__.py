...
class Recipe(object):
    ...
    def __init__(self, buildout, name, options):
        ...
        self.options['squid_log_dir'] = os.path.join(self.options['prefix'],
                                                     'log')
        self.options['squid_var_dir'] = os.path.join(self.options['prefix'],
                                                     'var')
    ...
    def install(self):
        ...
        self._make_squidctl()
        self._make_logrotate()
        self._setup_right()
        dirs = os.listdir(self.options['prefix'])
    ...
    def _make_squidctl(self):
        ...
        f = open(os.path.join(self.options['binary_location'],'squidctl'),'w')
        f.write(r)
        f.close()
    ...
    def _make_logrotate(self):
        ...
        f = open(os.path.join(self.options['squid_config_dir'],'squid_logrotate.conf'),'w')
        f.write(r)
        f.close()
