...
+++++++++++++++++++++++++++++++++++++
    ...
    <BLANKLINE>
        RewriteEngine On
        RewriteLog .../tests/squid/log/rewrite_www.mysite.com.log
        RewriteLogLevel 0
    <BLANKLINE>
        CustomLog .../tests/squid/log/access_www.mysite.com.log common
        ErrorLog .../tests/squid/log/error_www.mysite.com.log
    <BLANKLINE>
    <BLANKLINE>
    <BLANKLINE>
...
Test the change of default apache binding
    ...
    RewriteLogLevel 9
    ...
    RewriteRule  ^/(.*)/$ http://127.0.0.1:3128/%{ENV:BACKEND_LOCATION}/%{ENV:BACKEND_PORT}/https/%{SERVER_NAME}/81/%{ENV:BACKEND_PATH}/__original_url__/$1 [L,P]
    RewriteRule  ^/(.*)$ http://127.0.0.1:3128/%{ENV:BACKEND_LOCATION}/%{ENV:BACKEND_PORT}/https/%{SERVER_NAME}/81/%{ENV:BACKEND_PATH}/__original_url__/$1 [L,P]
    ...
