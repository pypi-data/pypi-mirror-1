...
:Version: 0.1b
:Date: 2007-12-08
:Description: TurboGears controller and widgets for feed handling.

.. contents::
  :depth: 1

Turbofeeds is a TurboGears_ extension which provides support for generating
...
* Other contributors include:
  ...
  Simon Belak, Kevi Dangoor, Charles Duffy, Alberto Valverde, Jorge Vargas
