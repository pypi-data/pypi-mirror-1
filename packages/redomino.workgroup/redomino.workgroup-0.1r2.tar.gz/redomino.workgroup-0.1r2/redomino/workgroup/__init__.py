...
from redomino.workgroup import config
...
MessageFactory = MessageFactory('redomino.workgroup')

import redomino.workgroup.content
...
def initialize(context):
    ...
    for atype, constructor in zip(content_types, constructors):
        cmf_utils.ContentInit('%s: %s' % (config.PROJECTNAME, atype.portal_type),
            content_types      = (atype,),
            permission         = permissions.ADD_PERMISSIONS[atype.portal_type],
