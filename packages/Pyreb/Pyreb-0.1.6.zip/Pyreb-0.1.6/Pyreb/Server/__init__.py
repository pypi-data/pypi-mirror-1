...
from XMLRPCServer import PyrebXMLRPCServer
from XMLRPCServer import EVT_EXT_SETTEXT, EVT_EXT_GETTEXT
from XMLRPCServer import EVT_EXT_SETREGEX, EVT_EXT_GETREGEX
from XMLRPCServer import EVT_EXT_QUIT
