...
class HTTPRequest(object):
    ...
    def process(self):
        print 'self.process. state:',self.state
        return getattr(self, 'state_%s' % self.state)()        
    
    def state_write(self):
        print 'state_write !!!!!!!!!!!'
        self.do_pending_actions()
        if not self.write_ended and not self.send_close:
            self.close()
    ...
    def do_pending_actions(self):
        print 'doing pending actions'
