...
-------
This module is extracted from the poster package (version 0.4), written by
Chris Atlee and released under the MIT license.  Thank you, Chris.  The
module is unmodified other than the addition of this paragraph.
