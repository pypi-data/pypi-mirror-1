...
##############################################################################
"""
$Id: SquidTool.py 80262 2009-02-03 12:53:22Z tesdal $
"""
...
def joinUrlPath(url, url2):
    ...
    return urlparse.urlunparse((scheme, host, path, params2, query2, frag2))
...
class SquidTool(UniqueObject, SimpleItem):
    ...
    def getUrlsToPurge(self, object):
        ...
        if REQUEST is not None:
            sn = st.getSkinNameFromRequest(REQUEST=REQUEST)
        if sn is None:
