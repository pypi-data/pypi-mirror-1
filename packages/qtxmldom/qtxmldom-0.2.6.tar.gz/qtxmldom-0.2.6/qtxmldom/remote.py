...
invoked on an HTML input element. After such actions, it is recommended that the
special setReady method is used on the part object before attempting to get the
changed document:
...
The above mechanism is not perfect and may be replaced by something that better
ensures the presence of a newly loaded document before any attempt may be made
to retrieve it.
"""
