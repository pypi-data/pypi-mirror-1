...
class Application:
    ...
    * depth (default 2) - The number of stack frames to call sys._getframe()
    ...
    def push(self, language_code):
        ...
        self._translator_stack.append(translator)
    ...
    def pop(self):
        ...
        context.
        """
        if len(self._translator_stack) > 0:
            self._translator_stack.pop()
    ...
    def current(self):
        ...
        return self._translator_stack[-1]
