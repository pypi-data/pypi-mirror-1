...
DEFAULT_DOCTEST_FLAGS = (doctest.ELLIPSIS | doctest.REPORT_ONLY_FIRST_FAILURE |
                         doctest.NORMALIZE_WHITESPACE)
...
def convert(src=None,
    ...
    input = _input_process(input)

    # Remove first docstring ...
    pinput = _input_fixup(input)       
