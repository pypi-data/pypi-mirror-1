...
This module implements a DAS parser.
"""
...
class DASParser(BaseParser):
    ...
    Now we build a new dataset from the DDS and apply the DAS:
    ...
    def _container(self):
        ...
        if isinstance(self._target, dtypes.StructureType) and name in self._target.keys():
