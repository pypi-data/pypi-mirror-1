...
def regrid_array(a, dims, ndims, *args, **kwargs):
    ...
    b = map_coordinates(a, coordinates, *args, **kwargs)
    b.shape = [len(ndim) for ndim in ndims]
    return b

def regrid(grid, ndims, *args, **kwargs):
    ...
    b = regrid_array(grid.data[:], dims, ndims, *args, **kwargs)
