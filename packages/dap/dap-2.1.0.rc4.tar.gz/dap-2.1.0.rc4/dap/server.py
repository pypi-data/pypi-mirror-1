...
This module implements the basic responses (DAS, DDS, DODS, ASCII, etc.)
for the DAP server, together with a simple server function.
"""
...
class BaseHandler(object):
    ...
    overwriting the method _parseconstraints (and possibly __init__) to 
    return the desired dataset from a filepath.
    """
    ...
    def json(self, constraints=None):
        ...
        headers = [('Content-description', 'dods_json'),
                   ...
                   #for debug... ('Content-type', 'text/plain'),
                  ]
