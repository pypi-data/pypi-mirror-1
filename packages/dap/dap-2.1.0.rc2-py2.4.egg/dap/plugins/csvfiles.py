...
abuses lambda and itertools, but it works *very* nice. The plugin uses the 
getfilter() function to create a filter from the constraint expression,
and applies it on-the-fly on the data as it is being read.
"""
