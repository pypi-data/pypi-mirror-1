...
setup(name="z-base-62",
      ...
      long_description='Encodes strings of binary bytes (base-256) into strings of alphanumerics chars (base-62) and decodes them again.',
      author='Zooko O\'Whielacronx',
      author_email='zooko@zooko.com',
      url='http://zooko.com/repos/z-base-62',
      license='BSD',
