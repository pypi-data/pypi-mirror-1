...
def pisaLoop(node, c, path=[], **kw):
    ...
    # ELEMENT
        ...
        if isBlock:
            ...
            # Page break by CSS
            if c.cssAttr.has_key("-pdf-page-break"): # XXX Just a test for vendor specific attribute, http://www.w3.org/TR/CSS21/syndata.html#vendor-keywords
        ...
        if c.cssAttr.has_key("font-weight"):   
            ...
            if value in ("bold", "bolder", "100", "200", "300", "400", "500", "600", "700", "800", "900"):
                c.frag.bold = 1
            else:
                c.frag.bold = 0
        ...
        if staticFrame:
            c.addPara()
            staticFrame.pisaStaticStory = c.story            
