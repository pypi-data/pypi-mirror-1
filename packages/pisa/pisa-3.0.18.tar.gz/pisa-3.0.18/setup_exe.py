...
__date__    = "$Date: 2008-03-12 18:40:31 +0100 (Mi, 12 Mrz 2008) $"
__svnid__   = "$Id: setup_exe.py 162 2008-03-12 17:40:31Z holtwick $"
...
class Target:
    def __init__(self, **kw):
        ...
        self.copyright = "(c) Dirk Holtwick, 2007"
        self.name = "pisa"
...
SDIST = "pisa-" + version.VERSION + "\\"
DIR = "pisa-" + version.VERSION + "-windows"
# os.makedirs(DIR)
os.rename("exe", DIR)
