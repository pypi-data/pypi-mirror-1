...
<axsl:apply-templates select="recursive" mode="id2277869"/>
</html>
  </axsl:template>
  <axsl:template match="recursive" mode="id2277869">
    <body xmlns="http://www.w3.org/1999/xhtml">
<form action="" method="POST">

<!-- Template text between the start and the interesting part. -->

<axsl:apply-templates select="list" mode="id2314525"/>
<p>
...
<!-- Template text between the interesting part and the end. -->
  ...
  <axsl:template match="list" mode="id2314525">
  ...
  <ul>
    <axsl:apply-templates select="item" mode="id2288091"/>
  </ul>
</div>
  </axsl:template>
  <axsl:template match="item" mode="id2288091">
  ...
  <axsl:template match="list" mode="id2310174">
