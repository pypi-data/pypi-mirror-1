...
<axsl:apply-templates select="recursive" mode="id2276755"/>
</html>
  </axsl:template>
  <axsl:template match="recursive" mode="id2276755">
    <body xmlns="http://www.w3.org/1999/xhtml">
<form action="" method="POST">

<!-- Template text between the start and the interesting part. -->

<axsl:apply-templates select="list" mode="id2277781"/>
<p>
...
<!-- Template text between the interesting part and the end. -->
  ...
  <axsl:template match="list" mode="id2277781">
  ...
  <ul>
    <axsl:apply-templates select="item" mode="id2298661"/>
  </ul>
</div>
  </axsl:template>
  <axsl:template match="item" mode="id2298661">
  ...
  <axsl:template match="list" mode="id2301298">
