...
<axsl:apply-templates select="candidate" mode="id2284222"/>
</html>
  </axsl:template>
  <axsl:template match="candidate" mode="id2284222">
...
<table border="0" cellspacing="0" cellpadding="5" width="80%" align="left">
  <tbody>
    <axsl:apply-templates select="identity" mode="id2284250"/>
    <tr>
      <th width="30%">Work status</th>
      <td width="70%">
        <axsl:apply-templates select="status" mode="id2284315"/>
      </td>
    </tr>
    <tr>
      <th width="30%">Skills</th>
      <td width="70%">
        <axsl:apply-templates select="skills" mode="id2284339"/>
      </td>
    </tr>
    <tr>
      <th width="30%">Qualifications</th>
      <td width="70%" xml:space="preserve">
        <axsl:apply-templates select="qualifications" mode="id2284375"/>
      </td>
    </tr>
    <axsl:apply-templates select="experience" mode="id2284427"/>
  </tbody>
</table>

</body>
  </axsl:template>
  <axsl:template match="identity" mode="id2284250">
  ...
  <axsl:template match="status" mode="id2284315">
    <span xmlns="http://www.w3.org/1999/xhtml">
      <axsl:value-of select="@value"/>
    </span>
  </axsl:template>
  <axsl:template match="skills" mode="id2284339">
    <axsl:apply-templates select="skill" mode="id2284339"/>
  </axsl:template>
  <axsl:template match="skill" mode="id2284339">
    <axsl:choose>
  ...
  <axsl:template match="qualifications" mode="id2284375">
    <axsl:apply-templates select="qualification" mode="id2284375"/>
  </axsl:template>
  <axsl:template match="qualification" mode="id2284375">
    <span xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="experience" mode="id2284427">
    <axsl:apply-templates select="employment" mode="id2284427"/>
  </axsl:template>
  <axsl:template match="employment" mode="id2284427">
    <tr xmlns="http://www.w3.org/1999/xhtml">
      <th width="30%">
