...
<html>
  ...
  <body>
    ...
    <ul>
      ...
      <li><a href="verysimplewithlogin">A very simple example requiring a login</a></li>
    </ul>
...
def get_site(host):
    ...
    """
    Define the resource mapping, using the server 'host' URL to initialise some
    examples.
    """
    ...
    resource = MapResource({
        ...
        "verysimplewithlogin" : VerySimpleWithLogin.get_site(host),
        "" : DemoResource(),
        })
...
def prepare_resources():
    for module in [Candidate, Configurator, Dictionary, Questionnaire, PEP241, Recursive, VerySimple, VerySimpleWithLogin]:
