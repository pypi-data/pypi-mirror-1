...
<axsl:apply-templates select="questionnaire" mode="id2347011"/>
</html>
  </axsl:template>
  <axsl:template match="questionnaire" mode="id2347011">
...
<form method="POST" action="">
  ...
  <table class="questionnaire">
    <axsl:apply-templates select="question" mode="id2347046"/>
  </table>
  ...
  <axsl:template match="question" mode="id2347046">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
      ...
      <axsl:apply-templates select="choice" mode="id2347254"/>
      <tr>
        <td class="response"/>
        <td class="response"/>
        <td class="response">
  ...
  <axsl:template match="choice" mode="id2347254">
