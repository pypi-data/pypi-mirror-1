...
<axsl:apply-templates select="login" mode="id2354824"/>
</html>
  </axsl:template>
  <axsl:template match="login" mode="id2354824">
...
<form method="post">
  <table cellspacing="0" cellpadding="5" id="login-info">
    ...
    <tbody>
      <axsl:apply-templates select="error" mode="id2410789"/>
      <tr>
        <th>Username</th>
  ...
  <axsl:template match="error" mode="id2410789">
