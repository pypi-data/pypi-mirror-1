...
<axsl:apply-templates select="admin" mode="id2290687"/>
</html>
  </axsl:template>
  <axsl:template match="admin" mode="id2290687">
...
<table border="0" cellspacing="0" cellpadding="5" width="80%" align="left">
  <tbody>
    ...
    <axsl:apply-templates select="cvs" mode="id2290747"/>
    <tr>
      <th width="30%">
      </th>
      <td width="70%">
  ...
  <axsl:template match="cvs" mode="id2290747">
    <axsl:apply-templates select="cv" mode="id2290747"/>
  </axsl:template>
  <axsl:template match="cv" mode="id2290747">
