...
<axsl:apply-templates select="candidate" mode="id2298351"/>
</html>
  </axsl:template>
  <axsl:template match="candidate" mode="id2298351">
...
<table border="0" cellspacing="0" cellpadding="5" width="80%" align="left">
  <tbody>
    <axsl:apply-templates select="identity" mode="id2298381"/>
    <tr>
      <th width="30%">Work status</th>
      <td width="70%">
        <axsl:apply-templates select="status" mode="id2298461"/>
      </td>
    </tr>
    <tr>
      <th width="30%">Skills</th>
      <td width="70%">
        <axsl:apply-templates select="skills" mode="id2298498"/>
      </td>
    </tr>
    <tr>
      <th width="30%">Qualifications</th>
      <td width="70%" xml:space="preserve">
        <axsl:apply-templates select="qualifications" mode="id2298547"/>
      </td>
    </tr>
    <axsl:apply-templates select="experience" mode="id2298618"/>
  </tbody>
</table>

</body>
  </axsl:template>
  <axsl:template match="identity" mode="id2298381">
  ...
  <axsl:template match="status" mode="id2298461">
    <span xmlns="http://www.w3.org/1999/xhtml">
      <axsl:value-of select="@value"/>
    </span>
  </axsl:template>
  <axsl:template match="skills" mode="id2298498">
    <axsl:apply-templates select="skill" mode="id2298498"/>
  </axsl:template>
  <axsl:template match="skill" mode="id2298498">
    <axsl:choose>
  ...
  <axsl:template match="qualifications" mode="id2298547">
    <axsl:apply-templates select="qualification" mode="id2298547"/>
  </axsl:template>
  <axsl:template match="qualification" mode="id2298547">
    <span xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="experience" mode="id2298618">
    <axsl:apply-templates select="employment" mode="id2298618"/>
  </axsl:template>
  <axsl:template match="employment" mode="id2298618">
    <tr xmlns="http://www.w3.org/1999/xhtml">
      <th width="30%">
