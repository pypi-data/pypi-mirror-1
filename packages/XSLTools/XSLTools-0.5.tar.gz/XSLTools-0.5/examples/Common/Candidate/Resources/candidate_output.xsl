...
<axsl:apply-templates select="candidate" mode="id2307000"/>
</html>
  </axsl:template>
  <axsl:template match="candidate" mode="id2307000">
...
<table border="0" cellspacing="0" cellpadding="5" width="80%" align="left">
  <tbody>
    ...
    <axsl:apply-templates select="identity" mode="id2307057"/>
    <tr>
      <th width="30%">Work status</th>
      <td width="70%">
        <axsl:apply-templates select="status" mode="id2307160"/>
      </td>
    </tr>
    <tr>
      <th colspan="2">Skills</th>
    </tr>
    <axsl:apply-templates select="skills" mode="id2307220"/>
    <tr>
      <th width="30%"/>
      <td width="70%">
  ...
  <axsl:apply-templates select="qualifications" mode="id2307307"/>
  <tbody>
    <tr>
      <th width="30%"/>
      <td width="70%">
  ...
  <axsl:apply-templates select="experience" mode="id2307503"/>
  <tbody>
    <tr>
      <th width="30%"/>
      <td width="70%">
  ...
  <axsl:template match="identity" mode="id2307057">
  ...
  <axsl:template match="status" mode="id2307160">
    <axsl:choose>
      <axsl:when test="@value">
        ...
        <select xmlns="http://www.w3.org/1999/xhtml" name="{template:this-attribute()}">
          <axsl:apply-templates select="status-enum" mode="id2307192"/>
        </select>
      </axsl:when>
      <axsl:otherwise>
        <axsl:variable name="this-name">value</axsl:variable>
  ...
  <axsl:template match="status-enum" mode="id2307192">
  ...
  <axsl:template match="skills" mode="id2307220">
    <axsl:apply-templates select="skill" mode="id2307220"/>
  </axsl:template>
  <axsl:template match="skill" mode="id2307220">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="qualifications" mode="id2307307">
    <axsl:apply-templates select="qualification" mode="id2307307"/>
  </axsl:template>
  <axsl:template match="qualification" mode="id2307307">
  ...
  <axsl:template match="experience" mode="id2307503">
    <axsl:apply-templates select="employment" mode="id2307503"/>
  </axsl:template>
  <axsl:template match="employment" mode="id2307503">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
    <tr>
