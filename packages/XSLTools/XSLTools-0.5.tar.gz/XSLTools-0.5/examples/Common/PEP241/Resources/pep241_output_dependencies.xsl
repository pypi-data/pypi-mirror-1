...
<axsl:stylesheet xmlns:dyn="http://exslt.org/dynamic" xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:template="http://www.boddie.org.uk/ns/xmltools/template" version="1.0" extension-element-prefixes="dyn">
  ...
  <axsl:template match="/">
    <axsl:for-each select="dyn:evaluate($element-path)">
      <tbody xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" template:section="dependencies" id="dependencies">
      <tr>
        <th colspan="2" class="heading">Dependencies</th>
      </tr>
      <axsl:apply-templates select="dependencies" mode="id2351861"/>
      <tr>
        <th/>
        <td>
  ...
  <axsl:template match="dependencies" mode="id2351861">
    <axsl:apply-templates select="dependency" mode="id2351861"/>
  </axsl:template>
  <axsl:template match="dependency" mode="id2351861">
