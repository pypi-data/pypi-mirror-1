...
<axsl:stylesheet xmlns:dyn="http://exslt.org/dynamic" xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:template="http://www.boddie.org.uk/ns/xmltools/template" version="1.0" extension-element-prefixes="dyn">
  ...
  <axsl:template match="/">
    <axsl:for-each select="dyn:evaluate($element-path)">
      <tbody xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="5" template:section="authors" id="authors">
      <tr>
        <th colspan="2" class="heading">Authors</th>
      </tr>
      <axsl:apply-templates select="authors" mode="id2367606"/>
      <tr>
        <th/>
        <td>
  ...
  <axsl:template match="authors" mode="id2367606">
    <axsl:apply-templates select="author" mode="id2367606"/>
  </axsl:template>
  <axsl:template match="author" mode="id2367606">
