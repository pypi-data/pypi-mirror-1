...
<axsl:apply-templates select="package" mode="id2352177"/>
</html>
  </axsl:template>
  <axsl:template match="package" mode="id2352177">
...
<form method="POST">
  ...
  <table cellspacing="0" cellpadding="5">
    <tbody>
      ...
      <axsl:apply-templates select="error" mode="id2352373"/>
      <tr>
        <th>Home page</th>
      ...
      <axsl:apply-templates select="categories" mode="id2352472"/>
      <tr>
        <th colspan="2" class="heading">Platforms</th>
      </tr>
    </tbody>
    <tbody template:section="platforms" id="platforms">
      <axsl:apply-templates select="platforms" mode="id2352569"/>
      <tr>
        <th/>
        <td>
    ...
    <tbody template:section="supported-platforms" id="supported-platforms">
      <tr>
        <th colspan="2" class="heading">Supported platforms</th>
      </tr>
      <axsl:apply-templates select="supported-platforms" mode="id2352678"/>
      <tr>
        <th/>
        <td>
    ...
    <tbody template:section="keywords" id="keywords">
      <tr>
        <th colspan="2" class="heading">Keywords</th>
      </tr>
      <axsl:apply-templates select="keywords" mode="id2352798"/>
      <tr>
        <th/>
        <td>
    ...
    <tbody cellspacing="0" cellpadding="5" template:section="authors" id="authors">
      <tr>
        <th colspan="2" class="heading">Authors</th>
      </tr>
      <axsl:apply-templates select="authors" mode="id2352907"/>
      <tr>
        <th/>
        <td>
    ...
    <tbody cellspacing="0" cellpadding="5" template:section="dependencies" id="dependencies">
      <tr>
        <th colspan="2" class="heading">Dependencies</th>
      </tr>
      <axsl:apply-templates select="dependencies" mode="id2353046"/>
      <tr>
        <th/>
        <td>
  ...
  <axsl:template match="error" mode="id2352373">
  ...
  <axsl:template match="categories" mode="id2352472">
    <tr xmlns="http://www.w3.org/1999/xhtml">
        <th>Categories</th>
        <td>
          <axsl:apply-templates select="category" mode="id2352504"/>
        </td>
      </tr>
  </axsl:template>
  <axsl:template match="category" mode="id2352504">
    <select xmlns="http://www.w3.org/1999/xhtml" multiple="multiple" name="{template:list-attribute('category-enum',&#10;            'value')}">
            <axsl:apply-templates select="category-enum" mode="id2352534"/>
          </select>
  </axsl:template>
  <axsl:template match="category-enum" mode="id2352534">
  ...
  <axsl:template match="platforms" mode="id2352569">
    <axsl:apply-templates select="platform" mode="id2352569"/>
  </axsl:template>
  <axsl:template match="platform" mode="id2352569">
    <tr xmlns="http://www.w3.org/1999/xhtml">
        <th>Platform name</th>
  ...
  <axsl:template match="supported-platforms" mode="id2352678">
    <axsl:apply-templates select="supported-platform" mode="id2352678"/>
  </axsl:template>
  <axsl:template match="supported-platform" mode="id2352678">
    <tr xmlns="http://www.w3.org/1999/xhtml">
        <th>Platform name</th>
        <td><axsl:choose><axsl:when test="@name"><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value" select="@name"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
  ...
  <axsl:template match="keywords" mode="id2352798">
    <axsl:apply-templates select="keyword" mode="id2352798"/>
  </axsl:template>
  <axsl:template match="keyword" mode="id2352798">
    <tr xmlns="http://www.w3.org/1999/xhtml">
        <th>Keyword</th>
        <td><axsl:choose><axsl:when test="@name"><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value" select="@name"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
  ...
  <axsl:template match="authors" mode="id2352907">
    <axsl:apply-templates select="author" mode="id2352907"/>
  </axsl:template>
  <axsl:template match="author" mode="id2352907">
        <tr xmlns="http://www.w3.org/1999/xhtml">
          <th>Author name</th>
          <td><axsl:choose><axsl:when test="@name"><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value" select="@name"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
  ...
  <axsl:template match="dependencies" mode="id2353046">
    <axsl:apply-templates select="dependency" mode="id2353046"/>
  </axsl:template>
  <axsl:template match="dependency" mode="id2353046">
        <tr xmlns="http://www.w3.org/1999/xhtml">
          <th>Package name</th>
          <td><axsl:choose><axsl:when test="@name"><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value" select="@name"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
