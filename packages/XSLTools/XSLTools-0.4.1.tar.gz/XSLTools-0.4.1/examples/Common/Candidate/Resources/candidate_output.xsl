...
<axsl:apply-templates select="candidate" mode="id2288611"/>
</html>
  </axsl:template>
  <axsl:template match="candidate" mode="id2288611">
...
<table border="0" cellspacing="0" cellpadding="5" width="80%" align="left">
  <tbody>
    ...
    <axsl:apply-templates select="identity" mode="id2288663"/>
    <tr>
      <th width="30%">Work status</th>
      <td width="70%">
        <axsl:apply-templates select="status" mode="id2288734"/>
      </td>
    </tr>
    <tr>
      <th colspan="2">Skills</th>
    </tr>
    <axsl:apply-templates select="skills" mode="id2288786"/>
    <tr>
      <th width="30%"/>
      <td width="70%">
  ...
  <axsl:apply-templates select="qualifications" mode="id2288848"/>
  <tbody>
    <tr>
      <th width="30%"/>
      <td width="70%">
  ...
  <axsl:apply-templates select="experience" mode="id2288985"/>
  <tbody>
    <tr>
      <th width="30%"/>
      <td width="70%">
  ...
  <axsl:template match="identity" mode="id2288663">
  ...
  <axsl:template match="status" mode="id2288734">
    <axsl:choose>
      <axsl:when test="@value">
        ...
        <select xmlns="http://www.w3.org/1999/xhtml" name="{template:this-attribute()}">
          <axsl:apply-templates select="status-enum" mode="id2288756"/>
        </select>
      </axsl:when>
      <axsl:otherwise>
        <axsl:variable name="this-name">value</axsl:variable>
  ...
  <axsl:template match="status-enum" mode="id2288756">
  ...
  <axsl:template match="skills" mode="id2288786">
    <axsl:apply-templates select="skill" mode="id2288786"/>
  </axsl:template>
  <axsl:template match="skill" mode="id2288786">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="qualifications" mode="id2288848">
    <axsl:apply-templates select="qualification" mode="id2288848"/>
  </axsl:template>
  <axsl:template match="qualification" mode="id2288848">
  ...
  <axsl:template match="experience" mode="id2288985">
    <axsl:apply-templates select="employment" mode="id2288985"/>
  </axsl:template>
  <axsl:template match="employment" mode="id2288985">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
    <tr>
