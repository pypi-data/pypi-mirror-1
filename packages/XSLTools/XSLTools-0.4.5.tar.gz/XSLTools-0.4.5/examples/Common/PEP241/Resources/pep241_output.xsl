...
<axsl:apply-templates select="package" mode="id2313425"/>
</html>
  </axsl:template>
  <axsl:template match="package" mode="id2313425">
...
<form method="POST">
  ...
  <table cellspacing="0" cellpadding="5">
    <tbody>
      ...
      <axsl:apply-templates select="error" mode="id2313571"/>
      <tr>
        <th>Home page</th>
      ...
      <axsl:apply-templates select="categories" mode="id2313644"/>
      <tr>
        <th colspan="2" class="heading">Platforms</th>
      </tr>
    </tbody>
    <tbody template:id="platforms" id="platforms">
      <axsl:apply-templates select="platforms" mode="id2313721"/>
      <tr>
        <th/>
        <td>
    ...
    <tbody template:id="supported-platforms" id="supported-platforms">
      ...
      <axsl:apply-templates select="supported-platforms" mode="id2313789"/>
      <tr>
        <th/>
        <td>
    ...
    <tbody template:id="keywords" id="keywords">
      ...
      <axsl:apply-templates select="keywords" mode="id2313878"/>
      <tr>
        <th/>
        <td>
    ...
    <tbody cellspacing="0" cellpadding="5" template:id="authors" id="authors">
      ...
      <axsl:apply-templates select="authors" mode="id2313966"/>
      <tr>
        <th/>
        <td>
    ...
    <tbody cellspacing="0" cellpadding="5" template:id="dependencies" id="dependencies">
      ...
      <axsl:apply-templates select="dependencies" mode="id2314106"/>
      <tr>
        <th/>
        <td>
  ...
  <axsl:template match="error" mode="id2313571">
  ...
  <axsl:template match="categories" mode="id2313644">
    <tr xmlns="http://www.w3.org/1999/xhtml">
        <th>Categories</th>
        <td>
          <axsl:apply-templates select="category" mode="id2313661"/>
        </td>
      </tr>
  </axsl:template>
  <axsl:template match="category" mode="id2313661">
    <select xmlns="http://www.w3.org/1999/xhtml" multiple="multiple" name="{template:list-attribute('category-enum',&#10;            'value')}">
            <axsl:apply-templates select="category-enum" mode="id2313684"/>
          </select>
  </axsl:template>
  <axsl:template match="category-enum" mode="id2313684">
  ...
  <axsl:template match="platforms" mode="id2313721">
    <axsl:apply-templates select="platform" mode="id2313721"/>
  </axsl:template>
  <axsl:template match="platform" mode="id2313721">
    <tr xmlns="http://www.w3.org/1999/xhtml">
        <th>Platform name</th>
  ...
  <axsl:template match="supported-platforms" mode="id2313789">
    <axsl:apply-templates select="supported-platform" mode="id2313789"/>
  </axsl:template>
  <axsl:template match="supported-platform" mode="id2313789">
    <tr xmlns="http://www.w3.org/1999/xhtml">
        <th>Platform name</th>
        <td><axsl:choose><axsl:when test="@name"><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value" select="@name"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
  ...
  <axsl:template match="keywords" mode="id2313878">
    <axsl:apply-templates select="keyword" mode="id2313878"/>
  </axsl:template>
  <axsl:template match="keyword" mode="id2313878">
    <tr xmlns="http://www.w3.org/1999/xhtml">
        <th>Keyword</th>
        <td><axsl:choose><axsl:when test="@name"><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value" select="@name"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
  ...
  <axsl:template match="authors" mode="id2313966">
    <axsl:apply-templates select="author" mode="id2313966"/>
  </axsl:template>
  <axsl:template match="author" mode="id2313966">
        <tr xmlns="http://www.w3.org/1999/xhtml">
          <th>Author name</th>
          <td><axsl:choose><axsl:when test="@name"><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value" select="@name"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
  ...
  <axsl:template match="dependencies" mode="id2314106">
    <axsl:apply-templates select="dependency" mode="id2314106"/>
  </axsl:template>
  <axsl:template match="dependency" mode="id2314106">
        <tr xmlns="http://www.w3.org/1999/xhtml">
          <th>Package name</th>
          <td><axsl:choose><axsl:when test="@name"><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value" select="@name"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:when><axsl:otherwise><axsl:variable name="this-name">name</axsl:variable><axsl:variable name="this-value"/><input type="text" size="20" name="{template:this-attribute()}" value="{$this-value}"/></axsl:otherwise></axsl:choose>
