...
<axsl:apply-templates select="candidate" mode="id2288407"/>
</html>
  </axsl:template>
  <axsl:template match="candidate" mode="id2288407">
...
<table border="0" cellspacing="0" cellpadding="5" width="80%" align="left">
  <tbody>
    ...
    <axsl:apply-templates select="identity" mode="id2288459"/>
    <tr>
      <th width="30%">Work status</th>
      <td width="70%">
        <axsl:apply-templates select="status" mode="id2288530"/>
      </td>
    </tr>
    <tr>
      <th colspan="2">Skills</th>
    </tr>
    <axsl:apply-templates select="skills" mode="id2288582"/>
    <tr>
      <th width="30%"/>
      <td width="70%">
  ...
  <axsl:apply-templates select="qualifications" mode="id2288643"/>
  <tbody>
    <tr>
      <th width="30%"/>
      <td width="70%">
  ...
  <axsl:apply-templates select="experience" mode="id2288780"/>
  <tbody>
    <tr>
      <th width="30%"/>
      <td width="70%">
  ...
  <axsl:template match="identity" mode="id2288459">
  ...
  <axsl:template match="status" mode="id2288530">
    <axsl:choose>
      <axsl:when test="@value">
        ...
        <select xmlns="http://www.w3.org/1999/xhtml" name="{template:this-attribute()}">
          <axsl:apply-templates select="status-enum" mode="id2288552"/>
        </select>
      </axsl:when>
      <axsl:otherwise>
        <axsl:variable name="this-name">value</axsl:variable>
  ...
  <axsl:template match="status-enum" mode="id2288552">
  ...
  <axsl:template match="skills" mode="id2288582">
    <axsl:apply-templates select="skill" mode="id2288582"/>
  </axsl:template>
  <axsl:template match="skill" mode="id2288582">
    <tr xmlns="http://www.w3.org/1999/xhtml">
  ...
  <axsl:template match="qualifications" mode="id2288643">
    <axsl:apply-templates select="qualification" mode="id2288643"/>
  </axsl:template>
  <axsl:template match="qualification" mode="id2288643">
  ...
  <axsl:template match="experience" mode="id2288780">
    <axsl:apply-templates select="employment" mode="id2288780"/>
  </axsl:template>
  <axsl:template match="employment" mode="id2288780">
    <tbody xmlns="http://www.w3.org/1999/xhtml">
    <tr>
