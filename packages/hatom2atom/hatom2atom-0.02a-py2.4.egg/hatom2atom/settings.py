...
main_xslt = "hAtom2Atom.xsl"
main_kid = 'proxypage.kid'
xsl_dir = 'xsl'
kid_dir = 'kid'
xsl_dir = resource_filename(app_resource, xsl_dir)
main_xslt = os.sep.join([xsl_dir, main_xslt])
kid_dir = resource_filename(app_resource, kid_dir)
main_kid = os.sep.join([kid_dir, main_kid])
