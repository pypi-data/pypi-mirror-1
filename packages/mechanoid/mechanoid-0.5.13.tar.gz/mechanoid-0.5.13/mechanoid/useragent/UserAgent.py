...
from mechanoid.http_processors.HTTPProcessors import HTTPErrorProcessor, HTTPRequestUpgradeProcessor, \
	 ...
	 SeekableProcessor, HTTPRedirectDebugProcessor, HTTPResponseDebugProcessor, HTTPRobotRulesProcessor
...
class UserAgent(OpenerDirector):
	...
	default_features = ["_authen", "_redirect", "_cookies", "_seek", "_proxy", "_robots"]
	...
	def set_handle_robots(self, handle):
		...
		"""
		self.__set_handler("_robots", handle)
		return
