...
##	argTypes=[CFUNCTYPE(None, c_int, c_int, c_int, c_int)],
##	doc='glutMouseWheelFunc( CFUNCTYPE(None, c_int, c_int, c_int, c_int)(callback) ) -> None', 
##	argNames=('callback',),
##)
...
##	argTypes=[CFUNCTYPE(None)],
##	doc='glutCloseFunc( CFUNCTYPE(None)(callback) ) -> None', 
##	argNames=('callback',),
##)
...
##	argTypes=[CFUNCTYPE(None)],
##	doc='glutWMCloseFunc( CFUNCTYPE(None)(callback) ) -> None', 
##	argNames=('callback',),
##)
...
##	argTypes=[CFUNCTYPE(None)],
##	doc='glutMenuDestroyFunc( CFUNCTYPE(None)(callback) ) -> None', 
##	argNames=('callback',),
##)
