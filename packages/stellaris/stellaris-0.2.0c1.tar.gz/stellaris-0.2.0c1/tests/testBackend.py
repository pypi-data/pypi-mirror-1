...
import unittest
from stellaris.backend import ContextNotFound
...
class TestBackend(unittest.TestCase):
    ...
    def testUpdate(self):
        ...
        self.update("./tests/data/update.rdf")
    ...
    def testListUpdate(self):
        self.insert('./tests/data/addlist.rdf')
        ...
        self.update('./tests/data/updatelist.rdf')
