...
__fileid    = "$Id: ui.py 37 2009-04-03 01:58:16Z jeanlou.dupont $"
...
class BaseCmdUI(object):
    ...
    **Messages object**
    ...
    def handleError( self, exc ):
        ...
        The object ``exc`` is inspected for the 
        """
        try:    msg_key = exc.msg    
        except: msg_key = None 
    ...
    def handleArguments(self, usage_msg=None, args = None, help_params = None):
        """ 
        ...
        parser = ExOptionParser( usage=usage_msg )
    ...
    def updateRegistry(self, reg):
        ...
        for o in self.ref_options:
            ...
            if do_update:
                ...
                key = o.get('dest', None)
                if key is None:
                    raise BaseCmdUIConfigError('error_var_key_not_found', {'option':o})
