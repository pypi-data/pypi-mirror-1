...
class AnnotationFile:
    ...
    def ReadAnnHeader( self, background ):
        ...
        while True:
            ...
            if parameter == 'bg_type':
                ...
                sz = int(value)
                background.med = num.fromstring(self.file.read(sz),num.double)
                background.med.shape = params.movie_size
            elif parameter == 'background mean':
                sz = int(value)
                background.mean = num.fromstring(self.file.read(sz),num.double)
                ...
                sz = int(value)
                background.mad = num.fromstring(self.file.read(sz),num.double)
                background.mad.shape = params.movie_size
            elif parameter == 'background std':
                sz = int(value)
                background.std = num.fromstring(self.file.read(sz),num.double)
                background.std.shape = params.movie_size
            elif parameter == 'hfnorm':
                sz = int(value)
                background.hfnorm = num.fromstring(self.file.read(sz),num.double)
    ...
    def WriteMAT( self, filename, data ):
