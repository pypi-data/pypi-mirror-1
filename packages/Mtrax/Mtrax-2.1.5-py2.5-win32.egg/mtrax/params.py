...
def averageshape(shape1,shape2):
    ...
    shape3.minor = (shape1.major+shape2.minor)/2.
    shape3.area = (shape1.major+shape2.area)/2.
    shape3.ecc = (shape1.major+shape2.ecc)/2.
    return shape3
...
class Parameters:
    def __init__(self):
        ...
        # whether mtrax was started in interactive mode or not
        ...
        self.maxshape = ShapeParams(num.inf,num.inf,num.inf,1.)
        ...
        self.velocity_angle_weight = None
